...
class Section {
 ...
 public:
  ...
  virtual void readXclBinBinary(std::istream& _istream, const hrx::property_tree::ptree& _ptSection);
  void readJSONSectionImage(const hrx::property_tree::ptree& _ptSection);
  ...
  virtual void appendToSectionMetadata(const hrx::property_tree::ptree& _ptAppendData, hrx::property_tree::ptree& _ptToAppendTo);
  ...
  void getPayload(hrx::property_tree::ptree& _pt) const;
  void purgeBuffers();
 ...
 protected:
  ...
  virtual void marshalToJSON(char* _pDataSection, unsigned int _sectionSize, hrx::property_tree::ptree& _ptree) const;
  virtual void marshalFromJSON(const hrx::property_tree::ptree& _ptSection, std::ostringstream& _buf) const;
