...
class XclBin {
 ...
 private:
  ...
  void findAndReadMirrorData(std::fstream& _istream, hrx::property_tree::ptree& _mirrorData) const;
  void readXclBinaryMirrorImage(std::fstream& _istream, const hrx::property_tree::ptree& _mirrorData);

  void writeXclBinBinaryMirrorData(std::ostream& _ostream, const hrx::property_tree::ptree& _mirroredData) const;

  void addHeaderMirrorData(hrx::property_tree::ptree& _pt_header);
 ...
 private:
  void readXclBinHeader(const hrx::property_tree::ptree& _ptHeader, struct axlf& _axlfHeader);
  void readXclBinSection(std::fstream& _istream, const hrx::property_tree::ptree& _ptSection);
  void writeXclBinBinaryHeader(std::ostream& _ostream, hrx::property_tree::ptree& _mirroredData);
  void writeXclBinBinarySections(std::ostream& _ostream, hrx::property_tree::ptree& _mirroredData);


 protected:
  void addPTreeSchemaVersion(hrx::property_tree::ptree& _pt, SchemaVersion const& _schemaVersion);
  void getSchemaVersion(hrx::property_tree::ptree& _pt, SchemaVersion& _schemaVersion);
