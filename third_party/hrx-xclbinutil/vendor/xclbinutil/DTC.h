...
class DTC {
 ...
 public:
  ...
  DTC(const hrx::property_tree::ptree& _ptDTC, const FDTProperty::PropertyNameFormat& _propertyNameFormat);
  virtual ~DTC();
 ...
 protected:
  ...
  void marshalFromJSON(const hrx::property_tree::ptree& _ptDTC, const FDTProperty::PropertyNameFormat& _propertyNameFormat);
