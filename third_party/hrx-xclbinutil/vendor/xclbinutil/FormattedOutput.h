...
void getKernelDDRMemory(const std::string& _sKernelInstanceName, const std::vector<Section*> _sections, hrx::property_tree::ptree& _ptKernelInstance, hrx::property_tree::ptree& _ptMemoryConnections);
