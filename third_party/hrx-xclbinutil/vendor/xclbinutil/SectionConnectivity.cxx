...
{
  auto sectionInfo = std::make_unique<SectionInfo>(CONNECTIVITY, "CONNECTIVITY", hrx::factory<SectionConnectivity*>());
                                   ...
                                   hrx::property_tree::ptree& _ptree) const
{
  ...
  if (_sectionSize < sizeof(connectivity)) {
    auto errMsg = hrx::format("ERROR: Section size (%d) is smaller than the size of the connectivity structure (%d)")
  ...
  if (_sectionSize != expectedSize) {
    auto errMsg = hrx::format("ERROR: Section size (%d) does not match expected section size (%d).")
...
void
SectionConnectivity::marshalFromJSON(const hrx::property_tree::ptree& _ptSection,
                                     std::ostringstream& _buf) const
{
  const hrx::property_tree::ptree& ptConnectivity = _ptSection.get_child("connectivity");
