...
{
  auto sectionInfo = std::make_unique<SectionInfo>(AIE_METADATA, "AIE_METADATA", hrx::factory<SectionAIEMetadata*>());
...
void
SectionAIEMetadata::marshalFromJSON(const hrx::property_tree::ptree& _ptSection,
