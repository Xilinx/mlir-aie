                         ...
                         hrx::property_tree::ptree::key_type const& key)
{
    ...
    hrx::property_tree::ptree::const_assoc_iterator it = pt.find(key);
...
template <typename T>
std::vector<T> as_vector_simple(const hrx::property_tree::ptree& pt, 
                                const hrx::property_tree::ptree::key_type& key)
{
...
void QUIET(const hrx::format & fmt);
void TRACE(const std::string& _msg, bool _endl = true);
void TRACE(const hrx::format & fmt, bool _endl = true);
void TRACE_PrintTree(const std::string& _msg, const hrx::property_tree::ptree& _pt);
