...
class FDTNode {
 ...
 private:
  ...
  FDTNode(const hrx::property_tree::ptree& _ptDTC, std::string& _nodeName, const FDTProperty::PropertyNameFormat& _propertyNameFormat);
 ...
 public:
  ...
  static FDTNode* marshalFromJSON(const hrx::property_tree::ptree& _ptDTC, const FDTProperty::PropertyNameFormat& _propertyNameFormat);

 public:
  void marshalToJSON(hrx::property_tree::ptree& _dtcTree, const FDTProperty::PropertyNameFormat& _propertyNameFormat) const;
  void marshalToDTC(DTCStringsBlock& _dtcStringsBlock, std::ostream& _buf) const;

 protected:
  void marshalSubNodeToJSON(hrx::property_tree::ptree& _ptTree, const FDTProperty::PropertyNameFormat& _propertyNameFormat) const;
