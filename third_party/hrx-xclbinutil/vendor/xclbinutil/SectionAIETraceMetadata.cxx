...
{
  auto sectionInfo = std::make_unique<SectionInfo>(AIE_TRACE_METADATA, "AIE_TRACE_METADATA", hrx::factory<SectionAIETraceMetadata*>());
                                  ...
                                  hrx::property_tree::ptree& _ptree) const
{
  ...
  try {
    ...
    hrx::property_tree::ptree& buildMetaData = pt.get_child("aie_metadata");
...
void
SectionAIETraceMetadata::marshalFromJSON(const hrx::property_tree::ptree& _ptSection,
                                    std::ostringstream& _buf) const
{
  XUtil::TRACE("AIE_TRACE_METADATA");
  hrx::property_tree::ptree ptWritable = _ptSection;
  hrx::property_tree::write_json(_buf, ptWritable, false);
}
