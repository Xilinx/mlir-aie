...
{
  auto sectionInfo = std::make_unique<SectionInfo>(EMBEDDED_METADATA, "EMBEDDED_METADATA", hrx::factory<SectionEmbeddedMetadata*>());
                                       ...
                                       hrx::property_tree::ptree& _ptree) const
{
  ...
  hrx::property_tree::read_xml(ss, _ptree, hrx::property_tree::xml_parser::trim_whitespace);
}

#include "hrx_util.h"

void
SectionEmbeddedMetadata::marshalFromJSON(const hrx::property_tree::ptree& _ptSection,
