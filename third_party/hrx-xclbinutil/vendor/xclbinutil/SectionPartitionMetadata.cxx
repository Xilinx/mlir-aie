...
{
  auto sectionInfo = std::make_unique<SectionInfo>(PARTITION_METADATA, "PARTITION_METADATA", hrx::factory<SectionPartitionMetadata*>());
 ...
 */
typedef void (SubNodeFunc)(const hrx::property_tree::ptree& _ptOriginal, hrx::property_tree::ptree& _ptTransformed);
...
SchemaTransform_subNode(const std::string& _nodeName,
                        ...
                        const hrx::property_tree::ptree& _ptOriginal,
                        hrx::property_tree::ptree& _ptTransformed)
{
  // Find the node
  hrx::property_tree::ptree::const_assoc_iterator iter = _ptOriginal.find(_nodeName);
  ...
  hrx::property_tree::ptree ptChildNode;
                          ...
                          hrx::property_tree::ptree& _ptTransformed)
{
  ...
  hrx::property_tree::ptree::const_assoc_iterator iter = _ptOriginal.find(_valueName);
  if (iter == _ptOriginal.not_found()) {
    if (_bRequired == true) {
 ...
 */
void
SchemaTransformUniversal_firmware(const hrx::property_tree::ptree& _ptOriginal,
                                  hrx::property_tree::ptree& _ptTransformed)
{
 ...
 */
void
SchemaTransformUniversal_schema_version(const hrx::property_tree::ptree& _ptOriginal,
                                        hrx::property_tree::ptree& _ptTransformed)
{
 ...
 */
void
SchemaTransformToDTC_pcie(const hrx::property_tree::ptree& _ptOriginal,
                          hrx::property_tree::ptree& _ptTransformed)
{
  hrx::property_tree::ptree ptEmpty;

  // --- Bars ---
  hrx::property_tree::ptree ptBarOriginal;
  ...
  hrx::property_tree::ptree ptBarArray;
  for (auto barEntryOrig : ptBarOriginal) {
    hrx::property_tree::ptree ptBarEntry;
    hrx::property_tree::ptree _ptBarOriginalEntry = barEntryOrig.second;
                                        ...
                                        hrx::property_tree::ptree& _ptTransformed)
{
  ...
  if (_ptOriginal.size() % 2 != 0) {
    auto errMsg =  hrx::format("Error: The interrupt count (%d) for the interrupt '%s' needs to be a paired (e.g. even) set.") % _ptOriginal.size() % _sEndPointName;
...
void
SchemaTransformToDTC_interrupt_mapping(const hrx::property_tree::ptree& _ptOriginal,
                                       hrx::property_tree::ptree& _ptTransformed)
{
  // Look at each entry
  unsigned int indexCount = 0;
  for (auto endpoint : _ptOriginal) {
    hrx::property_tree::ptree ptEndpoint;
 ...
 */
void
SchemaTransformToDTC_interfaces(const hrx::property_tree::ptree& _ptOriginal,
                                hrx::property_tree::ptree& _ptTransformed)
{
  unsigned int index = 0;
  for (auto interface : _ptOriginal) {
    hrx::property_tree::ptree ptInterface;

    SchemaTransform_nameValue("interface_uuid", "", true  /*required*/, interface.second, ptInterface);

    std::string sIndex = (hrx::format("@%d") % index++).str();
                                          ...
                                          hrx::property_tree::ptree& _ptTransformed)
{
  ...
  if (_ptOriginal.find("register_abstraction_name") != _ptOriginal.not_found()) {
    ...
    hrx::property_tree::ptree ptCompLine1;
    ptCompLine1.put("", sCompLine1.c_str());

    hrx::property_tree::ptree ptCompLine2;
    ptCompLine2.put("", tokens[2].c_str());

    hrx::property_tree::ptree ptCompatible;
 ...
 */
void
SchemaTransformToDTC_addressable_endpoints(const hrx::property_tree::ptree& _ptOriginal,
                                           hrx::property_tree::ptree& _ptTransformed)
{
  // Look at each entry
  for (auto endpoint : _ptOriginal) {
...
void
SchemaTransformToDTC_partition_info(const hrx::property_tree::ptree& _ptOriginal,
                                    hrx::property_tree::ptree& _ptTransformed)
{
  // Convert the entire JSON tree under the __INFO node to be a DTB string entry.
  std::ostringstream buf;

  hrx::property_tree::write_json(buf, _ptOriginal, false);
 ...
 */
void
SchemaTransformToDTC_root(const hrx::property_tree::ptree& _ptOriginal,
                          hrx::property_tree::ptree& _ptTransformed)
{
 ...
 */
void
SchemaTransformToPM_pcie(const hrx::property_tree::ptree& _ptOriginal,
                         hrx::property_tree::ptree& _ptTransformed)
{
  hrx::property_tree::ptree ptEmpty;
...
void
SchemaTransformToPM_interrupt_endpoint(const hrx::property_tree::ptree& _ptOriginal,
                                       ...
                                       hrx::property_tree::ptree& _ptTransformed)
{
  ...
  if (_ptOriginal.find("interrupts") != _ptOriginal.not_found()) {
    ...
    for (const std::string& interruptValue : interruptVector) {
      hrx::property_tree::ptree ptValue;
...
void
SchemaTransformToPM_interrupt_mapping(const hrx::property_tree::ptree& _ptOriginal,
                                      hrx::property_tree::ptree& _ptTransformed)
{
  // Look at each entry
  for (auto endpoint : _ptOriginal) {
 ...
 */
void
SchemaTransformToPM_interfaces(const hrx::property_tree::ptree& _ptOriginal,
                               hrx::property_tree::ptree& _ptTransformed)
{
  for (auto interface : _ptOriginal) {
    hrx::property_tree::ptree ptInterface;
                                         ...
                                         hrx::property_tree::ptree& _ptTransformed)
{
  ...
  if (_ptOriginal.find("compatible") != _ptOriginal.not_found()) {
    ...
    hrx::replace_all(registerAbstraction, searchStr, replaceStr);
 ...
 */
void
SchemaTransformToPM_addressable_endpoints(const hrx::property_tree::ptree& _ptOriginal,
                                          hrx::property_tree::ptree& _ptTransformed)
{
  // Look at each entry
  for (auto endpoint : _ptOriginal) {
 ...
 */
void
SchemaTransformToPM_partition_info(const hrx::property_tree::ptree& _ptOriginal,
                                   hrx::property_tree::ptree& _ptTransformed)
{
  // DRC check for known values
  ...
  hrx::property_tree::read_json(is, _ptTransformed);
}
 ...
 */
void
SchemaTransformToPM_root(const hrx::property_tree::ptree& _ptOriginal,
                         hrx::property_tree::ptree& _ptTransformed)
{
  SchemaTransform_subNode("schema_version", true /*required*/,
                          SchemaTransformUniversal_schema_version,
                                        ...
                                        hrx::property_tree::ptree& _ptree) const
{
  ...
  hrx::property_tree::ptree ptTransformed;

  // Parse the DTC buffer
  if (_pDataSection != nullptr) {
    hrx::property_tree::ptree dtcTree;
...
void
SectionPartitionMetadata::marshalFromJSON(const hrx::property_tree::ptree& _ptSection,
                                          std::ostringstream& _buf) const
{
  hrx::property_tree::ptree ptOriginal = _ptSection.get_child("partition_metadata");
  ...
  hrx::property_tree::ptree ptEmpty;
  hrx::property_tree::ptree ptPartitionInfo = _ptSection.get_child("partition_info", ptEmpty);
...
void
SectionPartitionMetadata::appendToSectionMetadata(const hrx::property_tree::ptree& _ptAppendData,
                                                  hrx::property_tree::ptree& _ptToAppendTo)
{
  ...
  hrx::property_tree::ptree& ipShellTree = _ptToAppendTo.get_child("partition_metadata");
