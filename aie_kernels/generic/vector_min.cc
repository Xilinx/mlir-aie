...
void vector(int32_t *restrict v1, int32_t *restrict v2) {
  ...
  int32_t v6 = 32;
  int32_t v7 = 0;
  v16int32 v8 = broadcast_to_v16int32((int32_t)2147483647);
  size_t v9 = 0;
  size_t v10 = 1024;
  size_t v11 = 16;
  v16int32 v12;
...
void scalar(int32_t *restrict v1, int32_t *restrict v2) {
  *(int32_t *)v2 = 27; // what could be smaller
  return;
}
