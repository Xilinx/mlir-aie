...
void swiglu_tanh_approx_bf16(bfloat16 *restrict input_vector,
  ...
  for (int i = 0; i < num_elems; i += 16) {
    ...
    aie::vector<bfloat16, 16> mul_input_weight_1 = 
        aie::mul(input, weight_1);
    // Compute the second part of the SWiGLU: x * w2
    aie::vector<bfloat16, 16> mul_input_weight_2 = 
        aie::mul(input, weight_2);
...
void swiglu_bf16(bfloat16 *restrict input, bfloat16 *restrict weights_1, bfloat16 *restrict weights_2, bfloat16 *restrict output) {
