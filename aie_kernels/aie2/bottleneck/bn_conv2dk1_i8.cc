...
#if defined (BN13_1_INPUT_SPLIT_PARTIAL_PUT_UI8_UI8_CAS_WIDTH_NEW) || (BN14_1_INPUT_SPLIT_PARTIAL_PUT_UI8_UI8_CAS_WIDTH_NEW) 
...
void conv2dk1_ui8_ui8_scalar_input_split_partial_width_put_new(uint8_t *input, int8_t *kernels,
...
#if defined (PARTIAL_PUT_I8_CAS_WIDTH_NEW)  || (BN13_1_PARTIAL_PUT_I8_CAS_WIDTH_NEW) || (BN14_1_PARTIAL_PUT_I8_CAS_WIDTH_NEW)
// 8 Pixels Width Processing Approach: Processes 8 spatial pixels (x_start to x_start + 8) simultaneously within each output channel (oc8 iteration).
...
void bn13_1_conv2dk1_ui8_ui8_input_split_partial_width_put_new(uint8_t *input, int8_t *kernels,
                                              const int32_t input_width, const int32_t input_channels,
                                              const int32_t output_channels, const int32_t input_split,
                                              const int32_t weight_index, const int32_t x_start, const int32_t oc)
                                              {
        conv2dk1_ui8_ui8_scalar_input_split_partial_width_put_new(input, kernels,
...
void bn14_1_conv2dk1_ui8_ui8_input_split_partial_width_put_new(uint8_t *input, int8_t *kernels,
                                              const int32_t input_width, const int32_t input_channels,
                                              const int32_t output_channels, const int32_t input_split,
                                              const int32_t weight_index, const int32_t x_start, const int32_t oc)
                                              {
...
void bn14_1_conv2dk1_i8_ui8_partial_width_put_new(int8_t *input, int8_t *kernels,
                                              const int32_t input_width, const int32_t input_channels,
                                              const int32_t output_channels, int32_t input_split,
                                              int32_t weight_index, int32_t x_start, int32_t oc)
                                              {
...
void bn13_1_conv2dk1_i8_ui8_partial_width_put_new(int8_t *input, int8_t *kernels,
                                              const int32_t input_width, const int32_t input_channels,
                                              const int32_t output_channels, int32_t input_split,
                                              int32_t weight_index, int32_t x_start, int32_t oc)
                                              {
