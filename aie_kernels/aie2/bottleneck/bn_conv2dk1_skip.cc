...
void conv2dk1_ui8_i8_i8_scalar_input_split_partial_width_get_new(uint8_t *input, int8_t *kernels, int8_t *output, int8_t *skip, 
        ...
        // Loop over output channels (oc8)
            for (oc8 = 0; oc8 < 8; oc8++) {
              ...
              for (oc8 = 0; oc8 < 8; oc8++) {
                    ...
                    output[(oc_offset * input_width * 8) + (pixel * 8) + oc8] = skip_sum_srs_final_out;
        }       
    } 
...
void bn_14_2_conv2dk1_ui8_i8_i8_scalar_input_split_partial_width_get_new(uint8_t *input, int8_t *kernels, int8_t *output, int8_t *skip, 
                                              const int32_t input_width, const int32_t input_channels,
                                              const int32_t output_channels, const int scale, const int skip_scale,
                                              const int32_t input_split, int32_t output_split, const int32_t weight_index, const int32_t x_start, const int32_t oc)
                                              {

    conv2dk1_ui8_i8_i8_scalar_input_split_partial_width_get_new(input, kernels, output, skip,
                                                            input_width, input_channels,
                                                            output_channels, scale,skip_scale,
                                                            input_split,output_split,weight_index,x_start,oc) ;

                                              }
#endif
#ifdef BN13_1_INPUT_SPLIT_PARTIAL_GET_UI8_I8_I8_CAS_WIDTH_NEW

void bn_13_2_conv2dk1_ui8_i8_i8_scalar_input_split_partial_width_get_new(uint8_t *input, int8_t *kernels, int8_t *output, int8_t *skip, 
                                              const int32_t input_width, const int32_t input_channels,
                                              const int32_t output_channels, const int scale, const int skip_scale,
                                              const int32_t input_split,  int32_t output_split, const int32_t weight_index, const int32_t x_start, const int32_t oc)
                                              {
