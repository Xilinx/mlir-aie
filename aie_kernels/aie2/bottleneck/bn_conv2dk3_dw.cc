...
//*****************************************************************************
  ...
  static void conv2dk3_stride2_ui8_scalar(uint8_t *line0, uint8_t *line1, uint8_t *line2,
 ...
 event0();
  ...
  #else
  static void conv2dk3_ui8_scalar(uint8_t *line0, uint8_t *line1, uint8_t *line2,
                          int8_t *wts, uint8_t *output,
                          const int32_t input_width,
                          const int32_t input_channels,
                          const int32_t output_channels,
