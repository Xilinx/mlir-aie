        ...
        def device_body():
            ...
            for i in range(n_cores):
                inX_fifos[inX_fifo_names[i]] = object_fifo(
                    inX_fifo_names[i], MemTile, ComputeTiles[i], buffer_depth, memRef_16_ty
                )
            ...
            of_out = object_fifo("out", ShimTile, MemTile, buffer_depth, memRef_48_ty)
            for i in range(n_cores):
                outX_fifos[outX_fifo_names[i]] = object_fifo(
                    outX_fifo_names[i], ComputeTiles[i], MemTile, buffer_depth, memRef_16_ty
                )
