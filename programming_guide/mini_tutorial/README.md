...
13. Familiarize yourself with [exercise_4c](./exercise_4/exercise_4c/aie2.py). Instead of applying the data transformations on the input data at runtime apply them directly on `of_out` to match those in [exercise_4a](./exercise_4/exercise_4a/aie2.py). Run `make run` to verify your answer.
