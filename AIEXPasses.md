...
_Expand load_pdi operations to explicit configuration sequences_
...
_Lower scratchpad parameter ops and emit parameter-sync preambles_
...
_Turn `aiex.configure` into configuration primitives and inline `aiex.run` calls_
