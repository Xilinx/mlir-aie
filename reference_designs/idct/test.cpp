...
int main(int argc, char *argv[]) {
  ...
  if (mlir_aie_acquire_buffer_out_lock(_xaie, 0, 1000) == XAIE_OK)
    printf("Acquired buffer_out_lock (0) in tile (7,0). Done.\n");
  else {
    errors++;
    printf("Timed out while trying to acquire buffer_out_lock.\n");
  }
