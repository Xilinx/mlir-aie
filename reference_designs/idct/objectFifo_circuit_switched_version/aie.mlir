...
module @idct {
  ...
  %of_t70_t73 = AIE.objectFifo.createObjectFifo(%t70, {%t73}, 2) {sym_name = "objFifo_in"} : !AIE.objectFifo<memref<64xi16>>
  %of_t73_t74 = AIE.objectFifo.createObjectFifo(%t73, {%t74}, 2) {sym_name = "objFifo_73_74"} : !AIE.objectFifo<memref<64xi16>>
  %of_t74_t75 = AIE.objectFifo.createObjectFifo(%t74, {%t75}, 2) {sym_name = "objFifo_74_75"} : !AIE.objectFifo<memref<64xi16>>
  %of_t75_t70 = AIE.objectFifo.createObjectFifo(%t75, {%t70}, 2) {sym_name = "objFifo_out"} : !AIE.objectFifo<memref<64xi16>>
