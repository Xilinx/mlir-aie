...
module @idct {
  ...
  %of_t70_t73 = AIE.objectFifo.createObjectFifo(%t70, {%t73}, 2 : i32) {sym_name = "of_in"} : !AIE.objectFifo<memref<64xi16>>
  %of_t73_t74 = AIE.objectFifo.createObjectFifo(%t73, {%t74}, 2 : i32) {sym_name = "of_dequant_horizontal"} : !AIE.objectFifo<memref<64xi16>>
  %of_t74_t75 = AIE.objectFifo.createObjectFifo(%t74, {%t75}, 2 : i32) {sym_name = "of_horizontal_vertical"} : !AIE.objectFifo<memref<64xi16>>
  %of_t75_t70 = AIE.objectFifo.createObjectFifo(%t75, {%t70}, 2 : i32) {sym_name = "of_out"} : !AIE.objectFifo<memref<64xi16>>
