...
module @stencil_2d_3point{
  ...
  %obj_fifo_in = AIE.objectFifo.createObjectFifo(%t70, {%t73}, 4) {sym_name = "obj_in" }: !AIE.objectFifo<memref<256xi32>>
  ...
  func.func private @stencil_2d_3point(%A: memref<256xi32>,%B: memref<256xi32>,%C: memref<256xi32>,%O: memref<256xi32>) -> ()
  ...
  %c13 = AIE.core(%t73) { 
    ...
    scf.for %iv = %lb to %ub step %step {  
      ...
      func.call @stencil_2d_3point(%row0,%row1,%row2,%obj_out) : (memref<256xi32>,memref<256xi32>,memref<256xi32>,  memref<256xi32>) -> ()
