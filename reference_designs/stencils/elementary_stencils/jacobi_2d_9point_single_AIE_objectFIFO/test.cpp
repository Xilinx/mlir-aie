...
#define DMA_COUNT_IN 1280
#define DMA_COUNT_OUT 768
  int *ddr_ptr_in = mlir_aie_mem_alloc(_xaie, 0, DMA_COUNT_IN);
  int *ddr_ptr_out = mlir_aie_mem_alloc(_xaie, 1, DMA_COUNT_OUT);
