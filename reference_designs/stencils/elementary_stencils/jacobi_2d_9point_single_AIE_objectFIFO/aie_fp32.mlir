...
module @stencil_2d_9point_fp32{
  ...
  %obj_fifo_out = AIE.objectFifo.createObjectFifo(%t71, {%t70}, 2){sym_name = "obj_out" } : !AIE.objectFifo<memref<256xf32>>
   ...
   // DDR buffer
  %ext_buffer_in0  = AIE.external_buffer  {sym_name = "ddr_test_buffer_in0"}: memref<1280 x f32>
  ...
  AIE.objectFifo.registerExternalBuffers(%t70, %obj_fifo_in : !AIE.objectFifo<memref<256xf32>>, {%ext_buffer_in0}) : (memref<1280xf32>)
  AIE.objectFifo.registerExternalBuffers(%t70, %obj_fifo_out : !AIE.objectFifo<memref<256xf32>>, {%ext_buffer_out}) : (memref<256xf32>)

  func.func private @stencil_2d_9point_fp32(%A: memref<256xf32>,%B: memref<256xf32>,%C: memref<256xf32>,%D: memref<256xf32>,%E: memref<256xf32>,%O: memref<256xf32>) -> ()
  ...
  %c13 = AIE.core(%t71) { 
    ...
    scf.for %iv = %lb to %ub step %step {  
      ...
      func.call @stencil_2d_9point_fp32(%row0,%row1,%row2,%row3,%row4,%obj_out) : (memref<256xf32>,memref<256xf32>,memref<256xf32>,memref<256xf32>,memref<256xf32>,  memref<256xf32>) -> ()
    ...
    AIE.end
  } { link_with="stencil_2d_9point_fp32.o" }
