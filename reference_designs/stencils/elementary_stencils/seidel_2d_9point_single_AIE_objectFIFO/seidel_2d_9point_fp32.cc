...
void seidel_2d_9point_fp32(float* restrict in1,float* restrict in2,float* restrict in3, float* restrict out)
{
 // const float *restrict w = weights;
    alignas(32) float weights[8] = {-16,-16,-16,-16,-16,-16,-16,-16};
    ...
    data_buf2 = upd_w(data_buf2, 1, *r2);
        ...
        for (unsigned i = 0; i < COL/8; i++)
            chess_prepare_for_pipelining
                    chess_loop_range(1,)
            {
            acc_0=fpmul   (data_buf1,1,0x76543210,coeffs_rest,    0,0x00000000);         //a
            acc_0=fpmac   (acc_0,data_buf1,2,0x76543210,coeffs_rest,    0,0x00000000); //b
            acc_0=fpmac   (acc_0,data_buf1,3,0x76543210,coeffs_rest,    0,0x00000000);  //c
 
            r3=((v8float *) in3)+i;
            data_buf1 = upd_w(data_buf1, 0, *r3++);
            data_buf1 = upd_w(data_buf1, 1, *r3);
            
            acc_0=fpmac   (acc_0,data_buf2,2,0x76543210,coeffs_rest,    0,0x00000000);  
            acc_0=fpmac   (acc_0,data_buf1,0,0x76543210,coeffs_rest,    0,0x00000000);  
            acc_0=fpmac   (acc_0,data_buf1,1,0x76543210,coeffs_rest,    0,0x00000000);  
            ...
            acc_0=fpmsc   (acc_0,data_buf2,1,0x76543210,coeffs,    0,0x00000000);     
