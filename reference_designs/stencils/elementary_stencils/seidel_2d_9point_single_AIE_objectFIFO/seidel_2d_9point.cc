...
void seidel_2d_9point(int32_t* restrict in1,int32_t* restrict in2,int32_t* restrict in3, int32_t* restrict out)
{
 // const int32_t *restrict w = weights;
    alignas(32) int32_t weights[8] = {-16,-16,-16,-16,-16,-16,-16,-16};
    ...
    data_buf2 = upd_w(data_buf2, 1, *r2);
        ...
        for (unsigned i = 0; i < COL/8; i++)
            ...
            acc_0=lmac8   (acc_0,data_buf1,0,0x76543210,coeffs_rest,    0,0x00000000);  
            acc_0=lmac8   (acc_0,data_buf1,1,0x76543210,coeffs_rest,    0,0x00000000);  
            acc_0=lmac8   (acc_0,data_buf1,2,0x76543210,coeffs_rest,    0,0x00000000);  
            ...
            acc_0=lmac8   (acc_0,data_buf2,0,0x76543210,coeffs_rest,    0,0x00000000);  
            acc_0=lmsc8   (acc_0,data_buf2,1,0x76543210,coeffs,    0,0x00000000);     
