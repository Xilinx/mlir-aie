...
template <typename T, int N>
void bitwiseOR_aie(const T* src1, const T*  src2, T* dst, 
                        const int32_t width, const int32_t height) {
...
#if BIT_WIDTH == 8
void bitwiseORLine(uint8_t *in1, uint8_t *in2, uint8_t *out, int32_t lineWidth) {
    bitwiseOR_aie<uint8_t, 64>(in1, in2, out, lineWidth, 1);
}

void bitwiseORTile(uint8_t *in1, uint8_t *in2, uint8_t *out, int32_t tileHeight, int32_t tileWidth) {
    bitwiseOR_aie<uint8_t, 64>(in1, in2, out, tileWidth, tileHeight);
}

#elif BIT_WIDTH == 16
void bitwiseORLine(int16_t *in1, int16_t *in2, int16_t *out, int32_t lineWidth) {
    bitwiseOR_aie<int16_t, 32>(in1, in2, out, lineWidth, 1);
}

void bitwiseORTile(int16_t *in1, int16_t *in2, int16_t *out, int32_t tileHeight, int32_t tileWidth) {
    bitwiseOR_aie<int16_t, 32>(in1, in2, out, tileWidth, tileHeight);
}

#else // 32

void bitwiseORLine(int32_t *in1, int32_t *in2, int32_t *out, int32_t lineWidth) {
    bitwiseOR_aie<int32_t, 16>(in1, in2, out, lineWidth);
}

void bitwiseORTile(int32_t *in1, int32_t *in2, int32_t *out, int32_t tileHeight, int32_t tileWidth) {
