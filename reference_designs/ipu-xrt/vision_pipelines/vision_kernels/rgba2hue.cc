...
__attribute__((noinline)) void rgba2hue_aie(uint8_t *rgba_in, uint8_t *hue_out, const int32_t height, const int32_t width) {
...
void rgba2hue_aie_scalar(uint8_t *rgba_in, uint8_t *hue_out, const int32_t height, const int32_t width) {
...
void rgba2hueTile(uint8_t *in, uint8_t *out, int32_t tileHeight, int32_t tileWidth)
{
