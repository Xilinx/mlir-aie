...
def color_threshold():
    ...
    with mlir_mod_ctx() as ctx:
        ...
        def device_body():
            ...
            ofifo_line_channels_ty = TypeAttr.get(ObjectFifoType.get(
                                                  T.memref(lineWidthChannels, T.ui8())))
            ofifo_line_ty          = TypeAttr.get(ObjectFifoType.get(
                                                  T.memref(lineWidth, T.ui8())))

            # AIE Core Function declarations
            thresholdLine = external_func("thresholdLine",
            ...
            def core_body():
                ...
                for _ in for_(sys.maxsize):
                    ...
                    Call(thresholdLine, [elemIn, elemOut, arith.constant(lineWidth), thresholdValue, maxValue, thresholdType])
