...
def conv2dk1():
    with mlir_mod_ctx() as ctx:
        ...
        def device_body():
            ...
            objectfifo_link(["inOF_act_L3L2"], ["act_L2_02"])
            ...
            objectfifo_link(["out_02_L2"], ["outOFL2L3"])
            ...
            def core_body():
                ...
                for _ in for_(4294967295):
                    elemWts = acquire(
                        ObjectFifoPort.Consume, "inOF_wts_0_L3L2", 1, weights_ty
                    ).acquired_elem()
                    ...
                    for _ in for_(y_dim):
                        elemIn = acquire(
                            ObjectFifoPort.Consume, "act_L2_02", 1, actIn_ty
                        ).acquired_elem()
