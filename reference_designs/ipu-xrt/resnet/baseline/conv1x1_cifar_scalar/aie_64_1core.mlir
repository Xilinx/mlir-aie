...
module {
  ...
  func.func @sequence(%in0 : memref<65536xi32>, %wts0 : memref<4096xi32>, %out : memref<16384xi32>) {
    aiex.ipu.rtp_write(0, 2, 0,  10) { buffer_sym_name = "rtp2" }  // scale 11 || 6
      ...
      %total_wts = arith.constant  4096 : i64 
      ...
      aiex.ipu.dma_memcpy_nd(0, 0, %wts0[0, 0, 0, 0][1, 1, 1, %total_wts][0, 0, 0]) {id = 2 : i64, metadata = @inOF_wts_0_L3L2} : memref<4096xi32>
