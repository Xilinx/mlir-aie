...
AIE.device(ipu) {
 ...
 // OF for intermediate ofm between 3x3 and 1x1
  ...
  func.func private @conv2dk1(memref<32x1x256xi8>, memref<16384xi8>, memref<32x1x64xui8>,i32,i32,i32,i32) -> ()
  ...
  func.func private @conv2dk1_skip(memref<32x1x32xui8>,memref<32x1x32xui8>, memref<16384xi8>,memref<32x1x256xui8>,memref<32x1x256xi8>,i32,i32,i32,i32,i32) -> ()
  ...
  aie.core(%tile02) {
    ...
    scf.for %arg3 = %c0 to %intmax step %c1 {
      ...
      scf.for %n = %c0 to %y_dim step %c1 {
        ...
        func.call @conv2dk1(%elemIn,%elemWts,  %elemOut0,%x_dim,%ci,%co,%scale) : (memref<32x1x256xi8>,memref<16384xi8>, memref<32x1x64xui8>,i32,i32,i32,i32) -> ()
 ...
 // 3x3 conv
  ...
  aie.core(%tile05) {
    ...
    scf.for %arg3 = %c0 to %intmax step %c1 {
      ...
      scf.for %n = %c0 to %y_dim step %c1 {
        ...
        // %skip_scale = arith.constant 0 : i32
        func.call @conv2dk1_skip(%elemIn0,%elemIn1,%elemWts, %elemOut0,%elemSkip,%x_dim,%ci,%co,%scale,%skip_scale) : (memref<32x1x32xui8>,memref<32x1x32xui8>,  memref<16384xi8>,memref<32x1x256xui8>,memref<32x1x256xi8>,i32,i32,i32,i32,i32) -> ()
  ...
  func.func @sequence(%in0 : memref<65536xi32>, %wts0 : memref<17408xi32>, %out : memref<65536xi32>) {
    ...
    aiex.ipu.rtp_write(0, 3, 0,  7) { buffer_sym_name = "rtp3" }  // scale 11 || 8
    aiex.ipu.rtp_write(0, 5, 0,  7) { buffer_sym_name = "rtp4" }  // scale 11 || 8
    aiex.ipu.rtp_write(0, 4, 0,  8)  { buffer_sym_name = "rtp5" }  // scale: 10 || 8 conv1x1 with the same scale as the input so we match the scaling factor of output after conv1x1 and the initial input
    aiex.ipu.rtp_write(0, 4, 1,  -1)  { buffer_sym_name = "rtp5" }  // skip_scale 0 || -1

      %c0 = arith.constant 0 : i32
      %c1 = arith.constant 1 : i32

      %X = arith.constant 32 : i32
      %Y = arith.constant 32 : i32
      
      %Y_out = arith.constant 32 : i32

      %Ci_1 = arith.constant 64 : i32
      %Co_1 = arith.constant 64 : i32
      

      %Kx_1 = arith.constant 1 : i32
      %Ky_1 = arith.constant 1 : i32


      %Ci_align_1 = arith.constant 64 : i32 // aligned to i32 from i8
      %Co_align_1 = arith.constant 16 : i32 // aligned to i32 from i8
      %Ci_alignX_1 = arith.constant 16384 : i32
      %Co_alignX_1 = arith.constant  512 : i32
      %Co_alignCi_1 = arith.constant  0 : i32 
