...
aie.device(ipu) {
  ...
  %rtp32 = aie.buffer(%tile32) {sym_name = "rtp32"} : memref<16xi32>
  %rtp33 = aie.buffer(%tile33) {sym_name = "rtp33"} : memref<16xi32>
  %rtp34 = aie.buffer(%tile34) {sym_name = "rtp34"} : memref<16xi32>
  %rtp35 = aie.buffer(%tile35) {sym_name = "rtp35"} : memref<16xi32>
  ...
  // ___________________________Bottleneck 4___________________________
    //wts
    aie.objectfifo @inOF_wts_3_L3L2(%tile30, {%tile31}, 1 : i32) : !aie.objectfifo<memref<69632xi8>> // total buffer for weights
    aie.objectfifo @wts_buf_30(%tile31, {%tile35}, 1 : i32) : !aie.objectfifo<memref<16384xi8>> // L1 buffer for first conv1x1 weights 256x64x1x1= 16384
    aie.objectfifo @wts_buf_31(%tile31, {%tile32,%tile34}, 1 : i32) : !aie.objectfifo<memref<36864xi8>> // L1 buffer for middle conv3x3 weights 64x64x3x3= 36864
    aie.objectfifo @wts_buf_32(%tile31, {%tile33}, 1 : i32) : !aie.objectfifo<memref<16384xi8>> // L1 buffer for final conv1x1 weights 64x256x1x1= 16384
    aie.objectfifo.link[@inOF_wts_3_L3L2]-> [@wts_buf_30,@wts_buf_31,@wts_buf_32] ()

    //initial activation for 1x1
    aie.objectfifo @act_24_35(%tile24, {%tile35,%tile31},[2,2,4]): !aie.objectfifo<memref<32x1x256xui8>> // from shim broadcast to core2 and memtile
    aie.objectfifo @skip_buf4(%tile31, {%tile33}, 2: i32): !aie.objectfifo<memref<32x1x256xui8>> // link the skip buffer in memtile to conv1_skip in tile4
    aie.objectfifo.link[@act_24_35]-> [@skip_buf4] ()
    
    // OF for intermediate ofm between 1x1 and 3x3
    aie.objectfifo @act_35_32_34(%tile35, {%tile32,%tile34}, 4 : i32) : !aie.objectfifo<memref<32x1x64xui8>> //32x1x32
    
    // OF for intermediate ofm between 3x3 and 1x1
    aie.objectfifo @act_32_33(%tile32, {%tile33}, 2 : i32) : !aie.objectfifo<memref<32x1x32xui8>> //32x1x32
    aie.objectfifo @act_34_33(%tile34, {%tile33}, 2 : i32) : !aie.objectfifo<memref<32x1x32xui8>> //32x1x32

    // Final output OF
    aie.objectfifo @outOFL2L3(%tile33, {%tile10}, 2 : i32) : !aie.objectfifo<memref<32x1x256xui8>> //32x1x64
    ...
    aie.core(%tile24) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
        ...
        scf.for %n = %c0 to %y_dim step %c1 {
          ...
          %subviewOut = aie.objectfifo.acquire @act_24_35(Produce, 1) : !aie.objectfifosubview<memref<32x1x256xui8>>
          %elemOut0 = aie.objectfifo.subview.access %subviewOut[0] : !aie.objectfifosubview<memref<32x1x256xui8>> -> memref<32x1x256xui8>
          ...
          aie.objectfifo.release @act_24_35(Produce, 1)
  ...
  // ___________________________Bottleneck 4___________________________
    ...
    aie.core(%tile35) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
        // acquire wts once
        %subviewWts = aie.objectfifo.acquire @wts_buf_30(Consume, 1) : !aie.objectfifosubview<memref<16384xi8>>
        %elemWts = aie.objectfifo.subview.access %subviewWts[0] : !aie.objectfifosubview<memref<16384xi8>> -> memref<16384xi8>
        %scale = memref.load %rtp35[%c0] : memref<16xi32>
        
        scf.for %n = %c0 to %y_dim step %c1 {
          %subviewIn = aie.objectfifo.acquire @act_24_35(Consume, 1) : !aie.objectfifosubview<memref<32x1x256xui8>>
          %elemIn = aie.objectfifo.subview.access %subviewIn[0] : !aie.objectfifosubview<memref<32x1x256xui8>> -> memref<32x1x256xui8>      

          %subviewOut = aie.objectfifo.acquire @act_35_32_34(Produce, 1) : !aie.objectfifosubview<memref<32x1x64xui8>>
          %elemOut0 = aie.objectfifo.subview.access %subviewOut[0] : !aie.objectfifosubview<memref<32x1x64xui8>> -> memref<32x1x64xui8>

          
          func.call @conv2dk1_ui8(%elemIn,%elemWts,  %elemOut0,%x_dim,%ci,%co,%scale) : (memref<32x1x256xui8>,memref<16384xi8>, memref<32x1x64xui8>,i32,i32,i32,i32) -> ()
          
          aie.objectfifo.release @act_24_35(Consume, 1)
          aie.objectfifo.release @act_35_32_34(Produce, 1)
      
        }
        aie.objectfifo.release @wts_buf_30(Consume, 1)
      }
      aie.end
    } { link_with="conv2dk1_ui8.o" }
    ...
    aie.core(%tile32) {
      ...
      %intmax = arith.constant 0xFFFFFFFF : index
      scf.for %arg3 = %c0 to %intmax step %c1 {
        %subviewWts = aie.objectfifo.acquire @wts_buf_31(Consume, 1) : !aie.objectfifosubview<memref<36864xi8>>
        %elemWts = aie.objectfifo.subview.access %subviewWts[0] : !aie.objectfifosubview<memref<36864xi8>> -> memref<36864xi8>

          // Preamble : Top Border
    
          %subviewIn = aie.objectfifo.acquire @act_35_32_34(Consume, 2) : !aie.objectfifosubview<memref<32x1x64xui8>>
          %elemIn0 = aie.objectfifo.subview.access %subviewIn[0] : !aie.objectfifosubview<memref<32x1x64xui8>> -> memref<32x1x64xui8>
          %elemIn1 = aie.objectfifo.subview.access %subviewIn[1] : !aie.objectfifosubview<memref<32x1x64xui8>> -> memref<32x1x64xui8>

          %subviewOut = aie.objectfifo.acquire @act_32_33(Produce, 1) : !aie.objectfifosubview<memref<32x1x32xui8>>
          %elemOut = aie.objectfifo.subview.access %subviewOut[0] : !aie.objectfifosubview<memref<32x1x32xui8>> -> memref<32x1x32xui8>
          ...
          aie.objectfifo.release @act_32_33(Produce, 1)
          
          // Middle
          scf.for %n = %c0 to %y_dim_minus_2 step %c1 {
            %subviewIn1 = aie.objectfifo.acquire @act_35_32_34(Consume, 3) : !aie.objectfifosubview<memref<32x1x64xui8>>
            %elemIn1_0 = aie.objectfifo.subview.access %subviewIn1[0] : !aie.objectfifosubview<memref<32x1x64xui8>> -> memref<32x1x64xui8>
            %elemIn1_1 = aie.objectfifo.subview.access %subviewIn1[1] : !aie.objectfifosubview<memref<32x1x64xui8>> -> memref<32x1x64xui8>
            %elemIn1_2 = aie.objectfifo.subview.access %subviewIn1[2] : !aie.objectfifosubview<memref<32x1x64xui8>> -> memref<32x1x64xui8>

            %subviewOut1 = aie.objectfifo.acquire @act_32_33(Produce, 1) : !aie.objectfifosubview<memref<32x1x32xui8>>
            %elemOut1 = aie.objectfifo.subview.access %subviewOut1[0] : !aie.objectfifosubview<memref<32x1x32xui8>> -> memref<32x1x32xui8>
        
            func.call @conv2dk3_ui8(%elemIn1_0,%elemIn1_1,%elemIn1_2,%elemWts, %elemOut1,%x_dim,%ci,%co,%kx_dim,%ky_dim,%middle,%scale,%co_offset ) : (memref<32x1x64xui8>, memref<32x1x64xui8>, memref<32x1x64xui8>, memref<36864xi8>,memref<32x1x32xui8>,i32,i32,i32,i32,i32,i32,i32,i32) -> ()

            aie.objectfifo.release @act_32_33(Produce, 1)
            aie.objectfifo.release @act_35_32_34(Consume, 1)
      
        }
        // Postamble : Bottom Border
          %subviewIn2 = aie.objectfifo.acquire @act_35_32_34(Consume, 2) : !aie.objectfifosubview<memref<32x1x64xui8>>
          %elemIn2_0 = aie.objectfifo.subview.access %subviewIn2[0] : !aie.objectfifosubview<memref<32x1x64xui8>> -> memref<32x1x64xui8>
          %elemIn2_1 = aie.objectfifo.subview.access %subviewIn2[1] : !aie.objectfifosubview<memref<32x1x64xui8>> -> memref<32x1x64xui8>

          %subviewOut2 = aie.objectfifo.acquire @act_32_33(Produce, 1) : !aie.objectfifosubview<memref<32x1x32xui8>>
          %elemOut2 = aie.objectfifo.subview.access %subviewOut2[0] : !aie.objectfifosubview<memref<32x1x32xui8>> -> memref<32x1x32xui8>
          ...
          aie.objectfifo.release @act_32_33(Produce, 1)
          aie.objectfifo.release @act_35_32_34(Consume, 2)
          
          //release weights
          aie.objectfifo.release @wts_buf_31(Consume, 1)
      }
        // aie.objectfifo.release<Consume>(%inOF_wts_0_L3L2 : !aie.objectfifo<memref<32x32x3x3xi32>>, 1)
      aie.end
    } { link_with="conv2dk3.o" }
    ...
    aie.core(%tile34) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
        ...
        %elemWts = aie.objectfifo.subview.access %subviewWts[0] : !aie.objectfifosubview<memref<36864xi8>> -> memref<36864xi8>
          ...
          %subviewOut = aie.objectfifo.acquire @act_34_33(Produce, 1) : !aie.objectfifosubview<memref<32x1x32xui8>>
          %elemOut = aie.objectfifo.subview.access %subviewOut[0] : !aie.objectfifosubview<memref<32x1x32xui8>> -> memref<32x1x32xui8>
          ...
          scf.for %n = %c0 to %y_dim_minus_2 step %c1 {
            ...
            %subviewOut1 = aie.objectfifo.acquire @act_34_33(Produce, 1) : !aie.objectfifosubview<memref<32x1x32xui8>>
            %elemOut1 = aie.objectfifo.subview.access %subviewOut1[0] : !aie.objectfifosubview<memref<32x1x32xui8>> -> memref<32x1x32xui8>
        ...
        // Postamble : Bottom Border
          ...
          %subviewOut2 = aie.objectfifo.acquire @act_34_33(Produce, 1) : !aie.objectfifosubview<memref<32x1x32xui8>>
          %elemOut2 = aie.objectfifo.subview.access %subviewOut2[0] : !aie.objectfifosubview<memref<32x1x32xui8>> -> memref<32x1x32xui8>
    ...
    aie.core(%tile33) {
        ...
        scf.for %arg3 = %c0 to %intmax step %c1 {
          // acquire wts once
          %subviewWts = aie.objectfifo.acquire @wts_buf_32(Consume, 1) : !aie.objectfifosubview<memref<16384xi8>>
          %elemWts = aie.objectfifo.subview.access %subviewWts[0] : !aie.objectfifosubview<memref<16384xi8>> -> memref<16384xi8>

          %scale = memref.load %rtp33[%c0] : memref<16xi32>
          %skip_scale = memref.load %rtp33[%c1] : memref<16xi32>
          // %skip_scale = arith.constant 0 : i32
          scf.for %n = %c0 to %y_dim step %c1 {
            %subviewIn0 = aie.objectfifo.acquire @act_32_33(Consume, 1) : !aie.objectfifosubview<memref<32x1x32xui8>>
            %elemIn0 = aie.objectfifo.subview.access %subviewIn0[0] : !aie.objectfifosubview<memref<32x1x32xui8>> -> memref<32x1x32xui8>      

            %subviewIn1 = aie.objectfifo.acquire @act_34_33(Consume, 1) : !aie.objectfifosubview<memref<32x1x32xui8>>
            %elemIn1 = aie.objectfifo.subview.access %subviewIn1[0] : !aie.objectfifosubview<memref<32x1x32xui8>> -> memref<32x1x32xui8>   

            %subviewOut = aie.objectfifo.acquire @outOFL2L3(Produce, 1) : !aie.objectfifosubview<memref<32x1x256xui8>>
            %elemOut0 = aie.objectfifo.subview.access %subviewOut[0] : !aie.objectfifosubview<memref<32x1x256xui8>> -> memref<32x1x256xui8>

            %subviewSkip = aie.objectfifo.acquire @skip_buf4(Consume, 1) : !aie.objectfifosubview<memref<32x1x256xui8>>
            %elemSkip = aie.objectfifo.subview.access %subviewSkip[0] : !aie.objectfifosubview<memref<32x1x256xui8>> -> memref<32x1x256xui8>    
            ...
            aie.objectfifo.release @act_32_33(Consume, 1)
            aie.objectfifo.release @act_34_33(Consume, 1)
            aie.objectfifo.release @skip_buf4(Consume, 1)
        
          }
          aie.objectfifo.release @wts_buf_32(Consume, 1)
        }
        aie.end
      } { link_with="conv2dk1_skip.o" }
  ...
  func.func @sequence(%in0 : memref<16384xi32>, %wts0 : memref<70656xi32>, %out : memref<65536xi32>) {
      ...
      aiex.ipu.rtp_write(3, 5, 0,  11) { buffer_sym_name = "rtp35" }  
      aiex.ipu.rtp_write(3, 4, 0,  11) { buffer_sym_name = "rtp34" }  
      aiex.ipu.rtp_write(3, 2, 0,  11) { buffer_sym_name = "rtp32" }  
      aiex.ipu.rtp_write(3, 3, 0,  10)  { buffer_sym_name = "rtp33" }  
      aiex.ipu.rtp_write(3, 3, 1,  0)  { buffer_sym_name = "rtp33" }  
      ...
      %total_wts_4_off = arith.constant  53248 : i64 
      ...
      aiex.ipu.dma_memcpy_nd(0, 0, %wts0[0, 0, 0, 0][1, 1, 1, %total_wts][0, 0, 0]) {id = 1 : i64, metadata = @inOF_wts_0_L3L2} : memref<70656xi32>
      aiex.ipu.dma_memcpy_nd(0, 0, %wts0[0, 0, 0, %total_wts][1, 1, 1, %total_wts_2][0, 0, 0]) {id = 1 : i64, metadata = @inOF_wts_1_L3L2} : memref<70656xi32>
      aiex.ipu.dma_memcpy_nd(0, 0, %wts0[0, 0, 0, %total_wts_3_off][1, 1, 1, %total_wts_3][0, 0, 0]) {id = 1 : i64, metadata = @inOF_wts_2_L3L2} : memref<70656xi32>
      aiex.ipu.dma_memcpy_nd(0, 0, %wts0[0, 0, 0, %total_wts_4_off][1, 1, 1, %total_wts_3][0, 0, 0]) {id = 1 : i64, metadata = @inOF_wts_3_L3L2} : memref<70656xi32>
