...
aie.device(ipu) {
  ...
  func.func @sequence(%in0 : memref<16384xi32>, %wts0 : memref<53248xi32>, %out : memref<65536xi32>) {
      aiex.ipu.rtp_write(0, 2, 0,  7) { buffer_sym_name = "rtp2" }  
      aiex.ipu.rtp_write(0, 3, 0,  10) { buffer_sym_name = "rtp3" } 
      aiex.ipu.rtp_write(0, 5, 0,  10) { buffer_sym_name = "rtp4" }  
      aiex.ipu.rtp_write(0, 4, 0,  11)  { buffer_sym_name = "rtp5" }  
      aiex.ipu.rtp_write(0, 4, 1,  0)  { buffer_sym_name = "rtp5" }  
      aiex.ipu.rtp_write(0, 4, 2,  8)  { buffer_sym_name = "rtp5" }  
      ...
      aiex.ipu.rtp_write(2, 3, 0,  9) { buffer_sym_name = "rtp23" }  
      aiex.ipu.rtp_write(2, 5, 0,  9) { buffer_sym_name = "rtp25" }  
      aiex.ipu.rtp_write(2, 4, 0,  12)  { buffer_sym_name = "rtp24" }  
