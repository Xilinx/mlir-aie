...
aie.device(ipu) {
  ...
  aie.core(%tile02) {
    ...
    scf.for %arg3 = %c0 to %intmax step %c1 {
      ...
      scf.for %n = %c0 to %y_dim step %c1 {
        ...
        func.call @conv2dk1(%elemIn,%elemWts,  %elemOut0,%x_dim,%ci,%co,%scale) : (memref<32x1x64xi8>,memref<4096xi8>, memref<32x1x64xui8>,i32,i32,i32,i32) -> ()
 ...
 // 3x3 conv
  ...
  aie.core(%tile05) {
    ...
    scf.for %arg3 = %c0 to %intmax step %c1 {
      ...
      scf.for %n = %c0 to %y_dim step %c1 {
        ...
        // %skip_scale = arith.constant 0 : i32
        func.call @conv2dk1_skip(%elemIn0,%elemIn1,%elemWts, %elemOut0,%elemSkip,%x_dim,%ci,%co,%ci_skip,%scale,%skip_scale,%skip_conv_scale) : (memref<32x1x32xui8>,memref<32x1x32xui8>,  memref<32768xi8>,memref<32x1x256xui8>,memref<32x1x64xi8>,i32,i32,i32,i32,i32,i32,i32) -> ()
  ...
  func.func @sequence(%in0 : memref<16384xi32>, %wts0 : memref<18432xi32>, %out : memref<65536xi32>) {
      aiex.ipu.rtp_write(0, 2, 0,  8) { buffer_sym_name = "rtp2" }  // scale 11 || 6
      ...
      aiex.ipu.rtp_write(0, 4, 2,  6)  { buffer_sym_name = "rtp5" }  // skip_scale 0 || -1
      ...
      aiex.ipu.dma_memcpy_nd(0, 0, %wts0[0, 0, 0, 0][1, 1, 1, %total_wts][0, 0, 0]) {id = 2 : i64, metadata = @inOF_wts_0_L3L2} : memref<18432xi32>
