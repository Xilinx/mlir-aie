module {
  aie.device(ipu) {
    ...
    func.func @sequence(%arg0: memref<16384xi32>, %arg1: memref<18432xi32>, %arg2: memref<65536xi32>) {
      ...
      aiex.ipu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 0][1, 1, 1, %c16384_i64][0, 0, 0]) {id = 0 : i64, metadata = @inOF_act_L3L2} : memref<16384xi32>
      aiex.ipu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 0][1, 1, 1, %c65536_i64][0, 0, 0]) {id = 2 : i64, metadata = @outOFL2L3} : memref<65536xi32>
      aiex.ipu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 0][1, 1, 1, %c18432_i64][0, 0, 0]) {id = 2 : i64, metadata = @inOF_wts_0_L3L2} : memref<18432xi32>
