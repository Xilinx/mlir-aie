...
aie.device(ipu) {
  ...
  // } {keep_pkt_header = "true"}
  aie.packet_flow(5) { 
    aie.packet_source<%tile04, Trace : 0> // core trace
    aie.packet_dest<%tile00, DMA : 1>
  } {keep_pkt_header = "true"}
  // aie.packet_flow(6) { 
  //   aie.packet_source<%tile04, Trace : 1> // memory trace
  //   aie.packet_dest<%tile00, DMA : 1>
  // } {keep_pkt_header = "true"}
  aie.packet_flow(7) { 
    aie.packet_source<%tile05, Trace : 0> // core trace
    aie.packet_dest<%tile00, DMA : 1>
  } {keep_pkt_header = "true"}
  // aie.packet_flow(8) { 
  //   aie.packet_source<%tile05, Trace : 1> // memory trace
  //   aie.packet_dest<%tile00, DMA : 1>
  // } {keep_pkt_header = "true"}
 ...
 // 3x3 conv
  ...
  func.func @sequence(%in0 : memref<65536xi32>, %wts0 : memref<17408xi32>, %out : memref<65536xi32>) {
      ...
      // Core Traces for Tile(0,5)
      // Trace_Event0  (4 slots)
      aiex.ipu.write32 { column = 0 : i32, row = 5 : i32, address = 0x340E0 : ui32, value = 0x4B222125 : ui32 }
      // Trace_Event1  (4 slots)
      aiex.ipu.write32 { column = 0 : i32, row = 5 : i32, address = 0x340E4 : ui32, value = 0x2D2C1A4F : ui32 }

      // Memory Trace_Event0(4 slots) - 0x140E0
      // Memory Trace_Event1  (4 slots) - 0x140E4
      ...
      aiex.ipu.write32 { column = 0 : i32, row = 5 : i32, address = 0x3FF00 : ui32, value = 0x121 : ui32 }
      ...
      aiex.ipu.write32 { column = 0 : i32, row = 5 : i32, address = 0x340D0 : ui32, value = 0x10000 : ui32 }

      // Trace_Control1: packet id = 1,3,5,7, packet_type = 0 (core)
      // NOTE the switch between tile position and id name/id for tile04 (row=5) and tile05 (row=4)
      aiex.ipu.write32 { column = 0 : i32, row = 2 : i32, address = 0x340D4 : ui32, value = 0x0001 : ui32 }
      aiex.ipu.write32 { column = 0 : i32, row = 3 : i32, address = 0x340D4 : ui32, value = 0x0003 : ui32 }
      aiex.ipu.write32 { column = 0 : i32, row = 4 : i32, address = 0x340D4 : ui32, value = 0x0007 : ui32 }
      aiex.ipu.write32 { column = 0 : i32, row = 5 : i32, address = 0x340D4 : ui32, value = 0x0005 : ui32 }

      // Start trace copy out.
      aiex.ipu.writebd_shimtile { bd_id = 3 : i32,
                                  buffer_length = 32768 : i32,
