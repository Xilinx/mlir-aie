...
aie.device(ipu) {
 ...
 //wts
  aie.objectfifo @inOF_wts_1_L3L2(%tile10, {%tile11}, 1 : i32) : !aie.objectfifo<memref<16384xi8>> // total buffer for weights
  ...
  aie.objectfifo.link[@inOF_wts_1_L3L2]-> [@wts_buf_10] ()
  
    //initial activation for 1x1
  aie.objectfifo @act_05_15(%tile05, {%tile15}, 2: i32 ) : !aie.objectfifo<memref<32x1x256xui8>> //conv1
 ...
 // 3x3 conv
  ...
  func.func @sequence(%in0 : memref<16384xi32>, %wts0 : memref<22528xi32>, %out : memref<16384xi32>) {
      ...
      aiex.ipu.rtp_write(1, 5, 0,  11)  { buffer_sym_name = "rtp15" }  // skip_scale 0 || -1
      ...
      %total_wts_2 = arith.constant  4096 : i64 
      ...
      aiex.ipu.dma_memcpy_nd(0, 0, %wts0[0, 0, 0, 0][1, 1, 1, %total_wts][0, 0, 0]) {id = 1 : i64, metadata = @inOF_wts_0_L3L2} : memref<22528xi32>
      aiex.ipu.dma_memcpy_nd(0, 0, %wts0[0, 0, 0, %total_wts][1, 1, 1, %total_wts_2][0, 0, 0]) {id = 1 : i64, metadata = @inOF_wts_1_L3L2} : memref<22528xi32>
