...
aie.device(ipu) {
 ...
 // OF for intermediate ofm between 3x3 and 1x1
  ...
  // Final output OF
  aie.objectfifo @outOFL2L3(%tile13, {%tile10}, 2 : i32) : !aie.objectfifo<memref<32x1x256xui8>> //32x1x64
  ...
  func.func private @conv2dk1_skip_ui8(memref<32x1x32xui8>,memref<32x1x32xui8>, memref<16384xi8>,memref<32x1x256xui8>,memref<32x1x256xui8>,i32,i32,i32,i32,i32,i32,i32) -> ()
 ...
 // 3x3 conv
        ...
        aie.core(%tile12) {
          ...
          scf.for %arg3 = %c0 to %intmax step %c1 {
            ...
            %elemWts = aie.objectfifo.subview.access %subviewWts[0] : !aie.objectfifosubview<memref<36864xi8>> -> memref<36864xi8>
              ...
              func.call @conv2dk3_ui8(%elemIn0,%elemIn0,%elemIn1,%elemWts, %elemOut,%x_dim,%ci,%co,%kx_dim,%ky_dim,%middle,%scale,%co_offset  ) : (memref<32x1x64xui8>, memref<32x1x64xui8>, memref<32x1x64xui8>, memref<36864xi8>,memref<32x1x32xui8>,i32,i32,i32,i32,i32,i32,i32,i32) -> ()
        ...
        aie.core(%tile13) {
          ...
          scf.for %arg3 = %c0 to %intmax step %c1 {
            ...
            scf.for %n = %c0 to %y_dim step %c1 {
              ...
              // %skip_scale = arith.constant 0 : i32
              // func.call @conv2dk1_skip_dummy(%elemIn0,%elemIn1,%elemWts, %elemOut0,%x_dim,%ci,%co,%scale,%skip_scale) : (memref<32x1x32xui8>,memref<32x1x32xui8>,  memref<16384xi8>,memref<32x1x256xui8>,i32,i32,i32,i32,i32) -> ()
  ...
  func.func @sequence(%in0 : memref<16384xi32>, %wts0 : memref<35840xi32>, %out : memref<65536xi32>) {
      ...
      aiex.ipu.rtp_write(1, 5, 0,  6) { buffer_sym_name = "rtp15" }  // scale 11 || 6
      aiex.ipu.rtp_write(1, 4, 0,  8) { buffer_sym_name = "rtp14" }  // scale 11 || 8
      aiex.ipu.rtp_write(1, 2, 0,  8) { buffer_sym_name = "rtp12" }  // scale 11 || 8
      aiex.ipu.rtp_write(1, 3, 0,  8)  { buffer_sym_name = "rtp13" }  // scale: 10 || 8 conv1x1 with the same scale as the input so we match the scaling factor of output after conv1x1 and the initial input
      aiex.ipu.rtp_write(1, 3, 1,  0)  { buffer_sym_name = "rtp13" }  // skip_scale 0 || 1
      ...
      %total_wts_2 = arith.constant  17408 : i32 
