...
//---Generating B0 buffers---*-
  %block_0_buf_in_shim_2 = AIE.objectFifo.createObjectFifo(%tile2_0,{%tile0_2,%tile1_2,%tile0_3,%tile1_3,%tile0_4,%tile1_4,%tile0_5,%tile1_5},9) { sym_name = "block_0_buf_in_shim_2" } : !AIE.objectFifo<memref<256xi32>> //B block input
  ...
  %block_0_buf_row_2_out_flx2= AIE.objectFifo.createObjectFifo(%tile2_2,{%tile2_3},2) { sym_name ="block_0_buf_row_2_out_flx2"} : !AIE.objectFifo<memref<256xi32>>
  ...
  %block_0_buf_out_shim_2= AIE.objectFifo.createObjectFifo(%tile2_3,{%tile2_0},5){ sym_name ="block_0_buf_out_shim_2"} : !AIE.objectFifo<memref<256xi32>> //B block output
  ...
  %block_0_buf_row_4_out_flx2= AIE.objectFifo.createObjectFifo(%tile2_4,{%tile2_3},2) { sym_name ="block_0_buf_row_4_out_flx2"} : !AIE.objectFifo<memref<256xi32>>

  %block_0_buf_row_5_inter_lap= AIE.objectFifo.createObjectFifo(%tile0_5,{%tile1_5},5){ sym_name ="block_0_buf_row_5_inter_lap"} : !AIE.objectFifo<memref<256xi32>>
  %block_0_buf_row_5_inter_flx1= AIE.objectFifo.createObjectFifo(%tile1_5,{%tile2_5},6) { sym_name ="block_0_buf_row_5_inter_flx1"} : !AIE.objectFifo<memref<512xi32>>
  %block_0_buf_row_5_out_flx2= AIE.objectFifo.createObjectFifo(%tile2_5,{%tile2_3},2) { sym_name ="block_0_buf_row_5_out_flx2"} : !AIE.objectFifo<memref<256xi32>>
...
//Registering buffers
  ...
  %block_0_core0_2 = AIE.core(%tile0_2) {
    ...
    scf.for %iv = %lb to %ub step %step {  
      ...
      AIE.objectFifo.release<Produce>(%block_0_buf_row_2_inter_lap: !AIE.objectFifo<memref<256xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_2_inter_lap: !AIE.objectFifo<memref<256xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_2_inter_lap: !AIE.objectFifo<memref<256xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_2_inter_lap: !AIE.objectFifo<memref<256xi32>>, 1)
    }
  ...
  %block_0_core1_2 = AIE.core(%tile1_2) {
    ...
    scf.for %iv = %lb to %ub step %step {  
      ...
      AIE.objectFifo.release<Produce>(%block_0_buf_row_2_inter_flx1: !AIE.objectFifo<memref<512xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_2_inter_flx1: !AIE.objectFifo<memref<512xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_2_inter_flx1: !AIE.objectFifo<memref<512xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_2_inter_flx1: !AIE.objectFifo<memref<512xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_2_inter_flx1: !AIE.objectFifo<memref<512xi32>>, 1)
  ...
  %block_0_core2_2 = AIE.core(%tile2_2) {
    ...
    scf.for %iv = %lb to %ub step %step {  
      ...
      %obj_out_subview_flux = AIE.objectFifo.acquire<Produce>(%block_0_buf_row_2_out_flx2: !AIE.objectFifo<memref<256xi32>>, 1): !AIE.objectFifoSubview<memref<256xi32>>
      ...
      AIE.objectFifo.release<Consume>(%block_0_buf_row_2_inter_flx1 :!AIE.objectFifo<memref<512xi32>>, 4)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_2_out_flx2 :!AIE.objectFifo<memref<256xi32>>, 1)
    }
    AIE.end
  ...
  %block_0_core0_3 = AIE.core(%tile0_3) {
    ...
    scf.for %iv = %lb to %ub step %step {  
      ...
      AIE.objectFifo.release<Consume>(%block_0_buf_in_shim_2: !AIE.objectFifo<memref<256xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_3_inter_lap: !AIE.objectFifo<memref<256xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_3_inter_lap: !AIE.objectFifo<memref<256xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_3_inter_lap: !AIE.objectFifo<memref<256xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_3_inter_lap: !AIE.objectFifo<memref<256xi32>>, 1)
    }
  ...
  %block_0_core1_3 = AIE.core(%tile1_3) {
    ...
    scf.for %iv = %lb to %ub step %step {  
      ...
      AIE.objectFifo.release<Produce>(%block_0_buf_row_3_inter_flx1: !AIE.objectFifo<memref<512xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_3_inter_flx1: !AIE.objectFifo<memref<512xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_3_inter_flx1: !AIE.objectFifo<memref<512xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_3_inter_flx1: !AIE.objectFifo<memref<512xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_3_inter_flx1: !AIE.objectFifo<memref<512xi32>>, 1)
  ...
  %block_0_core2_3 = AIE.core(%tile2_3) {
    ...
    scf.for %iv = %lb to %ub step %step {  
      ...
      %obj_out_subview_flux = AIE.objectFifo.acquire<Produce>(%block_0_buf_out_shim_2: !AIE.objectFifo<memref<256xi32>>, 5): !AIE.objectFifoSubview<memref<256xi32>>
  ...
  // Acquiring outputs from other flux
      %obj_out_subview_flux2 = AIE.objectFifo.acquire<Consume>(%block_0_buf_row_2_out_flx2: !AIE.objectFifo<memref<256xi32>>, 1): !AIE.objectFifoSubview<memref<256xi32>>
      %final_out_from2 = AIE.objectFifo.subview.access %obj_out_subview_flux2[0] : !AIE.objectFifoSubview<memref<256xi32>> -> memref<256xi32>
      ...
      %obj_out_subview_flux5 = AIE.objectFifo.acquire<Consume>(%block_0_buf_row_5_out_flx2: !AIE.objectFifo<memref<256xi32>>, 1): !AIE.objectFifoSubview<memref<256xi32>>
      %final_out_from5 = AIE.objectFifo.subview.access %obj_out_subview_flux5[0] : !AIE.objectFifoSubview<memref<256xi32>> -> memref<256xi32>

  // Ordering and copying data to gather tile (src-->dst)
      memref.copy %final_out_from2 , %obj_out_flux_element0 : memref<256xi32> to memref<256xi32>
      memref.copy %final_out_from4 , %obj_out_flux_element2 : memref<256xi32> to memref<256xi32>
      memref.copy %final_out_from5 , %obj_out_flux_element3 : memref<256xi32> to memref<256xi32>
      func.call @hdiff_flux2(%obj_flux_inter_element1, %obj_flux_inter_element2,%obj_flux_inter_element3, %obj_flux_inter_element4, %obj_flux_inter_element5,  %obj_out_flux_element1 ) : ( memref<512xi32>,  memref<512xi32>, memref<512xi32>, memref<512xi32>, memref<512xi32>, memref<256xi32>) -> ()

      AIE.objectFifo.release<Consume>(%block_0_buf_row_3_inter_flx1 :!AIE.objectFifo<memref<512xi32>>, 4)
  ...
  %block_0_core0_4 = AIE.core(%tile0_4) {
    ...
    scf.for %iv = %lb to %ub step %step {  
      ...
      AIE.objectFifo.release<Consume>(%block_0_buf_in_shim_2: !AIE.objectFifo<memref<256xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_4_inter_lap: !AIE.objectFifo<memref<256xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_4_inter_lap: !AIE.objectFifo<memref<256xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_4_inter_lap: !AIE.objectFifo<memref<256xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_4_inter_lap: !AIE.objectFifo<memref<256xi32>>, 1)
    }
  ...
  %block_0_core1_4 = AIE.core(%tile1_4) {
    ...
    scf.for %iv = %lb to %ub step %step {  
      ...
      AIE.objectFifo.release<Produce>(%block_0_buf_row_4_inter_flx1: !AIE.objectFifo<memref<512xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_4_inter_flx1: !AIE.objectFifo<memref<512xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_4_inter_flx1: !AIE.objectFifo<memref<512xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_4_inter_flx1: !AIE.objectFifo<memref<512xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_4_inter_flx1: !AIE.objectFifo<memref<512xi32>>, 1)
  ...
  %block_0_core2_4 = AIE.core(%tile2_4) {
    ...
    scf.for %iv = %lb to %ub step %step {  
      ...
      AIE.objectFifo.release<Consume>(%block_0_buf_row_4_inter_flx1 :!AIE.objectFifo<memref<512xi32>>, 4)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_4_out_flx2 :!AIE.objectFifo<memref<256xi32>>, 1)
    }
    AIE.end
  } { link_with="hdiff_flux2.o" }

  %block_0_core0_5 = AIE.core(%tile0_5) {
    %lb = arith.constant 0 : index
    %ub = arith.constant 2 : index
    %step = arith.constant 1 : index
    scf.for %iv = %lb to %ub step %step {  
      ...
      %obj_out_subview_lap = AIE.objectFifo.acquire<Produce>(%block_0_buf_row_5_inter_lap: !AIE.objectFifo<memref<256xi32>>, 4): !AIE.objectFifoSubview<memref<256xi32>>
      %obj_out_lap1 = AIE.objectFifo.subview.access %obj_out_subview_lap[0] : !AIE.objectFifoSubview<memref<256xi32>> -> memref<256xi32>
      %obj_out_lap2 = AIE.objectFifo.subview.access %obj_out_subview_lap[1] : !AIE.objectFifoSubview<memref<256xi32>> -> memref<256xi32>
      %obj_out_lap3 = AIE.objectFifo.subview.access %obj_out_subview_lap[2] : !AIE.objectFifoSubview<memref<256xi32>> -> memref<256xi32>
      %obj_out_lap4 = AIE.objectFifo.subview.access %obj_out_subview_lap[3] : !AIE.objectFifoSubview<memref<256xi32>> -> memref<256xi32>
      ...
      AIE.objectFifo.release<Consume>(%block_0_buf_in_shim_2: !AIE.objectFifo<memref<256xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_5_inter_lap: !AIE.objectFifo<memref<256xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_5_inter_lap: !AIE.objectFifo<memref<256xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_5_inter_lap: !AIE.objectFifo<memref<256xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_5_inter_lap: !AIE.objectFifo<memref<256xi32>>, 1)
    }
  ...
  %block_0_core1_5 = AIE.core(%tile1_5) {
    %lb = arith.constant 0 : index
    %ub = arith.constant 2 : index
    %step = arith.constant 1 : index
    scf.for %iv = %lb to %ub step %step {  
      ...
      %obj_out_subview_lap = AIE.objectFifo.acquire<Consume>(%block_0_buf_row_5_inter_lap: !AIE.objectFifo<memref<256xi32>>, 4): !AIE.objectFifoSubview<memref<256xi32>>
      %obj_out_lap1 = AIE.objectFifo.subview.access %obj_out_subview_lap[0] : !AIE.objectFifoSubview<memref<256xi32>> -> memref<256xi32>
      %obj_out_lap2 = AIE.objectFifo.subview.access %obj_out_subview_lap[1] : !AIE.objectFifoSubview<memref<256xi32>> -> memref<256xi32>
      %obj_out_lap3 = AIE.objectFifo.subview.access %obj_out_subview_lap[2] : !AIE.objectFifoSubview<memref<256xi32>> -> memref<256xi32>
      %obj_out_lap4 = AIE.objectFifo.subview.access %obj_out_subview_lap[3] : !AIE.objectFifoSubview<memref<256xi32>> -> memref<256xi32>

      %obj_out_subview_flux1 = AIE.objectFifo.acquire<Produce>(%block_0_buf_row_5_inter_flx1: !AIE.objectFifo<memref<512xi32>>, 5): !AIE.objectFifoSubview<memref<512xi32>>
      %obj_out_flux_inter1 = AIE.objectFifo.subview.access %obj_out_subview_flux1[0] : !AIE.objectFifoSubview<memref<512xi32>> -> memref<512xi32>
      %obj_out_flux_inter2 = AIE.objectFifo.subview.access %obj_out_subview_flux1[1] : !AIE.objectFifoSubview<memref<512xi32>> -> memref<512xi32>
      %obj_out_flux_inter3 = AIE.objectFifo.subview.access %obj_out_subview_flux1[2] : !AIE.objectFifoSubview<memref<512xi32>> -> memref<512xi32>
      %obj_out_flux_inter4 = AIE.objectFifo.subview.access %obj_out_subview_flux1[3] : !AIE.objectFifoSubview<memref<512xi32>> -> memref<512xi32>
      ...
      AIE.objectFifo.release<Consume>(%block_0_buf_row_5_inter_lap: !AIE.objectFifo<memref<256xi32>>, 4)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_5_inter_flx1: !AIE.objectFifo<memref<512xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_5_inter_flx1: !AIE.objectFifo<memref<512xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_5_inter_flx1: !AIE.objectFifo<memref<512xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_5_inter_flx1: !AIE.objectFifo<memref<512xi32>>, 1)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_5_inter_flx1: !AIE.objectFifo<memref<512xi32>>, 1)
  ...
  %block_0_core2_5 = AIE.core(%tile2_5) {
    %lb = arith.constant 0 : index
    %ub = arith.constant 2 : index
    %step = arith.constant 1 : index
    scf.for %iv = %lb to %ub step %step {  
      %obj_out_subview_flux_inter1 = AIE.objectFifo.acquire<Consume>(%block_0_buf_row_5_inter_flx1: !AIE.objectFifo<memref<512xi32>>, 5): !AIE.objectFifoSubview<memref<512xi32>>
      %obj_flux_inter_element1 = AIE.objectFifo.subview.access %obj_out_subview_flux_inter1[0] : !AIE.objectFifoSubview<memref<512xi32>> -> memref<512xi32>
      %obj_flux_inter_element2 = AIE.objectFifo.subview.access %obj_out_subview_flux_inter1[1] : !AIE.objectFifoSubview<memref<512xi32>> -> memref<512xi32>
      %obj_flux_inter_element3 = AIE.objectFifo.subview.access %obj_out_subview_flux_inter1[2] : !AIE.objectFifoSubview<memref<512xi32>> -> memref<512xi32>
      %obj_flux_inter_element4 = AIE.objectFifo.subview.access %obj_out_subview_flux_inter1[3] : !AIE.objectFifoSubview<memref<512xi32>> -> memref<512xi32>
      ...
      %obj_out_subview_flux = AIE.objectFifo.acquire<Produce>(%block_0_buf_row_5_out_flx2: !AIE.objectFifo<memref<256xi32>>, 1): !AIE.objectFifoSubview<memref<256xi32>>
      %obj_out_flux_element1 = AIE.objectFifo.subview.access %obj_out_subview_flux[0] : !AIE.objectFifoSubview<memref<256xi32>> -> memref<256xi32>

      func.call @hdiff_flux2(%obj_flux_inter_element1, %obj_flux_inter_element2,%obj_flux_inter_element3, %obj_flux_inter_element4, %obj_flux_inter_element5,  %obj_out_flux_element1 ) : ( memref<512xi32>,  memref<512xi32>, memref<512xi32>, memref<512xi32>, memref<512xi32>, memref<256xi32>) -> ()

      AIE.objectFifo.release<Consume>(%block_0_buf_row_5_inter_flx1 :!AIE.objectFifo<memref<512xi32>>, 4)
      AIE.objectFifo.release<Produce>(%block_0_buf_row_5_out_flx2 :!AIE.objectFifo<memref<256xi32>>, 1)
    }
    AIE.end
  } { link_with="hdiff_flux2.o" }
