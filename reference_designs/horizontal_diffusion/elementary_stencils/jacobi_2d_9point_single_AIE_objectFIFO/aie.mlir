...
module @stencil_2d_9point{
  ...
  %obj_fifo_out = AIE.objectFifo.createObjectFifo(%t73, {%t70}, 2){sym_name = "obj_out" } : !AIE.objectFifo<memref<256xi32>>
   ...
   // DDR buffer
  %ext_buffer_in0  = AIE.external_buffer  {sym_name = "ddr_test_buffer_in0"}: memref<1280 x i32>
  ...
  AIE.objectFifo.registerExternalBuffers(%t70, %obj_fifo_in : !AIE.objectFifo<memref<256xi32>>, {%ext_buffer_in0}) : (memref<1280xi32>)
  AIE.objectFifo.registerExternalBuffers(%t70, %obj_fifo_out : !AIE.objectFifo<memref<256xi32>>, {%ext_buffer_out}) : (memref<256xi32>)

  func.func private @stencil_2d_9point(%A: memref<256xi32>,%B: memref<256xi32>,%C: memref<256xi32>,%D: memref<256xi32>,%E: memref<256xi32>,%O: memref<256xi32>) -> ()
  ...
  %c13 = AIE.core(%t73) { 
    ...
    scf.for %iv = %lb to %ub step %step {  
      ...
      func.call @stencil_2d_9point(%row0,%row1,%row2,%row3,%row4,%obj_out) : (memref<256xi32>,memref<256xi32>,memref<256xi32>,memref<256xi32>,memref<256xi32>,  memref<256xi32>) -> ()
