...
pip install "llvm-aie==$(cat utils/peano-version.txt)" -f https://github.com/Xilinx/llvm-aie/releases/expanded_assets/nightly  # pinned to the tested nightly CI uses
```
