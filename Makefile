...
list_install_components:
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --cyan "Available install components are: \"ADF\" \"AIE\" \"AIECAPI\" \"AIECompilerPythonModules\" \"AIECompilerPythonSources.Core\" \"AIEMLIRPythonModules\" \"AIEPythonExtensions.MLIR\" \"AIEPythonModules\" \"AIEPythonSources\" \"AIEPythonSources.Dialects.AIE\" \"AIEPythonSources.Dialects.AIE.ops_gen\" \"AIEPythonSources.Dialects.AIEX\" \"AIEPythonSources.Dialects.AIEX.ops_gen\" \"AIETargets\" \"AIETransforms\" \"AIEUtils\" \"AIEX\" \"AIEXPythonExtensions.MLIR\" \"AIEXTransforms\" \"AIEXUtils\" \"MLIRAIEVec\" \"MLIRAIEVecToLLVM\" \"MLIRAIEVecTransformOps\" \"MLIRAIEVecTransforms\" \"MLIRAIEVecUtils\" \"MLIRTargetAIEVecCpp\" \"Unspecified\" \"aie-cmake-exports\" \"aie-headers\" \"aie-opt\" \"aie-reset\" \"aie-translate\" \"obj.AIECAPI\""
