...
list_install_components:
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --cyan "Available install components are: \"ADF\" \"AIE\" \"AIECAPI\" \"AIECompilerPythonModules\" \"AIEMLIRPythonModules\" \"AIEPythonModules\" \"AIETargets\" \"AIETransforms\" \"AIEX\" \"AIEXTransforms\" \"AIEXUtils\" \"MLIRAIEVec\" \"MLIRAIEVecToLLVM\" \"MLIRAIEVecTransformOps\" \"MLIRAIEVecTransforms\" \"MLIRAIEVecUtils\" \"MLIRTargetAIEVecCpp\" \"Unspecified\" \"aie-cmake-exports\" \"aie-headers\" \"aie-opt\" \"aie-reset\" \"aie-translate\" \"mlir-python-sources\" \"obj.AIECAPI\""
