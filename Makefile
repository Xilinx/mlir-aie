...
list_install_components:
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --cyan "Available install components are: \"ADF\" \"AIE\" \"AIECAPI\" \"AIETargets\" \"AIETransforms\" \"AIEUtils\" \"AIEX\" \"AIEXTransforms\" \"AIEXUtils\" \"AieCompilerPythonModules\" \"AieCompilerPythonSources.Core\" \"AieMLIRPythonModules\" \"AiePythonExtensions.MLIR\" \"AiePythonModules\" \"AiePythonSources\" \"AiePythonSources.Dialects.AIE\" \"AiePythonSources.Dialects.AIE.ops_gen\" \"MLIRAIEVec\" \"MLIRAIEVecToLLVM\" \"MLIRAIEVecTransforms\" \"MLIRAIEVecUtils\" \"MLIRTargetAIEVecCpp\" \"Unspecified\" \"aie-cmake-exports\" \"aie-headers\" \"aie-opt\" \"aie-reset\" \"aie-translate\" \"obj.AIECAPI\""
