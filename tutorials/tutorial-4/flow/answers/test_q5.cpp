...
main(int argc, char *argv[])
{
    ...
    mlir_aie_acquire_lock_a14_6(_xaie, 0, 0);
    mlir_aie_acquire_lock_a34_7(_xaie, 1, 0);

    mlir_aie_release_lock_a14_6(_xaie, 1, 0);
    mlir_aie_release_lock_a34_7(_xaie, 0, 0);
    ...
    // This is no longer 114 since we run the transfer again and the value is overwritten
