...
// CHECK:   aie.objectfifo.dma_endpoint @prod_dma({{.*}}) drains of @prod_pool {channel = #aie.objectfifo_channel<MM2S : 0>}
...
// CHECK:   aie.objectfifo.dma_endpoint @cons_dma({{.*}}) fills of @cons_pool {channel = #aie.objectfifo_channel<S2MM : 0>}
