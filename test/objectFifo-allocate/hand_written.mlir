...
// CHECK: aie.objectfifo.pool @prod_pool({{.*}}) {buffers = [@mine_0, @mine_1], depth = 2 : i32}
// CHECK: aie.objectfifo.segment @s0 {consumeLock = @full, offset = 0 : i32, produceLock = @free, size = 16 : i32}
