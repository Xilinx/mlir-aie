...
module @hand_written {
  aie.device(xcve2302) {
    ...
    aie.objectfifo.dma_endpoint @prod_dma(%tile12) drains of @prod_pool {pinnedChannel = 1 : i32}
...
// CHECK: aie.objectfifo.dma_endpoint @prod_dma({{.*}}) drains of @prod_pool {channel = #aie.objectfifo_channel<MM2S : 1>, pinnedChannel = 1 : i32}
