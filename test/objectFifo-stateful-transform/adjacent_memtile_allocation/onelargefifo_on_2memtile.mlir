...
// CHECK:       aie.dma_bd(%[[IN0_CONS_BUFF_0]] : memref<96000xi32>, 0, 96000)
// CHECK:       aie.use_lock(%[[IN0_CONS_CONS_LOCK]], Release, 1)
// CHECK:       aie.next_bd ^bb2
// CHECK:     ^bb2:
// CHECK:       aie.use_lock(%[[IN0_CONS_PROD_LOCK]], AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%[[IN0_CONS_BUFF_1]] : memref<96000xi32>, 0, 96000)
// CHECK:       aie.use_lock(%[[IN0_CONS_CONS_LOCK]], Release, 1)
...
// CHECK:       aie.dma_bd(%[[OUT1_CONS_BUFF_0]] : memref<8xi32>, 0, 8)
// CHECK:       aie.use_lock(%[[OUT1_CONS_PROD_LOCK]], Release, 1)
// CHECK:       aie.next_bd ^bb8
// CHECK:     ^bb8:
// CHECK:       aie.use_lock(%[[OUT1_CONS_CONS_LOCK]], AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%[[OUT1_CONS_BUFF_1]] : memref<8xi32>, 0, 8)
// CHECK:       aie.use_lock(%[[OUT1_CONS_PROD_LOCK]], Release, 1)
...
// CHECK:     ^bb2:
// CHECK:       aie.use_lock(%[[IN1_CONS_PROD_LOCK]], AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%[[IN1_CONS_BUFF_1]] : memref<8xi32>, 0, 8)
// CHECK:       aie.use_lock(%[[IN1_CONS_CONS_LOCK]], Release, 1)
// CHECK:       aie.next_bd ^bb1
// CHECK:     ^bb3:
// CHECK:       aie.dma_start(MM2S, 0, ^bb4, ^bb6)
...
// CHECK:     ^bb5:
// CHECK:       aie.use_lock(%[[OUT1_CONS_LOCK]], AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%[[OUT1_BUFF_1]] : memref<8xi32>, 0, 8)
// CHECK:       aie.use_lock(%[[OUT1_PROD_LOCK]], Release, 1)
// CHECK:       aie.next_bd ^bb4
// CHECK:     ^bb6:
// CHECK:       aie.end
...
module {
  aie.device(npu1) {
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      %0 = aie.objectfifo.acquire @out1(Produce, 1) : !aie.objectfifosubview<memref<8xi32>>
      ...
      scf.for %arg0 = %c0 to %c12000 step %c1 {
        %2 = aie.objectfifo.acquire @in1(Consume, 1) : !aie.objectfifosubview<memref<8xi32>>
        ...
        scf.for %arg1 = %c0_0 to %c8 step %c1_1 {
          %4 = memref.load %3[%arg1] : memref<8xi32>
          %c1_i32 = arith.constant 1 : i32
          %5 = arith.addi %4, %c1_i32 : i32
          memref.store %5, %1[%arg1] : memref<8xi32>
        }
