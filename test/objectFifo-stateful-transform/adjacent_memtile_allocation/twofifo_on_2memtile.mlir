...
// CHECK:       aie.dma_bd(%[[IN0_CONS_BUFF_0]] : memref<64000xi32> offset = 0 len = 64000 sizes = [] strides = [])
...
// CHECK:       aie.dma_bd(%[[OUT0_BUFF_0]] : memref<64000xi32> offset = 0 len = 64000 sizes = [] strides = [])
