...
// CHECK:           %[[VAL_8:.*]] = aie.buffer(%[[VAL_2]]) {sym_name = "out0_buff_0"} : memref<64000xi32>
// CHECK:           %[[VAL_9:.*]] = aie.buffer(%[[VAL_2]]) {sym_name = "out0_buff_1"} : memref<64000xi32>
// CHECK:           %[[VAL_10:.*]] = aie.lock(%[[VAL_1]]) {init = 2 : i32, sym_name = "out0_prod_lock_0"}
// CHECK:           %[[VAL_11:.*]] = aie.lock(%[[VAL_1]]) {init = 0 : i32, sym_name = "out0_cons_lock_0"}
...
// CHECK:           %[[VAL_16:.*]] = aie.buffer(%[[VAL_1]]) {sym_name = "in0_cons_buff_0"} : memref<64000xi32>
// CHECK:           %[[VAL_17:.*]] = aie.buffer(%[[VAL_1]]) {sym_name = "in0_cons_buff_1"} : memref<64000xi32>
...
// CHECK:           aie.flow(%[[VAL_0]], DMA : 0, %[[VAL_1]], DMA : 1)
...
// CHECK:             aie.dma_bd(%[[VAL_16]] : memref<64000xi32> offset = 0 len = 64000)
// CHECK:             aie.use_lock(%[[VAL_19]], Release, %[[VAL_21]])
// CHECK:             aie.next_bd ^bb2
// CHECK:           ^bb2:
// CHECK:             aie.use_lock(%[[VAL_18]], AcquireGreaterEqual, %[[VAL_21]])
// CHECK:             aie.dma_bd(%[[VAL_17]] : memref<64000xi32> offset = 0 len = 64000)
// CHECK:             aie.use_lock(%[[VAL_19]], Release, %[[VAL_21]])
...
// CHECK:             aie.dma_bd(%[[VAL_8]] : memref<64000xi32> offset = 0 len = 64000)
// CHECK:             aie.use_lock(%[[VAL_10]], Release, %[[VAL_21]])
// CHECK:             aie.next_bd ^bb8
// CHECK:           ^bb8:
// CHECK:             aie.use_lock(%[[VAL_11]], AcquireGreaterEqual, %[[VAL_21]])
// CHECK:             aie.dma_bd(%[[VAL_9]] : memref<64000xi32> offset = 0 len = 64000)
// CHECK:             aie.use_lock(%[[VAL_10]], Release, %[[VAL_21]])
