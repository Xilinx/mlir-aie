...
// CHECK:     %of1_cons_prod_lock = aie.lock(%tile_1_3, 0) {init = 1 : i32, sym_name = "of1_cons_prod_lock_0"}
// CHECK:     %of1_cons_cons_lock = aie.lock(%tile_1_3, 1) {init = 0 : i32, sym_name = "of1_cons_cons_lock_0"}
// CHECK:     %of1_buff_0 = aie.buffer(%tile_1_2) {sym_name = "of1_buff_0"} : memref<16xi32> 
// CHECK:     %of1_prod_lock = aie.lock(%tile_1_2, 2) {init = 3 : i32, sym_name = "of1_prod_lock_0"}
...
// CHECK:     %of0_cons_prod_lock = aie.lock(%tile_1_2, 0) {init = 1 : i32, sym_name = "of0_cons_prod_lock_0"}
// CHECK:     %of0_cons_cons_lock = aie.lock(%tile_1_2, 1) {init = 0 : i32, sym_name = "of0_cons_cons_lock_0"}
// CHECK:     %of0_buff_0 = aie.buffer(%tile_1_1) {sym_name = "of0_buff_0"} : memref<16xi32> 
// CHECK:     %of0_prod_lock = aie.lock(%tile_1_1, 0) {init = 1 : i32, sym_name = "of0_prod_lock_0"}
// CHECK:     %of0_cons_lock = aie.lock(%tile_1_1, 1) {init = 0 : i32, sym_name = "of0_cons_lock_0"}
