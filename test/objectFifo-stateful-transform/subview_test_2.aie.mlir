...
// CHECK:    %10 = AIE.buffer(%0) {sym_name = "of2_12_33_buff_0"} : memref<16xi32>
// CHECK:    %11 = AIE.lock(%0, 4) {sym_name = "of2_12_33_lock_0"}
// CHECK:    %12 = AIE.buffer(%0) {sym_name = "of2_12_33_buff_1"} : memref<16xi32>
// CHECK:    %13 = AIE.lock(%0, 5) {sym_name = "of2_12_33_lock_1"}
// CHECK:    %14 = AIE.buffer(%0) {sym_name = "of2_12_33_buff_2"} : memref<16xi32>
// CHECK:    %15 = AIE.lock(%0, 6) {sym_name = "of2_12_33_lock_2"}
...
module @multiFifo {
    ...
    %objFifo2 = AIE.objectFifo.createObjectFifo(%tile12, {%tile13}, 3) {sym_name = "of2_12_33"} : !AIE.objectFifo<memref<16xi32>>
