...
//CHECK:     %2 = AIE.buffer(%0) {sym_name = "of2_buff_0"} : memref<16xi32>
//CHECK:     %3 = AIE.buffer(%0) {sym_name = "of2_buff_1"} : memref<16xi32>
//CHECK:     %4 = AIE.buffer(%0) {sym_name = "of2_buff_2"} : memref<16xi32>
//CHECK:     %5 = AIE.lock(%0, 4) {init = 0 : i32, sym_name = "of2_lock_0"}
//CHECK:     %6 = AIE.lock(%0, 5) {init = 0 : i32, sym_name = "of2_lock_1"}
//CHECK:     %7 = AIE.lock(%0, 6) {init = 0 : i32, sym_name = "of2_lock_2"}
