...
// CHECK:   %2 = AIE.lock(%1, 0) {sym_name = "objfifo_prod_lock_0"}
// CHECK:   %3 = AIE.buffer(%0) {sym_name = "objfifo_cons_buff_0"} : memref<16xi32>
// CHECK:   %4 = AIE.lock(%0, 0) {sym_name = "objfifo_cons_lock_0"}
// CHECK:   %5 = AIE.buffer(%0) {sym_name = "objfifo_cons_buff_1"} : memref<16xi32>
// CHECK:   %6 = AIE.lock(%0, 1) {sym_name = "objfifo_cons_lock_1"}
// CHECK:   %7 = AIE.buffer(%0) {sym_name = "objfifo_cons_buff_2"} : memref<16xi32>
// CHECK:   %8 = AIE.lock(%0, 2) {sym_name = "objfifo_cons_lock_2"}
