...
// CHECK:     %10 = AIE.buffer(%1) {sym_name = "of_1_buff_0"} : memref<16xi32>
// CHECK:     %11 = AIE.buffer(%1) {sym_name = "of_1_buff_1"} : memref<16xi32>
// CHECK:     %12 = AIE.buffer(%1) {sym_name = "of_1_buff_2"} : memref<16xi32>
// CHECK:     %13 = AIE.lock(%1, 0) {init = 0 : i32, sym_name = "of_1_lock_0"}
// CHECK:     %14 = AIE.lock(%1, 1) {init = 0 : i32, sym_name = "of_1_lock_1"}
// CHECK:     %15 = AIE.lock(%1, 2) {init = 0 : i32, sym_name = "of_1_lock_2"}
