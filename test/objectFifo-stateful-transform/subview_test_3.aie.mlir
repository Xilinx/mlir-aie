...
// CHECK:    %10 = AIE.buffer(%1) {sym_name = "buff4"} : memref<16xi32>
// CHECK:    %11 = AIE.lock(%1, 0)
// CHECK:    %12 = AIE.buffer(%1) {sym_name = "buff5"} : memref<16xi32>
// CHECK:    %13 = AIE.lock(%1, 1)
// CHECK:    %14 = AIE.buffer(%1) {sym_name = "buff6"} : memref<16xi32>
// CHECK:    %15 = AIE.lock(%1, 2)
