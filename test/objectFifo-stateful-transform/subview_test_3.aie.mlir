...
// CHECK:    %2 = AIE.buffer(%0) {sym_name = "of_12_33_buff_0"} : memref<16xi32>
// CHECK:    %3 = AIE.lock(%0, 0) {sym_name = "of_12_33_lock_0"}
// CHECK:    %4 = AIE.buffer(%0) {sym_name = "of_12_33_buff_1"} : memref<16xi32>
// CHECK:    %5 = AIE.lock(%0, 1) {sym_name = "of_12_33_lock_1"}
// CHECK:    %6 = AIE.buffer(%0) {sym_name = "of_12_33_buff_2"} : memref<16xi32>
// CHECK:    %7 = AIE.lock(%0, 2) {sym_name = "of_12_33_lock_2"}
// CHECK:    %8 = AIE.buffer(%0) {sym_name = "of_12_33_buff_3"} : memref<16xi32>
// CHECK:    %9 = AIE.lock(%0, 3) {sym_name = "of_12_33_lock_3"}
// CHECK:    %10 = AIE.buffer(%1) {sym_name = "of2_12_33_buff_0"} : memref<16xi32>
// CHECK:    %11 = AIE.lock(%1, 0) {sym_name = "of2_12_33_lock_0"}
// CHECK:    %12 = AIE.buffer(%1) {sym_name = "of2_12_33_buff_1"} : memref<16xi32>
// CHECK:    %13 = AIE.lock(%1, 1) {sym_name = "of2_12_33_lock_1"}
// CHECK:    %14 = AIE.buffer(%1) {sym_name = "of2_12_33_buff_2"} : memref<16xi32>
// CHECK:    %15 = AIE.lock(%1, 2) {sym_name = "of2_12_33_lock_2"}
...
module @multiCoreMixedFifo {
    ...
    %objFifo = AIE.objectFifo.createObjectFifo(%tile12, {%tile13}, 4) {sym_name = "of_12_33"} : !AIE.objectFifo<memref<16xi32>>
    %objFifo2 = AIE.objectFifo.createObjectFifo(%tile13, {%tile12}, 3) {sym_name = "of2_12_33"} : !AIE.objectFifo<memref<16xi32>>
    ...
    %core11 = AIE.core(%tile12) {
        ...
        %subview02 = AIE.objectFifo.acquire<Consume>(%objFifo2 : !AIE.objectFifo<memref<16xi32>>, 1) : !AIE.objectFifoSubview<memref<16xi32>>
        ...
        %subview12 = AIE.objectFifo.acquire<Consume>(%objFifo2 : !AIE.objectFifo<memref<16xi32>>, 2) : !AIE.objectFifoSubview<memref<16xi32>>
    ...
    %core12 = AIE.core(%tile13) {
        ...
        %subview02 = AIE.objectFifo.acquire<Produce>(%objFifo2 : !AIE.objectFifo<memref<16xi32>>, 2) : !AIE.objectFifoSubview<memref<16xi32>>
        %elem002 = AIE.objectFifo.subview.access %subview02[0] : !AIE.objectFifoSubview<memref<16xi32>> -> memref<16xi32>
        ...
        AIE.objectFifo.release<Produce>(%objFifo2 : !AIE.objectFifo<memref<16xi32>>, 2)
