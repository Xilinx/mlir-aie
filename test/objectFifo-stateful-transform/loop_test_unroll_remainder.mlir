...
// CHECK:              func.call @some_work(%of_1_buff_1, %of_2_buff_3, %5) : (memref<16xi32>, memref<16xi32>, index) -> ()
// CHECK:              aie.use_lock(%of_1_lock_1, Release, 0)
// CHECK:              aie.use_lock(%of_2_lock_3, Release, 1)
// CHECK:            }

// TODO: this needs to be unrolled
    //   scf.for %arg0 = %c8 to %c10 step %c1 {
    //     aie.use_lock(%of_1_lock_0, Acquire, 1)
    //     aie.use_lock(%of_2_lock_0, Acquire, 0)
    //     func.call @some_work(%of_1_buff_0, %of_2_buff_0, %arg0) : (memref<16xi32>, memref<16xi32>, index) -> ()
    //     aie.use_lock(%of_1_lock_0, Release, 0)
    //     aie.use_lock(%of_2_lock_0, Release, 1)
    //   }
