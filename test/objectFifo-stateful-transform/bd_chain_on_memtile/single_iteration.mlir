...
// CHECK:       aie.dma_bd(%[[IN_CONS_BUFF_0]] : memref<1024xi32> offset = 0 len = 1024 sizes = [] strides = [])
// CHECK:       aie.use_lock(%[[IN_CONS_CONS_LOCK]], Release, 1)
// CHECK:       aie.next_bd ^bb2
// CHECK:     ^bb2:  // pred: ^bb1
// CHECK:       aie.use_lock(%[[IN_CONS_PROD_LOCK]], AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%[[IN_CONS_BUFF_1]] : memref<1024xi32> offset = 0 len = 1024 sizes = [] strides = [])
// CHECK:       aie.use_lock(%[[IN_CONS_CONS_LOCK]], Release, 1)
