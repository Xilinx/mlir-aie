...
// CHECK:       aie.dma_bd(%broadcast_input_cons_buff_0 : memref<512xui8> offset = 0 len = 512 sizes = [] strides = [])
// CHECK:       aie.use_lock(%broadcast_input_cons_cons_lock_0, Release, 1)
// CHECK:       aie.next_bd ^bb2
// CHECK:     ^bb2:  // pred: ^bb1
// CHECK:       aie.use_lock(%broadcast_input_cons_prod_lock_0, AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%broadcast_input_cons_buff_1 : memref<512xui8> offset = 0 len = 512 sizes = [] strides = [])
// CHECK:       aie.use_lock(%broadcast_input_cons_cons_lock_0, Release, 1)
...
// CHECK:       aie.dma_bd(%broadcast_output_0_cons_buff_0 : memref<512xui8> offset = 0 len = 512 sizes = [] strides = [])
// CHECK:       aie.use_lock(%broadcast_output_0_cons_cons_lock_0, Release, 1)
// CHECK:       aie.next_bd ^bb2
// CHECK:     ^bb2:  // pred: ^bb1
// CHECK:       aie.use_lock(%broadcast_output_0_cons_prod_lock_0, AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%broadcast_output_0_cons_buff_1 : memref<512xui8> offset = 0 len = 512 sizes = [] strides = [])
// CHECK:       aie.use_lock(%broadcast_output_0_cons_cons_lock_0, Release, 1)
// CHECK:       aie.next_bd ^bb3
// CHECK:     ^bb3:  // pred: ^bb2
// CHECK:       aie.use_lock(%broadcast_output_0_cons_prod_lock_0, AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%broadcast_output_0_cons_buff_2 : memref<512xui8> offset = 0 len = 512 sizes = [] strides = [])
// CHECK:       aie.use_lock(%broadcast_output_0_cons_cons_lock_0, Release, 1)
// CHECK:       aie.next_bd ^bb1
// CHECK:     ^bb4:  // pred: ^bb0
// CHECK:       aie.end
...
// CHECK:       aie.dma_bd(%broadcast_output_1_cons_buff_0 : memref<512xui8> offset = 0 len = 512 sizes = [] strides = [])
// CHECK:       aie.use_lock(%broadcast_output_1_cons_cons_lock_0, Release, 1)
// CHECK:       aie.next_bd ^bb2
// CHECK:     ^bb2:  // pred: ^bb1
// CHECK:       aie.use_lock(%broadcast_output_1_cons_prod_lock_0, AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%broadcast_output_1_cons_buff_1 : memref<512xui8> offset = 0 len = 512 sizes = [] strides = [])
// CHECK:       aie.use_lock(%broadcast_output_1_cons_cons_lock_0, Release, 1)
// CHECK:       aie.next_bd ^bb3
// CHECK:     ^bb3:  // pred: ^bb2
// CHECK:       aie.use_lock(%broadcast_output_1_cons_prod_lock_0, AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%broadcast_output_1_cons_buff_2 : memref<512xui8> offset = 0 len = 512 sizes = [] strides = [])
// CHECK:       aie.use_lock(%broadcast_output_1_cons_cons_lock_0, Release, 1)
// CHECK:       aie.next_bd ^bb1
// CHECK:     ^bb4:  // pred: ^bb0
// CHECK:       aie.end
...
// CHECK:       aie.dma_bd(%broadcast_output_2_cons_buff_0 : memref<512xui8> offset = 0 len = 512 sizes = [] strides = [])
// CHECK:       aie.use_lock(%broadcast_output_2_cons_cons_lock_0, Release, 1)
// CHECK:       aie.next_bd ^bb2
// CHECK:     ^bb2:  // pred: ^bb1
// CHECK:       aie.use_lock(%broadcast_output_2_cons_prod_lock_0, AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%broadcast_output_2_cons_buff_1 : memref<512xui8> offset = 0 len = 512 sizes = [] strides = [])
// CHECK:       aie.use_lock(%broadcast_output_2_cons_cons_lock_0, Release, 1)
// CHECK:       aie.next_bd ^bb3
// CHECK:     ^bb3:  // pred: ^bb2
// CHECK:       aie.use_lock(%broadcast_output_2_cons_prod_lock_0, AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%broadcast_output_2_cons_buff_2 : memref<512xui8> offset = 0 len = 512 sizes = [] strides = [])
// CHECK:       aie.use_lock(%broadcast_output_2_cons_cons_lock_0, Release, 1)
// CHECK:       aie.next_bd ^bb1
// CHECK:     ^bb4:  // pred: ^bb0
// CHECK:       aie.end
