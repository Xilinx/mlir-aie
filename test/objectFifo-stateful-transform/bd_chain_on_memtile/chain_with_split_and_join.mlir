...
// CHECK:     %out_buff_0 = aie.buffer(%mem_tile_0_1) {sym_name = "out_buff_0"} : memref<4096xui8> 
// CHECK:     %out_buff_1 = aie.buffer(%mem_tile_0_1) {sym_name = "out_buff_1"} : memref<4096xui8> 
...
// CHECK:     %join_1_buff_0 = aie.buffer(%tile_0_3) {sym_name = "join_1_buff_0"} : memref<2048xui8> 
// CHECK:     %join_1_buff_1 = aie.buffer(%tile_0_3) {sym_name = "join_1_buff_1"} : memref<2048xui8> 
...
// CHECK:     %join_0_buff_0 = aie.buffer(%tile_0_2) {sym_name = "join_0_buff_0"} : memref<2048xui8> 
// CHECK:     %join_0_buff_1 = aie.buffer(%tile_0_2) {sym_name = "join_0_buff_1"} : memref<2048xui8> 
...
// CHECK:     %split_1_cons_buff_0 = aie.buffer(%tile_0_3) {sym_name = "split_1_cons_buff_0"} : memref<2048xui8> 
// CHECK:     %split_1_cons_buff_1 = aie.buffer(%tile_0_3) {sym_name = "split_1_cons_buff_1"} : memref<2048xui8> 
...
// CHECK:     %split_0_cons_buff_0 = aie.buffer(%tile_0_2) {sym_name = "split_0_cons_buff_0"} : memref<2048xui8> 
// CHECK:     %split_0_cons_buff_1 = aie.buffer(%tile_0_2) {sym_name = "split_0_cons_buff_1"} : memref<2048xui8> 
...
// CHECK:     %in_cons_buff_0 = aie.buffer(%mem_tile_0_1) {sym_name = "in_cons_buff_0"} : memref<4096xui8> 
// CHECK:     %in_cons_buff_1 = aie.buffer(%mem_tile_0_1) {sym_name = "in_cons_buff_1"} : memref<4096xui8> 
...
// CHECK:       aie.dma_bd(%in_cons_buff_0 : memref<4096xui8>, 0, 4096)
// CHECK:       aie.use_lock(%in_cons_cons_lock_0, Release, 1)
// CHECK:       aie.next_bd ^bb2
// CHECK:     ^bb2:  // pred: ^bb1
// CHECK:       aie.use_lock(%in_cons_prod_lock_1, AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%in_cons_buff_0 : memref<4096xui8>, 4096, 0)
// CHECK:       aie.use_lock(%in_cons_cons_lock_1, Release, 1)
// CHECK:       aie.next_bd ^bb3
// CHECK:     ^bb3:  // pred: ^bb2
// CHECK:       aie.use_lock(%in_cons_prod_lock_0, AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%in_cons_buff_1 : memref<4096xui8>, 0, 4096)
// CHECK:       aie.use_lock(%in_cons_cons_lock_0, Release, 1)
// CHECK:       aie.next_bd ^bb4
// CHECK:     ^bb4:  // pred: ^bb3
// CHECK:       aie.use_lock(%in_cons_prod_lock_1, AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%in_cons_buff_1 : memref<4096xui8>, 4096, 0)
// CHECK:       aie.use_lock(%in_cons_cons_lock_1, Release, 1)
...
// CHECK:       aie.dma_bd(%out_buff_0 : memref<4096xui8>, 0, 4096)
// CHECK:       aie.use_lock(%out_cons_lock_0, Release, 1)
// CHECK:       aie.next_bd ^bb15
// CHECK:     ^bb15:  // pred: ^bb14
// CHECK:       aie.use_lock(%out_prod_lock_0, AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%out_buff_1 : memref<4096xui8>, 0, 4096)
// CHECK:       aie.use_lock(%out_cons_lock_0, Release, 1)
...
// CHECK:       aie.dma_bd(%out_buff_0 : memref<4096xui8>, 4096, 0)
// CHECK:       aie.use_lock(%out_cons_lock_1, Release, 1)
// CHECK:       aie.next_bd ^bb19
// CHECK:     ^bb19:  // pred: ^bb18
// CHECK:       aie.use_lock(%out_prod_lock_1, AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%out_buff_1 : memref<4096xui8>, 4096, 0)
// CHECK:       aie.use_lock(%out_cons_lock_1, Release, 1)
...
// CHECK:       aie.dma_bd(%split_0_cons_buff_0 : memref<2048xui8>, 0, 2048)
// CHECK:       aie.use_lock(%split_0_cons_cons_lock_0, Release, 1)
// CHECK:       aie.next_bd ^bb2
// CHECK:     ^bb2:  // pred: ^bb1
// CHECK:       aie.use_lock(%split_0_cons_prod_lock_0, AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%split_0_cons_buff_1 : memref<2048xui8>, 0, 2048)
// CHECK:       aie.use_lock(%split_0_cons_cons_lock_0, Release, 1)
// CHECK:       aie.next_bd ^bb1
// CHECK:     ^bb3:  // pred: ^bb0
...
// CHECK:       aie.dma_bd(%join_0_buff_0 : memref<2048xui8>, 0, 2048)
// CHECK:       aie.use_lock(%join_0_prod_lock_0, Release, 1)
// CHECK:       aie.next_bd ^bb5
// CHECK:     ^bb5:  // pred: ^bb4
// CHECK:       aie.use_lock(%join_0_cons_lock_0, AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%join_0_buff_1 : memref<2048xui8>, 0, 2048)
// CHECK:       aie.use_lock(%join_0_prod_lock_0, Release, 1)
// CHECK:       aie.next_bd ^bb4
// CHECK:     ^bb6:  // pred: ^bb3
// CHECK:       aie.end
...
// CHECK:       aie.dma_bd(%split_1_cons_buff_0 : memref<2048xui8>, 0, 2048)
// CHECK:       aie.use_lock(%split_1_cons_cons_lock_0, Release, 1)
// CHECK:       aie.next_bd ^bb2
// CHECK:     ^bb2:  // pred: ^bb1
// CHECK:       aie.use_lock(%split_1_cons_prod_lock_0, AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%split_1_cons_buff_1 : memref<2048xui8>, 0, 2048)
// CHECK:       aie.use_lock(%split_1_cons_cons_lock_0, Release, 1)
// CHECK:       aie.next_bd ^bb1
// CHECK:     ^bb3:  // pred: ^bb0
// CHECK:       %1 = aie.dma_start(MM2S, 0, ^bb4, ^bb6)
...
// CHECK:       aie.dma_bd(%join_1_buff_0 : memref<2048xui8>, 0, 2048)
// CHECK:       aie.use_lock(%join_1_prod_lock_0, Release, 1)
// CHECK:       aie.next_bd ^bb5
// CHECK:     ^bb5:  // pred: ^bb4
// CHECK:       aie.use_lock(%join_1_cons_lock_0, AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%join_1_buff_1 : memref<2048xui8>, 0, 2048)
// CHECK:       aie.use_lock(%join_1_prod_lock_0, Release, 1)
// CHECK:       aie.next_bd ^bb4
// CHECK:     ^bb6:  // pred: ^bb3
// CHECK:       aie.end
