...
// CHECK:             AIE.dma_bd(<%[[VAL_29]] : memref<16xi32>, 0, 16>, 0)
// CHECK:             AIE.use_lock(%[[VAL_31]], Release, 0)
// CHECK:             AIE.next_bd ^bb2
// CHECK:           ^bb2:  // pred: ^bb1
// CHECK:             AIE.use_lock(%[[VAL_32]], Acquire, 1)
// CHECK:             AIE.dma_bd(<%[[VAL_30]] : memref<16xi32>, 0, 16>, 0)
...
// CHECK:             AIE.dma_bd(<%[[VAL_5]] : memref<16xi32>, 0, 16>, 0)
// CHECK:             AIE.use_lock(%[[VAL_7]], Release, 1)
// CHECK:             AIE.next_bd ^bb2
// CHECK:           ^bb2:  // pred: ^bb1
// CHECK:             AIE.use_lock(%[[VAL_8]], Acquire, 0)
// CHECK:             AIE.dma_bd(<%[[VAL_6]] : memref<16xi32>, 0, 16>, 0)
