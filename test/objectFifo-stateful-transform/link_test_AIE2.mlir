...
//CHECK:     %4 = AIE.buffer(%3) {sym_name = "mem_out_cons_buff_0"} : memref<3000xi32>
//CHECK:     %5 = AIE.buffer(%3) {sym_name = "mem_out_cons_buff_1"} : memref<3000xi32>
//CHECK:     %6 = AIE.buffer(%3) {sym_name = "mem_out_cons_buff_2"} : memref<3000xi32>
//CHECK:     %7 = AIE.buffer(%3) {sym_name = "mem_out_cons_buff_3"} : memref<3000xi32>
//CHECK:     %8 = AIE.lock(%3, 0) {init = 4 : i32, sym_name = "mem_out_cons_prod_lock"}
//CHECK:     %9 = AIE.lock(%3, 1) {init = 0 : i32, sym_name = "mem_out_cons_cons_lock"}
//CHECK:     %10 = AIE.buffer(%2) {sym_name = "mem_in_0_cons_buff_0"} : memref<3000xi32>
//CHECK:     %11 = AIE.buffer(%2) {sym_name = "mem_in_0_cons_buff_1"} : memref<3000xi32>
//CHECK:     %12 = AIE.lock(%2, 0) {init = 2 : i32, sym_name = "mem_in_0_cons_prod_lock"}
//CHECK:     %13 = AIE.lock(%2, 1) {init = 0 : i32, sym_name = "mem_in_0_cons_cons_lock"}
//CHECK:     %14 = AIE.buffer(%1) {sym_name = "mem_in_1_cons_buff_0"} : memref<3000xi32>
//CHECK:     %15 = AIE.buffer(%1) {sym_name = "mem_in_1_cons_buff_1"} : memref<3000xi32>
//CHECK:     %16 = AIE.buffer(%1) {sym_name = "mem_in_1_cons_buff_2"} : memref<3000xi32>
//CHECK:     %17 = AIE.buffer(%1) {sym_name = "mem_in_1_cons_buff_3"} : memref<3000xi32>
//CHECK:     %18 = AIE.buffer(%1) {sym_name = "mem_in_1_cons_buff_4"} : memref<3000xi32>
//CHECK:     %19 = AIE.buffer(%1) {sym_name = "mem_in_1_cons_buff_5"} : memref<3000xi32>
//CHECK:     %20 = AIE.buffer(%1) {sym_name = "mem_in_1_cons_buff_6"} : memref<3000xi32>
//CHECK:     %21 = AIE.lock(%1, 0) {init = 7 : i32, sym_name = "mem_in_1_cons_prod_lock"}
//CHECK:     %22 = AIE.lock(%1, 1) {init = 0 : i32, sym_name = "mem_in_1_cons_cons_lock"}
//CHECK:     %23 = AIE.lock(%0, 0) {init = 0 : i32, sym_name = "mem_in_prod_lock"}
//CHECK:     %24 = AIE.lock(%0, 1) {init = 0 : i32, sym_name = "mem_in_cons_lock"}
...
//CHECK:       memref.store %c11_i32, %10[%c0] : memref<3000xi32>
//CHECK:       AIE.end
//CHECK:     }
...
//CHECK:       memref.store %c11_i32, %4[%c0] : memref<3000xi32>
//CHECK:       AIE.end
//CHECK:     }
//CHECK:     %27 = AIE.mem(%2) {
...
//CHECK:       AIE.dmaBd(<%14 : memref<3000xi32>, 0, 3000>, 0)
...
//CHECK:     ^bb4:  // pred: ^bb3
//CHECK:       AIE.useLock(%21, AcquireGreaterEqual, 1)
//CHECK:       AIE.dmaBd(<%17 : memref<3000xi32>, 0, 3000>, 0)
//CHECK:       AIE.useLock(%22, Release, 1)
//CHECK:       AIE.nextBd ^bb5
//CHECK:     ^bb5:  // pred: ^bb4
//CHECK:       AIE.useLock(%21, AcquireGreaterEqual, 1)
//CHECK:       AIE.dmaBd(<%18 : memref<3000xi32>, 0, 3000>, 0)
//CHECK:       AIE.useLock(%22, Release, 1)
...
//CHECK:       AIE.dmaBd(<%4 : memref<3000xi32>, 0, 3000>, 0)
//CHECK:       AIE.useLock(%9, Release, 1)
//CHECK:       AIE.nextBd ^bb2
//CHECK:     ^bb2:  // pred: ^bb1
//CHECK:       AIE.useLock(%8, AcquireGreaterEqual, 1)
//CHECK:       AIE.dmaBd(<%5 : memref<3000xi32>, 0, 3000>, 0)
//CHECK:       AIE.useLock(%9, Release, 1)
//CHECK:       AIE.nextBd ^bb3
//CHECK:     ^bb3:  // pred: ^bb2
//CHECK:       AIE.useLock(%8, AcquireGreaterEqual, 1)
