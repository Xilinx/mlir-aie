...
//CHECK:     %2 = AIE.lock(%1, 2) {init = 1 : i32, sym_name = "of_out_cons_prod_lock"}
//CHECK:     %3 = AIE.lock(%1, 3) {init = 0 : i32, sym_name = "of_out_cons_cons_lock"}
//CHECK:     %4 = AIE.buffer(%0) {sym_name = "of_out_buff_0"} : memref<16xi32>
//CHECK:     %5 = AIE.buffer(%0) {sym_name = "of_out_buff_1"} : memref<16xi32>
//CHECK:     %6 = AIE.lock(%0, 2) {init = 2 : i32, sym_name = "of_out_prod_lock"}
//CHECK:     %7 = AIE.lock(%0, 3) {init = 0 : i32, sym_name = "of_out_cons_lock"}
//CHECK:     %8 = AIE.buffer(%0) {sym_name = "of_in_cons_buff_0"} : memref<16xi32>
//CHECK:     %9 = AIE.buffer(%0) {sym_name = "of_in_cons_buff_1"} : memref<16xi32>
//CHECK:     %10 = AIE.lock(%0, 0) {init = 2 : i32, sym_name = "of_in_cons_prod_lock"}
//CHECK:     %11 = AIE.lock(%0, 1) {init = 0 : i32, sym_name = "of_in_cons_cons_lock"}
//CHECK:     %12 = AIE.lock(%1, 0) {init = 1 : i32, sym_name = "of_in_prod_lock"}
//CHECK:     %13 = AIE.lock(%1, 1) {init = 0 : i32, sym_name = "of_in_cons_lock"}
...
//CHECK:       AIE.useLock(%2, AcquireGreaterEqual, 1)
