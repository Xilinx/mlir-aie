...
// CHECK-DAG:     %[[of0_cons_buff_0:.*]] = aie.buffer(%[[tile_1_3]]) {sym_name = "of0_cons_buff_0"} : memref<256xi32>
// CHECK-DAG:     %[[of0_cons_buff_1:.*]] = aie.buffer(%[[tile_1_3]]) {sym_name = "of0_cons_buff_1"} : memref<256xi32>
// CHECK-DAG:     %[[of0_cons_buff_2:.*]] = aie.buffer(%[[tile_1_3]]) {sym_name = "of0_cons_buff_2"} : memref<256xi32>
// CHECK-DAG:     %[[of0_cons_buff_3:.*]] = aie.buffer(%[[tile_1_3]]) {sym_name = "of0_cons_buff_3"} : memref<256xi32>
// CHECK-DAG:     %[[of0_cons_prod_lock:.*]] = aie.lock(%[[tile_1_3]]) {init = 4 : i32, sym_name = "of0_cons_prod_lock_0"}
// CHECK-DAG:     %[[of0_cons_cons_lock:.*]] = aie.lock(%[[tile_1_3]]) {init = 0 : i32, sym_name = "of0_cons_cons_lock_0"}
...
// CHECK:           ^bb1:  // 2 preds: ^bb0, ^bb4
// CHECK:       aie.use_lock(%[[of0_cons_prod_lock]], AcquireGreaterEqual, %{{.*}})
// CHECK:       aie.dma_bd(%[[of0_cons_buff_0]] : memref<256xi32> offset = {{.*}} len = {{.*}})
// CHECK:       aie.use_lock(%[[of0_cons_cons_lock]], Release, %{{.*}})
// CHECK:             aie.next_bd ^bb2
// CHECK:           ^bb2:  // pred: ^bb1
// CHECK:       aie.use_lock(%[[of0_cons_prod_lock]], AcquireGreaterEqual, %{{.*}})
...
// CHECK:           ^bb3:  // pred: ^bb2
// CHECK:       aie.use_lock(%[[of0_cons_prod_lock]], AcquireGreaterEqual, %{{.*}})
// CHECK:       aie.dma_bd(%[[of0_cons_buff_2]] : memref<256xi32> offset = {{.*}} len = {{.*}})
// CHECK:       aie.use_lock(%[[of0_cons_cons_lock]], Release, %{{.*}})
// CHECK:             aie.next_bd ^bb4
// CHECK:           ^bb4:  // pred: ^bb3
// CHECK:       aie.use_lock(%[[of0_cons_prod_lock]], AcquireGreaterEqual, %{{.*}})
// CHECK:       aie.dma_bd(%[[of0_cons_buff_3]] : memref<256xi32> offset = {{.*}} len = {{.*}})
// CHECK:       aie.use_lock(%[[of0_cons_cons_lock]], Release, %{{.*}})
// CHECK:             aie.next_bd ^bb1
// CHECK:           ^bb5:  // pred: ^bb0
// CHECK:             aie.end
