...
// CHECK:           aie.use_lock(%[[OF0_CONS_PROD_LOCK_0]], AcquireGreaterEqual, 1)
// CHECK:           aie.dma_bd(%[[OF0_CONS_BUFF_0]] : memref<256xi32> offset = 0 len = 128 sizes = [] strides = [])
// CHECK:           aie.use_lock(%[[OF0_CONS_CONS_LOCK_0]], Release, 1)
// CHECK:           aie.next_bd ^bb2
// CHECK:         ^bb2:  // pred: ^bb1
// CHECK:           aie.use_lock(%[[OF0_CONS_PROD_LOCK_1]], AcquireGreaterEqual, 1)
// CHECK:           aie.dma_bd(%[[OF0_CONS_BUFF_0]] : memref<256xi32> offset = 128 len = 128 sizes = [] strides = [])
// CHECK:           aie.use_lock(%[[OF0_CONS_CONS_LOCK_1]], Release, 1)
// CHECK:           aie.next_bd ^bb3
// CHECK:         ^bb3:  // pred: ^bb2
// CHECK:           aie.use_lock(%[[OF0_CONS_PROD_LOCK_0]], AcquireGreaterEqual, 1)
// CHECK:           aie.dma_bd(%[[OF0_CONS_BUFF_1]] : memref<256xi32> offset = 0 len = 128 sizes = [] strides = [])
// CHECK:           aie.use_lock(%[[OF0_CONS_CONS_LOCK_0]], Release, 1)
// CHECK:           aie.next_bd ^bb4
// CHECK:         ^bb4:  // pred: ^bb3
// CHECK:           aie.use_lock(%[[OF0_CONS_PROD_LOCK_1]], AcquireGreaterEqual, 1)
// CHECK:           aie.dma_bd(%[[OF0_CONS_BUFF_1]] : memref<256xi32> offset = 128 len = 128 sizes = [] strides = [])
// CHECK:           aie.use_lock(%[[OF0_CONS_CONS_LOCK_1]], Release, 1)
...
// CHECK:           aie.dma_bd(%[[OF0_CONS_BUFF_0]] : memref<256xi32> offset = 0 len = 128 sizes = [4, 2, 8, 4] strides = [64, 4, 8, 1])
// CHECK:           aie.use_lock(%[[OF0_CONS_PROD_LOCK_0]], Release, 1)
// CHECK:           aie.next_bd ^bb7
// CHECK:         ^bb7:  // pred: ^bb6
// CHECK:           aie.use_lock(%[[OF0_CONS_CONS_LOCK_0]], AcquireGreaterEqual, 1)
// CHECK:           aie.dma_bd(%[[OF0_CONS_BUFF_1]] : memref<256xi32> offset = 0 len = 128 sizes = [4, 2, 8, 4] strides = [64, 4, 8, 1])
// CHECK:           aie.use_lock(%[[OF0_CONS_PROD_LOCK_0]], Release, 1)
// CHECK:           aie.next_bd ^bb6
// CHECK:         ^bb8:  // pred: ^bb5
// CHECK:           %[[VAL_2:.*]] = aie.dma_start(MM2S, 1, ^bb9, ^bb11)
// CHECK:         ^bb9:  // 2 preds: ^bb8, ^bb10
// CHECK:           aie.use_lock(%[[OF0_CONS_CONS_LOCK_1]], AcquireGreaterEqual, 1)
// CHECK:           aie.dma_bd(%[[OF0_CONS_BUFF_0]] : memref<256xi32> offset = 128 len = 128 sizes = [4, 2, 8, 4] strides = [64, 4, 8, 1])
// CHECK:           aie.use_lock(%[[OF0_CONS_PROD_LOCK_1]], Release, 1)
// CHECK:           aie.next_bd ^bb10
// CHECK:         ^bb10:  // pred: ^bb9
// CHECK:           aie.use_lock(%[[OF0_CONS_CONS_LOCK_1]], AcquireGreaterEqual, 1)
// CHECK:           aie.dma_bd(%[[OF0_CONS_BUFF_1]] : memref<256xi32> offset = 128 len = 128 sizes = [4, 2, 8, 4] strides = [64, 4, 8, 1])
// CHECK:           aie.use_lock(%[[OF0_CONS_PROD_LOCK_1]], Release, 1)
...
// CHECK:           aie.dma_bd(%[[OF1_0_CONS_BUFF_0]] : memref<128xi32> offset = 0 len = 128 sizes = [] strides = [])
// CHECK:           aie.use_lock(%[[OF1_0_CONS_CONS_LOCK]], Release, 1)
// CHECK:           aie.next_bd ^bb2
// CHECK:         ^bb2:
// CHECK:           aie.use_lock(%[[OF1_0_CONS_PROD_LOCK]], AcquireGreaterEqual, 1)
// CHECK:           aie.dma_bd(%[[OF1_0_CONS_BUFF_1]] : memref<128xi32> offset = 0 len = 128 sizes = [] strides = [])
// CHECK:           aie.use_lock(%[[OF1_0_CONS_CONS_LOCK]], Release, 1)
// CHECK:           aie.next_bd ^bb1
// CHECK:         ^bb3:
// CHECK:           aie.end
...
// CHECK:           aie.dma_bd(%[[OF1_1_CONS_BUFF_0]] : memref<128xi32> offset = 0 len = 128 sizes = [] strides = [])
// CHECK:           aie.use_lock(%[[OF1_1_CONS_CONS_LOCK]], Release, 1)
// CHECK:           aie.next_bd ^bb2
// CHECK:         ^bb2:
// CHECK:           aie.use_lock(%[[OF1_1_CONS_PROD_LOCK]], AcquireGreaterEqual, 1)
// CHECK:           aie.dma_bd(%[[OF1_1_CONS_BUFF_1]] : memref<128xi32> offset = 0 len = 128 sizes = [] strides = [])
// CHECK:           aie.use_lock(%[[OF1_1_CONS_CONS_LOCK]], Release, 1)
// CHECK:           aie.next_bd ^bb1
// CHECK:         ^bb3:
// CHECK:           aie.end
...
// CHECK:           aie.dma_bd(%[[OF2_0_CONS_BUFF_0]] : memref<128xi32> offset = 0 len = 128 sizes = [] strides = [])
// CHECK:           aie.use_lock(%[[OF2_0_CONS_CONS_LOCK]], Release, 1)
// CHECK:           aie.next_bd ^bb2
// CHECK:         ^bb2:
// CHECK:           aie.use_lock(%[[OF2_0_CONS_PROD_LOCK]], AcquireGreaterEqual, 1)
// CHECK:           aie.dma_bd(%[[OF2_0_CONS_BUFF_1]] : memref<128xi32> offset = 0 len = 128 sizes = [] strides = [])
// CHECK:           aie.use_lock(%[[OF2_0_CONS_CONS_LOCK]], Release, 1)
// CHECK:           aie.next_bd ^bb1
// CHECK:         ^bb3:
// CHECK:           aie.end
...
// CHECK:           aie.dma_bd(%[[OF2_1_CONS_BUFF_0]] : memref<128xi32> offset = 0 len = 128 sizes = [] strides = [])
// CHECK:           aie.use_lock(%[[OF2_1_CONS_CONS_LOCK]], Release, 1)
// CHECK:           aie.next_bd ^bb2
// CHECK:         ^bb2:
// CHECK:           aie.use_lock(%[[OF2_1_CONS_PROD_LOCK]], AcquireGreaterEqual, 1)
// CHECK:           aie.dma_bd(%[[OF2_1_CONS_BUFF_1]] : memref<128xi32> offset = 0 len = 128 sizes = [] strides = [])
// CHECK:           aie.use_lock(%[[OF2_1_CONS_CONS_LOCK]], Release, 1)
// CHECK:           aie.next_bd ^bb1
// CHECK:         ^bb3:
// CHECK:           aie.end
