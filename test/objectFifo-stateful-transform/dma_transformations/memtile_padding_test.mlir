...
// RUN: aie-opt --aie-objectFifo-stateful-transform %s | FileCheck %s
    ...
    // CHECK: %objFifo_out0_cons_prod_lock = aie.lock(%{{.*}}tile_0_0, 2) {init = 1 : i32, sym_name = "objFifo_out0_cons_prod_lock_0"}
    // CHECK: %objFifo_out0_cons_cons_lock = aie.lock(%{{.*}}tile_0_0, 3) {init = 0 : i32, sym_name = "objFifo_out0_cons_cons_lock_0"}
    ...
    // CHECK: %objFifo_out1_cons_prod_lock = aie.lock(%{{.*}}tile_0_1, 2) {init = 2 : i32, sym_name = "objFifo_out1_cons_prod_lock_0"}
    // CHECK: %objFifo_out1_cons_cons_lock = aie.lock(%{{.*}}tile_0_1, 3) {init = 0 : i32, sym_name = "objFifo_out1_cons_cons_lock_0"}
    ...
    // CHECK: %objFifo_out1_prod_lock = aie.lock(%{{.*}}tile_0_2, 2) {init = 2 : i32, sym_name = "objFifo_out1_prod_lock_0"}
    // CHECK: %objFifo_out1_cons_lock = aie.lock(%{{.*}}tile_0_2, 3) {init = 0 : i32, sym_name = "objFifo_out1_cons_lock_0"}
    ...
    // CHECK: %objFifo_in1_cons_prod_lock = aie.lock(%{{.*}}tile_0_2, 0) {init = 2 : i32, sym_name = "objFifo_in1_cons_prod_lock_0"}
    // CHECK: %objFifo_in1_cons_cons_lock = aie.lock(%{{.*}}tile_0_2, 1) {init = 0 : i32, sym_name = "objFifo_in1_cons_cons_lock_0"}
    ...
    // CHECK: %objFifo_in1_prod_lock = aie.lock(%{{.*}}tile_0_1, 0) {init = 2 : i32, sym_name = "objFifo_in1_prod_lock_0"}
    // CHECK: %objFifo_in1_cons_lock = aie.lock(%{{.*}}tile_0_1, 1) {init = 0 : i32, sym_name = "objFifo_in1_cons_lock_0"}
    // CHECK: %objFifo_in0_prod_lock = aie.lock(%{{.*}}tile_0_0, 0) {init = 1 : i32, sym_name = "objFifo_in0_prod_lock_0"}
    // CHECK: %objFifo_in0_cons_lock = aie.lock(%{{.*}}tile_0_0, 1) {init = 0 : i32, sym_name = "objFifo_in0_cons_lock_0"}
