...
// CHECK:       aie.dma_bd(%[[of0_buff_0]] : memref<256xi32> offset = 0 len = 256 sizes = [16, 16, 1] strides = [1, 16, 1])
// CHECK:       aie.use_lock(%[[of0_prod_lock]], Release, 1)
// CHECK:             aie.next_bd ^bb2
// CHECK:           ^bb2:  // pred: ^bb1
// CHECK:       aie.use_lock(%[[of0_cons_lock]], AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%[[of0_buff_1]] : memref<256xi32> offset = 0 len = 256 sizes = [16, 16, 1] strides = [1, 16, 1])
// CHECK:       aie.use_lock(%[[of0_prod_lock]], Release, 1)
// CHECK:             aie.next_bd ^bb3
// CHECK:           ^bb3:  // pred: ^bb2
// CHECK:       aie.use_lock(%[[of0_cons_lock]], AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%[[of0_buff_2]] : memref<256xi32> offset = 0 len = 256 sizes = [16, 16, 1] strides = [1, 16, 1])
// CHECK:       aie.use_lock(%[[of0_prod_lock]], Release, 1)
// CHECK:             aie.next_bd ^bb4
// CHECK:           ^bb4:  // pred: ^bb3
// CHECK:       aie.use_lock(%[[of0_cons_lock]], AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%[[of0_buff_3]] : memref<256xi32> offset = 0 len = 256 sizes = [16, 16, 1] strides = [1, 16, 1])
// CHECK:       aie.use_lock(%[[of0_prod_lock]], Release, 1)
...
// CHECK:       aie.dma_bd(%[[of1_buff_0]] : memref<256xi32> offset = 0 len = 256 sizes = [128] strides = [2])
// CHECK:       aie.use_lock(%[[of1_prod_lock]], Release, 1)
// CHECK:             aie.next_bd ^bb7
// CHECK:           ^bb7:  // pred: ^bb6
// CHECK:       aie.use_lock(%[[of1_cons_lock]], AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%[[of1_buff_1]] : memref<256xi32> offset = 0 len = 256 sizes = [128] strides = [2])
// CHECK:       aie.use_lock(%[[of1_prod_lock]], Release, 1)
...
// CHECK:       aie.dma_bd(%[[of0_0_cons_buff_0]] : memref<256xi32> offset = 0 len = 256 sizes = [1] strides = [1])
// CHECK:       aie.use_lock(%[[of0_0_cons_cons_lock]], Release, 1)
// CHECK:             aie.next_bd ^bb2
// CHECK:           ^bb2:  // pred: ^bb1
// CHECK:       aie.use_lock(%[[of0_0_cons_prod_lock]], AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%[[of0_0_cons_buff_1]] : memref<256xi32> offset = 0 len = 256 sizes = [1] strides = [1])
// CHECK:       aie.use_lock(%[[of0_0_cons_cons_lock]], Release, 1)
// CHECK:             aie.next_bd ^bb3
// CHECK:           ^bb3:  // pred: ^bb2
// CHECK:       aie.use_lock(%[[of0_0_cons_prod_lock]], AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%[[of0_0_cons_buff_2]] : memref<256xi32> offset = 0 len = 256 sizes = [1] strides = [1])
// CHECK:       aie.use_lock(%[[of0_0_cons_cons_lock]], Release, 1)
// CHECK:             aie.next_bd ^bb4
// CHECK:           ^bb4:  // pred: ^bb3
// CHECK:       aie.use_lock(%[[of0_0_cons_prod_lock]], AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%[[of0_0_cons_buff_3]] : memref<256xi32> offset = 0 len = 256 sizes = [1] strides = [1])
// CHECK:       aie.use_lock(%[[of0_0_cons_cons_lock]], Release, 1)
// CHECK:             aie.next_bd ^bb1
// CHECK:           ^bb5:  // pred: ^bb0
// CHECK:             aie.end
...
// CHECK:       aie.dma_bd(%[[of0_1_cons_buff_0]] : memref<256xi32> offset = 0 len = 256 sizes = [3] strides = [4])
// CHECK:       aie.use_lock(%[[of0_1_cons_cons_lock]], Release, 1)
// CHECK:             aie.next_bd ^bb2
// CHECK:           ^bb2:  // pred: ^bb1
// CHECK:       aie.use_lock(%[[of0_1_cons_prod_lock]], AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%[[of0_1_cons_buff_1]] : memref<256xi32> offset = 0 len = 256 sizes = [3] strides = [4])
// CHECK:       aie.use_lock(%[[of0_1_cons_cons_lock]], Release, 1)
// CHECK:             aie.next_bd ^bb3
// CHECK:           ^bb3:  // pred: ^bb2
// CHECK:       aie.use_lock(%[[of0_1_cons_prod_lock]], AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%[[of0_1_cons_buff_2]] : memref<256xi32> offset = 0 len = 256 sizes = [3] strides = [4])
// CHECK:       aie.use_lock(%[[of0_1_cons_cons_lock]], Release, 1)
// CHECK:             aie.next_bd ^bb4
// CHECK:           ^bb4:  // pred: ^bb3
// CHECK:       aie.use_lock(%[[of0_1_cons_prod_lock]], AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%[[of0_1_cons_buff_3]] : memref<256xi32> offset = 0 len = 256 sizes = [3] strides = [4])
// CHECK:       aie.use_lock(%[[of0_1_cons_cons_lock]], Release, 1)
// CHECK:             aie.next_bd ^bb1
// CHECK:           ^bb5:  // pred: ^bb0
...
// CHECK:       aie.dma_bd(%[[of1_cons_buff_0]] : memref<256xi32> offset = 0 len = 256 sizes = [] strides = [])
// CHECK:       aie.use_lock(%[[of1_cons_cons_lock]], Release, 1)
// CHECK:             aie.next_bd ^bb7
// CHECK:           ^bb7:  // pred: ^bb6
// CHECK:       aie.use_lock(%[[of1_cons_prod_lock]], AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%[[of1_cons_buff_1]] : memref<256xi32> offset = 0 len = 256 sizes = [] strides = [])
// CHECK:       aie.use_lock(%[[of1_cons_cons_lock]], Release, 1)
// CHECK:             aie.next_bd ^bb6
// CHECK:           ^bb8:  // pred: ^bb5
// CHECK:             aie.end
...
// CHECK:       aie.dma_bd(%[[of3_buff_0]] : memref<256xi32> offset = 0 len = 256 sizes = [] strides = [])
// CHECK:       aie.use_lock(%[[of3_prod_lock]], Release, 1)
// CHECK:             aie.next_bd ^bb2
// CHECK:           ^bb2:  // pred: ^bb1
// CHECK:       aie.use_lock(%[[of3_cons_lock]], AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%[[of3_buff_1]] : memref<256xi32> offset = 0 len = 256 sizes = [] strides = [])
// CHECK:       aie.use_lock(%[[of3_prod_lock]], Release, 1)
// CHECK:             aie.next_bd ^bb1
// CHECK:           ^bb3:  // pred: ^bb0
// CHECK:             aie.end
...
// CHECK:       aie.dma_bd(%[[of3_cons_buff_0]] : memref<256xi32> offset = 0 len = 256 sizes = [9] strides = [9])
// CHECK:       aie.use_lock(%[[of3_cons_cons_lock]], Release, 1)
// CHECK:             aie.next_bd ^bb2
// CHECK:           ^bb2:  // pred: ^bb1
// CHECK:       aie.use_lock(%[[of3_cons_prod_lock]], AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%[[of3_cons_buff_1]] : memref<256xi32> offset = 0 len = 256 sizes = [9] strides = [9])
// CHECK:       aie.use_lock(%[[of3_cons_cons_lock]], Release, 1)
// CHECK:             aie.next_bd ^bb1
// CHECK:           ^bb3:  // pred: ^bb0
// CHECK:             aie.end
