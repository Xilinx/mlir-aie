...
// CHECK:     %of2_cons_prod_lock_0 = aie.lock(%{{.*}}tile_2_3, 0) {init = 2 : i32, sym_name = "of2_cons_prod_lock_0"}
// CHECK:     %of2_cons_cons_lock_0 = aie.lock(%{{.*}}tile_2_3, 1) {init = 0 : i32, sym_name = "of2_cons_cons_lock_0"}
...
// CHECK:     %of1_cons_prod_lock_0 = aie.lock(%{{.*}}tile_2_2, 0) {init = 2 : i32, sym_name = "of1_cons_prod_lock_0"}
// CHECK:     %of1_cons_cons_lock_0 = aie.lock(%{{.*}}tile_2_2, 1) {init = 0 : i32, sym_name = "of1_cons_cons_lock_0"}
...
// CHECK:     %of0_cons_prod_lock_0 = aie.lock(%{{.*}}tile_1_1, 0) {init = 2 : i32, sym_name = "of0_cons_prod_lock_0"}
// CHECK:     %of0_cons_cons_lock_0 = aie.lock(%{{.*}}tile_1_1, 1) {init = 0 : i32, sym_name = "of0_cons_cons_lock_0"}
// CHECK:     %of0_cons_prod_lock_1 = aie.lock(%{{.*}}tile_1_1, 2) {init = 2 : i32, sym_name = "of0_cons_prod_lock_1"}
// CHECK:     %of0_cons_cons_lock_1 = aie.lock(%{{.*}}tile_1_1, 3) {init = 0 : i32, sym_name = "of0_cons_cons_lock_1"}
// CHECK:     %of0_prod_lock_0 = aie.lock(%{{.*}}tile_1_0, 0) {init = 1 : i32, sym_name = "of0_prod_lock_0"}
// CHECK:     %of0_cons_lock_0 = aie.lock(%{{.*}}tile_1_0, 1) {init = 0 : i32, sym_name = "of0_cons_lock_0"}
...
// CHECK:       aie.dma_bd(%of0_cons_buff_0 : memref<256xi32>, 0, 512)
// CHECK:       aie.use_lock(%of0_cons_cons_lock_0, Release, 1)
// CHECK:       aie.next_bd ^bb2
// CHECK:     ^bb2:  // pred: ^bb1
// CHECK:       aie.use_lock(%of0_cons_prod_lock_1, AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%of0_cons_buff_0 : memref<256xi32>, 512, -256)
// CHECK:       aie.use_lock(%of0_cons_cons_lock_1, Release, 1)
// CHECK:       aie.next_bd ^bb3
// CHECK:     ^bb3:  // pred: ^bb2
// CHECK:       aie.use_lock(%of0_cons_prod_lock_0, AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%of0_cons_buff_1 : memref<256xi32>, 0, 512)
// CHECK:       aie.use_lock(%of0_cons_cons_lock_0, Release, 1)
// CHECK:       aie.next_bd ^bb4
// CHECK:     ^bb4:  // pred: ^bb3
// CHECK:       aie.use_lock(%of0_cons_prod_lock_1, AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%of0_cons_buff_1 : memref<256xi32>, 512, -256)
// CHECK:       aie.use_lock(%of0_cons_cons_lock_1, Release, 1)
