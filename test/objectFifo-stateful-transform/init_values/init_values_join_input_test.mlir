...
// CHECK:     %of2_cons_prod_lock = aie.lock(%{{.*}}tile_1_0, 0) {init = 1 : i32, sym_name = "of2_cons_prod_lock_0"}
// CHECK:     %of2_cons_cons_lock = aie.lock(%{{.*}}tile_1_0, 1) {init = 0 : i32, sym_name = "of2_cons_cons_lock_0"}
// CHECK:     %of2_buff_0 = aie.buffer(%{{.*}}tile_1_1) {sym_name = "of2_buff_0"} : memref<8xi32> 
// CHECK:     %of2_buff_1 = aie.buffer(%{{.*}}tile_1_1) {sym_name = "of2_buff_1"} : memref<8xi32> 
// CHECK:     %of2_prod_lock = aie.lock(%{{.*}}tile_1_1, 0) {init = 4 : i32, sym_name = "of2_prod_lock_0"}
// CHECK:     %of2_cons_lock = aie.lock(%{{.*}}tile_1_1, 1) {init = 0 : i32, sym_name = "of2_cons_lock_0"}
...
// CHECK:     %of1_prod_lock = aie.lock(%{{.*}}tile_2_3, 0) {init = 0 : i32, sym_name = "of1_prod_lock_0"}
// CHECK:     %of1_cons_lock = aie.lock(%{{.*}}tile_2_3, 1) {init = 2 : i32, sym_name = "of1_cons_lock_0"}
...
// CHECK:     %of0_prod_lock = aie.lock(%{{.*}}tile_1_2, 0) {init = 0 : i32, sym_name = "of0_prod_lock_0"}
// CHECK:     %of0_cons_lock = aie.lock(%{{.*}}tile_1_2, 1) {init = 2 : i32, sym_name = "of0_cons_lock_0"}
...
// CHECK:       aie.dma_bd(%of2_buff_0 : memref<8xi32>, 0, 8)
// CHECK:       aie.use_lock(%of2_prod_lock, Release, 2)
// CHECK:       aie.next_bd ^bb8
// CHECK:     ^bb8:  // pred: ^bb7
// CHECK:       aie.use_lock(%of2_cons_lock, AcquireGreaterEqual, 2)
// CHECK:       aie.dma_bd(%of2_buff_1 : memref<8xi32>, 0, 8)
// CHECK:       aie.use_lock(%of2_prod_lock, Release, 2)
