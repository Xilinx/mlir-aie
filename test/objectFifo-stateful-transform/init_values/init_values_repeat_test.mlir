...
// CHECK:     %of0_cons_prod_lock = aie.lock(%{{.*}}tile_1_3, 0) {init = 2 : i32, sym_name = "of0_cons_prod_lock_0"}
...
// CHECK:     %of0_cons_lock = aie.lock(%{{.*}}tile_1_2, 1) {init = 6 : i32, sym_name = "of0_cons_lock_0"}
