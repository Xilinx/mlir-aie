...
// CHECK:     %of0_cons_prod_lock = aie.lock(%{{.*}}tile_2_3, 0) {init = 3 : i32, sym_name = "of0_cons_prod_lock_0"}
// CHECK:     %of0_cons_cons_lock = aie.lock(%{{.*}}tile_2_3, 1) {init = 0 : i32, sym_name = "of0_cons_cons_lock_0"}
...
// CHECK:     %of0_cons_lock = aie.lock(%{{.*}}tile_1_2, 1) {init = 3 : i32, sym_name = "of0_cons_lock_0"}
