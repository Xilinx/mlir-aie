...
// CHECK:     %of1_prod_lock = aie.lock(%{{.*}}tile_1_3, 0) {init = 0 : i32, sym_name = "of1_prod_lock_0"}
// CHECK:     %of1_cons_lock = aie.lock(%{{.*}}tile_1_3, 1) {init = 2 : i32, sym_name = "of1_cons_lock_0"}
