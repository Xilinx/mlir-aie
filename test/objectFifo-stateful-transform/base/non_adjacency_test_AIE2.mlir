...
// CHECK:               aie.use_lock(%[[VAL_3]], AcquireGreaterEqual, %[[VAL_15]])
// CHECK:               func.call @some_work(%[[VAL_1]]) : (memref<16xi32>) -> ()
// CHECK:               aie.use_lock(%[[VAL_4]], Release, %[[VAL_15]])
// CHECK:               aie.use_lock(%[[VAL_3]], AcquireGreaterEqual, %[[VAL_15]])
...
// CHECK:             aie.use_lock(%[[VAL_3]], Release, %[[VAL_24]])
...
// CHECK:             aie.end
// CHECK:           }
// CHECK:           %[[VAL_26:.*]] = aie.mem(%[[VAL_5]]) {
// CHECK:             %[[VAL_27:.*]] = arith.constant 1 : i32
// CHECK:             %[[VAL_28:.*]] = aie.dma_start(S2MM, 0, ^bb1, ^bb3)
// CHECK:           ^bb1:
// CHECK:             aie.use_lock(%[[VAL_8]], AcquireGreaterEqual, %[[VAL_27]])
