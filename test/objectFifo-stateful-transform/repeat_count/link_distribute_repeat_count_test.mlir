...
// CHECK:       aie.dma_bd(%[[VAL_8]] : memref<32xi32> offset = 0 len = 16 sizes = [] strides = [])
// CHECK:       aie.use_lock(%[[VAL_11]], Release, 3)
// CHECK:       aie.next_bd ^bb2
// CHECK:     ^bb2:  // pred: ^bb1
// CHECK:       aie.use_lock(%[[VAL_12]], AcquireGreaterEqual, 3)
// CHECK:       aie.dma_bd(%[[VAL_8]] : memref<32xi32> offset = 16 len = 16 sizes = [] strides = [])
// CHECK:       aie.use_lock(%[[VAL_13]], Release, 3)
// CHECK:       aie.next_bd ^bb3
// CHECK:     ^bb3:  // pred: ^bb2
// CHECK:       aie.use_lock(%[[VAL_10]], AcquireGreaterEqual, 3)
// CHECK:       aie.dma_bd(%[[VAL_9]] : memref<32xi32> offset = 0 len = 16 sizes = [] strides = [])
// CHECK:       aie.use_lock(%[[VAL_11]], Release, 3)
// CHECK:       aie.next_bd ^bb4
// CHECK:     ^bb4:  // pred: ^bb3
// CHECK:       aie.use_lock(%[[VAL_12]], AcquireGreaterEqual, 3)
// CHECK:       aie.dma_bd(%[[VAL_9]] : memref<32xi32> offset = 16 len = 16 sizes = [] strides = [])
// CHECK:       aie.use_lock(%[[VAL_13]], Release, 3)
...
// CHECK:       aie.dma_bd(%[[VAL_0]] : memref<16xi32> offset = 0 len = 16 sizes = [] strides = [])
// CHECK:       aie.use_lock(%[[VAL_3]], Release, 1)
// CHECK:       aie.next_bd ^bb2
// CHECK:     ^bb2:  // pred: ^bb1
// CHECK:       aie.use_lock(%[[VAL_2]], AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%[[VAL_1]] : memref<16xi32> offset = 0 len = 16 sizes = [] strides = [])
// CHECK:       aie.use_lock(%[[VAL_3]], Release, 1)
// CHECK:       aie.next_bd ^bb1
// CHECK:     ^bb3:  // pred: ^bb0
// CHECK:       aie.end
