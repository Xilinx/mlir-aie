...
// CHECK:       aie.dma_bd(%[[OF0_BUF]] : memref<16xi32> offset = 0 len = 16 sizes = [] strides = [])
...
// CHECK:       aie.dma_bd(%[[OF2_BUF]] : memref<32xi32> offset = 0 len = 16 sizes = [] strides = [])
...
// CHECK:       aie.dma_bd(%[[OF2_BUF]] : memref<32xi32> offset = 16 len = 16 sizes = [] strides = [])
...
// CHECK:       aie.dma_bd(%[[OF1_BUF]] : memref<16xi32> offset = 0 len = 16 sizes = [] strides = [])
