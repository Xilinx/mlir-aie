...
// CHECK:       aie.dma_bd(%[[OF0C_BUF]] : memref<32xi32> offset = {{.*}} len = {{.*}} sizes = {{.*}} strides = {{.*}})
...
// CHECK:       aie.dma_bd(%[[OF1C_BUF]] : memref<16xi32> offset = {{.*}} len = {{.*}} sizes = {{.*}} strides = {{.*}})
...
// CHECK:       aie.dma_bd(%[[OF2_BUF]] : memref<32xi32> offset = {{.*}} len = {{.*}} sizes = {{.*}} strides = {{.*}})
...
// CHECK:       aie.dma_bd(%[[OF2C_BUF]] : memref<32xi32> offset = {{.*}} len = {{.*}} sizes = {{.*}} strides = {{.*}})
