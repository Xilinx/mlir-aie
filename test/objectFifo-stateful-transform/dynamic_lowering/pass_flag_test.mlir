...
// CHECK:               aie.use_lock(%[[VAL_15]], AcquireGreaterEqual, %[[VAL_25]])
// CHECK:               aie.use_lock(%[[VAL_20]], AcquireGreaterEqual, %[[VAL_25]])
// CHECK:               func.call @passthrough_10_i32(%[[VAL_17]], %[[VAL_13]]) : (memref<10xi32>, memref<10xi32>) -> ()
// CHECK:               aie.use_lock(%[[VAL_19]], Release, %[[VAL_25]])
// CHECK:               aie.use_lock(%[[VAL_16]], Release, %[[VAL_25]])
// CHECK:               aie.use_lock(%[[VAL_15]], AcquireGreaterEqual, %[[VAL_25]])
// CHECK:               aie.use_lock(%[[VAL_20]], AcquireGreaterEqual, %[[VAL_25]])
// CHECK:               func.call @passthrough_10_i32(%[[VAL_18]], %[[VAL_14]]) : (memref<10xi32>, memref<10xi32>) -> ()
// CHECK:               aie.use_lock(%[[VAL_19]], Release, %[[VAL_25]])
// CHECK:               aie.use_lock(%[[VAL_16]], Release, %[[VAL_25]])
// CHECK:             }
// CHECK:             aie.end
// CHECK:           } {dynamic_objfifo_lowering = false}
// CHECK:           %[[VAL_27:.*]] = aie.core(%[[VAL_4]]) {
...
// CHECK:               aie.use_lock(%[[VAL_11]], Release, %[[VAL_32]])
