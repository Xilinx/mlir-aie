...
// CHECK:       %output_fifo_cons_prod_lock = aie.lock(%{{.*}}tile_0_0, 2) {init = 1 : i32, sym_name = "output_fifo_cons_prod_lock_0"}
// CHECK:       %output_fifo_cons_cons_lock = aie.lock(%{{.*}}tile_0_0, 3) {init = 0 : i32, sym_name = "output_fifo_cons_cons_lock_0"}
...
// CHECK:       %input_fifo_cons_prod_lock = aie.lock(%{{.*}}tile_0_2, 0) {init = 3 : i32, sym_name = "input_fifo_cons_prod_lock_0"}
// CHECK:       %input_fifo_cons_cons_lock = aie.lock(%{{.*}}tile_0_2, 1) {init = 0 : i32, sym_name = "input_fifo_cons_cons_lock_0"}
// CHECK:       %input_fifo_prod_lock = aie.lock(%{{.*}}tile_0_0, 0) {init = 1 : i32, sym_name = "input_fifo_prod_lock_0"}
// CHECK:       %input_fifo_cons_lock = aie.lock(%{{.*}}tile_0_0, 1) {init = 0 : i32, sym_name = "input_fifo_cons_lock_0"}
