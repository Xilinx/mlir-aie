...
// CHECK:           %[[VAL_7:.*]] = aie.buffer(%[[VAL_4]]) {sym_name = "input_fifo_cons_buff_2"} : memref<10xi32>
// CHECK:           %[[VAL_8:.*]] = aie.lock(%[[VAL_4]]) {init = 3 : i32, sym_name = "input_fifo_cons_prod_lock_0"}
// CHECK:           %[[VAL_9:.*]] = aie.lock(%[[VAL_4]]) {init = 0 : i32, sym_name = "input_fifo_cons_cons_lock_0"}
// CHECK:           %[[VAL_10:.*]] = aie.buffer(%[[VAL_4]]) {sym_name = "output_fifo_buff_0"} : memref<10xi32>
// CHECK:           %[[VAL_11:.*]] = aie.buffer(%[[VAL_4]]) {sym_name = "output_fifo_buff_1"} : memref<10xi32>
// CHECK:           %[[VAL_12:.*]] = aie.lock(%[[VAL_4]]) {init = 2 : i32, sym_name = "output_fifo_prod_lock_0"}
// CHECK:           %[[VAL_13:.*]] = aie.lock(%[[VAL_4]]) {init = 0 : i32, sym_name = "output_fifo_cons_lock_0"}
...
// CHECK:             aie.use_lock(%[[VAL_12]], AcquireGreaterEqual, %[[VAL_15]])
// CHECK:             aie.use_lock(%[[VAL_9]], AcquireGreaterEqual, %[[VAL_15]])
// CHECK:             func.call @add_10_i32(%[[VAL_5]], %[[VAL_5]], %[[VAL_10]]) : (memref<10xi32>, memref<10xi32>, memref<10xi32>) -> ()
// CHECK:             aie.use_lock(%[[VAL_13]], Release, %[[VAL_15]])
...
// CHECK:             aie.use_lock(%[[VAL_9]], Release, %[[VAL_44]])
...
// CHECK:           ^bb5:
// CHECK:             aie.use_lock(%[[VAL_13]], AcquireGreaterEqual, %[[VAL_44]])
