...
// CHECK:             func.call @some_work(%[[VAL_9]], %[[VAL_3]], %[[VAL_19]]) : (memref<16xi32>, memref<16xi32>, index) -> ()
// CHECK:             aie.use_lock(%[[VAL_11]], Release, %[[VAL_17]])
// CHECK:             aie.use_lock(%[[VAL_6]], Release, %[[VAL_18]])
// CHECK:             aie.use_lock(%[[VAL_10]], Acquire, %[[VAL_18]])
// CHECK:             aie.use_lock(%[[VAL_7]], Acquire, %[[VAL_17]])
// CHECK:             func.call @some_work(%[[VAL_8]], %[[VAL_4]], %[[VAL_20]]) : (memref<16xi32>, memref<16xi32>, index) -> ()
// CHECK:             aie.use_lock(%[[VAL_10]], Release, %[[VAL_17]])
// CHECK:             aie.use_lock(%[[VAL_7]], Release, %[[VAL_18]])
// CHECK:             aie.use_lock(%[[VAL_11]], Acquire, %[[VAL_18]])
// CHECK:             aie.use_lock(%[[VAL_5]], Acquire, %[[VAL_17]])
// CHECK:             func.call @some_work(%[[VAL_9]], %[[VAL_2]], %[[VAL_21]]) : (memref<16xi32>, memref<16xi32>, index) -> ()
// CHECK:             aie.use_lock(%[[VAL_11]], Release, %[[VAL_17]])
// CHECK:             aie.use_lock(%[[VAL_5]], Release, %[[VAL_18]])
// CHECK:             aie.end
// CHECK:           }
