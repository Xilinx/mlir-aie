...
aie.device(npu1) {
  ...
  %core_1_2 = aie.core(%tile_1_2) {
    ...
    %1 = aie.objectfifo.acquire @in8(Produce) : memref<32x32xi32, 1>
    ...
    scf.for %arg0 = %c64 to %c960 step %c64 {
      %11 = aie.objectfifo.acquire @in2(Consume) : memref<32x64xi32, 1>
      ...
      %13 = aie.objectfifo.acquire @in7(Consume) : memref<64x32xi32, 1>
