...
// CHECK:           %[[VAL_2:.*]] = aie.lock(%[[VAL_1]], 0) {init = 1 : i32, sym_name = "of_out_cons_prod_lock_0"}
// CHECK:           %[[VAL_3:.*]] = aie.lock(%[[VAL_1]], 1) {init = 0 : i32, sym_name = "of_out_cons_cons_lock_0"}
...
// CHECK:           %[[VAL_6:.*]] = aie.lock(%[[VAL_0]], 0) {init = 2 : i32, sym_name = "of_out_prod_lock_0"}
// CHECK:           %[[VAL_7:.*]] = aie.lock(%[[VAL_0]], 1) {init = 0 : i32, sym_name = "of_out_cons_lock_0"}
...
// CHECK:           %[[VAL_10:.*]] = aie.lock(%[[VAL_0]], 2) {init = 2 : i32, sym_name = "of_in_cons_prod_lock_0"}
// CHECK:           %[[VAL_11:.*]] = aie.lock(%[[VAL_0]], 3) {init = 0 : i32, sym_name = "of_in_cons_cons_lock_0"}
// CHECK:           %[[VAL_12:.*]] = aie.lock(%[[VAL_1]], 2) {init = 1 : i32, sym_name = "of_in_prod_lock_0"}
// CHECK:           %[[VAL_13:.*]] = aie.lock(%[[VAL_1]], 3) {init = 0 : i32, sym_name = "of_in_cons_lock_0"}
...
// CHECK:             aie.end
// CHECK:           }
// CHECK:           aie.shim_dma_allocation @of_in_shim_alloc(%[[VAL_1]], MM2S, 0)
...
// CHECK:             aie.end
// CHECK:           }
// CHECK:           aie.shim_dma_allocation @of_out_shim_alloc(%[[VAL_1]], S2MM, 0)
// CHECK:         }
