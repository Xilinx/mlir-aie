...
// CHECK:                 aie.dma_bd(%ext_buffer_in0 : memref<64xi32> offset = 0 len = 64 sizes = [] strides = [])
// CHECK:                 aie.use_lock(%[[VAL_2]], Release, 0)
// CHECK:                 aie.next_bd ^bb2
// CHECK:               ^bb2:  // pred: ^bb1
// CHECK:                 aie.use_lock(%[[VAL_3]], Acquire, 1)
// CHECK:                 aie.dma_bd(%ext_buffer_in1 : memref<64xi32> offset = 0 len = 64 sizes = [] strides = [])
