...
// CHECK:           %[[VAL_2:.*]] = aie.buffer(%[[VAL_1]]) {sym_name = "of_in_cons_buff_0"} : memref<16xi32>
// CHECK:           %[[VAL_3:.*]] = aie.buffer(%[[VAL_1]]) {sym_name = "of_in_cons_buff_1"} : memref<16xi32>
...
// CHECK:           aie.flow(%[[VAL_1]], DMA : 0, %[[VAL_6]], Core : 0)
