...
// CHECK:       aie.dma_bd(%of_in_cons_buff_0 : memref<16xi32> offset = 0 len = 16 sizes = [] strides = [])
// CHECK:       aie.use_lock(%of_in_cons_cons_lock_0, Release, 1)
// CHECK:       aie.next_bd ^bb2
// CHECK:     ^bb2:  // pred: ^bb1
// CHECK:       aie.use_lock(%of_in_cons_prod_lock_0, AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%of_in_cons_buff_1 : memref<16xi32> offset = 0 len = 16 sizes = [] strides = [])
// CHECK:       aie.use_lock(%of_in_cons_cons_lock_0, Release, 1)
// CHECK:       aie.next_bd ^bb1
// CHECK:     ^bb3:  // pred: ^bb0
// CHECK:       %1 = aie.dma_start(MM2S, 0, ^bb4, ^bb6)
// CHECK:     ^bb4:  // 2 preds: ^bb3, ^bb5
// CHECK:       aie.use_lock(%of_in_cons_cons_lock_0, AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%of_in_cons_buff_0 : memref<16xi32> offset = 0 len = 16 sizes = [] strides = [])
// CHECK:       aie.use_lock(%of_in_cons_prod_lock_0, Release, 1)
