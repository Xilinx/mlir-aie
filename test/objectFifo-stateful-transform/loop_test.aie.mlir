...
// CHECK:   %2 = AIE.buffer(%0) {sym_name = "of_12_13_buff_0"} : memref<16xi32>
// CHECK:   %3 = AIE.lock(%0, 0) {sym_name = "of_12_13_lock_0"}
// CHECK:   %4 = AIE.buffer(%0) {sym_name = "of_12_13_buff_1"} : memref<16xi32>
// CHECK:   %5 = AIE.lock(%0, 1) {sym_name = "of_12_13_lock_1"}
// CHECK:   %6 = AIE.buffer(%0) {sym_name = "of_12_13_buff_2"} : memref<16xi32>
// CHECK:   %7 = AIE.lock(%0, 2) {sym_name = "of_12_13_lock_2"}
// CHECK:   %8 = AIE.buffer(%0) {sym_name = "of_12_13_buff_3"} : memref<16xi32>
// CHECK:   %9 = AIE.lock(%0, 3) {sym_name = "of_12_13_lock_3"}
...
module @loop  {
    ...
    %objFifo = AIE.objectFifo.createObjectFifo(%tile12, {%tile13}, 4) {sym_name = "of_12_13"} : !AIE.objectFifo<memref<16xi32>>
