...
// CHECK:  aie.shim_dma_allocation @of_0_shim_alloc (%tile_2_0, MM2S, 0) {plio = true}
// CHECK:  aie.shim_dma_allocation @of_1_shim_alloc (%tile_2_0, S2MM, 0) {plio = true}
// CHECK:  aie.shim_dma_allocation @of_2_shim_alloc (%tile_2_0, S2MM, 1) {plio = true}
