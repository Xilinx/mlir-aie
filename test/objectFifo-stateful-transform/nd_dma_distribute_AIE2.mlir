...
// CHECK:     %18 = aie.memtile_dma(%[[tile_1_1:.*]]) {
...
// CHECK:       aie.dma_bd(%[[of0_cons_buf_0:.*]] : memref<256xi32>, 0, 128, [<wrap = 4, stride = 64>, <wrap = 2, stride = 4>, <wrap = 8, stride = 8>, <wrap = 4, stride = 1>])
// CHECK:       aie.use_lock(%[[of0_cons_prod_lock:.*]], Release, 1)
// CHECK:       aie.next_bd ^bb5
// CHECK:     ^bb5:  // pred: ^bb4
// CHECK:       aie.use_lock(%[[of0_cons_cons_lock:.*]], AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%[[of0_cons_buf_1:.*]] : memref<256xi32>, 0, 128, [<wrap = 4, stride = 64>, <wrap = 2, stride = 4>, <wrap = 8, stride = 8>, <wrap = 4, stride = 1>])
// CHECK:       aie.use_lock(%[[of0_cons_prod_lock:.*]], Release, 1)
...
// CHECK:       aie.use_lock(%[[of0_cons_cons_lock:.*]], AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%[[of0_cons_buf_0:.*]] : memref<256xi32>, 512, 128, [<wrap = 4, stride = 64>, <wrap = 2, stride = 4>, <wrap = 8, stride = 8>, <wrap = 4, stride = 1>])
// CHECK:       aie.use_lock(%[[of0_cons_prod_lock:.*]], Release, 1)
// CHECK:       aie.next_bd ^bb8
// CHECK:     ^bb8:  // pred: ^bb7
// CHECK:       aie.use_lock(%[[of0_cons_cons_lock:.*]], AcquireGreaterEqual, 1)
// CHECK:       aie.dma_bd(%[[of0_cons_buf_1:.*]] : memref<256xi32>, 512, 128, [<wrap = 4, stride = 64>, <wrap = 2, stride = 4>, <wrap = 8, stride = 8>, <wrap = 4, stride = 1>])
// CHECK:       aie.use_lock(%[[of0_cons_prod_lock:.*]], Release, 1)
