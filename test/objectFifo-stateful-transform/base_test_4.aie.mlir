...
// CHECK-LABEL: module @multiCoreMultiFifo  {
...
// CHECK-NEXT:    %10 = AIE.buffer(%0) {sym_name = "buff4"} : memref<16xi32>
// CHECK-NEXT:    %11 = AIE.lock(%0, 4)
// CHECK-NEXT:    %12 = AIE.buffer(%0) {sym_name = "buff5"} : memref<16xi32>
// CHECK-NEXT:    %13 = AIE.lock(%0, 5)
// CHECK-NEXT:    %14 = AIE.buffer(%0) {sym_name = "buff6"} : memref<16xi32>
// CHECK-NEXT:    %15 = AIE.lock(%0, 6)
...
// CHECK-NEXT:      AIE.useLock(%15, Acquire, 0)
