...
// CHECK:             memref.store %[[VAL_26]], %[[VAL_10]]{{\[}}%[[VAL_25]]] : memref<3000xi32>
// CHECK:             aie.end
// CHECK:           }
...
// CHECK:             memref.store %[[VAL_30]], %[[VAL_4]]{{\[}}%[[VAL_29]]] : memref<3000xi32>
// CHECK:             aie.end
// CHECK:           }
...
// CHECK:             aie.use_lock(%[[VAL_13]], Release, %[[VAL_32]])
...
// CHECK:           ^bb9:
// CHECK:             aie.use_lock(%[[VAL_22]], AcquireGreaterEqual, %[[VAL_35]])
// CHECK:             aie.dma_bd(%[[VAL_14]] : memref<3000xi32> offset = 0 len = 3000)
// CHECK:             aie.use_lock(%[[VAL_21]], Release, %[[VAL_35]])
...
// CHECK:             aie.end
// CHECK:           }
// CHECK:           %[[VAL_38:.*]] = aie.mem(%[[VAL_3]]) {
// CHECK:             %[[VAL_39:.*]] = arith.constant 1 : i32
// CHECK:             %[[VAL_40:.*]] = aie.dma_start(S2MM, 0, ^bb1, ^bb5)
// CHECK:           ^bb1:
// CHECK:             aie.use_lock(%[[VAL_8]], AcquireGreaterEqual, %[[VAL_39]])
