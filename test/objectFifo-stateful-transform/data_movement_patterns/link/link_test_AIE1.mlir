...
// CHECK:           %[[VAL_1:.*]] = aie.lock(%[[VAL_0]]) {init = 0 : i32, sym_name = "of1_lock_0"}
...
// CHECK:           %[[VAL_10:.*]] = aie.lock(%[[VAL_7]]) {init = 0 : i32, sym_name = "of2_cons_lock_0"}
// CHECK:           %[[VAL_11:.*]] = aie.lock(%[[VAL_7]]) {init = 0 : i32, sym_name = "of2_cons_lock_1"}
...
// CHECK:           ^bb1:
// CHECK:             aie.use_lock(%[[VAL_1]], Acquire, %[[VAL_14]])
...
// CHECK:           ^bb4:
// CHECK:             aie.use_lock(%[[VAL_5]], Acquire, %[[VAL_19]])
// CHECK:             aie.dma_bd(%[[VAL_3]] : memref<16xi32> offset = 0 len = 16)
// CHECK:             aie.use_lock(%[[VAL_5]], Release, %[[VAL_18]])
// CHECK:             aie.next_bd ^bb5
// CHECK:           ^bb5:
// CHECK:             aie.use_lock(%[[VAL_6]], Acquire, %[[VAL_19]])
// CHECK:             aie.dma_bd(%[[VAL_4]] : memref<16xi32> offset = 0 len = 16)
