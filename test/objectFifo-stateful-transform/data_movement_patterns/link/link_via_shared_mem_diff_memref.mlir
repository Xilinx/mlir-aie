...
// CHECK:      aie.dma_bd(%[[VAL_4]] : memref<32xi32> offset = 0 len = 32 sizes = [] strides = [])
// CHECK:      aie.use_lock(%[[VAL_7]], Release, 1)
// CHECK:      aie.next_bd ^bb2
// CHECK:    ^bb2:
// CHECK:      aie.use_lock(%[[VAL_6]], AcquireGreaterEqual, 1)
// CHECK:      aie.dma_bd(%[[VAL_5]] : memref<32xi32> offset = 0 len = 32 sizes = [] strides = [])
// CHECK:      aie.use_lock(%[[VAL_7]], Release, 1)
...
// CHECK:      aie.dma_bd(%[[VAL_4]] : memref<32xi32> offset = 0 len = 16 sizes = [] strides = [])
// CHECK:      aie.use_lock(%[[VAL_6]], Release, 1)
// CHECK:      aie.next_bd ^bb5
// CHECK:    ^bb5:
// CHECK:      aie.use_lock(%[[VAL_7]], AcquireGreaterEqual, 1)
// CHECK:      aie.dma_bd(%[[VAL_5]] : memref<32xi32> offset = 0 len = 16 sizes = [] strides = [])
// CHECK:      aie.use_lock(%[[VAL_6]], Release, 1)
