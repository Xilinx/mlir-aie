...
// CHECK:             aie.dma_bd(%[[VAL_5]] : memref<48xi32> offset = 0 len = 48 sizes = [] strides = [])
// CHECK:             aie.use_lock(%[[VAL_8]], Release, 1)
// CHECK:             aie.next_bd ^bb2
// CHECK:           ^bb2:  // pred: ^bb1
// CHECK:             aie.use_lock(%[[VAL_7]], AcquireGreaterEqual, 1)
// CHECK:             aie.dma_bd(%[[VAL_6]] : memref<48xi32> offset = 0 len = 48 sizes = [] strides = [])
// CHECK:             aie.use_lock(%[[VAL_8]], Release, 1)
// CHECK:             aie.next_bd ^bb1
// CHECK:           ^bb3:  // pred: ^bb0
...
// CHECK:             aie.dma_bd(%[[VAL_13]] : memref<48xi32> offset = 0 len = 48 sizes = [] strides = [])
