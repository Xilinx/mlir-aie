...
module @aie2_cyclostatic_l2 {
    AIE.device(xcve2302) {
        ...
        %core22 = AIE.core(%tile22) {
            ...
            // Push 66
            %subview1 = AIE.objectFifo.acquire<Produce>(%fifo0 : !AIE.objectFifo<memref<1xi32>>, 1) : !AIE.objectFifoSubview<memref<1xi32>>
            ...
            // Push 77
            %subview2 = AIE.objectFifo.acquire<Produce>(%fifo0 : !AIE.objectFifo<memref<1xi32>>, 1) : !AIE.objectFifoSubview<memref<1xi32>>
            ...
            // Push 88
            %subview3 = AIE.objectFifo.acquire<Produce>(%fifo0 : !AIE.objectFifo<memref<1xi32>>, 1) : !AIE.objectFifoSubview<memref<1xi32>>
        ...
        %core28 = AIE.core(%tile83) {
            ...
            %subview1 = AIE.objectFifo.acquire<Consume>(%fifo1 : !AIE.objectFifo<memref<1xi32>>, 2) : !AIE.objectFifoSubview<memref<1xi32>>
            ...
            // Pop 1 object off queue
            %subview2 = AIE.objectFifo.acquire<Consume>(%fifo1 : !AIE.objectFifo<memref<1xi32>>, 1) : !AIE.objectFifoSubview<memref<1xi32>>
            %subview2_obj = AIE.objectFifo.subview.access %subview2[0] : !AIE.objectFifoSubview<memref<1xi32>> -> memref<1xi32>
