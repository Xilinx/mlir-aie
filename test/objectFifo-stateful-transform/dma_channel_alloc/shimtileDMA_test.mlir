...
// CHECK:             aie.dma_bd(%0 : memref<16xi32> offset = 0 len = 16 sizes = [] strides = [])
// CHECK:             aie.use_lock(%lock_2_0, Release, 0)
// CHECK:             aie.next_bd ^bb2
// CHECK:           ^bb2:  // pred: ^bb1
// CHECK:             aie.use_lock(%lock_2_0_0, Acquire, 1)
// CHECK:             aie.dma_bd(%1 : memref<16xi32> offset = 0 len = 16 sizes = [] strides = [])
...
// CHECK:             aie.dma_bd(%2 : memref<16xi32> offset = 0 len = 16 sizes = [] strides = [])
