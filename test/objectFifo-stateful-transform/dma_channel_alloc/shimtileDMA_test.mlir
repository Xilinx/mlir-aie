...
// CHECK:           %objfifo_prod_lock = aie.lock(%{{.*}}tile_2_0, 3) {init = 1 : i32, sym_name = "objfifo_prod_lock"}
// CHECK:           %objfifo_cons_lock = aie.lock(%{{.*}}tile_2_0, 4) {init = 0 : i32, sym_name = "objfifo_cons_lock"}
