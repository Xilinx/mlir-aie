...
// CHECK:             aie.end
// CHECK:           }
// CHECK:           aie.shim_dma_allocation @inA_shim_alloc(MM2S, 0, 0)
...
// CHECK:             aie.end
// CHECK:           }
// CHECK:           aie.shim_dma_allocation @inB_shim_alloc(MM2S, 1, 0)
// CHECK:           aie.shim_dma_allocation @outC_shim_alloc(S2MM, 0, 0)
