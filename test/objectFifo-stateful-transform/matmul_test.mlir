...
// CHECK:             aie.dma_bd(%[[VAL_14]] : memref<16x8xi16> offset = {{.*}} len = {{.*}} sizes = {{.*}} strides = {{.*}})
// CHECK:             aie.use_lock(%[[VAL_17]], Release, 1)
// CHECK:             aie.next_bd ^bb2
// CHECK:           ^bb2:  // pred: ^bb1
// CHECK:             aie.use_lock(%[[VAL_16]], AcquireGreaterEqual, 1)
// CHECK:             aie.dma_bd(%[[VAL_15]] : memref<16x8xi16> offset = {{.*}} len = {{.*}} sizes = {{.*}} strides = {{.*}})
// CHECK:             aie.use_lock(%[[VAL_17]], Release, 1)
...
// CHECK:             aie.dma_bd(%[[VAL_8]] : memref<8x16xi16> offset = {{.*}} len = {{.*}} sizes = {{.*}} strides = {{.*}})
// CHECK:             aie.use_lock(%[[VAL_11]], Release, 1)
// CHECK:             aie.next_bd ^bb5
// CHECK:           ^bb5:  // pred: ^bb4
// CHECK:             aie.use_lock(%[[VAL_10]], AcquireGreaterEqual, 1)
// CHECK:             aie.dma_bd(%[[VAL_9]] : memref<8x16xi16> offset = {{.*}} len = {{.*}} sizes = {{.*}} strides = {{.*}})
// CHECK:             aie.use_lock(%[[VAL_11]], Release, 1)
...
// CHECK:             aie.dma_bd(%[[VAL_4]] : memref<16x16xi16> offset = {{.*}} len = {{.*}} sizes = {{.*}} strides = {{.*}})
// CHECK:             aie.use_lock(%[[VAL_6]], Release, 1)
// CHECK:             aie.next_bd ^bb8
// CHECK:           ^bb8:  // pred: ^bb7
// CHECK:             aie.use_lock(%[[VAL_7]], AcquireGreaterEqual, 1)
// CHECK:             aie.dma_bd(%[[VAL_5]] : memref<16x16xi16> offset = {{.*}} len = {{.*}} sizes = {{.*}} strides = {{.*}})
// CHECK:             aie.use_lock(%[[VAL_6]], Release, 1)
