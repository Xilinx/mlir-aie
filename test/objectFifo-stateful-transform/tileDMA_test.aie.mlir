...
// CHECK:   %8 = AIE.buffer(%0) {sym_name = "of_12_33_prod_buff_0"} : memref<16xi32>
// CHECK:   %9 = AIE.lock(%0, 3) {sym_name = "of_12_33_prod_lock_0"}
// CHECK:   %10 = AIE.buffer(%0) {sym_name = "of_12_33_prod_buff_1"} : memref<16xi32>
// CHECK:   %11 = AIE.lock(%0, 4) {sym_name = "of_12_33_prod_lock_1"}
...
module @tileDMA_channels {
    ...
    %objFifo = AIE.objectFifo.createObjectFifo(%tile12, {%tile33}, 2) {sym_name = "of_12_33"} : !AIE.objectFifo<memref<16xi32>>
