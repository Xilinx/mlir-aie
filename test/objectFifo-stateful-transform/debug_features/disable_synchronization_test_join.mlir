...
// CHECK:           %[[VAL_2:.*]] = aie.buffer(%[[VAL_1]]) {sym_name = "link1_cons_buff_0"} : memref<36xi32>
// CHECK:           %[[VAL_3:.*]] = aie.tile(2, 2)
// CHECK:           %[[VAL_4:.*]] = aie.buffer(%[[VAL_3]]) {sym_name = "link2_cons_buff_0"} : memref<4x4xi32>
// CHECK:           %[[VAL_5:.*]] = aie.lock(%[[VAL_3]]) {init = 1 : i32, sym_name = "link2_cons_prod_lock_0"}
// CHECK:           %[[VAL_6:.*]] = aie.lock(%[[VAL_3]]) {init = 0 : i32, sym_name = "link2_cons_cons_lock_0"}
// CHECK:           %[[VAL_7:.*]] = aie.tile(2, 3)
// CHECK:           %[[VAL_8:.*]] = aie.buffer(%[[VAL_7]]) {sym_name = "link3_cons_buff_0"} : memref<20xi32>
// CHECK:           %[[VAL_9:.*]] = aie.lock(%[[VAL_7]]) {init = 1 : i32, sym_name = "link3_cons_prod_lock_0"}
// CHECK:           %[[VAL_10:.*]] = aie.lock(%[[VAL_7]]) {init = 0 : i32, sym_name = "link3_cons_cons_lock_0"}
// CHECK:           aie.flow(%[[VAL_0]], DMA : 0, %[[VAL_1]], DMA : 0)
// CHECK:           aie.flow(%[[VAL_1]], DMA : 0, %[[VAL_3]], DMA : 0)
// CHECK:           aie.flow(%[[VAL_1]], DMA : 1, %[[VAL_7]], DMA : 0)
...
// CHECK:           ^bb3:
// CHECK:             %[[VAL_13:.*]] = aie.dma_start(MM2S, 0, ^bb4, ^bb5)
// CHECK:           ^bb4:
// CHECK:             aie.dma_bd(%[[VAL_2]] : memref<36xi32> offset = 0 len = 16)
// CHECK:             aie.next_bd ^bb4
// CHECK:           ^bb5:
// CHECK:             %[[VAL_14:.*]] = aie.dma_start(MM2S, 1, ^bb6, ^bb7)
// CHECK:           ^bb6:
// CHECK:             aie.dma_bd(%[[VAL_2]] : memref<36xi32> offset = 16 len = 20)
...
// CHECK:             aie.end
// CHECK:           }
// CHECK:           %[[VAL_15:.*]] = aie.mem(%[[VAL_3]]) {
// CHECK:             %[[VAL_16:.*]] = arith.constant 1 : i32
// CHECK:             %[[VAL_17:.*]] = aie.dma_start(S2MM, 0, ^bb1, ^bb2)
// CHECK:           ^bb1:
// CHECK:             aie.use_lock(%[[VAL_5]], AcquireGreaterEqual, %[[VAL_16]])
...
// CHECK:           ^bb1:
// CHECK:             aie.use_lock(%[[VAL_9]], AcquireGreaterEqual, %[[VAL_19]])
