...
// CHECK:     %link3_cons_prod_lock = aie.lock(%{{.*}}tile_2_3, 0) {init = 1 : i32, sym_name = "link3_cons_prod_lock"}
...
// CHECK:     %link2_cons_prod_lock = aie.lock(%{{.*}}tile_2_2, 0) {init = 1 : i32, sym_name = "link2_cons_prod_lock"}
