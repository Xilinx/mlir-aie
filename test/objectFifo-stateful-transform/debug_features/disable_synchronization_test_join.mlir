...
// CHECK:       aie.dma_bd(%[[VAL_6]] : memref<36xi32> offset = 0 len = 16 sizes = [] strides = [])
// CHECK:       aie.next_bd ^bb2
// CHECK:     ^bb2:  // pred: ^bb1
// CHECK:       aie.dma_bd(%[[VAL_6]] : memref<36xi32> offset = 16 len = 20 sizes = [] strides = [])
...
// CHECK:       aie.dma_bd(%[[VAL_3]] : memref<4x4xi32> offset = 0 len = 16 sizes = [] strides = [])
...
// CHECK:       aie.dma_bd(%[[VAL_0]] : memref<20xi32> offset = 0 len = 20 sizes = [] strides = [])
