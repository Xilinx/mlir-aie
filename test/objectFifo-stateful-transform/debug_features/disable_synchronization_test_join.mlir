...
// CHECK:       aie.dma_bd(%[[VAL_6]] : memref<36xi32> offset = {{.*}} len = {{.*}} sizes = {{.*}} strides = {{.*}})
...
// CHECK:       aie.dma_bd(%[[VAL_3]] : memref<4x4xi32> offset = {{.*}} len = {{.*}} sizes = {{.*}} strides = {{.*}})
...
// CHECK:       aie.dma_bd(%[[VAL_0]] : memref<20xi32> offset = {{.*}} len = {{.*}} sizes = {{.*}} strides = {{.*}})
