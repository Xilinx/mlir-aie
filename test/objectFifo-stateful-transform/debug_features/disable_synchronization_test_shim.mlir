...
// CHECK:     %of0_cons_buff_0 = aie.buffer(%{{.*}}tile_1_3) {sym_name = "of0_cons_buff_0"} : memref<16xi32> 
// CHECK:     %of0_cons_buff_1 = aie.buffer(%{{.*}}tile_1_3) {sym_name = "of0_cons_buff_1"} : memref<16xi32> 
...
// CHECK:     ^bb2:  // pred: ^bb1
// CHECK:       aie.dma_bd(%of0_cons_buff_1 : memref<16xi32>, 0, 16)
// CHECK:       aie.next_bd ^bb1
// CHECK:     ^bb3:  // pred: ^bb0
// CHECK:       aie.end
// CHECK:     }
