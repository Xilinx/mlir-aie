...
// CHECK:           aie.shim_dma_allocation @of_in_0_shim_alloc(MM2S, 0, 2)
// CHECK:           aie.shim_dma_allocation @of_out_0_shim_alloc(S2MM, 0, 2)
// CHECK:           aie.shim_dma_allocation @of_in_1_shim_alloc(MM2S, 1, 2)
// CHECK:           aie.shim_dma_allocation @of_out_1_shim_alloc(S2MM, 1, 2)
// CHECK:         }
