...
// CHECK:           %[[VAL_8:.*]] = aie.lock(%[[VAL_0]], 0) {init = 0 : i32, sym_name = "of2_prod_lock_0"}
// CHECK:           %[[VAL_9:.*]] = aie.lock(%[[VAL_0]], 1) {init = 0 : i32, sym_name = "of2_cons_lock_0"}
...
// CHECK:           %[[VAL_15:.*]] = aie.lock(%[[VAL_0]], 2) {init = 0 : i32, sym_name = "of_prod_lock_0"}
// CHECK:           %[[VAL_16:.*]] = aie.lock(%[[VAL_0]], 3) {init = 0 : i32, sym_name = "of_cons_lock_0"}
