...
// CHECK:           %[[VAL_10:.*]] = aie.buffer(%[[VAL_9]]) {sym_name = "of2_buff_0"} : memref<16xi32>
// CHECK:           %[[VAL_11:.*]] = aie.buffer(%[[VAL_9]]) {sym_name = "of2_buff_1"} : memref<16xi32>
// CHECK:           %[[VAL_12:.*]] = aie.buffer(%[[VAL_9]]) {sym_name = "of2_buff_2"} : memref<16xi32>
// CHECK:           %[[VAL_13:.*]] = aie.lock(%[[VAL_9]]) {init = 0 : i32, sym_name = "of2_lock_0"}
// CHECK:           %[[VAL_14:.*]] = aie.lock(%[[VAL_9]]) {init = 0 : i32, sym_name = "of2_lock_1"}
// CHECK:           %[[VAL_15:.*]] = aie.lock(%[[VAL_9]]) {init = 0 : i32, sym_name = "of2_lock_2"}
...
// CHECK:             aie.use_lock(%[[VAL_14]], Acquire, %[[VAL_19]])
// CHECK:             aie.use_lock(%[[VAL_15]], Acquire, %[[VAL_19]])
// CHECK:             func.call @some_work(%[[VAL_11]]) : (memref<16xi32>) -> ()
// CHECK:             func.call @some_work(%[[VAL_12]]) : (memref<16xi32>) -> ()
// CHECK:             aie.use_lock(%[[VAL_14]], Release, %[[VAL_18]])
// CHECK:             aie.end
// CHECK:           }
...
// CHECK:             func.call @some_work(%[[VAL_1]]) : (memref<16xi32>) -> ()
// CHECK:             aie.use_lock(%[[VAL_13]], Acquire, %[[VAL_21]])
// CHECK:             aie.use_lock(%[[VAL_14]], Acquire, %[[VAL_21]])
// CHECK:             func.call @some_work(%[[VAL_10]]) : (memref<16xi32>) -> ()
// CHECK:             func.call @some_work(%[[VAL_11]]) : (memref<16xi32>) -> ()
// CHECK:             aie.use_lock(%[[VAL_13]], Release, %[[VAL_22]])
// CHECK:             aie.use_lock(%[[VAL_14]], Release, %[[VAL_22]])
