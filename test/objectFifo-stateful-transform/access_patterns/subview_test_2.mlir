...
// CHECK:           %[[VAL_5:.*]] = aie.lock(%[[VAL_0]], 0) {init = 0 : i32, sym_name = "of2_lock_0"}
// CHECK:           %[[VAL_6:.*]] = aie.lock(%[[VAL_0]], 1) {init = 0 : i32, sym_name = "of2_lock_1"}
// CHECK:           %[[VAL_7:.*]] = aie.lock(%[[VAL_0]], 2) {init = 0 : i32, sym_name = "of2_lock_2"}
...
// CHECK:           %[[VAL_12:.*]] = aie.lock(%[[VAL_0]], 3) {init = 0 : i32, sym_name = "of_lock_0"}
// CHECK:           %[[VAL_13:.*]] = aie.lock(%[[VAL_0]], 4) {init = 0 : i32, sym_name = "of_lock_1"}
// CHECK:           %[[VAL_14:.*]] = aie.lock(%[[VAL_0]], 5) {init = 0 : i32, sym_name = "of_lock_2"}
// CHECK:           %[[VAL_15:.*]] = aie.lock(%[[VAL_0]], 6) {init = 0 : i32, sym_name = "of_lock_3"}
