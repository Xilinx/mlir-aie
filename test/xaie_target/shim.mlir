...
// CHECK: XAieDma_ShimBdSetAddr(&ShimDMAInst_2_0,  /* bd */ 0, HIGH_ADDR((u64)0x1234567890), LOW_ADDR((u64)0x1234567890),  /* len */ 16 * 4);
...
module {
  %buffer = AIE.external_buffer 0x1234567890 : memref<16 x f32>
  %t21 = AIE.tile(2, 1)
  %t20 = AIE.tile(2, 0)
  %c21 = AIE.core(%t21)  {
    AIE.end
