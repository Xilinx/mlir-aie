...
// CHECK: XAieDma_ShimBdSetAddr(&ShimDMAInst_2_0,  /* bd */ 0, HIGH_ADDR((u64)0x20000), LOW_ADDR((u64)0x20000),  /* len */ 16 * 4);
...
// CHECK: XAieDma_ShimBdSetAddr(&ShimDMAInst_2_0,  /* bd */ 1, HIGH_ADDR((u64)0x20000), LOW_ADDR((u64)0x20000),  /* len */ 4 * 4);
