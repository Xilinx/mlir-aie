...
// CHECK:     AIE.connect<"South" : 2, "North" : 1>
// CHECK:   }
// CHECK:   %23 = AIE.iter(0, 1, 1)
// CHECK:   %24 = AIE.iter(3, 4, 1)
// CHECK:   %25 = AIE.select(%0, %23, %24)
// CHECK:   %26 = AIE.switchbox(%25) {
// CHECK:     AIE.connect<"South" : 0, "DMA" : 0>
// CHECK:     AIE.connect<"South" : 1, "North" : 0>
// CHECK:   }
// CHECK:   %27 = AIE.iter(0, 1, 1)
// CHECK:   %28 = AIE.iter(1, 2, 1)
// CHECK:   %29 = AIE.select(%0, %27, %28)
// CHECK:   %30 = AIE.switchbox(%29) {
// CHECK:     AIE.connect<"South" : 0, "DMA" : 0>
// CHECK:     AIE.connect<"South" : 1, "North" : 0>
// CHECK:     AIE.connect<"South" : 2, "North" : 1>
// CHECK:     AIE.connect<"South" : 3, "North" : 2>
// CHECK:   }
// CHECK:   %31 = AIE.iter(2, 3, 1)
// CHECK:   %32 = AIE.iter(1, 2, 1)
...
// CHECK:     AIE.connect<"South" : 3, "North" : 2>
// CHECK:   }
// CHECK:   %35 = AIE.iter(3, 4, 1)
// CHECK:   %36 = AIE.iter(3, 4, 1)
...
// CHECK:     AIE.connect<"DMA" : 0, "North" : 2>
// CHECK:     AIE.connect<"DMA" : 0, "North" : 3>
// CHECK:   }
// CHECK:   %47 = AIE.iter(2, 3, 1)
// CHECK:   %48 = AIE.iter(4, 5, 1)
// CHECK:   %49 = AIE.select(%0, %47, %48)
// CHECK:   %50 = AIE.switchbox(%49) {
// CHECK:     AIE.connect<"South" : 0, "DMA" : 0>
// CHECK:   }
// CHECK:   %51 = AIE.iter(1, 2, 1)
// CHECK:   %52 = AIE.iter(2, 3, 1)
...
// CHECK:   %60 = AIE.iter(3, 4, 1)
// CHECK:   %61 = AIE.select(%0, %59, %60)
// CHECK:   %62 = AIE.switchbox(%61) {
// CHECK:     AIE.connect<"South" : 0, "DMA" : 0>
// CHECK:     AIE.connect<"South" : 1, "North" : 0>
// CHECK:   }
// CHECK:   %63 = AIE.iter(0, 1, 1)
// CHECK:   %64 = AIE.iter(2, 3, 1)
...
// CHECK:     AIE.connect<"South" : 2, "North" : 1>
// CHECK:   }
// CHECK:   %67 = AIE.iter(1, 2, 1)
// CHECK:   %68 = AIE.iter(1, 2, 1)
...
// CHECK:   %72 = AIE.iter(4, 5, 1)
// CHECK:   %73 = AIE.select(%0, %71, %72)
// CHECK:   %74 = AIE.switchbox(%73) {
// CHECK:     AIE.connect<"South" : 0, "DMA" : 0>
// CHECK:   }
// CHECK:   %75 = AIE.iter(3, 4, 1)
// CHECK:   %76 = AIE.iter(0, 1, 1)
...
// CHECK:     AIE.connect<"DMA" : 0, "North" : 3>
// CHECK:   }
// CHECK:   %83 = AIE.iter(1, 2, 1)
// CHECK:   %84 = AIE.iter(3, 4, 1)
