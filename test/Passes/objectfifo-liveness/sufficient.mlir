  ...
  aie.device(npu2) {
    ...
    aie.runtime_sequence(%arg0: memref<8192xbf16>, %arg1: memref<32768xbf16>, %arg2: memref<16384xbf16>, %arg3: memref<4096xf32>) {
      %8 = aiex.dma_configure_task_for @outC_0 {
        aie.dma_bd(%arg3 : memref<4096xf32> offset = 0 len = 512 sizes = [1, 1, 16, 32] strides = [0, 0, 64, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%8)
      %9 = aiex.dma_configure_task_for @outC_0 {
        aie.dma_bd(%arg3 : memref<4096xf32> offset = 32 len = 512 sizes = [1, 1, 16, 32] strides = [0, 0, 64, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%9)
      %10 = aiex.dma_configure_task_for @outC_1 {
        aie.dma_bd(%arg3 : memref<4096xf32> offset = 1024 len = 512 sizes = [1, 1, 16, 32] strides = [0, 0, 64, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%10)
      %11 = aiex.dma_configure_task_for @outC_1 {
        aie.dma_bd(%arg3 : memref<4096xf32> offset = 1056 len = 512 sizes = [1, 1, 16, 32] strides = [0, 0, 64, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%11)
      %12 = aiex.dma_configure_task_for @outC_2 {
        aie.dma_bd(%arg3 : memref<4096xf32> offset = 2048 len = 512 sizes = [1, 1, 16, 32] strides = [0, 0, 64, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%12)
      %13 = aiex.dma_configure_task_for @outC_2 {
        aie.dma_bd(%arg3 : memref<4096xf32> offset = 2080 len = 512 sizes = [1, 1, 16, 32] strides = [0, 0, 64, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%13)
      %14 = aiex.dma_configure_task_for @outC_3 {
        aie.dma_bd(%arg3 : memref<4096xf32> offset = 3072 len = 512 sizes = [1, 1, 16, 32] strides = [0, 0, 64, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%14)
      %15 = aiex.dma_configure_task_for @outC_3 {
        aie.dma_bd(%arg3 : memref<4096xf32> offset = 3104 len = 512 sizes = [1, 1, 16, 32] strides = [0, 0, 64, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%15)
      %16 = aiex.dma_configure_task_for @inA_0 {
        aie.dma_bd(%arg0 : memref<8192xbf16> offset = 0 len = 2048 sizes = [8, 4, 16, 32] strides = [0, 32, 128, 1]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%16)
      %17 = aiex.dma_configure_task_for @inA_1 {
        aie.dma_bd(%arg0 : memref<8192xbf16> offset = 2048 len = 2048 sizes = [8, 4, 16, 32] strides = [0, 32, 128, 1]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%17)
      %18 = aiex.dma_configure_task_for @inA_2 {
        aie.dma_bd(%arg0 : memref<8192xbf16> offset = 4096 len = 2048 sizes = [8, 4, 16, 32] strides = [0, 32, 128, 1]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%18)
      %19 = aiex.dma_configure_task_for @inA_3 {
        aie.dma_bd(%arg0 : memref<8192xbf16> offset = 6144 len = 2048 sizes = [8, 4, 16, 32] strides = [0, 32, 128, 1]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
