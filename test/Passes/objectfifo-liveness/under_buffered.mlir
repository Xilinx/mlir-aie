  ...
  aie.device(npu2) {
    ...
    aie.runtime_sequence(%arg0: memref<16384xbf16>, %arg1: memref<32768xbf16>, %arg2: memref<16384xbf16>, %arg3: memref<8192xf32>) {
      %16 = aiex.dma_configure_task_for @outC_0 {
        aie.dma_bd(%arg3 : memref<8192xf32> offset = 0 len = 512 sizes = [1, 1, 16, 32] strides = [0, 0, 64, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%16)
      %17 = aiex.dma_configure_task_for @outC_0 {
        aie.dma_bd(%arg3 : memref<8192xf32> offset = 32 len = 512 sizes = [1, 1, 16, 32] strides = [0, 0, 64, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%17)
      %18 = aiex.dma_configure_task_for @outC_1 {
        aie.dma_bd(%arg3 : memref<8192xf32> offset = 1024 len = 512 sizes = [1, 1, 16, 32] strides = [0, 0, 64, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%18)
      %19 = aiex.dma_configure_task_for @outC_1 {
        aie.dma_bd(%arg3 : memref<8192xf32> offset = 1056 len = 512 sizes = [1, 1, 16, 32] strides = [0, 0, 64, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%19)
      %20 = aiex.dma_configure_task_for @outC_2 {
        aie.dma_bd(%arg3 : memref<8192xf32> offset = 2048 len = 512 sizes = [1, 1, 16, 32] strides = [0, 0, 64, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%20)
      %21 = aiex.dma_configure_task_for @outC_2 {
        aie.dma_bd(%arg3 : memref<8192xf32> offset = 2080 len = 512 sizes = [1, 1, 16, 32] strides = [0, 0, 64, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%21)
      %22 = aiex.dma_configure_task_for @outC_3 {
        aie.dma_bd(%arg3 : memref<8192xf32> offset = 3072 len = 512 sizes = [1, 1, 16, 32] strides = [0, 0, 64, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%22)
      %23 = aiex.dma_configure_task_for @outC_3 {
        aie.dma_bd(%arg3 : memref<8192xf32> offset = 3104 len = 512 sizes = [1, 1, 16, 32] strides = [0, 0, 64, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%23)
      %24 = aiex.dma_configure_task_for @outC_4 {
        aie.dma_bd(%arg3 : memref<8192xf32> offset = 4096 len = 512 sizes = [1, 1, 16, 32] strides = [0, 0, 64, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%24)
      %25 = aiex.dma_configure_task_for @outC_4 {
        aie.dma_bd(%arg3 : memref<8192xf32> offset = 4128 len = 512 sizes = [1, 1, 16, 32] strides = [0, 0, 64, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%25)
      %26 = aiex.dma_configure_task_for @outC_5 {
        aie.dma_bd(%arg3 : memref<8192xf32> offset = 5120 len = 512 sizes = [1, 1, 16, 32] strides = [0, 0, 64, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%26)
      %27 = aiex.dma_configure_task_for @outC_5 {
        aie.dma_bd(%arg3 : memref<8192xf32> offset = 5152 len = 512 sizes = [1, 1, 16, 32] strides = [0, 0, 64, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%27)
      %28 = aiex.dma_configure_task_for @outC_6 {
        aie.dma_bd(%arg3 : memref<8192xf32> offset = 6144 len = 512 sizes = [1, 1, 16, 32] strides = [0, 0, 64, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%28)
      %29 = aiex.dma_configure_task_for @outC_6 {
        aie.dma_bd(%arg3 : memref<8192xf32> offset = 6176 len = 512 sizes = [1, 1, 16, 32] strides = [0, 0, 64, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%29)
      %30 = aiex.dma_configure_task_for @outC_7 {
        aie.dma_bd(%arg3 : memref<8192xf32> offset = 7168 len = 512 sizes = [1, 1, 16, 32] strides = [0, 0, 64, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%30)
      %31 = aiex.dma_configure_task_for @outC_7 {
        aie.dma_bd(%arg3 : memref<8192xf32> offset = 7200 len = 512 sizes = [1, 1, 16, 32] strides = [0, 0, 64, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%31)
      %32 = aiex.dma_configure_task_for @inA_0 {
        aie.dma_bd(%arg0 : memref<16384xbf16> offset = 0 len = 2048 sizes = [8, 4, 16, 32] strides = [0, 32, 128, 1]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%32)
      %33 = aiex.dma_configure_task_for @inA_1 {
        aie.dma_bd(%arg0 : memref<16384xbf16> offset = 2048 len = 2048 sizes = [8, 4, 16, 32] strides = [0, 32, 128, 1]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%33)
      %34 = aiex.dma_configure_task_for @inA_2 {
        aie.dma_bd(%arg0 : memref<16384xbf16> offset = 4096 len = 2048 sizes = [8, 4, 16, 32] strides = [0, 32, 128, 1]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%34)
      %35 = aiex.dma_configure_task_for @inA_3 {
        aie.dma_bd(%arg0 : memref<16384xbf16> offset = 6144 len = 2048 sizes = [8, 4, 16, 32] strides = [0, 32, 128, 1]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%35)
      %36 = aiex.dma_configure_task_for @inA_4 {
        aie.dma_bd(%arg0 : memref<16384xbf16> offset = 8192 len = 2048 sizes = [8, 4, 16, 32] strides = [0, 32, 128, 1]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%36)
      %37 = aiex.dma_configure_task_for @inA_5 {
        aie.dma_bd(%arg0 : memref<16384xbf16> offset = 10240 len = 2048 sizes = [8, 4, 16, 32] strides = [0, 32, 128, 1]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%37)
      %38 = aiex.dma_configure_task_for @inA_6 {
        aie.dma_bd(%arg0 : memref<16384xbf16> offset = 12288 len = 2048 sizes = [8, 4, 16, 32] strides = [0, 32, 128, 1]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%38)
      %39 = aiex.dma_configure_task_for @inA_7 {
        aie.dma_bd(%arg0 : memref<16384xbf16> offset = 14336 len = 2048 sizes = [8, 4, 16, 32] strides = [0, 32, 128, 1]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%39)
      %40 = aiex.dma_configure_task_for @inW1_0 {
        aie.dma_bd(%arg1 : memref<32768xbf16> offset = 0 len = 4096 sizes = [8, 4, 32, 32] strides = [32, 8192, 256, 1]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%40)
      %41 = aiex.dma_configure_task_for @inW2_0 {
        aie.dma_bd(%arg2 : memref<16384xbf16> offset = 0 len = 2048 sizes = [1, 2, 32, 32] strides = [0, 32, 64, 1]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%41)
      %42 = aiex.dma_configure_task_for @inW2_0 {
        aie.dma_bd(%arg2 : memref<16384xbf16> offset = 2048 len = 2048 sizes = [1, 2, 32, 32] strides = [0, 32, 64, 1]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%42)
      %43 = aiex.dma_configure_task_for @inW2_0 {
        aie.dma_bd(%arg2 : memref<16384xbf16> offset = 4096 len = 2048 sizes = [1, 2, 32, 32] strides = [0, 32, 64, 1]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%43)
      %44 = aiex.dma_configure_task_for @inW2_0 {
        aie.dma_bd(%arg2 : memref<16384xbf16> offset = 6144 len = 2048 sizes = [1, 2, 32, 32] strides = [0, 32, 64, 1]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%44)
      %45 = aiex.dma_configure_task_for @inW2_0 {
        aie.dma_bd(%arg2 : memref<16384xbf16> offset = 8192 len = 2048 sizes = [1, 2, 32, 32] strides = [0, 32, 64, 1]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%45)
      %46 = aiex.dma_configure_task_for @inW2_0 {
        aie.dma_bd(%arg2 : memref<16384xbf16> offset = 10240 len = 2048 sizes = [1, 2, 32, 32] strides = [0, 32, 64, 1]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%46)
      %47 = aiex.dma_configure_task_for @inW2_0 {
        aie.dma_bd(%arg2 : memref<16384xbf16> offset = 12288 len = 2048 sizes = [1, 2, 32, 32] strides = [0, 32, 64, 1]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%47)
      %48 = aiex.dma_configure_task_for @inW2_0 {
        aie.dma_bd(%arg2 : memref<16384xbf16> offset = 14336 len = 2048 sizes = [1, 2, 32, 32] strides = [0, 32, 64, 1]) {burst_length = 0 : i32}
        aie.end
      }
