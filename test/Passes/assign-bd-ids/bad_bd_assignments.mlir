  ...
  aie.device(npu1) {
    ...
    %mem_0_2 = aie.mem(%tile_0_2) {
      %player_a = aie.dma(S2MM, 0) [{
        ...
        aie.dma_bd(%double_buffer : memref<32xi32> offset = 0 sizes = [] strides = []) {bd_id = 16 : i32, next_bd_id = 1 : i32}
  ...
  aie.device(npu1) {
    ...
    %mem_0_2 = aie.mem(%tile_0_2) {
      %player_a = aie.dma(S2MM, 0) [{
        ...
        aie.dma_bd(%double_buffer : memref<32xi32> offset = 0 sizes = [] strides = []) {bd_id = 1 : i32, next_bd_id = 16 : i32}
  ...
  aie.device(npu1) {
    ...
    %memtile_dma_0_1 = aie.memtile_dma(%tile_0_1) {
      ...
      %0 = aie.dma(S2MM, 0) [{
        ...
        aie.dma_bd(%buffer_0_1 : memref<32xi32> offset = 0 sizes = [] strides = []) {bd_id = 48 : i32, next_bd_id = 1 : i32}
  ...
  aie.device(npu1) {
    ...
    %memtile_dma_0_1 = aie.memtile_dma(%tile_0_1) {
      ...
      %0 = aie.dma(S2MM, 0) [{
        ...
        aie.dma_bd(%buffer_0_1 : memref<32xi32> offset = 0 sizes = [] strides = []) {bd_id = 1 : i32, next_bd_id = 48 : i32}
        aie.use_lock(%lock_0_1_0, Release)
      }]
      aie.end
    }
  ...
  aie.device(npu1) {
    ...
    %memtile_dma_0_1 = aie.memtile_dma(%tile_0_1) {
      ...
      %0 = aie.dma(S2MM, 0) [{
        ...
        aie.dma_bd(%buffer_0_1 : memref<128xi16> offset = 0 len = 129 sizes = [] strides = [])
        aie.use_lock(%lock_0_1_0, Release)
      }]
      aie.end
    }
