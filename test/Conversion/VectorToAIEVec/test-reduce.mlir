...
func.func @reduce_add_i32(%arg0: vector<16xi32>) -> i32 {
  ...
  // CHECK: %[[SHIFT8:.*]] = aievec.shift %[[ADD2]] {isAcc = false, shift = 8 : i32} : vector<16xi32>, vector<16xi32>
...
func.func @reduce_min_i32(%arg0: vector<16xi32>) -> i32 {
  ...
  // CHECK: %[[SHIFT8:.*]] = aievec.shift %[[MIN2]] {isAcc = false, shift = 8 : i32} : vector<16xi32>, vector<16xi32>
...
func.func @reduce_max_i32(%arg0: vector<16xi32>) -> i32 {
  ...
  // CHECK: %[[SHIFT8:.*]] = aievec.shift %[[MAX2]] {isAcc = false, shift = 8 : i32} : vector<16xi32>, vector<16xi32>
...
func.func @reduce_add_i16(%arg0: vector<32xi16>) -> i16 {
  ...
  // CHECK: %[[SHIFT8:.*]] = aievec.shift %[[ADD2]] {isAcc = false, shift = 8 : i32} : vector<32xi16>, vector<32xi16>
  // CHECK: %[[ADD3:.*]] = aievec.add_elem %[[ADD2]], %[[SHIFT8]] : vector<32xi16>
  // CHECK: %[[SHIFT4:.*]] = aievec.shift %[[ADD3]] {isAcc = false, shift = 4 : i32} : vector<32xi16>, vector<32xi16>
...
func.func @reduce_min_i16(%arg0: vector<32xi16>) -> i16 {
  ...
  // CHECK: %[[SHIFT8:.*]] = aievec.shift %[[MIN2]] {isAcc = false, shift = 8 : i32} : vector<32xi16>, vector<32xi16>
  // CHECK: %[[MIN3:.*]] = aievec.min %[[MIN2]], %[[SHIFT8]] : vector<32xi16>
  // CHECK: %[[SHIFT4:.*]] = aievec.shift %[[MIN3]] {isAcc = false, shift = 4 : i32} : vector<32xi16>, vector<32xi16>
...
func.func @reduce_max_i16(%arg0: vector<32xi16>) -> i16 {
  ...
  // CHECK: %[[SHIFT8:.*]] = aievec.shift %[[MAX2]] {isAcc = false, shift = 8 : i32} : vector<32xi16>, vector<32xi16>
  // CHECK: %[[MAX3:.*]] = aievec.max %[[MAX2]], %[[SHIFT8]] : vector<32xi16>
  // CHECK: %[[SHIFT4:.*]] = aievec.shift %[[MAX3]] {isAcc = false, shift = 4 : i32} : vector<32xi16>, vector<32xi16>
...
func.func @reduce_add_i8(%arg0: vector<64xi8>) -> i8 {
  ...
  // CHECK: %[[SHIFT8:.*]] = aievec.shift %[[ADD2]] {isAcc = false, shift = 8 : i32} : vector<64xi8>, vector<64xi8>
  // CHECK: %[[ADD3:.*]] = aievec.add_elem %[[ADD2]], %[[SHIFT8]] : vector<64xi8>
  // CHECK: %[[SHIFT4:.*]] = aievec.shift %[[ADD3]] {isAcc = false, shift = 4 : i32} : vector<64xi8>, vector<64xi8>
  // CHECK: %[[ADD4:.*]] = aievec.add_elem %[[ADD3]], %[[SHIFT4]] : vector<64xi8>
  // CHECK: %[[SHIFT5:.*]] = aievec.shift %[[ADD4]] {isAcc = false, shift = 2 : i32} : vector<64xi8>, vector<64xi8>
...
func.func @reduce_min_i8(%arg0: vector<64xi8>) -> i8 {
  ...
  // CHECK: %[[SHIFT8:.*]] = aievec.shift %[[MIN2]] {isAcc = false, shift = 8 : i32} : vector<64xi8>, vector<64xi8>
  // CHECK: %[[MIN3:.*]] = aievec.min %[[MIN2]], %[[SHIFT8]] : vector<64xi8>
  // CHECK: %[[SHIFT4:.*]] = aievec.shift %[[MIN3]] {isAcc = false, shift = 4 : i32} : vector<64xi8>, vector<64xi8>
  // CHECK: %[[MIN4:.*]] = aievec.min %[[MIN3]], %[[SHIFT4]] : vector<64xi8>
  // CHECK: %[[SHIFT5:.*]] = aievec.shift %[[MIN4]] {isAcc = false, shift = 2 : i32} : vector<64xi8>, vector<64xi8>
...
func.func @reduce_max_i8(%arg0: vector<64xi8>) -> i8 {
  ...
  // CHECK: %[[SHIFT8:.*]] = aievec.shift %[[MAX2]] {isAcc = false, shift = 8 : i32} : vector<64xi8>, vector<64xi8>
  // CHECK: %[[MAX3:.*]] = aievec.max %[[MAX2]], %[[SHIFT8]] : vector<64xi8>
  // CHECK: %[[SHIFT4:.*]] = aievec.shift %[[MAX3]] {isAcc = false, shift = 4 : i32} : vector<64xi8>, vector<64xi8>
  // CHECK: %[[MAX4:.*]] = aievec.max %[[MAX3]], %[[SHIFT4]] : vector<64xi8>
  // CHECK: %[[SHIFT5:.*]] = aievec.shift %[[MAX4]] {isAcc = false, shift = 2 : i32} : vector<64xi8>, vector<64xi8>
...
func.func @reduce_add_f32(%arg0: vector<16xf32>) -> f32 {
  ...
  // CHECK: %[[SHIFT16:.*]] = aievec.shift %[[CAST1]] {isAcc = false, shift = 16 : i32} : vector<16xf32>, vector<16xf32>
  ...
  // CHECK: %[[SHIFT8:.*]] = aievec.shift %[[CAST2]] {isAcc = false, shift = 8 : i32} : vector<16xf32>, vector<16xf32>
  ...
  // CHECK: %[[SHIFT4:.*]] = aievec.shift %[[CAST3]] {isAcc = false, shift = 4 : i32} : vector<16xf32>, vector<16xf32>
...
func.func @reduce_min_f32(%arg0: vector<16xf32>) -> f32 {
  ...
  // CHECK: %[[SHIFT8:.*]] = aievec.shift %[[MIN2]] {isAcc = false, shift = 8 : i32} : vector<16xf32>, vector<16xf32>
...
func.func @reduce_max_f32(%arg0: vector<16xf32>) -> f32 {
  ...
  // CHECK: %[[SHIFT8:.*]] = aievec.shift %[[MAX2]] {isAcc = false, shift = 8 : i32} : vector<16xf32>, vector<16xf32>
...
func.func @reduce_min_bf16(%arg0: vector<32xbf16>) -> bf16 {
  ...
  // CHECK: %[[SHIFT8:.*]] = aievec.shift %[[MIN2]] {isAcc = false, shift = 8 : i32} : vector<32xbf16>, vector<32xbf16>
  // CHECK: %[[MIN3:.*]] = aievec.min %[[MIN2]], %[[SHIFT8]] : vector<32xbf16>
  // CHECK: %[[SHIFT4:.*]] = aievec.shift %[[MIN3]] {isAcc = false, shift = 4 : i32} : vector<32xbf16>, vector<32xbf16>
...
func.func @reduce_max_bf16(%arg0: vector<32xbf16>) -> bf16 {
  ...
  // CHECK: %[[SHIFT8:.*]] = aievec.shift %[[MAX2]] {isAcc = false, shift = 8 : i32} : vector<32xbf16>, vector<32xbf16>
  // CHECK: %[[MAX3:.*]] = aievec.max %[[MAX2]], %[[SHIFT8]] : vector<32xbf16>
  // CHECK: %[[SHIFT4:.*]] = aievec.shift %[[MAX3]] {isAcc = false, shift = 4 : i32} : vector<32xbf16>, vector<32xbf16>
