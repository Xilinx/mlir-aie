...
func.func @vecmin_i32(%arg0: vector<16xi32>, %arg1: vector<16xi32>) -> vector<16xi32> {
  // CHECK: %[[RES:.*]] = aievec.min %[[LHS]], %[[RHS]] : vector<16xi32>, vector<16xi32>, vector<16xi32>
...
func.func @vecmin_i16(%arg0: vector<32xi16>, %arg1: vector<32xi16>) -> vector<32xi16> {
  // CHECK: %[[RES:.*]] = aievec.min %[[LHS]], %[[RHS]] : vector<32xi16>, vector<32xi16>, vector<32xi16>
...
func.func @vecmin_i8(%arg0: vector<64xi8>, %arg1: vector<64xi8>) -> vector<64xi8> {
  // CHECK: %[[RES:.*]] = aievec.min %[[LHS]], %[[RHS]] : vector<64xi8>, vector<64xi8>, vector<64xi8>
...
func.func @vecmin_bf16(%arg0: vector<32xbf16>, %arg1: vector<32xbf16>) -> vector<32xbf16> {
  // CHECK: %[[RES:.*]] = aievec.min %[[LHS]], %[[RHS]] : vector<32xbf16>, vector<32xbf16>, vector<32xbf16>
  %0 = arith.minf %arg0, %arg1 : vector<32xbf16>
...
func.func @vecmin_f32(%arg0: vector<16xf32>, %arg1: vector<16xf32>) -> vector<16xf32> {
  // CHECK: %[[RES:.*]] = aievec.min %[[LHS]], %[[RHS]] : vector<16xf32>, vector<16xf32>, vector<16xf32>
  %0 = arith.minf %arg0, %arg1 : vector<16xf32>
