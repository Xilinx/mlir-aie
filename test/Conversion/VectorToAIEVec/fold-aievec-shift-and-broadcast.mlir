...
func.func @fold_aievec_shift_and_broadcast(%a: memref<48xi8>) -> vector<32xi8> {
    %c0 = arith.constant 0 : index
    %0 = aievec.upd %a[%c0] {index = 0 : i8, offset = 0 : si32} : memref<48xi8>, vector<32xi8>
    %1 = aievec.shift %0 {shift = 16 : i32} : vector<32xi8>, vector<32xi8>
    %2 = aievec.broadcast %1 {idx = 0 : i8} : vector<32xi8>, vector<32xi8>
    return %2 : vector<32xi8>
}
