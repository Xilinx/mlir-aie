...
// CHECK      :    %[[T1:.*]] = aievec.shift %[[T0:.*]] {shift = 16 : i32} : vector<32xi8>, vector<32xi8>
// CHECK      :    %[[T2:.*]] = aievec.upd {{.*}}[%[[C32:.*]]] {index = 0 : i8, offset = 0 : si32} : memref<48xi8>, vector<32xi8>
// CHECK      :    %[[T3:.*]] = aievec.shift %[[T2:.*]] {shift = 2 : i32} : vector<32xi8>, vector<32xi8>
// CHECK      :    return %[[T1:.*]], %[[T3:.*]] : vector<32xi8>, vector<32xi8>
