...
// RUN: aie-opt %s --convert-vector-to-aievec="aie-target=aie2" -split-input-file | FileCheck %s --check-prefix=CHECK-V2-LLVM
// RUN: aie-opt %s --convert-vector-to-aievec="aie-target=aie2p" -split-input-file | FileCheck %s --check-prefix=CHECK-V2P-LLVM

// CHECK-V2-LLVM-LABEL: func @veccopy_i8
// CHECK-V2P-LLVM-LABEL: func @veccopy_i8
func.func @veccopy_i8(%arg0: memref<256xi8>, %arg1: memref<256xi8>) {
  ...
  affine.for %arg2 = 0 to 256 step 16 {
    ...
    // CHECK-V2P-LLVM: %[[LD:.*]] = vector.transfer_read {{.*}}, {{.*}} : memref<256xi8>, vector<16xi8>
    ...
    // CHECK-V2P-LLVM: vector.transfer_write %[[LD]], {{.*}} : vector<16xi8>, memref<256xi8>
...
// CHECK-V2P-LLVM-LABEL: func @veccopy_i16
func.func @veccopy_i16(%arg0: memref<256xi16>, %arg1: memref<256xi16>) {
  ...
  affine.for %arg2 = 0 to 256 step 16 {
    ...
    // CHECK-V2P-LLVM: %[[LD:.*]] = vector.transfer_read {{.*}}, {{.*}} : memref<256xi16>, vector<16xi16>
    ...
    // CHECK-V2P-LLVM: vector.transfer_write %[[LD]], {{.*}} : vector<16xi16>, memref<256xi16>
...
// CHECK-V2P-LLVM-LABEL: func @veccopy_i32
func.func @veccopy_i32(%arg0: memref<256xi32>, %arg1: memref<256xi32>) {
  ...
  affine.for %arg2 = 0 to 256 step 8 {
    ...
    // CHECK-V2P-LLVM: %[[LD:.*]] = vector.transfer_read {{.*}}, {{.*}} : memref<256xi32>, vector<8xi32>
    ...
    // CHECK-V2P-LLVM: vector.transfer_write %[[LD]], {{.*}} : vector<8xi32>, memref<256xi32>
...
func.func @veccopy_long_i32(%arg0: memref<256xi32>, %arg1: memref<256xi32>) {
  affine.for %arg2 = 0 to 256 step 16 {
    ...
    // CHECK-V2P-LLVM: %[[LD:.*]] = vector.transfer_read {{.*}}, {{.*}} : memref<256xi32>, vector<16xi32>
    ...
    // CHECK-V2P-LLVM: vector.transfer_write %[[LD]], {{.*}} : vector<16xi32>, memref<256xi32>
...
func.func @veccopy_2d_i32(%arg0: memref<16x4x4xi32>, %arg1: memref<16x4x4xi32>) {
  ...
  // CHECK-V2P-LLVM: %[[COLLAPSE_SHAPE_1:.*]] = memref.collapse_shape %arg1 {{\[\[}}0], [1, 2]] : memref<16x4x4xi32> into memref<16x16xi32>
  affine.for %arg2 = 0 to 16 step 1 {
    ...
    // CHECK-V2P-LLVM: %[[LD:.*]] = vector.transfer_read %[[COLLAPSE_SHAPE_0]]{{\[}}%arg2, %c0], {{.*}} {in_bounds = [true]} : memref<16x16xi32>, vector<16xi32>
    ...
    // CHECK-V2P-LLVM: vector.transfer_write %[[LD]], {{.*}} {in_bounds = [true]} : vector<16xi32>, memref<16x16xi32>
