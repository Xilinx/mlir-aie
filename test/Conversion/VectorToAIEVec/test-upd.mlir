...
func.func @veccopy_i16(%arg0: memref<256xi16>, %arg1: memref<256xi16>) {
  ...
  affine.for %arg2 = 0 to 256 step 16 {
    // CHECK: %[[LD:.*]] = aievec_aie1.upd {{.*}} {index = 0 : i8, offset = 0 : i32} : memref<256xi16>, vector<16xi16>
...
func.func @veccopy_i32(%arg0: memref<256xi32>, %arg1: memref<256xi32>) {
  ...
  affine.for %arg2 = 0 to 256 step 8 {
    // CHECK: %[[LD:.*]] = aievec_aie1.upd {{.*}} {index = 0 : i8, offset = 0 : i32} : memref<256xi32>, vector<8xi32>
...
func.func @veccopy_long_i32(%arg0: memref<256xi32>, %arg1: memref<256xi32>) {
  %c0_i32 = arith.constant 0 : i32
  affine.for %arg2 = 0 to 256 step 16 {
    // CHECK: %[[LD0:.*]] = aievec_aie1.upd {{.*}} {index = 0 : i8, offset = 0 : i32} : memref<256xi32>, vector<16xi32>
    // CHECK-NEXT: %[[LD1:.*]] = aievec_aie1.upd {{.*}}, %[[LD0]] {index = 1 : i8, offset = 256 : i32} : memref<256xi32>, vector<16xi32>
