...
// CHECK-LABEL: func private @_Z10getExpBf16Dv16_u6__bf16(vector<16xbf16>) -> vector<8xi64>
...
func.func @test_exp_lut(%a: vector<16xbf16>) -> vector<16xbf16> {
    ...
    // CHECK: %[[CALL:.*]] = call @_Z10getExpBf16Dv16_u6__bf16(%[[A]]) : (vector<16xbf16>) -> vector<8xi64>
