...
// aie_runtime::txn_append_* function, wrapped in generate_txn_<seq>.

// CHECK-LABEL: emitc.func @generate_txn_seq_write32
...
// CHECK-LABEL: emitc.func @generate_txn_seq_maskwrite32
...
// CHECK-LABEL: emitc.func @generate_txn_seq_sync
...
// CHECK-LABEL: emitc.func @generate_txn_seq_address_patch
...
// CHECK-LABEL: emitc.func @generate_txn_seq_blockwrite
...
// CHECK-DAG: emitc.func @generate_txn_seqA
// CHECK-DAG: emitc.func @generate_txn_seqB
module {
  aie.device(npu1_1col) {
...
// CHECK-LABEL: emitc.func @generate_txn_seq_npu2
