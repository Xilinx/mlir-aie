...
// RUN: aie-opt %s -split-input-file --convert-aievec-to-llvm="aie-target=aie2" | FileCheck %s
...
// CHECK: llvm.func @__aie2_scalar_fdiv
...
func.func @vector_4xf32_fdiv(%lhs : vector<4xf32>, %rhs : vector<4xf32>) -> vector<4xf32> {
  ...
  // CHECK-COUNT-4: llvm.call @__aie2_scalar_fdiv
...
func.func @vector_16xf32_fdiv(%lhs : vector<16xf32>, %rhs : vector<16xf32>) -> vector<16xf32> {
  ...
  // CHECK-COUNT-16: llvm.call @__aie2_scalar_fdiv
...
func.func @vector_8xf32_fdiv(%lhs : vector<8xf32>, %rhs : vector<8xf32>) -> vector<8xf32> {
  ...
  // CHECK-COUNT-8: llvm.call @__aie2_scalar_fdiv
