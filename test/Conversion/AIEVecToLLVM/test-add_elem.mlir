...
// AIE2P-LABEL: add_elem_flat_fp32
...
func.func @add_elem_flat_fp32(%lhs : vector<16xf32>, %rhs : vector<16xf32>) -> vector<16xf32> {
  ...
  // AIE2P: %[[ADD:.*]] = "xllvm.intr.aie2p.ACC2048.accfloat.add.conf"(%[[BC2]], %[[BC3]], %[[CONF]]) : (vector<64xf32>, vector<64xf32>, i32) -> vector<64xf32>
  // AIE2P: %[[BC4:.*]] = llvm.bitcast %[[ADD]] : vector<64xf32> to vector<32xi64>
