...
// CHECK-NEXT: %14 = llvm.call @llvm.aie.v32int16.undef() : () -> vector<32xi16>
// CHECK-NEXT: %15 = llvm.call @llvm.aie.upd.w.v32int16.lo(%14, %13) : (vector<32xi16>, vector<16xi16>) -> vector<32xi16>
// CHECK-NEXT: %16 = llvm.extractvalue %0[1] : !llvm.struct<(ptr<i16>, ptr<i16>, i64, array<3 x i64>, array<3 x i64>)>
// CHECK-NEXT: %17 = llvm.mlir.constant(2048 : index) : i64
// CHECK-NEXT: %18 = llvm.mul %1, %17 : i64
// CHECK-NEXT: %19 = llvm.mlir.constant(64 : index) : i64
// CHECK-NEXT: %20 = llvm.mul %2, %19 : i64
// CHECK-NEXT: %21 = llvm.add %18, %20 : i64
// CHECK-NEXT: %22 = llvm.add %21, %3 : i64
// CHECK-NEXT: %23 = llvm.getelementptr %16[%22] : (!llvm.ptr<i16>, i64) -> !llvm.ptr<i16>
// CHECK-NEXT: %24 = llvm.bitcast %23 : !llvm.ptr<i16> to !llvm.ptr<vector<16xi16>>
// CHECK-NEXT: %25 = llvm.load %24 {alignment = 1 : i64} : !llvm.ptr<vector<16xi16>>
// CHECK-NEXT: %26 = llvm.call @llvm.aie.upd.w.v32int16.hi(%15, %25) : (vector<32xi16>, vector<16xi16>) -> vector<32xi16>
