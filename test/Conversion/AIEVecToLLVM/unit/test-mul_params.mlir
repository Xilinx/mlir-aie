...
// CHECK-NEXT: %6 = llvm.call @__builtin_aie_mul16_v32int16_v16int16_bm_sw48(%arg0, %arg1, %0, %1, %2, %3, %4, %5) : (vector<32xi16>, vector<16xi16>, i32, i32, i32, vector<2xi32>, vector<2xi32>, vector<2xi32>) -> vector<16xi48>
...
// CHECK-NEXT: %13 = llvm.call @__builtin_aie_mul16_v32int16_v16int16_bm_sw48(%arg0, %arg1, %7, %8, %9, %10, %11, %12) : (vector<32xi16>, vector<16xi16>, i32, i32, i32, vector<2xi32>, vector<2xi32>, vector<2xi32>) -> vector<16xi48>
...
// CHECK-NEXT: %20 = llvm.call @__builtin_aie_mul16_v32int16_v16int16_bm_sw48(%arg0, %arg1, %14, %15, %16, %17, %18, %19) : (vector<32xi16>, vector<16xi16>, i32, i32, i32, vector<2xi32>, vector<2xi32>, vector<2xi32>) -> vector<16xi48>
...
// CHECK-NEXT: %27 = llvm.call @__builtin_aie_mul16_v32int16_v16int16_bm_sw48(%arg0, %arg1, %21, %22, %23, %24, %25, %26) : (vector<32xi16>, vector<16xi16>, i32, i32, i32, vector<2xi32>, vector<2xi32>, vector<2xi32>) -> vector<16xi48>
...
// CHECK-NEXT: %34 = llvm.call @__builtin_aie_mul16_v32int16_v16int16_bm_sw48(%arg0, %arg1, %28, %29, %30, %31, %32, %33) : (vector<32xi16>, vector<16xi16>, i32, i32, i32, vector<2xi32>, vector<2xi32>, vector<2xi32>) -> vector<16xi48>
...
// CHECK-NEXT: %41 = llvm.call @__builtin_aie_mul16_v32int16_v16int16_bm_sw48(%arg0, %arg1, %35, %36, %37, %38, %39, %40) : (vector<32xi16>, vector<16xi16>, i32, i32, i32, vector<2xi32>, vector<2xi32>, vector<2xi32>) -> vector<16xi48>
...
// CHECK-NEXT: %48 = llvm.call @__builtin_aie_mul16_v32int16_v16int16_bm_sw48(%arg0, %arg1, %42, %43, %44, %45, %46, %47) : (vector<32xi16>, vector<16xi16>, i32, i32, i32, vector<2xi32>, vector<2xi32>, vector<2xi32>) -> vector<16xi48>
