...
// CHECK-NEXT: %13 = llvm.call @__builtin_aie_mac16_v32int16_v16int16_bm_sw48(%arg0, %arg1, %arg2, %7, %8, %9, %10, %11, %12) : (vector<32xi16>, vector<16xi16>, vector<16xi48>, i32, i32, i32, vector<2xi32>, vector<2xi32>, vector<2xi32>) -> vector<16xi48>
...
// CHECK-NEXT: %20 = llvm.call @__builtin_aie_mac16_v32int16_v16int16_bm_sw48(%arg0, %arg1, %arg2, %14, %15, %16, %17, %18, %19) : (vector<32xi16>, vector<16xi16>, vector<16xi48>, i32, i32, i32, vector<2xi32>, vector<2xi32>, vector<2xi32>) -> vector<16xi48>
...
// CHECK-NEXT: %27 = llvm.call @__builtin_aie_mac16_v32int16_v16int16_bm_sw48(%arg0, %arg1, %arg2, %21, %22, %23, %24, %25, %26) : (vector<32xi16>, vector<16xi16>, vector<16xi48>, i32, i32, i32, vector<2xi32>, vector<2xi32>, vector<2xi32>) -> vector<16xi48>
...
// CHECK-NEXT: %34 = llvm.call @__builtin_aie_mac16_v32int16_v16int16_bm_sw48(%arg0, %arg1, %arg2, %28, %29, %30, %31, %32, %33) : (vector<32xi16>, vector<16xi16>, vector<16xi48>, i32, i32, i32, vector<2xi32>, vector<2xi32>, vector<2xi32>) -> vector<16xi48>
...
// CHECK-NEXT: %41 = llvm.call @__builtin_aie_mac16_v32int16_v16int16_bm_sw48(%arg0, %arg1, %arg2, %35, %36, %37, %38, %39, %40) : (vector<32xi16>, vector<16xi16>, vector<16xi48>, i32, i32, i32, vector<2xi32>, vector<2xi32>, vector<2xi32>) -> vector<16xi48>
...
// CHECK-NEXT: %47 = llvm.mlir.constant(dense<[0, 131072]> : vector<2xi32>) : vector<2xi32>
// CHECK-NEXT: %48 = llvm.call @__builtin_aie_mac16_v32int16_v16int16_bm_sw48(%arg0, %arg1, %arg2, %42, %43, %44, %45, %46, %47) : (vector<32xi16>, vector<16xi16>, vector<16xi48>, i32, i32, i32, vector<2xi32>, vector<2xi32>, vector<2xi32>) -> vector<16xi48>
// CHECK:      %49 = llvm.mlir.constant(0 : i32) : i32
// CHECK-NEXT: %50 = llvm.mlir.constant(0 : i32) : i32
// CHECK-NEXT: %51 = llvm.mlir.constant(0 : i32) : i32
// CHECK-NEXT: %52 = llvm.mlir.constant(dense<0> : vector<2xi32>) : vector<2xi32>
// CHECK-NEXT: %53 = llvm.mlir.constant(dense<0> : vector<2xi32>) : vector<2xi32>
// CHECK-NEXT: %54 = llvm.mlir.constant(dense<[260, 189668]> : vector<2xi32>) : vector<2xi32>
// CHECK-NEXT: %55 = llvm.call @__builtin_aie_mac16_v32int16_v16int16_bm_sw48(%arg0, %arg1, %arg2, %49, %50, %51, %52, %53, %54) : (vector<32xi16>, vector<16xi16>, vector<16xi48>, i32, i32, i32, vector<2xi32>, vector<2xi32>, vector<2xi32>) -> vector<16xi48>
