...
// CHECK:      llvm.func @llvm.aie.srs.v4i32.v4acc80(vector<4xi80>, i8) -> vector<4xi32>
// CHECK:      llvm.func @llvm.aie.lsrs.v8i32.v8acc48(vector<8xi48>, i8) -> vector<8xi32>
// CHECK:      llvm.func @llvm.aie.srs.v16i16.v16acc48(vector<16xi48>, i8) -> vector<16xi16>
// CHECK:      llvm.func @llvm.aie.usrs.v16i8.v16acc48(vector<16xi48>, i8) -> vector<16xui8>
// CHECK:      llvm.func @llvm.aie.bsrs.v16i8.v16acc48(vector<16xi48>, i8) -> vector<16xi8>
...
// CHECK-NEXT: %5 = llvm.call @llvm.aie.bsrs.v16i8.v16acc48(%1, %4) : (vector<16xi48>, i8) -> vector<16xi8>
// CHECK-NEXT: %6 = llvm.mlir.constant(1 : i8) : i8
// CHECK-NEXT: %7 = llvm.call @llvm.aie.usrs.v16i8.v16acc48(%1, %6) : (vector<16xi48>, i8) -> vector<16xui8>
// CHECK-NEXT: %8 = llvm.mlir.constant(2 : i8) : i8
// CHECK-NEXT: %9 = llvm.call @llvm.aie.srs.v16i16.v16acc48(%1, %8) : (vector<16xi48>, i8) -> vector<16xi16>
// CHECK-NEXT: %10 = llvm.mlir.constant(3 : i8) : i8
// CHECK-NEXT: %11 = llvm.call @llvm.aie.lsrs.v8i32.v8acc48(%0, %10) : (vector<8xi48>, i8) -> vector<8xi32>
// CHECK-NEXT: %12 = llvm.mlir.constant(4 : i8) : i8
// CHECK-NEXT: %13 = llvm.call @llvm.aie.srs.v4i32.v4acc80(%2, %12) : (vector<4xi80>, i8) -> vector<4xi32>
