...
module @test_lock0_reuse {
  ...
  %c23 = AIE.core(%t23) {
    ...
    // In this implemented lock, Token Acquire 0 is implemented as Lock
    // Acquire 0, Token Acquire 1 is implemented as Lock Acquire 1, and Token
    // Release 0/1 should be Lock Release 0/1 as well.
