...
// CHECK:   %3 = AIE.objectFifo.createObjectFifo(%0, {%2, %1}, 2) {sym_name = "objFifo_broadcast"} : !AIE.objectFifo<memref<16xi32>>
...
module @registerPatterns  {
    ...
    %objFifo = AIE.objectFifo.createObjectFifo(%tile12, {%tile33, %tile13}, 2) {sym_name = "objFifo_broadcast"} : !AIE.objectFifo<memref<16xi32>>
