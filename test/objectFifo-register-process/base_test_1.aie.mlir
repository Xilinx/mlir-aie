...
// CHECK:    %2 = AIE.objectFifo.createObjectFifo(%0, {%1}, 4) {sym_name = "objFifo_12_13"} : !AIE.objectFifo<memref<16xi32>>
...
module @registerPatterns  {
    ...
    %objFifo = AIE.objectFifo.createObjectFifo(%tile12, {%tile13}, 4) {sym_name = "objFifo_12_13"} : !AIE.objectFifo<memref<16xi32>>
