...
module @multi_segment {
  aie.device(xcve2302) {
    ...
    %core = aie.core(%tile12) {
      %sv = aie.objectfifo.acquire @reader (1) : !aie.objectfifosubview<memref<48xi32>>
      %e = aie.objectfifo.subview.access %sv[0] : !aie.objectfifosubview<memref<48xi32>> -> memref<48xi32>
