...
module {
    func private @kfunc1(%in1 : !ADF.itf<i1, i32> {ADF.data_access = "window", ADF.blk_form = "int",  ADF.blk_unit = 8})  
                             ->(!ADF.itf<i1, i32> {ADF.data_access = "window", ADF.blk_form = "int",  ADF.blk_unit = 32})

    func private @kfunc2(%in1 : !ADF.itf<i1, i32> {ADF.data_access = "window", ADF.blk_form = "cint", ADF.blk_unit = 16}, 
                         %in2 : !ADF.itf<i1, i32> {ADF.data_access = "window", ADF.blk_form = "cacc", ADF.blk_unit = 80}) 
                             ->(!ADF.itf<i1, i32> {ADF.data_access = "window", ADF.blk_form = "cint", ADF.blk_unit = 16})

    func private @kfunc3(%in1 : !ADF.itf<i1, i32> {ADF.data_access = "window", ADF.blk_form = "cint", ADF.blk_unit = 16}, 
                         %in2 : !ADF.itf<i1, i32> {ADF.data_access = "window", ADF.blk_form = "cacc", ADF.blk_unit = 48}) 
                             ->(!ADF.itf<i1, i32> {ADF.data_access = "window", ADF.blk_form = "cacc", ADF.blk_unit = 48})

    ADF.graph {
        %gi = ADF.create_ginp  [0:i1, 128:i32] -> !ADF.itf<i1, i32> 
        ...
        %go = ADF.create_gout %4 : (!ADF.itf<i1, i32>) 
                                 -> !ADF.itf<i1, i32>                                            
    } {graph_name = "simpleWindow", graph_input_name = "gin", graph_output_name = "gout"} 
}
