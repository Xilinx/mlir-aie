...
module {
  aie.device(npu1_1col) {
    ...
    aie.runtime_sequence @sequence(%arg0: memref<4096xi16>, %arg1: memref<1xi32>, %arg2: memref<4096xi16>) {
      ...
      %w32_addr_7 = arith.constant 82128 : i32
      %w32_val_7 = arith.constant 2038038528 : i32
      aiex.npu.write32(%w32_addr_7, %w32_val_7) {column = 0 : i32, row = 2 : i32} : i32, i32
      %w32_addr_8 = arith.constant 82132 : i32
      %w32_val_8 = arith.constant 4098 : i32
      aiex.npu.write32(%w32_addr_8, %w32_val_8) {column = 0 : i32, row = 2 : i32} : i32, i32
      %w32_addr_9 = arith.constant 82144 : i32
      %w32_val_9 = arith.constant 370414941 : i32
      aiex.npu.write32(%w32_addr_9, %w32_val_9) {column = 0 : i32, row = 2 : i32} : i32, i32
      %w32_addr_10 = arith.constant 82148 : i32
      %w32_val_10 = arith.constant 808266042 : i32
      aiex.npu.write32(%w32_addr_10, %w32_val_10) {column = 0 : i32, row = 2 : i32} : i32, i32
      %w32_addr_11 = arith.constant 81920 : i32
      %w32_val_11 = arith.constant 31232 : i32
      aiex.npu.write32(%w32_addr_11, %w32_val_11) {column = 0 : i32, row = 2 : i32} : i32, i32
      ...
      %w32_addr_12 = arith.constant 119308 : i32
      %w32_val_12 = arith.constant 15 : i32
      aiex.npu.write32(%w32_addr_12, %w32_val_12) {column = 0 : i32, row = 0 : i32} : i32, i32
      %w32_addr_13 = arith.constant 212992 : i32
      %w32_val_13 = arith.constant 32512 : i32
      aiex.npu.write32(%w32_addr_13, %w32_val_13) {column = 0 : i32, row = 0 : i32} : i32, i32
      %w32_addr_14 = arith.constant 213068 : i32
      %w32_val_14 = arith.constant 127 : i32
      aiex.npu.write32(%w32_addr_14, %w32_val_14) {column = 0 : i32, row = 0 : i32} : i32, i32
      %w32_addr_15 = arith.constant 213000 : i32
      %w32_val_15 = arith.constant 127 : i32
      aiex.npu.write32(%w32_addr_15, %w32_val_15) {column = 0 : i32, row = 0 : i32} : i32, i32
      ...
      %w32_addr_16 = arith.constant 213064 : i32
      %w32_val_16 = arith.constant 126 : i32
      aiex.npu.write32(%w32_addr_16, %w32_val_16) {column = 0 : i32, row = 0 : i32} : i32, i32
      %w32_addr_17 = arith.constant 213000 : i32
      %w32_val_17 = arith.constant 126 : i32
      aiex.npu.write32(%w32_addr_17, %w32_val_17) {column = 0 : i32, row = 0 : i32} : i32, i32
    }
  }
}
