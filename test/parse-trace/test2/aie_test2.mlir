  ...
  aie.device(npu1_1col) {
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        %1 = aie.objectfifo.acquire @infactor(Consume, 1) : memref<1xi32>
        %c0_0 = arith.constant 0 : index
        %c4 = arith.constant 4 : index
        %c1_1 = arith.constant 1 : index
        scf.for %arg1 = %c0_0 to %c4 step %c1_1 {
          %3 = aie.objectfifo.acquire @out(Produce, 1) : memref<1024xi16>
          %5 = aie.objectfifo.acquire @in(Consume, 1) : memref<1024xi16>
          %c1024_i32 = arith.constant 1024 : i32
          func.call @vector_scalar_mul_vector(%5, %3, %1, %c1024_i32) : (memref<1024xi16>, memref<1024xi16>, memref<1xi32>, i32) -> ()
    ...
    aie.runtime_sequence @sequence(%arg0: memref<4096xi16>, %arg1: memref<1xi32>, %arg2: memref<4096xi16>) {
      ...
      %cst_npu_14 = arith.constant 82128 : i32
      %cst_npu_15 = arith.constant 2038038528 : i32
      aiex.npu.write32(%cst_npu_14, %cst_npu_15) {column = 0 : i32, row = 2 : i32} : i32, i32
      %cst_npu_16 = arith.constant 82132 : i32
      %cst_npu_17 = arith.constant 4098 : i32
      aiex.npu.write32(%cst_npu_16, %cst_npu_17) {column = 0 : i32, row = 2 : i32} : i32, i32
      %cst_npu_18 = arith.constant 82144 : i32
      %cst_npu_19 = arith.constant 370414941 : i32
      aiex.npu.write32(%cst_npu_18, %cst_npu_19) {column = 0 : i32, row = 2 : i32} : i32, i32
      %cst_npu_20 = arith.constant 82148 : i32
      %cst_npu_21 = arith.constant 808266042 : i32
      aiex.npu.write32(%cst_npu_20, %cst_npu_21) {column = 0 : i32, row = 2 : i32} : i32, i32
      %cst_npu_22 = arith.constant 81920 : i32
      %cst_npu_23 = arith.constant 31232 : i32
      aiex.npu.write32(%cst_npu_22, %cst_npu_23) {column = 0 : i32, row = 2 : i32} : i32, i32
      ...
      aiex.npu.address_patch(%cst_npu_24 : i32) {addr = 119268 : ui32, arg_idx = 4 : i32}
      %cst_npu_25 = arith.constant 119308 : i32
      %cst_npu_26 = arith.constant 15 : i32
      aiex.npu.write32(%cst_npu_25, %cst_npu_26) {column = 0 : i32, row = 0 : i32} : i32, i32
      %cst_npu_27 = arith.constant 212992 : i32
      %cst_npu_28 = arith.constant 32512 : i32
      aiex.npu.write32(%cst_npu_27, %cst_npu_28) {column = 0 : i32, row = 0 : i32} : i32, i32
      %cst_npu_29 = arith.constant 213068 : i32
      %cst_npu_30 = arith.constant 127 : i32
      aiex.npu.write32(%cst_npu_29, %cst_npu_30) {column = 0 : i32, row = 0 : i32} : i32, i32
      %cst_npu_31 = arith.constant 213000 : i32
      ...
      %0 = aiex.dma_configure_task_for @in {
        aie.dma_bd(%arg0 : memref<4096xi16> offset = 0 len = 4096 sizes = [1, 1, 4096] strides = [0, 0, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      %1 = aiex.dma_configure_task_for @infactor {
        aie.dma_bd(%arg1 : memref<1xi32> offset = 0 len = 1 sizes = [1, 1, 1] strides = [0, 0, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      %2 = aiex.dma_configure_task_for @out {
        aie.dma_bd(%arg2 : memref<4096xi16> offset = 0 len = 4096 sizes = [1, 1, 4096] strides = [0, 0, 1]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      ...
      %cst_npu_33 = arith.constant 213064 : i32
      %cst_npu_34 = arith.constant 126 : i32
      aiex.npu.write32(%cst_npu_33, %cst_npu_34) {column = 0 : i32, row = 0 : i32} : i32, i32
      %cst_npu_35 = arith.constant 213000 : i32
      %cst_npu_36 = arith.constant 126 : i32
      aiex.npu.write32(%cst_npu_35, %cst_npu_36) {column = 0 : i32, row = 0 : i32} : i32, i32
    }
  }
}
