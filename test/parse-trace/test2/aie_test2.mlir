...
module {
  aie.device(npu1_1col) {
    ...
    aiex.runtime_sequence @sequence(%arg0: memref<4096xi16>, %arg1: memref<1xi32>, %arg2: memref<4096xi16>) {
      ...
      aiex.npu.write32 {address = 213220 : ui32, column = 0 : i32, row = 2 : i32, value = 556608591 : ui32}
      ...
      aiex.npu.write32 {address = 82132 : ui32, column = 0 : i32, row = 2 : i32, value = 4098 : ui32}
      aiex.npu.write32 {address = 82144 : ui32, column = 0 : i32, row = 2 : i32, value = 370414941 : ui32}
      aiex.npu.write32 {address = 82148 : ui32, column = 0 : i32, row = 2 : i32, value = 808266042 : ui32}
