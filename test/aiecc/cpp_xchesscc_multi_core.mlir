//===- cpp_xchesscc_multi_core.mlir -----------------------------*- MLIR -*-===//
//
...
module {
  aie.device(npu1_1col) {
    ...
    aie.objectfifo @of_mid(%tile_0_2, {%tile_0_3}, 2 : i32) : !aie.objectfifo<memref<16xi32>>
    aie.objectfifo @of_out(%tile_0_3, {%tile_0_0}, 2 : i32) : !aie.objectfifo<memref<16xi32>>

    // Core 1: Add 1 to each element
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      %subview_out = aie.objectfifo.acquire @of_mid(Produce, 1) : !aie.objectfifosubview<memref<16xi32>>
      ...
      aie.objectfifo.release @of_mid(Produce, 1)
      aie.end
    }

    // Core 2: Multiply by 2
    %core_0_3 = aie.core(%tile_0_3) {
      ...
      %subview_in = aie.objectfifo.acquire @of_mid(Consume, 1) : !aie.objectfifosubview<memref<16xi32>>
      %elem_in = aie.objectfifo.subview.access %subview_in[0] : !aie.objectfifosubview<memref<16xi32>> -> memref<16xi32>
      ...
      scf.for %i = %c0 to %c16 step %c1 {
        %val = memref.load %elem_in[%i] : memref<16xi32>
        %result = arith.muli %val, %c2_i32 : i32
        memref.store %result, %elem_out[%i] : memref<16xi32>
      }

      aie.objectfifo.release @of_mid(Consume, 1)
