...
module {
  aie.device(npu1_2col) @device1 {
    ...
    %core = aie.core(%tile02) {
      %input = aie.objectfifo.acquire @in1(Consume) : memref<16xi32>
      %output = aie.objectfifo.acquire @out1(Produce) : memref<16xi32>
  ...
  aie.device(npu1_2col) @device2 {
    ...
    %core = aie.core(%tile12) {
      %input = aie.objectfifo.acquire @in2(Consume) : memref<16xi32>
      %output = aie.objectfifo.acquire @out2(Produce) : memref<16xi32>
