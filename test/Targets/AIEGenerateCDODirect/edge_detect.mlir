...
module {
  aie.device(ipu) {
    ...
    func.func @sequence(%arg0: memref<2073600xi32>, %arg1: memref<16x16xi32>, %arg2: memref<2073600xi32>) {
      aiex.ipu.dma_memcpy_nd(%outOF_L2L3, %arg2[0, 0, 0, 0][1, 1, 1, 2073600][0, 0, 0]) {bd_id = 0 : i64} : memref<2073600xi32>
      aiex.ipu.dma_memcpy_nd(%inOF_L3L2, %arg0[0, 0, 0, 0][1, 1, 1, 2073600][0, 0, 0]) {bd_id = 1 : i64} : memref<2073600xi32>
