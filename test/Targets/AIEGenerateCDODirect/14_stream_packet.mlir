...
module @test14_stream_packet {
  aie.device(ipu) {
    ...
    %tile_1_2_0 = aie.tile(1, 2)
    %switchbox_1_3 = aie.switchbox(%tile_1_3) {
      aie.connect<DMA : 0, South : 3>
    }
    %switchbox_1_2 = aie.switchbox(%tile_1_2_0) {
      aie.connect<DMA : 0, North : 1>
    }
    %switchbox_1_2_1 = aie.switchbox(%tile_1_2) {
      %0 = aie.amsel<1> (0)
    ...
    %buf73 = aie.buffer(%tile_1_3) {sym_name = "buf73"} : memref<256xi32>
    %buf71 = aie.buffer(%tile_1_2_0) {sym_name = "buf71"} : memref<256xi32>
    %lock73 = aie.lock(%tile_1_3, 0) {sym_name = "lock73"}
    %lock71 = aie.lock(%tile_1_2_0, 0) {sym_name = "lock71"}
