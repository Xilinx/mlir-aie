...
module {
  aie.device(ipu) {
    ...
    func.func @sequence(%arg0: memref<4096xi32>, %arg1: memref<4096xi32>, %arg2: memref<4096xi32>) {
      ...
      aiex.ipu.dma_memcpy_nd(%out, %arg2[%c0_i64, %c0_i64, %c0_i64, %c0_i64] [%c1_i64, %c1_i64, %c1_i64, %c4096_i64] [%c0_i64, %c0_i64, %c0_i64]) {bd_id = 0 : i64} : memref<4096xi32>
      aiex.ipu.dma_memcpy_nd(%in, %arg0[%c0_i64, %c0_i64, %c0_i64, %c0_i64] [%c1_i64, %c1_i64, %c1_i64, %c4096_i64] [%c0_i64, %c0_i64, %c0_i64]) {bd_id = 1 : i64} : memref<4096xi32>
