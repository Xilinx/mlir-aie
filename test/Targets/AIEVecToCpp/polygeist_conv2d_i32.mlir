// RUN: aie-opt --affine-loop-unroll="unroll-full unroll-full-threshold=3" --canonicalize --aie-affine-vectorize="virtual-vector-size=8 vectorize-reductions" | aie-translate --aievec-to-cpp > %t.cpp
