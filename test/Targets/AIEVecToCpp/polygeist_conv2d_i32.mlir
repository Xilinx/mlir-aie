...
//
//===----------------------------------------------------------------------===//
// RUN: aie-opt -pass-pipeline="builtin.module(func.func(affine-loop-unroll{unroll-full=true unroll-full-threshold=3}), canonicalize, affine-super-vectorize{virtual-vector-size=8 vectorize-reductions}, aie-vectorize)" | aie-translate --aievec-to-cpp > %t.cpp
