...
func.func @conv2d_0(%arg0: memref<2048x2048xi32>, %arg1: memref<9xi32>, %arg2: memref<2046x2046xi32>) {
  ...
  %0 = aievec_aie1.upd %arg1[%c0] {index = 0 : i8, offset = 0 : i32} : memref<9xi32>, vector<8xi32>
  %1 = aievec_aie1.upd %arg1[%c8] {index = 0 : i8, offset = 0 : i32} : memref<9xi32>, vector<8xi32>
  ...
  scf.for %arg3 = %c0_0 to %c2046 step %c1 {
    ...
    scf.for %arg4 = %c0_2 to %c2046_3 step %c8_4 {
      %4 = aievec_aie1.upd %arg2[%arg3, %arg4] {index = 0 : i8, offset = 0 : i32} : memref<2046x2046xi32>, vector<8xi32>
      %5 = aievec_aie1.upd %arg0[%arg3, %arg4] {index = 0 : i8, offset = 0 : i32} : memref<2048x2048xi32>, vector<16xi32>
      ...
      %9 = aievec_aie1.upd %arg0[%arg3, %8], %5 {index = 1 : i8, offset = 224 : i32} : memref<2048x2048xi32>, vector<16xi32>
      ...
      %12 = aievec_aie1.upd %arg0[%2, %arg4] {index = 0 : i8, offset = 0 : i32} : memref<2048x2048xi32>, vector<16xi32>
      ...
      %14 = aievec_aie1.upd %arg0[%2, %8], %12 {index = 1 : i8, offset = 224 : i32} : memref<2048x2048xi32>, vector<16xi32>
      ...
      %17 = aievec_aie1.upd %arg0[%3, %arg4] {index = 0 : i8, offset = 0 : i32} : memref<2048x2048xi32>, vector<16xi32>
      ...
      %19 = aievec_aie1.upd %arg0[%3, %8], %17 {index = 1 : i8, offset = 224 : i32} : memref<2048x2048xi32>, vector<16xi32>
...
func.func @conv2d_1(%arg0: memref<?x?xi32>, %arg1: memref<?xi32>, %arg2: memref<?x?xi32>, %arg3: index, %arg4: index) {
  ...
  %c0 = arith.constant 0 : index
  %c0_i32 = arith.constant 0 : i32
  %0 = aievec_aie1.upd %arg1[%c0] {index = 0 : i8, offset = 0 : i32} : memref<?xi32>, vector<8xi32>
  %1 = aievec_aie1.upd %arg1[%c8] {index = 0 : i8, offset = 0 : i32} : memref<?xi32>, vector<8xi32>
  %c0_0 = arith.constant 0 : index
  %c1 = arith.constant 1 : index
  scf.for %arg5 = %c0_0 to %arg3 step %c1 {
    ...
    scf.for %arg6 = %c0_2 to %arg4 step %c8_3 {
      %4 = aievec_aie1.upd %arg2[%arg5, %arg6] {index = 0 : i8, offset = 0 : i32} : memref<?x?xi32>, vector<8xi32>
      %5 = aievec_aie1.upd %arg0[%arg5, %arg6] {index = 0 : i8, offset = 0 : i32} : memref<?x?xi32>, vector<16xi32>
      %6 = aievec.ups %4 {shift = 0 : i8} : vector<8xi32>, vector<8xi80>
      %7 = aievec_aie1.mac %5, %0, %6 {xoffsets = "0x76543210", xstart = "0", zoffsets = "0x00000000", zstart = "0"} : vector<16xi32>, vector<8xi32>, vector<8xi80>
      %c1_4 = arith.constant 1 : index
      %8 = arith.addi %arg6, %c1_4 : index
      %9 = aievec_aie1.upd %arg0[%arg5, %8], %5 {index = 1 : i8, offset = 224 : i32} : memref<?x?xi32>, vector<16xi32>
      %10 = aievec_aie1.mac %9, %0, %7 {xoffsets = "0x76543210", xstart = "1", zoffsets = "0x00000000", zstart = "1"} : vector<16xi32>, vector<8xi32>, vector<8xi80>
      %11 = aievec_aie1.mac %9, %0, %10 {xoffsets = "0x76543210", xstart = "2", zoffsets = "0x00000000", zstart = "2"} : vector<16xi32>, vector<8xi32>, vector<8xi80>
      %12 = aievec_aie1.upd %arg0[%2, %arg6] {index = 0 : i8, offset = 0 : i32} : memref<?x?xi32>, vector<16xi32>
      %13 = aievec_aie1.mac %12, %0, %11 {xoffsets = "0x76543210", xstart = "0", zoffsets = "0x00000000", zstart = "3"} : vector<16xi32>, vector<8xi32>, vector<8xi80>
      %14 = aievec_aie1.upd %arg0[%2, %8], %12 {index = 1 : i8, offset = 224 : i32} : memref<?x?xi32>, vector<16xi32>
      %15 = aievec_aie1.mac %14, %0, %13 {xoffsets = "0x76543210", xstart = "1", zoffsets = "0x00000000", zstart = "4"} : vector<16xi32>, vector<8xi32>, vector<8xi80>
      %16 = aievec_aie1.mac %14, %0, %15 {xoffsets = "0x76543210", xstart = "2", zoffsets = "0x00000000", zstart = "5"} : vector<16xi32>, vector<8xi32>, vector<8xi80>
      %17 = aievec_aie1.upd %arg0[%3, %arg6] {index = 0 : i8, offset = 0 : i32} : memref<?x?xi32>, vector<16xi32>
      %18 = aievec_aie1.mac %17, %0, %16 {xoffsets = "0x76543210", xstart = "0", zoffsets = "0x00000000", zstart = "6"} : vector<16xi32>, vector<8xi32>, vector<8xi80>
      %19 = aievec_aie1.upd %arg0[%3, %8], %17 {index = 1 : i8, offset = 224 : i32} : memref<?x?xi32>, vector<16xi32>
      %20 = aievec_aie1.mac %19, %0, %18 {xoffsets = "0x76543210", xstart = "1", zoffsets = "0x00000000", zstart = "7"} : vector<16xi32>, vector<8xi32>, vector<8xi80>
      %21 = aievec_aie1.mac %19, %1, %20 {xoffsets = "0x76543210", xstart = "2", zoffsets = "0x00000000", zstart = "0"} : vector<16xi32>, vector<8xi32>, vector<8xi80>
      %22 = aievec.srs %21, %c0_i32 : vector<8xi80>, i32, vector<8xi32>
...
func.func @conv2d_2(%arg0: memref<?x?xi32>, %arg1: memref<?xi32>, %arg2: memref<?x?xi32>) {
  ...
  %2 = aievec_aie1.upd %arg1[%c0] {index = 0 : i8, offset = 0 : i32} : memref<?xi32>, vector<8xi32>
  %3 = aievec_aie1.upd %arg1[%c8] {index = 0 : i8, offset = 0 : i32} : memref<?xi32>, vector<8xi32>
  %c0_0 = arith.constant 0 : index
  %c1_1 = arith.constant 1 : index
  scf.for %arg3 = %c0_0 to %0 step %c1_1 {
    ...
    scf.for %arg4 = %c0_3 to %1 step %c8_4 {
      %6 = aievec_aie1.upd %arg2[%arg3, %arg4] {index = 0 : i8, offset = 0 : i32} : memref<?x?xi32>, vector<8xi32>
      %7 = aievec_aie1.upd %arg0[%arg3, %arg4] {index = 0 : i8, offset = 0 : i32} : memref<?x?xi32>, vector<16xi32>
      ...
      %11 = aievec_aie1.upd %arg0[%arg3, %10], %7 {index = 1 : i8, offset = 224 : i32} : memref<?x?xi32>, vector<16xi32>
      ...
      %14 = aievec_aie1.upd %arg0[%4, %arg4] {index = 0 : i8, offset = 0 : i32} : memref<?x?xi32>, vector<16xi32>
      ...
      %16 = aievec_aie1.upd %arg0[%4, %10], %14 {index = 1 : i8, offset = 224 : i32} : memref<?x?xi32>, vector<16xi32>
      ...
      %19 = aievec_aie1.upd %arg0[%5, %arg4] {index = 0 : i8, offset = 0 : i32} : memref<?x?xi32>, vector<16xi32>
      ...
      %21 = aievec_aie1.upd %arg0[%5, %10], %19 {index = 1 : i8, offset = 224 : i32} : memref<?x?xi32>, vector<16xi32>
...
func.func @conv2d_3(%arg0: memref<?x256xi32>, %arg1: memref<?xi32>, %arg2: memref<?x256xi32>) {
  ...
  %1 = aievec_aie1.upd %arg1[%c0] {index = 0 : i8, offset = 0 : i32} : memref<?xi32>, vector<8xi32>
  %2 = aievec_aie1.upd %arg1[%c8] {index = 0 : i8, offset = 0 : i32} : memref<?xi32>, vector<8xi32>
  %c0_0 = arith.constant 0 : index
  %c1 = arith.constant 1 : index
  scf.for %arg3 = %c0_0 to %0 step %c1 {
    ...
    scf.for %arg4 = %c0_2 to %c256 step %c8_3 {
      %5 = aievec_aie1.upd %arg2[%arg3, %arg4] {index = 0 : i8, offset = 0 : i32} : memref<?x256xi32>, vector<8xi32>
      %6 = aievec_aie1.upd %arg0[%arg3, %arg4] {index = 0 : i8, offset = 0 : i32} : memref<?x256xi32>, vector<16xi32>
      ...
      %10 = aievec_aie1.upd %arg0[%arg3, %9], %6 {index = 1 : i8, offset = 224 : i32} : memref<?x256xi32>, vector<16xi32>
      ...
      %13 = aievec_aie1.upd %arg0[%3, %arg4] {index = 0 : i8, offset = 0 : i32} : memref<?x256xi32>, vector<16xi32>
      ...
      %15 = aievec_aie1.upd %arg0[%3, %9], %13 {index = 1 : i8, offset = 224 : i32} : memref<?x256xi32>, vector<16xi32>
      ...
      %18 = aievec_aie1.upd %arg0[%4, %arg4] {index = 0 : i8, offset = 0 : i32} : memref<?x256xi32>, vector<16xi32>
      ...
      %20 = aievec_aie1.upd %arg0[%4, %9], %18 {index = 1 : i8, offset = 224 : i32} : memref<?x256xi32>, vector<16xi32>
