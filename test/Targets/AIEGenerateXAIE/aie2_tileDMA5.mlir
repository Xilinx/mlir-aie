...
module @aie_module {
  aie.device(xcve2802) {
    ...
    ^bb1:  // pred: ^bb0
      ...
      aie.use_lock(%lock_7_3, AcquireGreaterEqual, %c1_ul1)
      aie.dma_bd(%buf7 : memref<5xi32, 1 : i32> offset = 0 len = 5)
      %c1_ul2 = arith.constant 1 : i32
      aie.use_lock(%lock_7_3_0, Release, %c1_ul2)
      aie.next_bd ^bb4
    ^bb2:  // pred: ^bb0
      %1 = aie.dma_start(S2MM, 0, ^bb3, ^bb7, repeat_count = 7)
    ^bb3:  // pred: ^bb2
      %c1_ul3 = arith.constant 1 : i32
      aie.use_lock(%lock_7_3, AcquireGreaterEqual, %c1_ul3)
      aie.dma_bd(%buf8 : memref<12xi32, 1 : i32> offset = 0 len = 12)
      %c1_ul4 = arith.constant 1 : i32
      aie.use_lock(%lock_7_3_0, Release, %c1_ul4)
      aie.next_bd ^bb4
    ...
    ^bb6:  // pred: ^bb5
      ...
      aie.use_lock(%lock_7_3_0, AcquireGreaterEqual, %c1_ul5)
      aie.dma_bd(%buf8 : memref<12xi32, 1 : i32> offset = 0 len = 12)
      %c1_ul6 = arith.constant 1 : i32
      aie.use_lock(%lock_7_3, Release, %c1_ul6)
      aie.next_bd ^bb4
    ^bb7:  // pred: ^bb2
      %3 = aie.dma_start(MM2S, 0, ^bb8, ^bb5)
    ^bb8:  // pred: ^bb7
      %c1_ul7 = arith.constant 1 : i32
      aie.use_lock(%lock_7_3_0, AcquireGreaterEqual, %c1_ul7)
      aie.dma_bd(%buf7 : memref<5xi32, 1 : i32> offset = 0 len = 5)
      %c1_ul8 = arith.constant 1 : i32
      aie.use_lock(%lock_7_3, Release, %c1_ul8)
      aie.next_bd ^bb4
    }
  }
}
