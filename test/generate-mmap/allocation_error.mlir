...
// REQUIRES: peano
// RUN: not aiecc.py --alloc-scheme=basic-sequential --no-xchesscc --no-xbridge
// %s 2>&1 | FileCheck %s --check-prefix=PEANO PEANO: ld.lld: error: section
// '.bss' will not fit in region 'data': overflowed by 4 bytes
