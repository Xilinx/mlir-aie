...
// The core_data buffer covers the *smaller* gap. A generator that recomputed the region
// would emit ORIGIN = 0x74000, LENGTH = 0x4000; the buffer gives
...
// LD02-NEXT:    bank0 (!RX) : ORIGIN = 0x70000, LENGTH = 0x0
...
module @test_mmap_data_region_record {
 aie.device(npu1_1col) {
  ...
  %core_data = aie.buffer(%t02) { sym_name = "core_data", address = 1024 : i32, core_data } : memref<7168xi8>
