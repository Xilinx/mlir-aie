...
// LD44-NEXT:    bank0 (!RX) : ORIGIN = 0x28000, LENGTH = 0x0
// LD44-NEXT:    bank1 (!RX) : ORIGIN = 0x2A000, LENGTH = 0x0
// LD44-NEXT:    bank2 (!RX) : ORIGIN = 0x2C000, LENGTH = 0x0
// LD44-NEXT:    bank3 (!RX) : ORIGIN = 0x2E000, LENGTH = 0x0
// LD44-NEXT: }
