  ...
  aie.device(npu1) {
    ...
    aie.runtime_sequence(%arg0: memref<32xi8>) {
      %t1 = "aiex.dma_configure_task"(%tile_0_0) <{channel = 0 : i32, direction = 1 : i32}> ({
        ...
        "aie.dma_bd"(%arg0) <{bd_id = 0 : i32, operandSegmentSizes = array<i32: 1, 0, 0, 0, 0, 0, 0, 0>, static_len = 32 : i32, static_offset = 4 : i32, static_sizes = array<i64: 8, 2>, static_strides = array<i64: 1>}> : (memref<32xi8>) -> ()
        aie.end
      }) : (index) -> index
    }
  }
