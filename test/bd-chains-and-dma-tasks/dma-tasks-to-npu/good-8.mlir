  ...
  aie.device(npu1) {
    ...
    aie.runtime_sequence(%arg0: memref<32xi8>) {
      ...
      %t1 = aiex.dma_configure_task(%tile_0_1, MM2S, 0) {
          aie.dma_bd(%buf : memref<32xi8> offset = %c4_i32 len = %c16_i32 sizes = [2, 2, 4] strides = [4, 8, 1] pad [<const_pad_before=2, const_pad_after=1>, <const_pad_before=2, const_pad_after=2>, <const_pad_before=1, const_pad_after=1>]) {bd_id = 0 : i32}
          aie.end
      }
    }
  }
