...
module {
  aie.device(npu1) {
    ...
    aie.runtime_sequence(%arg0: memref<8xi16>, %arg1: memref<10xi32>) {
      ...
      // CHECK: %[[AP1:.+]] = arith.constant 8 : i32
      // CHECK: aiex.npu.address_patch(%[[AP1]] : i32) {addr = 118820 : ui32, arg_idx = 1 : i32}
      ...
      // CHECK: %[[AP2:.+]] = arith.constant 4 : i32
      // CHECK: aiex.npu.address_patch(%[[AP2]] : i32) {addr = 118852 : ui32, arg_idx = 0 : i32}
