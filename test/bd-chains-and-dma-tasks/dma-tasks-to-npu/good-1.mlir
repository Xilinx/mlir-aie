...
module {
  aie.device(npu1) {
    ...
    aie.runtime_sequence(%arg0: memref<8xi16>, %arg1: memref<10xi32>) {
      ...
      // CHECK: aiex.npu.address_patch(%[[AP0]] : i32) {addr = 119012 : ui32, arg_idx = 0 : i32}
      ...
      // CHECK: %[[AP1:.+]] = arith.constant 0 : i32
      // CHECK: aiex.npu.address_patch(%[[AP1]] : i32) {addr = 67227908 : ui32, arg_idx = 1 : i32}
