  ...
  aie.device(npu2) {
    ...
    aie.runtime_sequence(%buf_a: memref<40960xbf16>, %buf_b: memref<40960xbf16>) {
      ...
      %t0 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        aie.dma_bd(%buf_a : memref<40960xbf16> offset = 0 len = 4096)
        aie.end
      }
      ...
      %t1 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        aie.dma_bd(%buf_b : memref<40960xbf16> offset = 0 len = 4096)
        aie.end
      }
      ...
      %t2 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        aie.dma_bd(%buf_a : memref<40960xbf16> offset = 4096 len = 4096)
        aie.end
      }
      ...
      %t3 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        aie.dma_bd(%buf_b : memref<40960xbf16> offset = 4096 len = 4096)
        aie.end
      }
      ...
      %t4 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        aie.dma_bd(%buf_a : memref<40960xbf16> offset = 8192 len = 4096)
        aie.end
      }
      ...
      %t5 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        aie.dma_bd(%buf_b : memref<40960xbf16> offset = 8192 len = 4096)
        aie.end
      }
      ...
      %t6 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        aie.dma_bd(%buf_a : memref<40960xbf16> offset = 12288 len = 4096)
        aie.end
      }
      ...
      %t7 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        aie.dma_bd(%buf_b : memref<40960xbf16> offset = 12288 len = 4096)
        aie.end
      }
      ...
      %t8 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        aie.dma_bd(%buf_a : memref<40960xbf16> offset = 16384 len = 4096)
        aie.end
      }
      ...
      %t10 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        aie.dma_bd(%buf_a : memref<40960xbf16> offset = 20480 len = 4096)
        aie.end
      }
      ...
      %t11 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        aie.dma_bd(%buf_b : memref<40960xbf16> offset = 20480 len = 4096)
        aie.end
      }
      ...
      %t12 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        aie.dma_bd(%buf_a : memref<40960xbf16> offset = 24576 len = 4096)
        aie.end
      }
      ...
      %t13 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        aie.dma_bd(%buf_b : memref<40960xbf16> offset = 24576 len = 4096)
        aie.end
      }
      ...
      %t14 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        aie.dma_bd(%buf_a : memref<40960xbf16> offset = 28672 len = 4096)
        aie.end
      }
      ...
      %t15 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        aie.dma_bd(%buf_b : memref<40960xbf16> offset = 28672 len = 4096)
        aie.end
      }
      ...
      %t16 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        aie.dma_bd(%buf_a : memref<40960xbf16> offset = 32768 len = 4096)
        aie.end
      }
      ...
      %t17 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        aie.dma_bd(%buf_b : memref<40960xbf16> offset = 32768 len = 4096)
        aie.end
      }
      ...
      %t18 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        aie.dma_bd(%buf_a : memref<40960xbf16> offset = 36864 len = 4096)
        aie.end
      }
