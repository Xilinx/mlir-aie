  ...
  aie.device(npu1) {
    ...
    aie.runtime_sequence(%arg0: memref<8xi16>) {
      ...
      %t7 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        // CHECK:   aie.dma_bd(%arg0 : memref<8xi16> offset = {{.*}} len = {{.*}}) {bd_id = 6 : i32}
        aie.dma_bd(%arg0 : memref<8xi16> offset = 0 len = 8)
        aie.end
      }
      ...
      %t9 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        // CHECK:   aie.dma_bd(%arg0 : memref<8xi16> offset = {{.*}} len = {{.*}}) {bd_id = 8 : i32}
        aie.dma_bd(%arg0 : memref<8xi16> offset = 0 len = 8)
        aie.end
      }
      %t10 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        // CHECK:   aie.dma_bd(%arg0 : memref<8xi16> offset = {{.*}} len = {{.*}}) {bd_id = 9 : i32}
        aie.dma_bd(%arg0 : memref<8xi16> offset = 0 len = 8)
        aie.end
      }
      %t11 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        // CHECK:   aie.dma_bd(%arg0 : memref<8xi16> offset = {{.*}} len = {{.*}}) {bd_id = 10 : i32}
        aie.dma_bd(%arg0 : memref<8xi16> offset = 0 len = 8)
        aie.end
      }
      %t12 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        // CHECK:   aie.dma_bd(%arg0 : memref<8xi16> offset = {{.*}} len = {{.*}}) {bd_id = 11 : i32}
        aie.dma_bd(%arg0 : memref<8xi16> offset = 0 len = 8)
        aie.end
      }
      %t13 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        // CHECK:   aie.dma_bd(%arg0 : memref<8xi16> offset = {{.*}} len = {{.*}}) {bd_id = 12 : i32}
        aie.dma_bd(%arg0 : memref<8xi16> offset = 0 len = 8)
        aie.end
      }
      %t14 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        // CHECK:   aie.dma_bd(%arg0 : memref<8xi16> offset = {{.*}} len = {{.*}}) {bd_id = 13 : i32}
        aie.dma_bd(%arg0 : memref<8xi16> offset = 0 len = 8)
        aie.end
      }
      %t15 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        // CHECK:   aie.dma_bd(%arg0 : memref<8xi16> offset = {{.*}} len = {{.*}}) {bd_id = 14 : i32}
        aie.dma_bd(%arg0 : memref<8xi16> offset = 0 len = 8)
        aie.end
      }
      %t16 = aiex.dma_configure_task(%tile_0_0, MM2S, 0) {
        // CHECK:   aie.dma_bd(%arg0 : memref<8xi16> offset = {{.*}} len = {{.*}}) {bd_id = 15 : i32}
        aie.dma_bd(%arg0 : memref<8xi16> offset = 0 len = 8)
        aie.end
      }
    }
