...
module {
  aie.device(npu1) {
    ...
    aie.shim_dma_allocation @alloc1 (%tile_2_0, MM2S, 1)
    ...
    aie.runtime_sequence(%arg0: memref<8xi16>, %arg1: memref<12xi16>, %arg2: memref<8xi16>) {
      ...
      // CHECK:   aie.dma_bd(%arg0 : memref<8xi16> offset = 0 len = 8 sizes = [1, 2, 2, 2] strides = [0, 2, 4, 1])
      // CHECK:   aie.next_bd ^bb1
      // CHECK: ^bb1:
      // CHECK:   aie.dma_bd(%arg1 : memref<12xi16> offset = 0 len = 12 sizes = [] strides = [])
      // CHECK:   aie.next_bd ^bb2
      // CHECK: ^bb2:
      // CHECK:   aie.dma_bd(%arg2 : memref<8xi16> offset = 0 len = 8 sizes = [] strides = [])
      // CHECK:   aie.end
      // CHECK: }
      ...
      // CHECK:   aie.dma_bd(%arg2 : memref<8xi16> offset = 0 len = 8 sizes = [1, 2, 2, 2] strides = [0, 2, 4, 1])
      // CHECK:   aie.next_bd ^bb1
      // CHECK: ^bb1:
      // CHECK:   aie.dma_bd(%arg1 : memref<12xi16> offset = 0 len = 12 sizes = [] strides = [])
      // CHECK:   aie.next_bd ^bb2
      // CHECK: ^bb2:
      // CHECK:   aie.dma_bd(%arg0 : memref<8xi16> offset = 0 len = 8 sizes = [] strides = [])
      // CHECK:   aie.end
      // CHECK: }
