...
module {
  aie.device(npu1) {
    ...
    aie.bd_chain @simple_chain(%arg0: memref<8xi16>, %arg1: memref<12xi16>) {
            aie.dma_bd(%arg0 : memref<8xi16> offset = 0 len = 8) {packet = #aie.packet_info<pkt_type = 1, pkt_id = 1>}
            aie.next_bd ^bd1
        ^bd1:
            aie.dma_bd(%arg1 : memref<12xi16> offset = 0 len = 12) {packet = #aie.packet_info<pkt_type = 1, pkt_id = 2>}
            aie.end
    }
