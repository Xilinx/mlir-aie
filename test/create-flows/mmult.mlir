...
module @aie.herd_0  {
  aie.device(xcvc1902) {
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.dma_bd(%10 : memref<16x16xf32, 2> offset = 0 len = 256 sizes = [] strides = [])
      aie.use_lock(%9, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%4, Acquire, 0)
      aie.dma_bd(%6 : memref<16x16xf32, 2> offset = 0 len = 256 sizes = [] strides = [])
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.dma_bd(%8 : memref<16x16xf32, 2> offset = 0 len = 256 sizes = [] strides = [])
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.dma_bd(%24 : memref<16x16xf32, 2> offset = 0 len = 256 sizes = [] strides = [])
      aie.use_lock(%23, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%18, Acquire, 0)
      aie.dma_bd(%20 : memref<16x16xf32, 2> offset = 0 len = 256 sizes = [] strides = [])
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.dma_bd(%22 : memref<16x16xf32, 2> offset = 0 len = 256 sizes = [] strides = [])
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.dma_bd(%38 : memref<16x16xf32, 2> offset = 0 len = 256 sizes = [] strides = [])
      aie.use_lock(%37, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%32, Acquire, 0)
      aie.dma_bd(%34 : memref<16x16xf32, 2> offset = 0 len = 256 sizes = [] strides = [])
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.dma_bd(%36 : memref<16x16xf32, 2> offset = 0 len = 256 sizes = [] strides = [])
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.dma_bd(%52 : memref<16x16xf32, 2> offset = 0 len = 256 sizes = [] strides = [])
      aie.use_lock(%51, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%46, Acquire, 0)
      aie.dma_bd(%48 : memref<16x16xf32, 2> offset = 0 len = 256 sizes = [] strides = [])
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.dma_bd(%50 : memref<16x16xf32, 2> offset = 0 len = 256 sizes = [] strides = [])
