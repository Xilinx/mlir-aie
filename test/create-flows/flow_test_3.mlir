...
//CHECK-DAG: AIE.flow(%[[t01]], Core : 0, %[[t83]], Core : 0)
//CHECK-DAG: AIE.flow(%[[t01]], Core : 1, %[[t72]], Core : 1)
//CHECK-DAG: AIE.flow(%[[t02]], Core : 1, %[[t24]], Core : 1)
//CHECK-DAG: AIE.flow(%[[t03]], Core : 0, %[[t71]], Core : 0)
//CHECK-DAG: AIE.flow(%[[t11]], Core : 0, %[[t24]], Core : 0)
//CHECK-DAG: AIE.flow(%[[t14]], Core : 0, %[[t01]], Core : 0)
//CHECK-DAG: AIE.flow(%[[t20]], DMA : 0, %[[t03]], DMA : 0)
//CHECK-DAG: AIE.flow(%[[t20]], DMA : 1, %[[t83]], DMA : 1)
//CHECK-DAG: AIE.flow(%[[t21]], Core : 0, %[[t73]], Core : 0)
//CHECK-DAG: AIE.flow(%[[t24]], Core : 1, %[[t71]], Core : 1)
//CHECK-DAG: AIE.flow(%[[t24]], DMA : 0, %[[t20]], DMA : 0)
//CHECK-DAG: AIE.flow(%[[t30]], DMA : 0, %[[t14]], DMA : 0)
//CHECK-DAG: AIE.flow(%[[t71]], Core : 0, %[[t84]], Core : 0)
//CHECK-DAG: AIE.flow(%[[t71]], Core : 1, %[[t84]], Core : 1)
//CHECK-DAG: AIE.flow(%[[t72]], Core : 1, %[[t02]], Core : 1)
//CHECK-DAG: AIE.flow(%[[t73]], Core : 0, %[[t82]], Core : 0)
//CHECK-DAG: AIE.flow(%[[t82]], DMA : 0, %[[t30]], DMA : 0)
//CHECK-DAG: AIE.flow(%[[t83]], Core : 0, %[[t21]], Core : 0)
//CHECK-DAG: AIE.flow(%[[t83]], Core : 1, %[[t01]], Core : 1)
//CHECK-DAG: AIE.flow(%[[t84]], Core : 0, %[[t11]], Core : 0)
//CHECK-DAG: AIE.flow(%[[t84]], DMA : 1, %[[t20]], DMA : 1)
