...
// Destination tile: both id-0 streams arrive on separate North input ports and
// fan in to the single DMA : 3 endpoint.
...
// one South output port. No single amsel fans out to two ports.
...
// CHECK-DAG:    aie.masterset(North : {{[0-9]+}}, %[[a0]])
// CHECK-DAG:    aie.rule(31, 0, %[[a1]])
// CHECK-DAG:    aie.rule(31, 0, %[[a2]])
// CHECK-DAG:    aie.rule(31, 2, %[[a0]])
