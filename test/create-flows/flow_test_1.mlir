...
// CHECK-DAG: AIE.flow(%[[t20]], DMA : 0, %[[t63]], DMA : 0)
// CHECK-DAG: AIE.flow(%[[t20]], DMA : 1, %[[t83]], DMA : 0)
// CHECK-DAG: AIE.flow(%[[t30]], DMA : 0, %[[t72]], DMA : 0)
// CHECK-DAG: AIE.flow(%[[t30]], DMA : 1, %[[t54]], DMA : 0)

// CHECK-DAG: AIE.flow(%[[t34]], Core : 0, %[[t63]], Core : 1)
// CHECK-DAG: AIE.flow(%[[t34]], DMA : 1, %[[t70]], DMA : 0)
// CHECK-DAG: AIE.flow(%[[t43]], Core : 0, %[[t84]], Core : 1)
// CHECK-DAG: AIE.flow(%[[t43]], DMA : 1, %[[t60]], DMA : 1)

// CHECK-DAG: AIE.flow(%[[t44]], Core : 0, %[[t54]], Core : 1)
// CHECK-DAG: AIE.flow(%[[t44]], DMA : 1, %[[t60]], DMA : 0)
// CHECK-DAG: AIE.flow(%[[t54]], Core : 0, %[[t43]], Core : 1)
// CHECK-DAG: AIE.flow(%[[t54]], DMA : 1, %[[t30]], DMA : 1)

// CHECK-DAG: AIE.flow(%[[t60]], DMA : 0, %[[t44]], DMA : 0)
// CHECK-DAG: AIE.flow(%[[t60]], DMA : 1, %[[t43]], DMA : 0)
// CHECK-DAG: AIE.flow(%[[t63]], Core : 0, %[[t34]], Core : 1)
// CHECK-DAG: AIE.flow(%[[t63]], DMA : 1, %[[t20]], DMA : 1)

// CHECK-DAG: AIE.flow(%[[t70]], DMA : 0, %[[t34]], DMA : 0)
// CHECK-DAG: AIE.flow(%[[t70]], DMA : 1, %[[t84]], DMA : 0)
// CHECK-DAG: AIE.flow(%[[t72]], Core : 0, %[[t83]], Core : 1)
// CHECK-DAG: AIE.flow(%[[t72]], DMA : 1, %[[t30]], DMA : 0)

// CHECK-DAG: AIE.flow(%[[t83]], Core : 0, %[[t44]], Core : 1)
// CHECK-DAG: AIE.flow(%[[t83]], DMA : 1, %[[t20]], DMA : 0)
// CHECK-DAG: AIE.flow(%[[t84]], Core : 0, %[[t72]], Core : 1)
// CHECK-DAG: AIE.flow(%[[t84]], DMA : 1, %[[t70]], DMA : 1)
