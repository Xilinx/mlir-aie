...
module @vecmul_4x4  {
  aie.device(xcvc1902) {
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%10 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb3:  // 2 preds: ^bb2, ^bb3
      ...
      aie.dma_bd(%8 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb5:  // 2 preds: ^bb4, ^bb5
      ...
      aie.dma_bd(%6 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%23 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb3:  // 2 preds: ^bb2, ^bb3
      ...
      aie.dma_bd(%21 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb5:  // 2 preds: ^bb4, ^bb5
      ...
      aie.dma_bd(%19 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%36 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb3:  // 2 preds: ^bb2, ^bb3
      ...
      aie.dma_bd(%34 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb5:  // 2 preds: ^bb4, ^bb5
      ...
      aie.dma_bd(%32 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%49 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb3:  // 2 preds: ^bb2, ^bb3
      ...
      aie.dma_bd(%47 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb5:  // 2 preds: ^bb4, ^bb5
      ...
      aie.dma_bd(%45 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%61 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb3:  // 2 preds: ^bb2, ^bb3
      ...
      aie.dma_bd(%59 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb5:  // 2 preds: ^bb4, ^bb5
      ...
      aie.dma_bd(%57 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%73 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb3:  // 2 preds: ^bb2, ^bb3
      ...
      aie.dma_bd(%71 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb5:  // 2 preds: ^bb4, ^bb5
      ...
      aie.dma_bd(%69 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%86 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb3:  // 2 preds: ^bb2, ^bb3
      ...
      aie.dma_bd(%84 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb5:  // 2 preds: ^bb4, ^bb5
      ...
      aie.dma_bd(%82 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%99 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb3:  // 2 preds: ^bb2, ^bb3
      ...
      aie.dma_bd(%97 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb5:  // 2 preds: ^bb4, ^bb5
      ...
      aie.dma_bd(%95 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%111 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb3:  // 2 preds: ^bb2, ^bb3
      ...
      aie.dma_bd(%109 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb5:  // 2 preds: ^bb4, ^bb5
      ...
      aie.dma_bd(%107 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%123 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb3:  // 2 preds: ^bb2, ^bb3
      ...
      aie.dma_bd(%121 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb5:  // 2 preds: ^bb4, ^bb5
      ...
      aie.dma_bd(%119 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%136 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb3:  // 2 preds: ^bb2, ^bb3
      ...
      aie.dma_bd(%134 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb5:  // 2 preds: ^bb4, ^bb5
      ...
      aie.dma_bd(%132 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%148 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb3:  // 2 preds: ^bb2, ^bb3
      ...
      aie.dma_bd(%146 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb5:  // 2 preds: ^bb4, ^bb5
      ...
      aie.dma_bd(%144 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%159 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb3:  // 2 preds: ^bb2, ^bb3
      ...
      aie.dma_bd(%157 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb5:  // 2 preds: ^bb4, ^bb5
      ...
      aie.dma_bd(%155 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%171 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb3:  // 2 preds: ^bb2, ^bb3
      ...
      aie.dma_bd(%169 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb5:  // 2 preds: ^bb4, ^bb5
      ...
      aie.dma_bd(%167 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%184 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb3:  // 2 preds: ^bb2, ^bb3
      ...
      aie.dma_bd(%182 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb5:  // 2 preds: ^bb4, ^bb5
      ...
      aie.dma_bd(%180 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%197 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb3:  // 2 preds: ^bb2, ^bb3
      ...
      aie.dma_bd(%195 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
    ...
    ^bb5:  // 2 preds: ^bb4, ^bb5
      ...
      aie.dma_bd(%193 : memref<64xi32, 2> offset = %c0_i32 len = %c64_i32)
