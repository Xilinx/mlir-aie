...
// CHECK:           %[[VAL_22:.*]] = aie.tile(8, 4)
// CHECK:           %[[VAL_23:.*]] = aie.tile(1, 0)
// CHECK:           %[[VAL_24:.*]] = aie.switchbox(%[[VAL_23]]) {
// CHECK:             aie.connect<East : 0, North : 0>
// CHECK:           }
// CHECK:           %[[VAL_25:.*]] = aie.switchbox(%[[VAL_8]]) {
...
// CHECK:           }
// CHECK:           %[[VAL_26:.*]] = aie.shim_mux(%[[VAL_8]]) {
// CHECK:             aie.connect<DMA : 0, North : 3>
// CHECK:             aie.connect<North : 2, DMA : 0>
// CHECK:             aie.connect<DMA : 1, North : 7>
// CHECK:             aie.connect<North : 3, DMA : 1>
// CHECK:           }
// CHECK:           %[[VAL_27:.*]] = aie.switchbox(%[[VAL_0]]) {
// CHECK:             aie.connect<East : 0, North : 0>
...
// CHECK:           }
// CHECK:           %[[VAL_28:.*]] = aie.switchbox(%[[VAL_4]]) {
...
// CHECK:             aie.connect<North : 0, South : 0>
// CHECK:           }
// CHECK:           %[[VAL_43:.*]] = aie.switchbox(%[[VAL_16]]) {
...
// CHECK:             aie.connect<North : 1, South : 1>
// CHECK:           }
// CHECK:           %[[VAL_54:.*]] = aie.tile(4, 4)
// CHECK:           %[[VAL_55:.*]] = aie.switchbox(%[[VAL_54]]) {
// CHECK:             aie.connect<East : 0, South : 0>
// CHECK:             aie.connect<West : 0, East : 0>
// CHECK:             aie.connect<East : 1, South : 1>
// CHECK:           }
// CHECK:           %[[VAL_56:.*]] = aie.tile(5, 4)
// CHECK:           %[[VAL_57:.*]] = aie.switchbox(%[[VAL_56]]) {
// CHECK:             aie.connect<East : 0, West : 0>
// CHECK:             aie.connect<West : 0, East : 0>
// CHECK:             aie.connect<East : 1, West : 1>
// CHECK:           }
// CHECK:           %[[VAL_58:.*]] = aie.tile(6, 4)
// CHECK:           %[[VAL_59:.*]] = aie.switchbox(%[[VAL_58]]) {
// CHECK:             aie.connect<East : 0, West : 0>
// CHECK:             aie.connect<West : 0, South : 0>
// CHECK:             aie.connect<East : 1, West : 1>
// CHECK:           }
// CHECK:           %[[VAL_60:.*]] = aie.switchbox(%[[VAL_17]]) {
// CHECK:             aie.connect<East : 0, West : 0>
// CHECK:             aie.connect<East : 1, West : 1>
// CHECK:           }
// CHECK:           %[[VAL_61:.*]] = aie.switchbox(%[[VAL_5]]) {
// CHECK:             aie.connect<South : 0, East : 0>
// CHECK:             aie.connect<South : 1, North : 0>
// CHECK:             aie.connect<North : 0, South : 0>
// CHECK:             aie.connect<North : 1, South : 1>
...
// CHECK:             aie.connect<East : 0, West : 0>
// CHECK:           }
// CHECK:           %[[VAL_63:.*]] = aie.switchbox(%[[VAL_12]]) {
// CHECK:             aie.connect<South : 0, Core : 0>
...
// CHECK:             aie.connect<North : 2, DMA : 0>
// CHECK:           }
// CHECK:           %[[VAL_66:.*]] = aie.switchbox(%[[VAL_7]]) {
// CHECK:             aie.connect<South : 0, DMA : 0>
// CHECK:             aie.connect<Core : 0, South : 0>
// CHECK:             aie.connect<West : 0, East : 0>
// CHECK:           }
// CHECK:           %[[VAL_67:.*]] = aie.tile(5, 1)
// CHECK:           %[[VAL_68:.*]] = aie.switchbox(%[[VAL_67]]) {
// CHECK:             aie.connect<West : 0, East : 0>
// CHECK:             aie.connect<West : 1, East : 1>
// CHECK:           }
// CHECK:           %[[VAL_69:.*]] = aie.tile(6, 1)
// CHECK:           %[[VAL_70:.*]] = aie.switchbox(%[[VAL_69]]) {
// CHECK:             aie.connect<West : 0, North : 0>
// CHECK:             aie.connect<West : 1, North : 1>
// CHECK:             aie.connect<North : 0, East : 0>
// CHECK:           }
// CHECK:           %[[VAL_71:.*]] = aie.tile(6, 2)
...
// CHECK:             aie.connect<East : 1, West : 0>
// CHECK:           }
// CHECK:           %[[VAL_75:.*]] = aie.tile(5, 2)
// CHECK:           %[[VAL_76:.*]] = aie.switchbox(%[[VAL_75]]) {
// CHECK:             aie.connect<East : 0, West : 0>
// CHECK:             aie.connect<West : 0, North : 0>
// CHECK:             aie.connect<East : 1, West : 1>
// CHECK:           }
// CHECK:           %[[VAL_77:.*]] = aie.switchbox(%[[VAL_3]]) {
// CHECK:             aie.connect<South : 0, East : 0>
// CHECK:           }
// CHECK:           %[[VAL_78:.*]] = aie.tile(3, 4)
// CHECK:           %[[VAL_79:.*]] = aie.switchbox(%[[VAL_78]]) {
// CHECK:             aie.connect<West : 0, East : 0>
// CHECK:           }
// CHECK:           aie.wire(%[[VAL_0]] : Core, %[[VAL_80:.*]] : Core)
// CHECK:           aie.wire(%[[VAL_0]] : DMA, %[[VAL_80]] : DMA)
// CHECK:           aie.wire(%[[VAL_1]] : Core, %[[VAL_81:.*]] : Core)
// CHECK:           aie.wire(%[[VAL_1]] : DMA, %[[VAL_81]] : DMA)
// CHECK:           aie.wire(%[[VAL_80]] : North, %[[VAL_81]] : South)
// CHECK:           aie.wire(%[[VAL_2]] : Core, %[[VAL_82:.*]] : Core)
// CHECK:           aie.wire(%[[VAL_2]] : DMA, %[[VAL_82]] : DMA)
...
// CHECK:           aie.wire(%[[VAL_85:.*]] : North, %[[VAL_84]] : South)
// CHECK:           aie.wire(%[[VAL_81]] : East, %[[VAL_86:.*]] : West)
// CHECK:           aie.wire(%[[VAL_5]] : Core, %[[VAL_86]] : Core)
// CHECK:           aie.wire(%[[VAL_5]] : DMA, %[[VAL_86]] : DMA)
// CHECK:           aie.wire(%[[VAL_84]] : North, %[[VAL_86]] : South)
// CHECK:           aie.wire(%[[VAL_82]] : East, %[[VAL_87:.*]] : West)
// CHECK:           aie.wire(%[[VAL_6]] : Core, %[[VAL_87]] : Core)
// CHECK:           aie.wire(%[[VAL_6]] : DMA, %[[VAL_87]] : DMA)
// CHECK:           aie.wire(%[[VAL_86]] : North, %[[VAL_87]] : South)
// CHECK:           aie.wire(%[[VAL_83]] : East, %[[VAL_88:.*]] : West)
// CHECK:           aie.wire(%[[VAL_7]] : Core, %[[VAL_88]] : Core)
// CHECK:           aie.wire(%[[VAL_7]] : DMA, %[[VAL_88]] : DMA)
...
// CHECK:           aie.wire(%[[VAL_84]] : East, %[[VAL_91:.*]] : West)
// CHECK:           aie.wire(%[[VAL_9]] : Core, %[[VAL_91]] : Core)
// CHECK:           aie.wire(%[[VAL_9]] : DMA, %[[VAL_91]] : DMA)
// CHECK:           aie.wire(%[[VAL_89]] : North, %[[VAL_91]] : South)
// CHECK:           aie.wire(%[[VAL_86]] : East, %[[VAL_92:.*]] : West)
// CHECK:           aie.wire(%[[VAL_10]] : Core, %[[VAL_92]] : Core)
// CHECK:           aie.wire(%[[VAL_10]] : DMA, %[[VAL_92]] : DMA)
// CHECK:           aie.wire(%[[VAL_91]] : North, %[[VAL_92]] : South)
// CHECK:           aie.wire(%[[VAL_87]] : East, %[[VAL_93:.*]] : West)
// CHECK:           aie.wire(%[[VAL_11]] : Core, %[[VAL_93]] : Core)
// CHECK:           aie.wire(%[[VAL_11]] : DMA, %[[VAL_93]] : DMA)
// CHECK:           aie.wire(%[[VAL_92]] : North, %[[VAL_93]] : South)
// CHECK:           aie.wire(%[[VAL_88]] : East, %[[VAL_94:.*]] : West)
// CHECK:           aie.wire(%[[VAL_12]] : Core, %[[VAL_94]] : Core)
// CHECK:           aie.wire(%[[VAL_12]] : DMA, %[[VAL_94]] : DMA)
// CHECK:           aie.wire(%[[VAL_93]] : North, %[[VAL_94]] : South)
// CHECK:           aie.wire(%[[VAL_89]] : East, %[[VAL_95:.*]] : West)
// CHECK:           aie.wire(%[[VAL_96:.*]] : North, %[[VAL_95]] : South)
// CHECK:           aie.wire(%[[VAL_13]] : DMA, %[[VAL_96]] : DMA)
// CHECK:           aie.wire(%[[VAL_91]] : East, %[[VAL_97:.*]] : West)
// CHECK:           aie.wire(%[[VAL_48]] : Core, %[[VAL_97]] : Core)
// CHECK:           aie.wire(%[[VAL_48]] : DMA, %[[VAL_97]] : DMA)
// CHECK:           aie.wire(%[[VAL_95]] : North, %[[VAL_97]] : South)
// CHECK:           aie.wire(%[[VAL_92]] : East, %[[VAL_98:.*]] : West)
// CHECK:           aie.wire(%[[VAL_73]] : Core, %[[VAL_98]] : Core)
// CHECK:           aie.wire(%[[VAL_73]] : DMA, %[[VAL_98]] : DMA)
// CHECK:           aie.wire(%[[VAL_97]] : North, %[[VAL_98]] : South)
// CHECK:           aie.wire(%[[VAL_93]] : East, %[[VAL_99:.*]] : West)
// CHECK:           aie.wire(%[[VAL_35]] : Core, %[[VAL_99]] : Core)
// CHECK:           aie.wire(%[[VAL_35]] : DMA, %[[VAL_99]] : DMA)
// CHECK:           aie.wire(%[[VAL_98]] : North, %[[VAL_99]] : South)
// CHECK:           aie.wire(%[[VAL_94]] : East, %[[VAL_100:.*]] : West)
// CHECK:           aie.wire(%[[VAL_78]] : Core, %[[VAL_100]] : Core)
// CHECK:           aie.wire(%[[VAL_78]] : DMA, %[[VAL_100]] : DMA)
// CHECK:           aie.wire(%[[VAL_99]] : North, %[[VAL_100]] : South)
// CHECK:           aie.wire(%[[VAL_97]] : East, %[[VAL_101:.*]] : West)
// CHECK:           aie.wire(%[[VAL_50]] : Core, %[[VAL_101]] : Core)
// CHECK:           aie.wire(%[[VAL_50]] : DMA, %[[VAL_101]] : DMA)
// CHECK:           aie.wire(%[[VAL_98]] : East, %[[VAL_102:.*]] : West)
// CHECK:           aie.wire(%[[VAL_52]] : Core, %[[VAL_102]] : Core)
// CHECK:           aie.wire(%[[VAL_52]] : DMA, %[[VAL_102]] : DMA)
// CHECK:           aie.wire(%[[VAL_101]] : North, %[[VAL_102]] : South)
// CHECK:           aie.wire(%[[VAL_99]] : East, %[[VAL_103:.*]] : West)
// CHECK:           aie.wire(%[[VAL_37]] : Core, %[[VAL_103]] : Core)
// CHECK:           aie.wire(%[[VAL_37]] : DMA, %[[VAL_103]] : DMA)
// CHECK:           aie.wire(%[[VAL_102]] : North, %[[VAL_103]] : South)
// CHECK:           aie.wire(%[[VAL_100]] : East, %[[VAL_104:.*]] : West)
// CHECK:           aie.wire(%[[VAL_54]] : Core, %[[VAL_104]] : Core)
// CHECK:           aie.wire(%[[VAL_54]] : DMA, %[[VAL_104]] : DMA)
// CHECK:           aie.wire(%[[VAL_103]] : North, %[[VAL_104]] : South)
// CHECK:           aie.wire(%[[VAL_101]] : East, %[[VAL_105:.*]] : West)
// CHECK:           aie.wire(%[[VAL_67]] : Core, %[[VAL_105]] : Core)
// CHECK:           aie.wire(%[[VAL_67]] : DMA, %[[VAL_105]] : DMA)
// CHECK:           aie.wire(%[[VAL_102]] : East, %[[VAL_106:.*]] : West)
// CHECK:           aie.wire(%[[VAL_75]] : Core, %[[VAL_106]] : Core)
// CHECK:           aie.wire(%[[VAL_75]] : DMA, %[[VAL_106]] : DMA)
// CHECK:           aie.wire(%[[VAL_105]] : North, %[[VAL_106]] : South)
// CHECK:           aie.wire(%[[VAL_103]] : East, %[[VAL_107:.*]] : West)
// CHECK:           aie.wire(%[[VAL_39]] : Core, %[[VAL_107]] : Core)
// CHECK:           aie.wire(%[[VAL_39]] : DMA, %[[VAL_107]] : DMA)
...
// CHECK:           aie.wire(%[[VAL_69]] : Core, %[[VAL_109]] : Core)
// CHECK:           aie.wire(%[[VAL_69]] : DMA, %[[VAL_109]] : DMA)
// CHECK:           aie.wire(%[[VAL_106]] : East, %[[VAL_110:.*]] : West)
// CHECK:           aie.wire(%[[VAL_71]] : Core, %[[VAL_110]] : Core)
// CHECK:           aie.wire(%[[VAL_71]] : DMA, %[[VAL_110]] : DMA)
// CHECK:           aie.wire(%[[VAL_109]] : North, %[[VAL_110]] : South)
// CHECK:           aie.wire(%[[VAL_107]] : East, %[[VAL_111:.*]] : West)
// CHECK:           aie.wire(%[[VAL_41]] : Core, %[[VAL_111]] : Core)
// CHECK:           aie.wire(%[[VAL_41]] : DMA, %[[VAL_111]] : DMA)
// CHECK:           aie.wire(%[[VAL_110]] : North, %[[VAL_111]] : South)
// CHECK:           aie.wire(%[[VAL_108]] : East, %[[VAL_112:.*]] : West)
// CHECK:           aie.wire(%[[VAL_58]] : Core, %[[VAL_112]] : Core)
// CHECK:           aie.wire(%[[VAL_58]] : DMA, %[[VAL_112]] : DMA)
// CHECK:           aie.wire(%[[VAL_111]] : North, %[[VAL_112]] : South)
// CHECK:           aie.wire(%[[VAL_109]] : East, %[[VAL_113:.*]] : West)
// CHECK:           aie.wire(%[[VAL_14]] : Core, %[[VAL_113]] : Core)
// CHECK:           aie.wire(%[[VAL_14]] : DMA, %[[VAL_113]] : DMA)
// CHECK:           aie.wire(%[[VAL_110]] : East, %[[VAL_114:.*]] : West)
// CHECK:           aie.wire(%[[VAL_15]] : Core, %[[VAL_114]] : Core)
// CHECK:           aie.wire(%[[VAL_15]] : DMA, %[[VAL_114]] : DMA)
...
// CHECK:           aie.wire(%[[VAL_112]] : East, %[[VAL_116:.*]] : West)
// CHECK:           aie.wire(%[[VAL_17]] : Core, %[[VAL_116]] : Core)
// CHECK:           aie.wire(%[[VAL_17]] : DMA, %[[VAL_116]] : DMA)
...
// CHECK:           aie.wire(%[[VAL_116]] : East, %[[VAL_119:.*]] : West)
// CHECK:           aie.wire(%[[VAL_22]] : Core, %[[VAL_119]] : Core)
// CHECK:           aie.wire(%[[VAL_22]] : DMA, %[[VAL_119]] : DMA)
// CHECK:           aie.wire(%[[VAL_118]] : North, %[[VAL_119]] : South)
// CHECK:         }
