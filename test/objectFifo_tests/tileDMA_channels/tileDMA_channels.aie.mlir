...
module @dmaChannels {
    ...
    %objFifoIn0 = AIE.objectFifo.createObjectFifo(%tile33, {%tile12}, 2) {sym_name = "objFifo_in0"} : !AIE.objectFifo<memref<16xi32>>
    %objFifoIn1 = AIE.objectFifo.createObjectFifo(%tile33, {%tile12}, 2) {sym_name = "objFifo_in1"} : !AIE.objectFifo<memref<16xi32>>

    %objFifoOut0 = AIE.objectFifo.createObjectFifo(%tile12, {%tile33}, 2) {sym_name = "objFifo_out0"} : !AIE.objectFifo<memref<16xi32>>
    %objFifoOut1 = AIE.objectFifo.createObjectFifo(%tile12, {%tile33}, 2) {sym_name = "objFifo_out1"} : !AIE.objectFifo<memref<16xi32>>
