...
module {
  aie.device(ipu) {
    ...
    %inA_cons_buff_0 = aie.buffer(%tile_0_1) : memref<64x32xi16>
    %inA_cons_buff_1 = aie.buffer(%tile_0_1) : memref<64x32xi16>
    %inB_cons_buff_0 = aie.buffer(%tile_0_1) : memref<32x64xi16>
    %inB_cons_buff_1 = aie.buffer(%tile_0_1) : memref<32x64xi16>

    %memA_cons_buff_0 = aie.buffer(%tile_0_2) : memref<64x32xi16>
    %memA_cons_buff_1 = aie.buffer(%tile_0_2) : memref<64x32xi16>
    %memB_cons_buff_0 = aie.buffer(%tile_0_2) : memref<32x64xi16>
    %memB_cons_buff_1 = aie.buffer(%tile_0_2) : memref<32x64xi16>
    %memC_cons_buff_0 = aie.buffer(%tile_0_1) : memref<64x64xi16>
    %memC_cons_buff_1 = aie.buffer(%tile_0_1) : memref<64x64xi16>
    %memC_buff_0 = aie.buffer(%tile_0_2) : memref<64x64xi16>
    %memC_buff_1 = aie.buffer(%tile_0_2) : memref<64x64xi16>
    ...
    %inA_cons_cons_lock = aie.lock(%tile_0_1, 1) {init = 0 : i32}
    %inA_cons_prod_lock = aie.lock(%tile_0_1, 0) {init = 2 : i32}
    %inB_cons_cons_lock = aie.lock(%tile_0_1, 3) {init = 0 : i32}
    %inB_cons_prod_lock = aie.lock(%tile_0_1, 2) {init = 2 : i32}
    ...
    %memA_cons_cons_lock = aie.lock(%tile_0_2, 1) {init = 0 : i32}
    %memA_cons_prod_lock = aie.lock(%tile_0_2, 0) {init = 2 : i32}
    %memB_cons_cons_lock = aie.lock(%tile_0_2, 3) {init = 0 : i32}
    %memB_cons_prod_lock = aie.lock(%tile_0_2, 2) {init = 2 : i32}
    %memC_cons_cons_lock = aie.lock(%tile_0_1, 5) {init = 0 : i32}
    %memC_cons_prod_lock = aie.lock(%tile_0_1, 4) {init = 2 : i32}
    %memC_cons_lock = aie.lock(%tile_0_2, 5) {init = 0 : i32}
    %memC_prod_lock = aie.lock(%tile_0_2, 4) {init = 2 : i32}
