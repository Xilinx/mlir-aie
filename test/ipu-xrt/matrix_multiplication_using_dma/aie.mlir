...
module {
  aie.device(ipu) {
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb5
      ...
      aie.dma_bd(%inA_cons_buff_0 : memref<64x32xi16>, 0, 2048, [<wrap = 16, stride = 64>, <wrap = 8, stride = 2>, <wrap = 4, stride = 16>, <wrap = 2, stride = 1>])
      aie.use_lock(%inA_cons_prod_lock, Release, 1)
      aie.next_bd ^bb5
    ^bb5:  // pred: ^bb4
      aie.use_lock(%inA_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%inA_cons_buff_1 : memref<64x32xi16>, 0, 2048, [<wrap = 16, stride = 64>, <wrap = 8, stride = 2>, <wrap = 4, stride = 16>, <wrap = 2, stride = 1>])
      aie.use_lock(%inA_cons_prod_lock, Release, 1)
      aie.next_bd ^bb4
    ^bb6:  // pred: ^bb3
    ...
    ^bb10:  // 2 preds: ^bb9, ^bb11
      ...
      aie.dma_bd(%inB_cons_buff_0 : memref<32x64xi16>, 0, 2048, [<wrap = 8, stride = 128>, <wrap = 16, stride = 2>, <wrap = 4, stride = 32>, <wrap = 2, stride = 1>])
      aie.use_lock(%inB_cons_prod_lock, Release, 1)
      aie.next_bd ^bb11
    ^bb11:  // pred: ^bb10
      aie.use_lock(%inB_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%inB_cons_buff_1 : memref<32x64xi16>, 0, 2048, [<wrap = 8, stride = 128>, <wrap = 16, stride = 2>, <wrap = 4, stride = 32>, <wrap = 2, stride = 1>])
      aie.use_lock(%inB_cons_prod_lock, Release, 1)
      aie.next_bd ^bb10
    ^bb12:  // pred: ^bb9
    ...
    ^bb16:  // 2 preds: ^bb15, ^bb17
      ...
      aie.dma_bd(%memC_cons_buff_0 : memref<64x64xi16>, 0, 4096, [<wrap = 16, stride = 128>, <wrap = 4, stride = 2>, <wrap = 16, stride = 8>, <wrap = 2, stride = 1>])
      aie.use_lock(%memC_cons_prod_lock, Release, 1)
      aie.next_bd ^bb17
    ^bb17:  // pred: ^bb16
      aie.use_lock(%memC_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%memC_cons_buff_1 : memref<64x64xi16>, 0, 4096, [<wrap = 16, stride = 128>, <wrap = 4, stride = 2>, <wrap = 16, stride = 8>, <wrap = 2, stride = 1>])
      aie.use_lock(%memC_cons_prod_lock, Release, 1)
      aie.next_bd ^bb16
    ^bb18:  // pred: ^bb15
      aie.end
