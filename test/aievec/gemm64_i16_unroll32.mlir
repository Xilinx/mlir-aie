...
//      CHECK:          %[[T19:.*]] = aievec.upd %[[A1]][%18, %[[A4:.*]]] {index = 0 : i8, offset = 0 : si32} : memref<?x64xi16>, vector<32xi16>
...
//      CHECK:          %[[T91:.*]] = aievec.upd %[[A1]][%[[T90:.*]], %[[A4:.*]]] {index = 0 : i8, offset = 0 : si32} : memref<?x64xi16>, vector<32xi16>
