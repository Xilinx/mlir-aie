...
//CHECK-LABEL: func @conv2d(%arg0: memref<2048x2048xi16>, %arg1: memref<3x3xi16>, %arg2: memref<2046x2046xi16>) {
func @conv2d (%A: memref<2048x2048xi16>, %B: memref<3x3xi16>, %C: memref<2046x2046xi16>) {
