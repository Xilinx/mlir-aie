...
// CHECK:           %[[VAL_8:.*]] = aievec_aie1.upd %[[VAL_1]]{{\[}}%[[VAL_5]]] {index = 0 : i8, offset = 0 : i32} : memref<?xf32>, vector<8xf32>
// CHECK:           %[[VAL_9:.*]] = aievec_aie1.upd %[[VAL_1]]{{\[}}%[[VAL_3]]] {index = 0 : i8, offset = 0 : i32} : memref<?xf32>, vector<8xf32>
...
// CHECK:               %[[VAL_20:.*]] = aievec_aie1.upd %[[VAL_2]]{{\[}}%[[VAL_12]], %[[VAL_19]]] {index = 0 : i8, offset = 0 : i32} : memref<?x?xf32>, vector<8xf32>
// CHECK:               %[[VAL_21:.*]] = aievec_aie1.upd %[[VAL_0]]{{\[}}%[[VAL_12]], %[[VAL_19]]] {index = 0 : i8, offset = 0 : i32} : memref<?x?xf32>, vector<16xf32>
...
// CHECK:               %[[VAL_25:.*]] = aievec_aie1.upd %[[VAL_0]]{{\[}}%[[VAL_12]], %[[VAL_24]]], %[[VAL_21]] {index = 1 : i8, offset = 224 : i32} : memref<?x?xf32>, vector<16xf32>
...
// CHECK:               %[[VAL_28:.*]] = aievec_aie1.upd %[[VAL_0]]{{\[}}%[[VAL_14]], %[[VAL_19]]] {index = 0 : i8, offset = 0 : i32} : memref<?x?xf32>, vector<16xf32>
...
// CHECK:               %[[VAL_30:.*]] = aievec_aie1.upd %[[VAL_0]]{{\[}}%[[VAL_14]], %[[VAL_24]]], %[[VAL_28]] {index = 1 : i8, offset = 224 : i32} : memref<?x?xf32>, vector<16xf32>
...
// CHECK:               %[[VAL_33:.*]] = aievec_aie1.upd %[[VAL_0]]{{\[}}%[[VAL_16]], %[[VAL_19]]] {index = 0 : i8, offset = 0 : i32} : memref<?x?xf32>, vector<16xf32>
...
// CHECK:               %[[VAL_35:.*]] = aievec_aie1.upd %[[VAL_0]]{{\[}}%[[VAL_16]], %[[VAL_24]]], %[[VAL_33]] {index = 1 : i8, offset = 224 : i32} : memref<?x?xf32>, vector<16xf32>
...
// CHECK:           %[[VAL_6:.*]] = aievec_aie1.upd %[[VAL_1]]{{\[}}%[[VAL_4]]] {index = 0 : i8, offset = 0 : i32} : memref<?xf32>, vector<8xf32>
// CHECK:           %[[VAL_7:.*]] = aievec_aie1.upd %[[VAL_1]]{{\[}}%[[VAL_3]]] {index = 0 : i8, offset = 0 : i32} : memref<?xf32>, vector<8xf32>
...
// CHECK:               %[[VAL_19:.*]] = aievec_aie1.upd %[[VAL_2]]{{\[}}%[[VAL_10]], %[[VAL_18]]] {index = 0 : i8, offset = 0 : i32} : memref<?x256xf32>, vector<8xf32>
// CHECK:               %[[VAL_20:.*]] = aievec_aie1.upd %[[VAL_0]]{{\[}}%[[VAL_10]], %[[VAL_18]]] {index = 0 : i8, offset = 0 : i32} : memref<?x256xf32>, vector<16xf32>
...
// CHECK:               %[[VAL_24:.*]] = aievec_aie1.upd %[[VAL_0]]{{\[}}%[[VAL_10]], %[[VAL_23]]], %[[VAL_20]] {index = 1 : i8, offset = 224 : i32} : memref<?x256xf32>, vector<16xf32>
...
// CHECK:               %[[VAL_27:.*]] = aievec_aie1.upd %[[VAL_0]]{{\[}}%[[VAL_12]], %[[VAL_18]]] {index = 0 : i8, offset = 0 : i32} : memref<?x256xf32>, vector<16xf32>
...
// CHECK:               %[[VAL_29:.*]] = aievec_aie1.upd %[[VAL_0]]{{\[}}%[[VAL_12]], %[[VAL_23]]], %[[VAL_27]] {index = 1 : i8, offset = 224 : i32} : memref<?x256xf32>, vector<16xf32>
...
// CHECK:               %[[VAL_32:.*]] = aievec_aie1.upd %[[VAL_0]]{{\[}}%[[VAL_14]], %[[VAL_18]]] {index = 0 : i8, offset = 0 : i32} : memref<?x256xf32>, vector<16xf32>
...
// CHECK:               %[[VAL_34:.*]] = aievec_aie1.upd %[[VAL_0]]{{\[}}%[[VAL_14]], %[[VAL_23]]], %[[VAL_32]] {index = 1 : i8, offset = 224 : i32} : memref<?x256xf32>, vector<16xf32>
