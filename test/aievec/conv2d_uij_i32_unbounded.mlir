// RUN: aie-opt %s --aie-affine-vectorize="virtual-vector-size=8 shift=0" -split-input-file | FileCheck %s
...
// CHECK:           %[[VAL_8:.*]] = aievec.upd %[[VAL_1]]{{\[}}%[[VAL_5]]] {index = 0 : i8, offset = 0 : si32} : memref<?xi32>, vector<8xi32>
// CHECK:           %[[VAL_9:.*]] = aievec.upd %[[VAL_1]]{{\[}}%[[VAL_3]]] {index = 0 : i8, offset = 0 : si32} : memref<?xi32>, vector<8xi32>
...
// CHECK:               %[[VAL_20:.*]] = aievec.upd %[[VAL_2]]{{\[}}%[[VAL_12]], %[[VAL_19]]] {index = 0 : i8, offset = 0 : si32} : memref<?x?xi32>, vector<8xi32>
// CHECK:               %[[VAL_21:.*]] = aievec.upd %[[VAL_0]]{{\[}}%[[VAL_12]], %[[VAL_19]]] {index = 0 : i8, offset = 0 : si32} : memref<?x?xi32>, vector<16xi32>
...
// CHECK:               %[[VAL_26:.*]] = aievec.upd %[[VAL_0]]{{\[}}%[[VAL_12]], %[[VAL_25]]], %[[VAL_21]] {index = 1 : i8, offset = 224 : si32} : memref<?x?xi32>, vector<16xi32>
...
// CHECK:               %[[VAL_29:.*]] = aievec.upd %[[VAL_0]]{{\[}}%[[VAL_14]], %[[VAL_19]]] {index = 0 : i8, offset = 0 : si32} : memref<?x?xi32>, vector<16xi32>
...
// CHECK:               %[[VAL_31:.*]] = aievec.upd %[[VAL_0]]{{\[}}%[[VAL_14]], %[[VAL_25]]], %[[VAL_29]] {index = 1 : i8, offset = 224 : si32} : memref<?x?xi32>, vector<16xi32>
...
// CHECK:               %[[VAL_34:.*]] = aievec.upd %[[VAL_0]]{{\[}}%[[VAL_16]], %[[VAL_19]]] {index = 0 : i8, offset = 0 : si32} : memref<?x?xi32>, vector<16xi32>
...
// CHECK:               %[[VAL_36:.*]] = aievec.upd %[[VAL_0]]{{\[}}%[[VAL_16]], %[[VAL_25]]], %[[VAL_34]] {index = 1 : i8, offset = 224 : si32} : memref<?x?xi32>, vector<16xi32>
...
// CHECK:               %[[VAL_39:.*]] = aievec.srs %[[VAL_38]] {shift = 0 : i8} : vector<8xi80>, vector<8xi32>
...
// CHECK:           %[[VAL_6:.*]] = aievec.upd %[[VAL_1]]{{\[}}%[[VAL_4]]] {index = 0 : i8, offset = 0 : si32} : memref<?xi32>, vector<8xi32>
// CHECK:           %[[VAL_7:.*]] = aievec.upd %[[VAL_1]]{{\[}}%[[VAL_3]]] {index = 0 : i8, offset = 0 : si32} : memref<?xi32>, vector<8xi32>
...
// CHECK:               %[[VAL_19:.*]] = aievec.upd %[[VAL_2]]{{\[}}%[[VAL_10]], %[[VAL_18]]] {index = 0 : i8, offset = 0 : si32} : memref<?x256xi32>, vector<8xi32>
// CHECK:               %[[VAL_20:.*]] = aievec.upd %[[VAL_0]]{{\[}}%[[VAL_10]], %[[VAL_18]]] {index = 0 : i8, offset = 0 : si32} : memref<?x256xi32>, vector<16xi32>
...
// CHECK:               %[[VAL_25:.*]] = aievec.upd %[[VAL_0]]{{\[}}%[[VAL_10]], %[[VAL_24]]], %[[VAL_20]] {index = 1 : i8, offset = 224 : si32} : memref<?x256xi32>, vector<16xi32>
...
// CHECK:               %[[VAL_28:.*]] = aievec.upd %[[VAL_0]]{{\[}}%[[VAL_12]], %[[VAL_18]]] {index = 0 : i8, offset = 0 : si32} : memref<?x256xi32>, vector<16xi32>
...
// CHECK:               %[[VAL_30:.*]] = aievec.upd %[[VAL_0]]{{\[}}%[[VAL_12]], %[[VAL_24]]], %[[VAL_28]] {index = 1 : i8, offset = 224 : si32} : memref<?x256xi32>, vector<16xi32>
...
// CHECK:               %[[VAL_33:.*]] = aievec.upd %[[VAL_0]]{{\[}}%[[VAL_14]], %[[VAL_18]]] {index = 0 : i8, offset = 0 : si32} : memref<?x256xi32>, vector<16xi32>
...
// CHECK:               %[[VAL_35:.*]] = aievec.upd %[[VAL_0]]{{\[}}%[[VAL_14]], %[[VAL_24]]], %[[VAL_33]] {index = 1 : i8, offset = 224 : si32} : memref<?x256xi32>, vector<16xi32>
...
// CHECK:               %[[VAL_38:.*]] = aievec.srs %[[VAL_37]] {shift = 0 : i8} : vector<8xi80>, vector<8xi32>
