// RUN: aie-opt %s --affine-loop-unroll="unroll-full unroll-full-threshold=3" --canonicalize --aie-affine-vectorize="virtual-vector-size=16" -split-input-file | FileCheck %s
