...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @conv2d(%arg0: memref<?x288xi8>, %arg1: memref<?xi8>, %arg2: memref<?x256xi8>) attributes {llvm.linkage = #llvm.linkage<external>} {
    affine.for %arg3 = 0 to 16 {
      affine.for %arg4 = 0 to 256 {
        ...
        %6 = affine.load %arg0[%arg3, %arg4 + 1] : memref<?x288xi8>
        %7 = arith.extsi %6 : i8 to i32
        %8 = affine.load %arg1[2] : memref<?xi8>
        %9 = arith.extsi %8 : i8 to i32
        %10 = arith.muli %7, %9 : i32
        %11 = arith.trunci %10 : i32 to i8
        %12 = arith.addi %5, %11 : i8
        %13 = affine.load %arg0[%arg3, %arg4 + 2] : memref<?x288xi8>
        %14 = arith.extsi %13 : i8 to i32
        %15 = affine.load %arg1[4] : memref<?xi8>
        %16 = arith.extsi %15 : i8 to i32
        %17 = arith.muli %14, %16 : i32
        %18 = arith.trunci %17 : i32 to i8
        %19 = arith.addi %12, %18 : i8
        affine.store %19, %arg2[%arg3, %arg4] : memref<?x256xi8>
      }
    }
    return
  }
...
// CHECK-SAME: %[[A2:[0-9a-zA-Z]*]]: memref<?x256xi8>
//      CHECK:    %[[C32:.*]] = arith.constant 32 : index
//      CHECK:    %[[C256:.*]] = arith.constant 256 : index
//      CHECK:    %[[C1:.*]] = arith.constant 1 : index
//      CHECK:    %[[C16:.*]] = arith.constant 16 : index
//      CHECK:    %[[C0:.*]] = arith.constant 0 : index
//      CHECK:    %[[T0:.*]] = aievec.upd %[[A1]][%[[C0:.*]]] {index = 0 : i8, offset = 0 : si32} : memref<?xi8>, vector<64xi8>
...
//      CHECK:        vector.transfer_write %[[T4:.*]], %[[A2]][%[[A3:.*]], %[[A4:.*]]] {in_bounds = [true]} : vector<32xi8>, memref<?x256xi8>
