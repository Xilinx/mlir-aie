...
module {
  func.func @dut(%arg0: tensor<16x1024xf32>, %arg1: tensor<1024xf32>) -> (tensor<16x1024xf32>) {
    %0 = "tosa.reshape"(%arg1) { new_shape = array<i64: 1, 1024>} : (tensor<1024xf32>)  -> (tensor<1x1024xf32>)
    %1 = "tosa.sub"(%arg0,%0) : (tensor<16x1024xf32>, tensor<1x1024xf32>)  -> (tensor<16x1024xf32>)
    return %1 : tensor<16x1024xf32>
  }
}
