...
module {
  func.func @dut(%arg0: tensor<16x1024xf32>, %arg1: tensor<1x1024xf32>) -> (tensor<16x1024xf32>) {
    %1 = "tosa.sub"(%arg0,%arg1) : (tensor<16x1024xf32>, tensor<1x1024xf32>)  -> (tensor<16x1024xf32>)
