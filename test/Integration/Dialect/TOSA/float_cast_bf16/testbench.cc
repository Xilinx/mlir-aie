...
void dut(float *restrict in0, bfloat16 *restrict out0);
void dut_ref(float *in0, bfloat16 *out0);
...
int main(int argc, char *argv[]) {
  ...
  srand(10);
  std::generate(g_in0, g_in0 + IN0_SIZE, [&]() { return random_float(); });
