...
module {
  func.func @dut(%arg0: tensor<?xbf16>, %arg1: tensor<?xbf16>) -> (tensor<?xbf16>) attributes {tosa.no_implicit_broadcast_of_dynamic_sizes} {
    %1 = "tosa.sub"(%arg0,%arg1) : (tensor<?xbf16>, tensor<?xbf16>)  -> (tensor<?xbf16>)
