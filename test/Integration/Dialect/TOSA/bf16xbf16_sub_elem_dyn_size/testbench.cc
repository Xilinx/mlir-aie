...
#include <cstdio>
#include <cstdlib>
void dut(bfloat16 *restrict in0, size_t m1, bfloat16 *restrict in1, size_t m2,
         bfloat16 *restrict out0, size_t m3);
...
int main(int argc, char *argv[]) {
  ...
  dut(g_in0, IN0_SIZE, g_in1, IN1_SIZE, g_out0, OUT0_SIZE);
