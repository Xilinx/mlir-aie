...
module {
  func.func @dut(%arg0: tensor<1024xi8>, %arg1: tensor<1024xi8>) -> (tensor<1024xi8>) {
    %0 = "tosa.greater"(%arg0, %arg1) : (tensor<1024xi8>, tensor<1024xi8>) -> (tensor<1024xi1>)
    %1 = "tosa.select"(%0, %arg0, %arg1) : (tensor<1024xi1>, tensor<1024xi8>, tensor<1024xi8>) -> (tensor<1024xi8>)
