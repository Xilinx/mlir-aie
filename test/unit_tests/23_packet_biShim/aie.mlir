// RUN: aie-opt --aie-create-packet-flows %s >temp.mlir
// RUN: aiecc.py --sysroot=%VITIS_SYSROOT% temp.mlir -I%aie_runtime_lib% %aie_runtime_lib%/test_library.cpp %S/test.cpp -o test.elf
