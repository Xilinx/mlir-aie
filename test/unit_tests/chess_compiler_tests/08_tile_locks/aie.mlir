...
aie.device(xcvc1902) {
    ...
    %m73 = aie.mem(%t73) {
      ...
      ^bd0:
        ...
        aie.use_lock(%lock_e, Acquire, %c0_ul0)
      ...
      ^bd1:
        ...
        aie.use_lock(%lock_l, Acquire, %c0_ul2)
        aie.dma_bd(%buf_l : memref<256xi32>, 4, 2)
        %c1_ul3 = arith.constant 1 : i32
        aie.use_lock(%lock_l, Release, %c1_ul3)
        aie.next_bd ^end
      ^bd2:
        %c0_ul4 = arith.constant 0 : i32
        aie.use_lock(%lock_n, Acquire, %c0_ul4)
        aie.dma_bd(%buf_l : memref<256xi32>, 8, 2)
        %c1_ul5 = arith.constant 1 : i32
        aie.use_lock(%lock_n, Release, %c1_ul5)
        aie.next_bd ^bd3
      ^bd3:
        %c0_ul6 = arith.constant 0 : i32
        aie.use_lock(%lock_s, Acquire, %c0_ul6)
        aie.dma_bd(%buf_l : memref<256xi32>, 12, 2)
        %c1_ul7 = arith.constant 1 : i32
        aie.use_lock(%lock_s, Release, %c1_ul7)
        aie.next_bd ^end
      ^end:
        aie.end
    }
