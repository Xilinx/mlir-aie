...
aie.device(xcvc1902) {
  ...
  %m62 = aie.mem(%t62) {
    ...
    ^bd0:
      ...
      aie.use_lock(%l62, "Acquire", %c0_ul4)
      aie.dma_bd(%buf62 : memref<512xi32>, 0, 512)
      %c1_ul5 = arith.constant 1 : i32
      aie.use_lock(%l62, "Release", %c1_ul5)
      aie.next_bd ^end
    //^bd1:
