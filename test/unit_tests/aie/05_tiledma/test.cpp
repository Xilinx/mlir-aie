...
int main(int argc, char *argv[]) {
  ...
  mlir_aie_check("Before release lock:", mlir_aie_read_buffer_a13(_xaie, 3), 7,
                 errors);
  mlir_aie_check("Before release lock:", mlir_aie_read_buffer_b13(_xaie, 5), 0,
                 errors);
  mlir_aie_check("Before release lock:", mlir_aie_read_buffer_a33(_xaie, 5), 0,
                 errors);
  mlir_aie_check("Before release lock:", mlir_aie_read_buffer_b33(_xaie, 5), 0,
                 errors);
  ...
  mlir_aie_check("After acquire lock:", mlir_aie_read_buffer_a33(_xaie, 5), 35,
                 errors);
  mlir_aie_check("After acquire lock:", mlir_aie_read_buffer_b33(_xaie, 5), 175,
                 errors);
