...
aie.device(xcvc1902) {
  ...
  %dma = aie.shim_dma(%t70) {
    ...
    ^bd0:
      ...
      aie.dma_bd(%buffer : memref<512 x i32> offset = %c0_i32 len = %c512_i32)
  ...
  %m72 = aie.mem(%t72) {
    ...
    ^bd0:
      ...
      aie.dma_bd(%buf72_0 : memref<256xi32> offset = %c0_i32 len = %c256_i32)
      aie.use_lock(%l72_0, "Release", 1)
      aie.next_bd ^bd1
    ^bd1:
      aie.use_lock(%l72_1, "Acquire", 0)
      aie.dma_bd(%buf72_1 : memref<256xi32> offset = %c0_i32 len = %c256_i32)
  ...
  %m73 = aie.mem(%t73) {
    ...
    ^bd0:
      ...
      aie.dma_bd(%buf73_0 : memref<256xi32> offset = %c0_i32 len = %c256_i32)
      aie.use_lock(%l73_0, "Release", 1)
      aie.next_bd ^bd1
    ^bd1:
      aie.use_lock(%l73_1, "Acquire", 0)
      aie.dma_bd(%buf73_1 : memref<256xi32> offset = %c0_i32 len = %c256_i32)
