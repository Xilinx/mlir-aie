...
aie.device(xcvc1902) {
  ...
  ^bb1:  // 2 preds: ^bb0, ^bb1
    ...
    aie.dma_bd(%6 : memref<32x32xi32> offset = %c0_i32 len = %c1024_i32 sizes = [] strides = [])
  ...
  ^bb1:  // 2 preds: ^bb0, ^bb1
    ...
    aie.dma_bd(%16 : memref<32x32xi32> offset = %c0_i32 len = %c1024_i32 sizes = [] strides = [])
  ...
  ^bb3:  // 2 preds: ^bb2, ^bb3
    ...
    aie.dma_bd(%15 : memref<32x32xi32> offset = %c0_i32 len = %c1024_i32 sizes = [] strides = [])
  ...
  ^bb5:  // 2 preds: ^bb4, ^bb5
    ...
    aie.dma_bd(%14 : memref<32x32xi32> offset = %c0_i32 len = %c1024_i32 sizes = [] strides = [])
  ...
  ^bb1:  // 2 preds: ^bb0, ^bb1
    ...
    aie.dma_bd(%31 : memref<32x32xi32> offset = %c0_i32 len = %c1024_i32 sizes = [] strides = [])
  ...
  ^bb3:  // 2 preds: ^bb2, ^bb4
    ...
    aie.dma_bd_packet(0, 2)
    aie.dma_bd(%29 : memref<32x32xi32> offset = %c0_i32 len = %c1024_i32 sizes = [] strides = [])
    aie.use_lock(%24, Release, 1)
    aie.next_bd ^bb4
  ^bb4:  // pred: ^bb3
    aie.use_lock(%23, Acquire, 0)
    aie.dma_bd_packet(0, 3)
    aie.dma_bd(%30 : memref<32x32xi32> offset = %c0_i32 len = %c1024_i32 sizes = [] strides = [])
  ...
  ^bb6:  // 2 preds: ^bb5, ^bb6
    ...
    aie.dma_bd(%26 : memref<32x32xi32> offset = %c0_i32 len = %c1024_i32 sizes = [] strides = [])
