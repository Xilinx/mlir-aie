...
//  aie.switchbox(%tile34) { aie.connect<"South": 3, "DMA": 1> }
  ...
  %mem13 = aie.mem(%tile13) {
    ...
    ^bd0:
      ...
      aie.dma_bd(%buf13_1 : memref<256xi32> offset = 0 len = 256 sizes = [] strides = [])
...
//    %5 = arith.addi %4, %val1 : i32
  ...
  %mem32 = aie.mem(%tile32) {
    ...
    ^bd0:
      ...
      aie.dma_bd(%buf32_0 : memref<256xi32> offset = 0 len = 256 sizes = [] strides = [])
...
//    %5 = arith.addi %4, %val1 : i32
  ...
  %mem33 = aie.mem(%tile33) {
    ...
    ^bd0:
      ...
      aie.dma_bd(%buf33_0 : memref<256xi32> offset = 0 len = 256 sizes = [] strides = [])
  ...
  %mem34 = aie.mem(%tile34) {
    ...
    ^bd0:
      ...
      aie.dma_bd(%buf34_0 : memref<256xi32> offset = 0 len = 256 sizes = [] strides = [])
