...
int main(int argc, char *argv[]) {
  ...
  mlir_aie_check("After acquire lock:", mlir_aie_read_buffer_b13(_xaie, 5), 35,
                 errors);
  mlir_aie_check("After acquire lock:", mlir_aie_read_buffer_a32(_xaie, 5), 35,
                 errors);
  mlir_aie_check("After acquire lock:", mlir_aie_read_buffer_b32(_xaie, 5), 105,
                 errors);
  ...
  mlir_aie_check("After acquire lock:", mlir_aie_read_buffer_a33(_xaie, 5), 35,
                 errors);
  mlir_aie_check("After acquire lock:", mlir_aie_read_buffer_b33(_xaie, 5), 140,
                 errors);
  ...
  mlir_aie_check("After acquire lock:", mlir_aie_read_buffer_a34(_xaie, 5), 35,
                 errors);
  mlir_aie_check("After acquire lock:", mlir_aie_read_buffer_b34(_xaie, 5), 175,
                 errors);
