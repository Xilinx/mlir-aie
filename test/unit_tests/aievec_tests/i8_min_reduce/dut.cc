void dut(int8_t *restrict v1, int8_t *restrict v2) {
  v64int8 v3 = broadcast_to_v64int8((int8_t)127);
  size_t v4 = 0;
  size_t v5 = 1024;
  size_t v6 = 64;
  v64int8 v7;
