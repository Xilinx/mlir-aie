void dut(int8_t *restrict v1, int8_t *restrict v2) {
  int32_t v3 = 0;
  v64int8 v4 = broadcast_to_v64int8((int8_t)127);
  size_t v5 = 0;
  size_t v6 = 1024;
  size_t v7 = 64;
  v64int8 v8;
