...
// RUN: mkdir -p data
// RUN: xca_udm_dbg --aiearch aie-ml -qf -T -P %aietools/data/aie_ml/lib/ -t "%S/../profiling.tcl ./work_cpp/a.out" >& xca_udm_dbg_cpp.stdout
// RUN: FileCheck --input-file=./xca_udm_dbg_cpp.stdout %s
...
// RUN: xca_udm_dbg --aiearch aie-ml -qf -T -P %aietools/data/aie_ml/lib/ -t "%S/../profiling.tcl ./work_vector_llvm/a.out" >& xca_udm_dbg_vector_llvm.stdout
// RUN: FileCheck --input-file=./xca_udm_dbg_vector_llvm.stdout %s
...
// RUN: xca_udm_dbg --aiearch aie-ml -qf -T -P %aietools/data/aie_ml/lib/ -t "%S/../profiling.tcl ./work_scalar_llvm/a.out" >& xca_udm_dbg_scalar_llvm.stdout
// RUN: FileCheck --input-file=./xca_udm_dbg_scalar_llvm.stdout %s
