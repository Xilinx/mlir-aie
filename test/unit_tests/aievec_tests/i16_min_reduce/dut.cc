void dut(int16_t *restrict v1, int16_t *restrict v2) {
  int32_t v3 = 0;
  v32int16 v4 = broadcast_to_v32int16((int16_t)32767);
  size_t v5 = 0;
  size_t v6 = 1024;
  size_t v7 = 32;
  v32int16 v8;
