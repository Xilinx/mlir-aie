void dut(int32_t *restrict v1, int32_t *restrict v2) {
  v16int32 v3 = broadcast_to_v16int32((int32_t)-2147483648);
  size_t v4 = 0;
  size_t v5 = 1024;
  size_t v6 = 16;
  v16int32 v7;
