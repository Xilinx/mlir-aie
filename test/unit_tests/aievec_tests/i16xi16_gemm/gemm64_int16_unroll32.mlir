...
//RUN: xchesscc -f -g +s -p me -P ${XILINX_VITIS}/aietools/data/aie_ml/lib/ +w work +o work -I%S -I. %S/testbench.cc %S/kernel.cc
// RUN: cp -r %S/data . && xme_ca_udm_dbg -qf -T -P ${XILINX_VITIS}/aietools/data/aie_ml/lib/ -t "%S/../profiling.tcl ./work/a.out"
