    ...
    chess_prepare_for_pipelining chess_loop_range(16, 16) {
      ...
      for (size_t v20 = v17; v20 < v18; v20 += v19)
        chess_prepare_for_pipelining chess_loop_range(8, 8) {
          v64int8 v21 = *(v64int8 *)(v1 + 288 * v12 + v20);
          v32acc32 v22 = mul_conv_32x8(v21, v6);
          v64int8 v23 = *(v64int8 *)(v1 + 288 * v14 + v20);
          v22 = mac_conv_32x8(v23, v7, v22);
          v64int8 v24 = *(v64int8 *)(v1 + 288 * v16 + v20);
          v22 = mac_conv_32x8(v24, v8, v22);
          v32int8 v25 = srs_to_v32int8(v22, 0);
          *(v32int8 *)(v3 + 256 * v12 + v20) = v25;
        }
    }
  return;
}
