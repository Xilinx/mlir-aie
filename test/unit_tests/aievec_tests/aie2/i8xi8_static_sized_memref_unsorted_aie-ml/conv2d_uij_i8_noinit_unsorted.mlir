...
func.func @conv2d (%A: memref<18x288xi8>, %B: memref<48xi8>, %C: memref<16x256xi8>) {
    affine.for %arg3 = 0 to 16 {
        affine.for %arg4 = 0 to 256 {
            //First row
            //first point 
            %a11 = affine.load %A[%arg3+1, %arg4+0] : memref<18x288xi8>
            %b11 = affine.load %B[16] : memref<48xi8>
            %p11 = arith.muli %a11, %b11 : i8

            //second point 
            %a12 = affine.load %A[%arg3+2, %arg4+2] : memref<18x288xi8>
            %b12 = affine.load %B[36] : memref<48xi8>
            ...
            //Second row
            //first point 
            %a21 = affine.load %A[%arg3, %arg4+0] : memref<18x288xi8>
            %b21 = affine.load %B[0] : memref<48xi8>
            ...
            //third point 
            %a33 = affine.load %A[%arg3, %arg4+1] : memref<18x288xi8>
            %b33 = affine.load %B[2] : memref<48xi8>
