...
// RUN: xchesscc_wrapper aie2 -f -g +s +w work +o work -I%S -I ../../../../aie_runtime_lib/AIE2 -L../../../../aie_runtime_lib/AIE2 -lexp_lut -I %aietools/include -D__AIEARCH__=20 -D__AIENGINE__ -I. %S/testbench.cc dut.cc
// RUN: mkdir -p data
