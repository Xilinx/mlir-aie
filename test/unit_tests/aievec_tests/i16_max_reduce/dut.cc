void dut(int16_t *restrict v1, int16_t *restrict v2) {
  v32int16 v3 = broadcast_to_v32int16((int16_t)-32768);
  size_t v4 = 0;
  size_t v5 = 1024;
  size_t v6 = 32;
  v32int16 v7;
