//===- pinned_adapt_coherent.mlir -----------------------------*- MLIR -*-===//
//
...
// RUN: aie-opt %s --aie-pin-control-overlay='mode=adapt' --aie-create-pathfinder-flows | FileCheck %s

// Adaptive control pinning captures a COHERENT control spine: a control
