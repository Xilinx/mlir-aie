...
// CHECK:   aie.packet_source<%[[tile_0_0]], Control : 0>
...
// TCTALLTILES:   aie.packet_source<%[[tile_0_0]], Control : 0>
...
// TCTALLTILES:   aie.packet_source<%[[tile_0_1]], Control : 0>
// TCTALLTILES:   aie.packet_dest<%[[tile_0_0]], South : 0>
// TCTALLTILES: }{{.*}}keep_pkt_header = true{{.*}}priority_route = true
...
// CTRLPKT:   aie.packet_dest<%[[tile_0_0]], Control : 0>
// CTRLPKT: }
...
// CTRLPKT:   aie.packet_source<%[[tile_0_0]], DMA : 0>
// CTRLPKT:   aie.packet_dest<%[[tile_0_1]], Control : 0>
// CTRLPKT: }
...
// CHECK: }{{.*}}keep_pkt_header = true{{.*}}priority_route = true
// CHECK: aie.packet_flow(15) {
// CHECK:   aie.packet_source<%[[tile_1_0]], Control : 0>
...
// TCTALLTILES: }{{.*}}keep_pkt_header = true{{.*}}priority_route = true
// TCTALLTILES: aie.packet_flow(15) {
// TCTALLTILES:   aie.packet_source<%[[tile_1_0]], Control : 0>
// TCTALLTILES:   aie.packet_dest<%[[tile_1_0]], South : 0>
// TCTALLTILES: }{{.*}}keep_pkt_header = true{{.*}}priority_route = true
// TCTALLTILES: aie.packet_flow(26) {
// TCTALLTILES:   aie.packet_source<%[[tile_1_1]], Control : 0>
// TCTALLTILES:   aie.packet_dest<%[[tile_1_0]], South : 0>
// TCTALLTILES: }{{.*}}keep_pkt_header = true{{.*}}priority_route = true
// CTRLPKT-LABEL: module {
// CTRLPKT: %[[tile_0_0:.*]] = aie.tile(0, 0)
...
// CTRLPKT:   aie.packet_dest<%[[tile_1_0]], Control : 0>
// CTRLPKT: }
...
// CTRLPKT: aie.packet_flow(26) {
// CTRLPKT:   aie.packet_source<%[[tile_1_0]], DMA : 0>
// CTRLPKT:   aie.packet_dest<%[[tile_1_1]], Control : 0>
// CTRLPKT: }
...
// TCTALLTILES:   aie.packet_source<%[[tile_0_2]], Control : 0>
// TCTALLTILES:   aie.packet_dest<%[[tile_0_0]], South : 0>
// TCTALLTILES: }{{.*}}keep_pkt_header = true{{.*}}priority_route = true
// TCTALLTILES: aie.packet_flow(1) {
// TCTALLTILES:   aie.packet_source<%[[tile_0_3]], Control : 0>
// TCTALLTILES:   aie.packet_dest<%[[tile_0_0]], South : 0>
// TCTALLTILES: }{{.*}}keep_pkt_header = true{{.*}}priority_route = true
// TCTALLTILES: aie.packet_flow(6) {
// TCTALLTILES:   aie.packet_source<%[[tile_0_4]], Control : 0>
// TCTALLTILES:   aie.packet_dest<%[[tile_0_0]], South : 0>
// TCTALLTILES: }{{.*}}keep_pkt_header = true{{.*}}priority_route = true
// TCTALLTILES: aie.packet_flow(2) {
// TCTALLTILES:   aie.packet_source<%[[tile_0_5]], Control : 0>
// TCTALLTILES:   aie.packet_dest<%[[tile_0_0]], South : 0>
// TCTALLTILES: }{{.*}}keep_pkt_header = true{{.*}}priority_route = true
// TCTALLTILES: aie.packet_flow(5) {
// TCTALLTILES:   aie.packet_source<%[[tile_1_0]], Control : 0>
...
// CTRLPKT:   aie.packet_source<%[[tile_0_0]], DMA : 0>
// CTRLPKT:   aie.packet_dest<%[[tile_0_2]], Control : 0>
// CTRLPKT: }
// CTRLPKT: aie.packet_flow(1) {
// CTRLPKT:   aie.packet_source<%[[tile_0_0]], DMA : 1>
// CTRLPKT:   aie.packet_dest<%[[tile_0_3]], Control : 0>
// CTRLPKT: }
...
// CTRLPKT:   aie.packet_source<%[[tile_0_0]], DMA : 1>
// CTRLPKT:   aie.packet_dest<%[[tile_0_4]], Control : 0>
// CTRLPKT: }
// CTRLPKT: aie.packet_flow(2) {
// CTRLPKT:   aie.packet_source<%[[tile_0_0]], DMA : 1>
// CTRLPKT:   aie.packet_dest<%[[tile_0_5]], Control : 0>
// CTRLPKT: }
// CTRLPKT: aie.packet_flow(5) {
// CTRLPKT:   aie.packet_source<%[[tile_1_0]], DMA : 0>
// CTRLPKT:   aie.packet_dest<%[[tile_1_0]], Control : 0>
