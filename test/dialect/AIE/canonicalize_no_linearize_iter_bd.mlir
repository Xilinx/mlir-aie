...
// CANON:         aie.dma_bd(%arg0 : memref<131072xbf16> offset = 0 len = 4096 sizes = [32, 1, 64, 64] strides = [4096, 64, 64, 1])
...
// CANON:         aie.dma_bd(%arg0 : memref<131072xbf16> offset = 0 len = 131072)
// CANON-NOT:         sizes = [
module {
  aie.device(npu1) {
    %tile_0_0 = aie.tile(0, 0)
...
// CANON:         aie.dma_bd(%arg0 : memref<4096xbf16> offset = 0 len = 4096)
// CANON-NOT:         sizes = [
module {
  aie.device(npu1) {
    %tile_0_0 = aie.tile(0, 0)
