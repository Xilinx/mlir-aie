//===- freeze_missing_control_source.mlir --------------------*- MLIR -*-===//
//
...
// RUN: not aie-opt %s --aie-freeze-control-fabric 2>&1 | FileCheck %s
...
// config-to-config, silently defeating the freeze for that source. Here @cfg's
