...
// CHECK: error: ObjectFifoLinkOp only supports 'join' and distribute' with same number of inputs and outputs
...
aie.device(xcve2302) {
   ...
   aie.objectfifo @of_in1 (%tile20, {%tile21}, 2 : i32) : !aie.objectfifo<memref<32xi32>>
   ...
   aie.objectfifo.link [@of_in1] -> [@of_out1, @of_out2] ([0][0, 16])
}

// -----

// CHECK: error: ObjectFifoLinkOp only supports 'join' and distribute' with equal number of offsets
...
aie.device(xcve2302) {
   ...
   aie.objectfifo.link [@of_in1, @of_in2] -> [@of_out1, @of_out2] ([0][0, 16])
}

// -----

// CHECK: error: ObjectFifoLinkOp only supports 'join' and distribute' with equal offsets
...
aie.device(xcve2302) {
   ...
   aie.objectfifo.link [@of_in1, @of_in2] -> [@of_out1, @of_out2] ([0, 32][0, 16])
}
