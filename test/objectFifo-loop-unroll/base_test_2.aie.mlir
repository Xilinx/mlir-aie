...
module @loopUnrollWithRemainder  {
    ...
    %core12 = AIE.core(%tile12) {
        ...
        %subviewInit = AIE.objectFifo.acquire{ port = "produce" }(%objFifo : !AIE.objectFifo<memref<16xi32>>, 1) : !AIE.objectFifoSubview<memref<16xi32>>
        %elemInit0 = AIE.objectFifo.subview.access %subviewInit[0] : !AIE.objectFifoSubview<memref<16xi32>> -> memref<16xi32>
        call @some_work(%elemInit0) : (memref<16xi32>) -> ()
