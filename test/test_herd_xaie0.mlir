...
// CHECK: 	XAIETILE_STRSW_MPORT_NORTH(&(TileInst[x][y + 1]), 0),
// CHECK: 	XAIE_ENABLE);
// CHECK: }
// CHECK: }
...
// CHECK: XAieTile_StrmConnectCct(&(TileInst[x][y + 1]),
// CHECK: 	XAIETILE_STRSW_SPORT_NORTH(&(TileInst[x][y + 1]), 0),
// CHECK: 	XAIETILE_STRSW_MPORT_DMA(&(TileInst[x][y + 1]), 0),
// CHECK: 	XAIE_ENABLE);
// CHECK: XAieTile_StrmConnectCct(&(TileInst[x][y + 1]),
// CHECK: 	XAIETILE_STRSW_SPORT_NORTH(&(TileInst[x][y + 1]), 0),
// CHECK: 	XAIETILE_STRSW_MPORT_SOUTH(&(TileInst[x][y + 1]), 0),
// CHECK: 	XAIE_ENABLE);
// CHECK: }
// CHECK: }
...
// CHECK: XAieTile_StrmConnectCct(&(TileInst[x][y + 1]),
// CHECK: 	XAIETILE_STRSW_SPORT_DMA(&(TileInst[x][y + 1]), 0),
// CHECK: 	XAIETILE_STRSW_MPORT_NORTH(&(TileInst[x][y + 1]), 1),
// CHECK: 	XAIE_ENABLE);
// CHECK: XAieTile_StrmConnectCct(&(TileInst[x][y + 1]),
// CHECK: 	XAIETILE_STRSW_SPORT_EAST(&(TileInst[x][y + 1]), 0),
// CHECK: 	XAIETILE_STRSW_MPORT_NORTH(&(TileInst[x][y + 1]), 2),
// CHECK: 	XAIE_ENABLE);
// CHECK: XAieTile_StrmConnectCct(&(TileInst[x][y + 1]),
// CHECK: 	XAIETILE_STRSW_SPORT_EAST(&(TileInst[x][y + 1]), 1),
// CHECK: 	XAIETILE_STRSW_MPORT_NORTH(&(TileInst[x][y + 1]), 3),
// CHECK: 	XAIE_ENABLE);
// CHECK: XAieTile_StrmConnectCct(&(TileInst[x][y + 1]),
// CHECK: 	XAIETILE_STRSW_SPORT_EAST(&(TileInst[x][y + 1]), 2),
// CHECK: 	XAIETILE_STRSW_MPORT_NORTH(&(TileInst[x][y + 1]), 4),
// CHECK: 	XAIE_ENABLE);
// CHECK: }
// CHECK: }
// CHECK: for (x = pp_X + 0; x < pp_X + 1; x += 1) {
...
// CHECK: XAieTile_StrmConnectCct(&(TileInst[x][y + 1]),
// CHECK: 	XAIETILE_STRSW_SPORT_SOUTH(&(TileInst[x][y + 1]), 1),
// CHECK: 	XAIETILE_STRSW_MPORT_NORTH(&(TileInst[x][y + 1]), 1),
// CHECK: 	XAIE_ENABLE);
// CHECK: XAieTile_StrmConnectCct(&(TileInst[x][y + 1]),
// CHECK: 	XAIETILE_STRSW_SPORT_SOUTH(&(TileInst[x][y + 1]), 2),
// CHECK: 	XAIETILE_STRSW_MPORT_NORTH(&(TileInst[x][y + 1]), 2),
// CHECK: 	XAIE_ENABLE);
// CHECK: XAieTile_StrmConnectCct(&(TileInst[x][y + 1]),
// CHECK: 	XAIETILE_STRSW_SPORT_SOUTH(&(TileInst[x][y + 1]), 3),
// CHECK: 	XAIETILE_STRSW_MPORT_NORTH(&(TileInst[x][y + 1]), 3),
// CHECK: 	XAIE_ENABLE);
// CHECK: XAieTile_StrmConnectCct(&(TileInst[x][y + 1]),
// CHECK: 	XAIETILE_STRSW_SPORT_SOUTH(&(TileInst[x][y + 1]), 4),
// CHECK: 	XAIETILE_STRSW_MPORT_NORTH(&(TileInst[x][y + 1]), 4),
// CHECK: 	XAIE_ENABLE);
// CHECK: }
// CHECK: }
...
// CHECK: XAieTile_StrmConnectCct(&(TileInst[x][y + 1]),
// CHECK: 	XAIETILE_STRSW_SPORT_DMA(&(TileInst[x][y + 1]), 0),
// CHECK: 	XAIETILE_STRSW_MPORT_WEST(&(TileInst[x][y + 1]), 0),
// CHECK: 	XAIE_ENABLE);
// CHECK: XAieTile_StrmConnectCct(&(TileInst[x][y + 1]),
// CHECK: 	XAIETILE_STRSW_SPORT_EAST(&(TileInst[x][y + 1]), 1),
// CHECK: 	XAIETILE_STRSW_MPORT_WEST(&(TileInst[x][y + 1]), 1),
// CHECK: 	XAIE_ENABLE);
// CHECK: XAieTile_StrmConnectCct(&(TileInst[x][y + 1]),
// CHECK: 	XAIETILE_STRSW_SPORT_EAST(&(TileInst[x][y + 1]), 2),
// CHECK: 	XAIETILE_STRSW_MPORT_WEST(&(TileInst[x][y + 1]), 2),
// CHECK: 	XAIE_ENABLE);
// CHECK: }
// CHECK: }
// CHECK: for (x = pp_X + 0; x < pp_X + 1; x += 1) {
...
// CHECK: XAieTile_StrmConnectCct(&(TileInst[x][y + 1]),
// CHECK: 	XAIETILE_STRSW_SPORT_SOUTH(&(TileInst[x][y + 1]), 1),
// CHECK: 	XAIETILE_STRSW_MPORT_DMA(&(TileInst[x][y + 1]), 1),
// CHECK: 	XAIE_ENABLE);
// CHECK: XAieTile_StrmConnectCct(&(TileInst[x][y + 1]),
// CHECK: 	XAIETILE_STRSW_SPORT_SOUTH(&(TileInst[x][y + 1]), 2),
// CHECK: 	XAIETILE_STRSW_MPORT_NORTH(&(TileInst[x][y + 1]), 1),
