...
// CHECK: XAieTile_CoreControl(&(TileInst[4][4]), XAIE_ENABLE, XAIE_DISABLE);
...
// CHECK: XAieDma_TileInitialize(&(TileInst[4][4]), &(TileDMAInst[4][4]));
// CHECK: XAieDma_TileBdClearAll(&(TileDMAInst[4][4]));
// CHECK: XAieDma_TileChResetAll(&(TileDMAInst[4][4]));
// CHECK: XAieDma_TileBdSetLock(&(TileDMAInst[4][4]), 0, XAIEDMA_TILE_BD_ADDRA, 0, XAIE_ENABLE, 1, XAIE_ENABLE, 0);
// CHECK: XAieDma_TileBdSetAdrLenMod(&(TileDMAInst[4][4]), 0, 0x0, 0x0, 16, XAIE_ENABLE, XAIE_DISABLE);
// CHECK: XAieDma_TileBdSetLock(&(TileDMAInst[4][4]), 1, XAIEDMA_TILE_BD_ADDRA, 1, XAIE_ENABLE, 1, XAIE_ENABLE, 0);
// CHECK: XAieDma_TileBdSetAdrLenMod(&(TileDMAInst[4][4]), 1, 0x100, 0x0, 16, XAIE_ENABLE, XAIE_DISABLE);
// CHECK: XAieDma_TileBdSetLock(&(TileDMAInst[4][4]), 2, XAIEDMA_TILE_BD_ADDRA, 2, XAIE_ENABLE, 1, XAIE_ENABLE, 0);
// CHECK: XAieDma_TileBdSetAdrLenMod(&(TileDMAInst[4][4]), 2, 0x200, 0x0, 16, XAIE_ENABLE, XAIE_DISABLE);
// CHECK: XAieDma_TileBdSetLock(&(TileDMAInst[4][4]), 3, XAIEDMA_TILE_BD_ADDRA, 3, XAIE_ENABLE, 1, XAIE_ENABLE, 0);
// CHECK: XAieDma_TileBdSetAdrLenMod(&(TileDMAInst[4][4]), 3, 0x300, 0x0, 16, XAIE_ENABLE, XAIE_DISABLE);
// CHECK: XAieDma_TileBdWrite(&(TileDMAInst[4][4]), 2);
// CHECK: XAieDma_TileBdSetNext(&(TileDMAInst[4][4]), 2, 3);
// CHECK: XAieDma_TileBdWrite(&(TileDMAInst[4][4]), 0);
// CHECK: XAieDma_TileBdSetNext(&(TileDMAInst[4][4]), 0, 1);
// CHECK: XAieDma_TileBdWrite(&(TileDMAInst[4][4]), 1);
// CHECK: XAieDma_TileBdSetNext(&(TileDMAInst[4][4]), 1, 2);
// CHECK: XAieDma_TileBdWrite(&(TileDMAInst[4][4]), 3);
// CHECK: XAieDma_TileSetStartBd(&(TileDMAInst[4][4]), XAIEDMA_TILE_CHNUM_S2MM0, 0);
// CHECK: XAieDma_TileChControl(&(TileDMAInst[4][4]), XAIEDMA_TILE_CHNUM_S2MM0, XAIE_RESETDISABLE, XAIE_ENABLE);
