...
// Placement maximises the largest free run it leaves behind, so these pack
// head to tail in one bank rather than taking a fresh bank each: "b" fills
// 1024-3072, "c" follows at 3072 and "a" at 3104, leaving everything above
// 3120 free in one piece for the core's own sections.
