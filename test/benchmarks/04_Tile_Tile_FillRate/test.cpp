...
main(int argc, char *argv[])
{
    ...
    // Destination Tile
    EventMon pc0(&TileInst[1][4], 0, XAIETILE_EVENT_MEM_BROADCAST_2, XAIETILE_EVENT_MEM_DMA_S2MM_1_FINISHED_BD, XAIETILE_EVENT_MEM_NONE, MODE_MEM);
    pc0.set();
    EventMon pc1(&TileInst[1][4], 1, XAIETILE_EVENT_MEM_BROADCAST_2, XAIETILE_EVENT_MEM_LOCK_6_RELEASE, XAIETILE_EVENT_MEM_NONE, MODE_MEM);
    pc1.set();

    //Source Tile
    EventMon pc2(&TileInst[1][3], 0, XAIETILE_EVENT_MEM_LOCK_5_ACQUIRED, XAIETILE_EVENT_MEM_DMA_MM2S_0_FINISHED_BD, XAIETILE_EVENT_MEM_NONE, MODE_MEM);
    pc2.set();
    EventMon pc3(&TileInst[1][3], 1, XAIETILE_EVENT_MEM_LOCK_5_ACQUIRED, XAIETILE_EVENT_MEM_LOCK_5_RELEASE, XAIETILE_EVENT_MEM_NONE, MODE_MEM);
    pc3.set();


    XAieTileMem_EventBroadcast(&TileInst[1][3], 2, XAIETILE_EVENT_MEM_LOCK_5_ACQUIRED); // Start
