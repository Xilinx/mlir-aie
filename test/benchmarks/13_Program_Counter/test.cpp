...
int main(int argc, char *argv[])
{
  ...
  for (int iters = 0; iters < n; iters++)
  {
    ...
    // EventMon pc0(&TileInst[7][3], 0, XAIETILE_EVENT_CORE_ACTIVE, XAIETILE_EVENT_CORE_DISABLED, XAIETILE_EVENT_CORE_NONE, MODE_CORE);
    // pc0.set();

    XAieTileCore_EventPCEvent(&TileInst[7][3], XAIETILE_EVENT_CORE_PC_EVENT0, 0x00, 1);
     XAieTileCore_EventPCEvent(&TileInst[7][3], XAIETILE_EVENT_CORE_PC_EVENT1, 0x088, 1);

    EventMon pc1(&TileInst[7][3], 1, XAIETILE_EVENT_CORE_PC_0, XAIETILE_EVENT_CORE_PC_1, XAIETILE_EVENT_CORE_NONE, MODE_CORE);
    pc1.set();
