...
int main(int argc, char *argv[])
{
  ...
  for (int iters = 0; iters < n; iters++)
  {
    ...
    XAieTilePl_EventBroadcast(&TileInst[7][0], 2, XAIETILE_EVENT_SHIM_LOCK_1_ACQUIRED_NOC); // Start
    XAieTilePl_EventBroadcast(&TileInst[7][0], 3, XAIETILE_EVENT_SHIM_LOCK_1_RELEASE_NOC); // Stop


    EventMon pc2(&TileInst[7][1], 0, XAIETILE_EVENT_MEM_BROADCAST_2, XAIETILE_EVENT_MEM_LOCK_0_RELEASE, XAIETILE_EVENT_MEM_NONE, MODE_MEM);
    pc2.set();
