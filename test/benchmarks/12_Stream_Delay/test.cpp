...
main(int argc, char *argv[])
{
    ...
    // Destination Tile
    EventMon pc0(&TileInst[4][3], 0, XAIETILE_EVENT_MEM_BROADCAST_2, XAIETILE_EVENT_MEM_DMA_S2MM_1_FINISHED_BD, XAIETILE_EVENT_MEM_NONE, MODE_MEM);
    pc0.set();
    EventMon pc1(&TileInst[4][3], 1, XAIETILE_EVENT_MEM_BROADCAST_2, XAIETILE_EVENT_MEM_LOCK_6_RELEASE, XAIETILE_EVENT_MEM_NONE, MODE_MEM);
    pc1.set();
