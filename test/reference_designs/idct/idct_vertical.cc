...
alignas(v16int16) int16_t cospi_coeff_lut_v[DCT8x8_BLOCK_WIDTH*DCT8x8_BLOCK_HEIGHT] = {
...
alignas(v8int16) int16_t ffv_lut[8] = {
    512, 512, 512, 512, 512, 512, 512, 512
};
// void idct_8x8_mmult_v(int16_t  *restrict input,
                   ...
                   int16_t *restrict output)
{
    ...
    int16_t SHIFT_TXFM = DCT8x8_SHIFT_V_TXFM;
    ...
    for (int j=0; j<NUM_DCT8x8_BLOCKS_PER_ITERATION; ++j)
        ...
        chess_loop_range(NUM_DCT8x8_BLOCKS_PER_ITERATION, )  //pre-condition n > 1
#endif
    {
