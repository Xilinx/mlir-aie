...
main(int argc, char *argv[])
{
    ...
    */
    ...
    if (fd != -1) {
        ddr_ptr_in  = (float *)mmap(NULL, 0x1400, PROT_READ|PROT_WRITE, MAP_SHARED, fd, DDR_ADDR_IN);
        ddr_ptr_out = (float *)mmap(NULL, 0x1400, PROT_READ|PROT_WRITE, MAP_SHARED, fd, DDR_ADDR_OUT);
