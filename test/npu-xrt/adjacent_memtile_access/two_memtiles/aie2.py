...
# RUN: %aiecc %backend_flags --no-aiesim --get-xclbin --get-npu-insts --no-compile-host --alloc-scheme=basic-sequential --xclbin-name=aie.xclbin --npu-insts-name=insts.bin ./aie2.mlir
