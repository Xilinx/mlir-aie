  ...
  aie.device(NPUDEVICE) {
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775806 step %c2 {
        ...
        aie.use_lock(%in2_mem_cons_cons_lock, AcquireGreaterEqual, %c1_ul0)
        scf.for %arg1 = %c0 to %c16 step %c2 {
          %c1_ul1 = arith.constant 1 : i32
          aie.use_lock(%in1_cons_cons_lock, AcquireGreaterEqual, %c1_ul1)
          %c1_ul2 = arith.constant 1 : i32
          aie.use_lock(%out_prod_lock, AcquireGreaterEqual, %c1_ul2)
          ...
          aie.use_lock(%in1_cons_prod_lock, Release, %c1_ul3)
          %c1_ul4 = arith.constant 1 : i32
          aie.use_lock(%out_cons_lock, Release, %c1_ul4)
          %0 = arith.addi %arg1, %c1 : index
          %c1_ul5 = arith.constant 1 : i32
          aie.use_lock(%in1_cons_cons_lock, AcquireGreaterEqual, %c1_ul5)
          %c1_ul6 = arith.constant 1 : i32
          aie.use_lock(%out_prod_lock, AcquireGreaterEqual, %c1_ul6)
          ...
          aie.use_lock(%in1_cons_prod_lock, Release, %c1_ul7)
          %c1_ul8 = arith.constant 1 : i32
          aie.use_lock(%out_cons_lock, Release, %c1_ul8)
        }
        %c1_ul9 = arith.constant 1 : i32
        aie.use_lock(%in2_mem_cons_prod_lock, Release, %c1_ul9)
        %c1_ul10 = arith.constant 1 : i32
        aie.use_lock(%in2_mem_cons_cons_lock, AcquireGreaterEqual, %c1_ul10)
        scf.for %arg1 = %c0 to %c16 step %c2 {
          %c1_ul11 = arith.constant 1 : i32
          aie.use_lock(%in1_cons_cons_lock, AcquireGreaterEqual, %c1_ul11)
          %c1_ul12 = arith.constant 1 : i32
          aie.use_lock(%out_prod_lock, AcquireGreaterEqual, %c1_ul12)
          scf.for %arg2 = %c0 to %c16 step %c1 {
            %1 = memref.load %in1_cons_buff_0[%arg2] : memref<16xi32>
            %2 = arith.muli %arg1, %c16 : index
            %3 = arith.addi %arg2, %2 : index
          ...
          aie.use_lock(%in1_cons_prod_lock, Release, %c1_ul13)
          %c1_ul14 = arith.constant 1 : i32
          aie.use_lock(%out_cons_lock, Release, %c1_ul14)
          %0 = arith.addi %arg1, %c1 : index
          %c1_ul15 = arith.constant 1 : i32
          aie.use_lock(%in1_cons_cons_lock, AcquireGreaterEqual, %c1_ul15)
          %c1_ul16 = arith.constant 1 : i32
          aie.use_lock(%out_prod_lock, AcquireGreaterEqual, %c1_ul16)
          scf.for %arg2 = %c0 to %c16 step %c2 {
            %1 = memref.load %in1_cons_buff_1[%arg2] : memref<16xi32>
            %2 = arith.muli %0, %c16 : index
            %3 = arith.addi %arg2, %2 : index
          ...
          aie.use_lock(%in1_cons_prod_lock, Release, %c1_ul17)
          %c1_ul18 = arith.constant 1 : i32
          aie.use_lock(%out_cons_lock, Release, %c1_ul18)
        }
        %c1_ul19 = arith.constant 1 : i32
        aie.use_lock(%in2_mem_cons_prod_lock, Release, %c1_ul19)
      }
      %c1_ul20 = arith.constant 1 : i32
      aie.use_lock(%in2_mem_cons_cons_lock, AcquireGreaterEqual, %c1_ul20)
      scf.for %arg0 = %c0 to %c16 step %c2 {
        %c1_ul21 = arith.constant 1 : i32
        aie.use_lock(%in1_cons_cons_lock, AcquireGreaterEqual, %c1_ul21)
        %c1_ul22 = arith.constant 1 : i32
        aie.use_lock(%out_prod_lock, AcquireGreaterEqual, %c1_ul22)
        ...
        aie.use_lock(%in1_cons_prod_lock, Release, %c1_ul23)
        %c1_ul24 = arith.constant 1 : i32
        aie.use_lock(%out_cons_lock, Release, %c1_ul24)
        %0 = arith.addi %arg0, %c1 : index
        %c1_ul25 = arith.constant 1 : i32
        aie.use_lock(%in1_cons_cons_lock, AcquireGreaterEqual, %c1_ul25)
        %c1_ul26 = arith.constant 1 : i32
        aie.use_lock(%out_prod_lock, AcquireGreaterEqual, %c1_ul26)
        scf.for %arg1 = %c0 to %c16 step %c2 {
        ...
        aie.use_lock(%in1_cons_prod_lock, Release, %c1_ul27)
        %c1_ul28 = arith.constant 1 : i32
        aie.use_lock(%out_cons_lock, Release, %c1_ul28)
      }
      %c1_ul29 = arith.constant 1 : i32
      aie.use_lock(%in2_mem_cons_prod_lock, Release, %c1_ul29)
      aie.end
    }
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.use_lock(%in1_cons_prod_lock, AcquireGreaterEqual, %c1_ul30)
      aie.dma_bd(%in1_cons_buff_0 : memref<16xi32>, 0, 16)
      %c1_ul31 = arith.constant 1 : i32
      aie.use_lock(%in1_cons_cons_lock, Release, %c1_ul31)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      %c1_ul32 = arith.constant 1 : i32
      aie.use_lock(%in1_cons_prod_lock, AcquireGreaterEqual, %c1_ul32)
      aie.dma_bd(%in1_cons_buff_1 : memref<16xi32>, 0, 16)
      %c1_ul33 = arith.constant 1 : i32
      aie.use_lock(%in1_cons_cons_lock, Release, %c1_ul33)
      aie.next_bd ^bb1
    ^bb3:  // pred: ^bb0
      %1 = aie.dma_start(S2MM, 1, ^bb4, ^bb6)
    ^bb4:  // 2 preds: ^bb3, ^bb5
      %c1_ul34 = arith.constant 1 : i32
      aie.use_lock(%in2_mem_cons_prod_lock, AcquireGreaterEqual, %c1_ul34)
      aie.dma_bd(%in2_mem_cons_buff_0 : memref<256xi32>, 0, 256)
      %c1_ul35 = arith.constant 1 : i32
      aie.use_lock(%in2_mem_cons_cons_lock, Release, %c1_ul35)
      aie.next_bd ^bb5
    ^bb5:  // pred: ^bb4
      %c1_ul36 = arith.constant 1 : i32
      aie.use_lock(%in2_mem_cons_prod_lock, AcquireGreaterEqual, %c1_ul36)
      aie.dma_bd(%in2_mem_cons_buff_1 : memref<256xi32>, 0, 256)
      %c1_ul37 = arith.constant 1 : i32
      aie.use_lock(%in2_mem_cons_cons_lock, Release, %c1_ul37)
      aie.next_bd ^bb4
    ^bb6:  // pred: ^bb3
      %2 = aie.dma_start(MM2S, 0, ^bb7, ^bb9)
    ^bb7:  // 2 preds: ^bb6, ^bb8
      %c1_ul38 = arith.constant 1 : i32
      aie.use_lock(%out_cons_lock, AcquireGreaterEqual, %c1_ul38)
      aie.dma_bd(%out_buff_0 : memref<16xi32>, 0, 16)
      %c1_ul39 = arith.constant 1 : i32
      aie.use_lock(%out_prod_lock, Release, %c1_ul39)
      aie.next_bd ^bb8
    ^bb8:  // pred: ^bb7
      %c1_ul40 = arith.constant 1 : i32
      aie.use_lock(%out_cons_lock, AcquireGreaterEqual, %c1_ul40)
      aie.dma_bd(%out_buff_1 : memref<16xi32>, 0, 16)
      %c1_ul41 = arith.constant 1 : i32
      aie.use_lock(%out_prod_lock, Release, %c1_ul41)
      aie.next_bd ^bb7
    ^bb9:  // pred: ^bb6
      aie.end
    }
    ...
    ^bb1:
      ...
      aie.use_lock(%in2_mem_cons_lock, AcquireGreaterEqual, %c1_ul42)
      aie.dma_bd(%in2_mem_buff_0 : memref<256xi32>, 0, 256)
      %c1_ul43 = arith.constant 1 : i32
      aie.use_lock(%in2_mem_prod_lock, Release, %c1_ul43)
      aie.next_bd ^bb2
    ^bb2:
      %c1_ul44 = arith.constant 1 : i32
      aie.use_lock(%in2_mem_cons_lock, AcquireGreaterEqual, %c1_ul44)
      aie.dma_bd(%in2_mem_buff_1 : memref<256xi32>, 0, 256)
      %c1_ul45 = arith.constant 1 : i32
      aie.use_lock(%in2_mem_prod_lock, Release, %c1_ul45)
      aie.next_bd ^bb1
    ^bb3:
      aie.end
    }
