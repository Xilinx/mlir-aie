  ...
  aie.device(NPUDEVICE) @main {
    ...
    %mem_1_2 = aie.mem(%tile_1_2) {
      %0 = aie.dma(S2MM, 0) [{
        ...
        aie.dma_bd(%tile_1_2_buff_0 : memref<64x64xi8> offset = 0 sizes = [] strides = [])
        aie.use_lock(%tile_1_2_lock_1, Release, 1)
      }]
      %1 = aie.dma(MM2S, 0) [{
        aie.use_lock(%tile_1_2_lock_2, AcquireGreaterEqual, 1)
        aie.dma_bd(%tile_1_2_buff_1 : memref<64x64xi8> offset = 0 sizes = [] strides = [])
    ...
    %mem_2_2 = aie.mem(%tile_2_2) {
      %0 = aie.dma(S2MM, 0) [{
        ...
        aie.dma_bd(%tile_2_2_buff_0 : memref<64x64xi8> offset = 0 sizes = [] strides = [])
        aie.use_lock(%tile_2_2_lock_1, Release, 1)
      }]
      %1 = aie.dma(MM2S, 0) [{
        aie.use_lock(%tile_2_2_lock_2, AcquireGreaterEqual, 1)
        aie.dma_bd(%tile_2_2_buff_1 : memref<64x64xi8> offset = 0 sizes = [] strides = [])
    ...
    %mem_3_2 = aie.mem(%tile_3_2) {
      %0 = aie.dma(S2MM, 0) [{
        ...
        aie.dma_bd(%tile_3_2_buff_0 : memref<64x64xi8> offset = 0 sizes = [] strides = [])
        aie.use_lock(%tile_3_2_lock_1, Release, 1)
      }]
      %1 = aie.dma(MM2S, 0) [{
        aie.use_lock(%tile_3_2_lock_2, AcquireGreaterEqual, 1)
        aie.dma_bd(%tile_3_2_buff_1 : memref<64x64xi8> offset = 0 sizes = [] strides = [])
