...
module {
  aie.device(NPUDEVICE) {
    ...
    aie.runtime_sequence(%arg0: memref<64xi32>, %arg1: memref<32xi32>, %arg2: memref<64xi32>) {
      ...
      %cst_npu_0 = arith.constant 4 : i32
      %cst_npu_1 = arith.constant 42 : i32
      aiex.npu.write32(%cst_npu_0, %cst_npu_1) {buffer = @constant_buffer} : i32, i32
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.use_lock(%objFifo_in1_cons_prod_lock, AcquireGreaterEqual, %c1_ul8)
      aie.dma_bd(%objFifo_in1_cons_buff_0 : memref<8xi32>, 0, 8)
      %c1_ul9 = arith.constant 1 : i32
      aie.use_lock(%objFifo_in1_cons_cons_lock, Release, %c1_ul9)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      %c1_ul10 = arith.constant 1 : i32
      aie.use_lock(%objFifo_in1_cons_prod_lock, AcquireGreaterEqual, %c1_ul10)
      aie.dma_bd(%objFifo_in1_cons_buff_1 : memref<8xi32>, 0, 8)
      %c1_ul11 = arith.constant 1 : i32
      aie.use_lock(%objFifo_in1_cons_cons_lock, Release, %c1_ul11)
      aie.next_bd ^bb1
    ^bb3:  // pred: ^bb0
      %1 = aie.dma_start(MM2S, 0, ^bb4, ^bb6)
    ^bb4:  // 2 preds: ^bb3, ^bb5
      %c1_ul12 = arith.constant 1 : i32
      aie.use_lock(%objFifo_out1_cons_lock, AcquireGreaterEqual, %c1_ul12)
      aie.dma_bd(%objFifo_out1_buff_0 : memref<8xi32>, 0, 8)
      %c1_ul13 = arith.constant 1 : i32
      aie.use_lock(%objFifo_out1_prod_lock, Release, %c1_ul13)
      aie.next_bd ^bb5
    ^bb5:  // pred: ^bb4
      %c1_ul14 = arith.constant 1 : i32
      aie.use_lock(%objFifo_out1_cons_lock, AcquireGreaterEqual, %c1_ul14)
      aie.dma_bd(%objFifo_out1_buff_1 : memref<8xi32>, 0, 8)
      %c1_ul15 = arith.constant 1 : i32
      aie.use_lock(%objFifo_out1_prod_lock, Release, %c1_ul15)
      aie.next_bd ^bb4
    ^bb6:  // pred: ^bb3
      aie.end
    }
