  ...
  aie.device(NPUDEVICE) @main {
    ...
    %mem_0_3 = aie.mem(%tile_0_3) {
      %0 = aie.dma(S2MM, 0) [{
        ...
        aie.dma_bd(%tile_0_3_buff_0 : memref<64x64xi8> sizes = [] strides = [])
        aie.use_lock(%tile_0_3_lock_1, Release, 1)
      }]
      %1 = aie.dma(MM2S, 0) [{
        aie.use_lock(%tile_0_3_lock_2, AcquireGreaterEqual, 1)
        aie.dma_bd(%tile_0_3_buff_1 : memref<64x64xi8> sizes = [] strides = [])
    ...
    %mem_0_4 = aie.mem(%tile_0_4) {
      %0 = aie.dma(S2MM, 0) [{
        ...
        aie.dma_bd(%tile_0_4_buff_0 : memref<64x64xi8> sizes = [] strides = [])
        aie.use_lock(%tile_0_4_lock_1, Release, 1)
      }]
      %1 = aie.dma(MM2S, 0) [{
        aie.use_lock(%tile_0_4_lock_2, AcquireGreaterEqual, 1)
        aie.dma_bd(%tile_0_4_buff_1 : memref<64x64xi8> sizes = [] strides = [])
    ...
    %mem_0_5 = aie.mem(%tile_0_5) {
      %0 = aie.dma(S2MM, 0) [{
        ...
        aie.dma_bd(%tile_0_5_buff_0 : memref<64x64xi8> sizes = [] strides = [])
        aie.use_lock(%tile_0_5_lock_1, Release, 1)
      }]
      %1 = aie.dma(MM2S, 0) [{
        aie.use_lock(%tile_0_5_lock_2, AcquireGreaterEqual, 1)
        aie.dma_bd(%tile_0_5_buff_1 : memref<64x64xi8> sizes = [] strides = [])
    ...
    %memtile_dma_0_1 = aie.memtile_dma(%tile_0_1) {
      ...
      %0 = aie.dma(S2MM, 0) [{
        ...
        aie.dma_bd(%buff_0 : memref<4x64x64xi8> offset = %c0_i32 len = %c16384_i32 sizes = [] strides = [])
        aie.use_lock(%memtile_lock_1, Release, 4)
      }]
      %1 = aie.dma(MM2S, 0) [{
        aie.use_lock(%memtile_lock_1, AcquireGreaterEqual, 1)
        aie.dma_bd(%buff_0 : memref<4x64x64xi8> offset = %c0_i32 len = %c4096_i32 sizes = [] strides = [])
        aie.use_lock(%memtile_lock_0, Release, 1)
      }]
      %2 = aie.dma(MM2S, 1) [{
        aie.use_lock(%memtile_lock_1, AcquireGreaterEqual, 1)
        aie.dma_bd(%buff_0 : memref<4x64x64xi8> offset = %c4096_i32 len = %c4096_i32 sizes = [] strides = [])
        aie.use_lock(%memtile_lock_0, Release, 1)
      }]
      %3 = aie.dma(MM2S, 2) [{
        aie.use_lock(%memtile_lock_1, AcquireGreaterEqual, 1)
        aie.dma_bd(%buff_0 : memref<4x64x64xi8> offset = %c8192_i32 len = %c4096_i32 sizes = [] strides = [])
        aie.use_lock(%memtile_lock_0, Release, 1)
      }]
      %4 = aie.dma(MM2S, 3) [{
        aie.use_lock(%memtile_lock_1, AcquireGreaterEqual, 1)
        aie.dma_bd(%buff_0 : memref<4x64x64xi8> offset = %c12288_i32 len = %c4096_i32 sizes = [] strides = [])
        aie.use_lock(%memtile_lock_0, Release, 1)
      }]

      %5 = aie.dma(S2MM, 1) [{
        aie.use_lock(%memtile_lock_3, AcquireGreaterEqual, 1)
        aie.dma_bd(%buff_1 : memref<4x64x64xi8> offset = %c0_i32 len = %c4096_i32 sizes = [] strides = [])
        aie.use_lock(%memtile_lock_2, Release, 1)
      }]
      %6 = aie.dma(S2MM, 2) [{
        aie.use_lock(%memtile_lock_3, AcquireGreaterEqual, 1)
        aie.dma_bd(%buff_1 : memref<4x64x64xi8> offset = %c4096_i32 len = %c4096_i32 sizes = [] strides = [])
        aie.use_lock(%memtile_lock_2, Release, 1)
      }]
      %7 = aie.dma(S2MM, 3) [{
        aie.use_lock(%memtile_lock_3, AcquireGreaterEqual, 1)
        aie.dma_bd(%buff_1 : memref<4x64x64xi8> offset = %c8192_i32 len = %c4096_i32 sizes = [] strides = [])
        aie.use_lock(%memtile_lock_2, Release, 1)
      }]
      %8 = aie.dma(S2MM, 4) [{
        aie.use_lock(%memtile_lock_3, AcquireGreaterEqual, 1)
        aie.dma_bd(%buff_1 : memref<4x64x64xi8> offset = %c12288_i32 len = %c4096_i32 sizes = [] strides = [])
        aie.use_lock(%memtile_lock_2, Release, 1)
      }]
      %9 = aie.dma(MM2S, 4) [{
        aie.use_lock(%memtile_lock_2, AcquireGreaterEqual, 4)
        aie.dma_bd(%buff_1 : memref<4x64x64xi8> offset = %c0_i32 len = %c16384_i32 sizes = [] strides = [])
