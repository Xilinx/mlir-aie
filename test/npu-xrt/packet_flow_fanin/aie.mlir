...
module {
  aie.device(NPUDEVICE) {
    ...
    %objFifo_core02_cons_prod_lock = aie.lock(%tile_0_2, 0) {init = 2 : i32, sym_name = "objFifo_core02_cons_prod_lock"}
    ...
    // Packet id 0 and 4 fanin to tile_0_2's S2MM DMA channel 0
    aie.packet_flow(0) {
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg1 = %c0 to %c64 step %c1 {
        scf.for %arg2 = %c0 to %c64 step %c1 {
          %0 = memref.load %objFifo_core02_cons_buff_1[%arg1, %arg2] : memref<64x64xi8>
    ...
    aie.shim_dma_allocation @objFifo_in1 (%tile_0_0, MM2S, 1)
    ...
    %mem_0_2 = aie.mem(%tile_0_2) {
      %0 = aie.dma(S2MM, 0) [{
        ...
        aie.use_lock(%objFifo_core02_cons_prod_lock, AcquireGreaterEqual, 1)
        aie.dma_bd(%objFifo_core02_cons_buff_1 : memref<64x64xi8> offset = 0 sizes = [] strides = [])
        aie.use_lock(%objFifo_core02_cons_cons_lock, Release, 1)
      }]
      %1 = aie.dma(MM2S, 0) [{
