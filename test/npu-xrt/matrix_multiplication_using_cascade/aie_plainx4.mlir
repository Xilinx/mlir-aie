...
module {
  aie.device(npu1) {
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%buf11 : memref<2x2x4x8xi32, 2 : i32> offset = 0 len = 128 sizes = [] strides = [])
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.dma_bd(%buf10 : memref<2x2x8x4xi32, 2 : i32> offset = 0 len = 128 sizes = [] strides = [])
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%buf8 : memref<2x2x4x8xi32, 2 : i32> offset = 0 len = 128 sizes = [] strides = [])
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.dma_bd(%buf7 : memref<2x2x8x4xi32, 2 : i32> offset = 0 len = 128 sizes = [] strides = [])
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%buf5 : memref<2x2x4x8xi32, 2 : i32> offset = 0 len = 128 sizes = [] strides = [])
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.dma_bd(%buf4 : memref<2x2x8x4xi32, 2 : i32> offset = 0 len = 128 sizes = [] strides = [])
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%buf2 : memref<2x2x4x8xi32, 2 : i32> offset = 0 len = 128 sizes = [] strides = [])
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.dma_bd(%buf1 : memref<2x2x8x4xi32, 2 : i32> offset = 0 len = 128 sizes = [] strides = [])
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%buf14 : memref<16x16xi32, 1 : i32> offset = 0 len = 256 sizes = [] strides = [])
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%buf13 : memref<16x16xi32, 1 : i32> offset = 0 len = 256 sizes = [] strides = [])
    ...
    %memtile_dma_2_1 = aie.memtile_dma(%tile_2_1) {
      ...
      ^bb10:  // 2 preds: ^bb9, ^bb10
        ...
        aie.dma_bd(%buf12 : memref<16x16xi32, 1 : i32> offset = 0 len = 256 sizes = [] strides = [])
