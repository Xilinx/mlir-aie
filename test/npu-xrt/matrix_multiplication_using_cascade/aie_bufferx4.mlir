...
module {
  aie.device(npu1) {
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%buf2 : memref<1x4x4x4xi32, 2 : i32> offset = 0 len = 64 sizes = [] strides = [])
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.dma_bd(%buf1 : memref<4x1x4x4xi32, 2 : i32> offset = 0 len = 64 sizes = [] strides = [])
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%buf5 : memref<1x4x4x4xi32, 2 : i32> offset = 0 len = 64 sizes = [] strides = [])
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.dma_bd(%buf4 : memref<4x1x4x4xi32, 2 : i32> offset = 0 len = 64 sizes = [] strides = [])
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%buf8 : memref<1x4x4x4xi32, 2 : i32> offset = 0 len = 64 sizes = [] strides = [])
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.dma_bd(%buf7 : memref<4x1x4x4xi32, 2 : i32> offset = 0 len = 64 sizes = [] strides = [])
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%buf11 : memref<1x4x4x4xi32, 2 : i32> offset = 0 len = 64 sizes = [] strides = [])
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.dma_bd(%buf10 : memref<4x1x4x4xi32, 2 : i32> offset = 0 len = 64 sizes = [] strides = [])
