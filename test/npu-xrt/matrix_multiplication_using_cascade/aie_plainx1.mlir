...
module {
  aie.device(npu1) {
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%buf2 : memref<2x4x4x8xi32, 2 : i32> offset = %c0_i32 len = %c256_i32 sizes = [] strides = [])
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.dma_bd(%buf1 : memref<4x2x8x4xi32, 2 : i32> offset = %c0_i32 len = %c256_i32 sizes = [] strides = [])
    ...
    ^bb6:  // 2 preds: ^bb5, ^bb6
      ...
      aie.dma_bd(%buf0 : memref<4x4x4x4xi32, 2 : i32> offset = %c0_i32 len = %c256_i32 sizes = [16, 4, 4] strides = [4, 64, 1])
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%buf3 : memref<16x16xi32, 1 : i32> offset = %c0_i32 len = %c256_i32 sizes = [] strides = [])
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%buf5 : memref<16x16xi32, 1 : i32> offset = %c0_i32 len = %c256_i32 sizes = [] strides = [])
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.dma_bd(%buf5 : memref<16x16xi32, 1 : i32> offset = %c0_i32 len = %c256_i32 sizes = [2, 16, 8] strides = [8, 16, 1])
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%buf4 : memref<16x16xi32, 1 : i32> offset = %c0_i32 len = %c256_i32 sizes = [] strides = [])
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.dma_bd(%buf4 : memref<16x16xi32, 1 : i32> offset = %c0_i32 len = %c256_i32 sizes = [4, 16, 4] strides = [4, 16, 1])
