  ...
  aie.device(NPUDEVICE) {
    ...
    aie.runtime_sequence(%arg0: memref<4096xi32>, %arg1: memref<4096xi32>) {
      ...
      %t1 = aiex.dma_configure_task(%tile_0_1, S2MM, 0) {
        ...
        aie.use_lock(%prod_lock, AcquireGreaterEqual, %c1_ul0)
      ...
      ^bb1:
        ...
        aie.use_lock(%prod_lock, AcquireGreaterEqual, %c1_ul2)
      ...
      %t2 = aiex.dma_configure_task(%tile_0_1, MM2S, 0) {
        %c4_ul8 = arith.constant 4 : i32
        aie.use_lock(%cons_lock, AcquireGreaterEqual, %c4_ul8)
        aie.dma_bd(%out_buff : memref<4096xi32>, 0, 4096) {bd_id = 4 : i32}
        %c4_ul9 = arith.constant 4 : i32
        aie.use_lock(%prod_lock, Release, %c4_ul9)
        aie.end
      }
