...
module {
  aie.device(npu1_1col) {
    ...
    aie.runtime_sequence(%arg0: memref<4096xi32>, %arg1: memref<4096xi32>, %arg2: memref<4096xi32>) {
      ...
      aiex.npu.address_patch(%cst_npu_0 : i32) {addr = 0x1d004 : ui32, arg_idx = 2 : i32}
      %cst_npu_1 = arith.constant 0x1d200 : i32
      %cst_npu_2 = arith.constant 0x200 : i32
      ...
      %cst_npu_4 = arith.constant 0x1d204 : i32
      ...
      aiex.npu.address_patch(%cst_npu_6 : i32) {addr = 0x1d024 : ui32, arg_idx = 0 : i32}
      %cst_npu_7 = arith.constant 0x1d214 : i32
      ...
      %cst_npu_9 = arith.constant 0xa0600 : i32
      %cst_npu_10 = arith.constant 0x100 : i32
      %cst_npu_11 = arith.constant 0x00000F00 : i32
      aiex.npu.maskwrite32(%cst_npu_9, %cst_npu_10, %cst_npu_11) {column = 0 : i32, row = 1 : i32} : i32, i32, i32
      %cst_npu_12 = arith.constant 0xa0604 : i32
      %cst_npu_13 = arith.constant 0x80000000 : i32
      aiex.npu.write32(%cst_npu_12, %cst_npu_13) {column = 0 : i32, row = 1 : i32} : i32, i32
      ...
      aiex.npu.writebd {bd_id = 1 : i32, buffer_length = 4096 : i32, buffer_offset = 0 : i32, column = 0 : i32, d0_size = 0 : i32, d0_stride = 0 : i32, d0_zero_after = 0 : i32, d0_zero_before = 0 : i32, d1_size = 0 : i32, d1_stride = 0 : i32, d1_zero_after = 0 : i32, d1_zero_before = 0 : i32, d2_size = 0 : i32, d2_stride = 0 : i32, d2_zero_after = 0 : i32, d2_zero_before = 0 : i32, enable_packet = 0 : i32, iteration_current = 0 : i32, iteration_size = 0 : i32, iteration_stride = 0 : i32, lock_acq_enable = 0 : i32, lock_acq_id = 0 : i32, lock_acq_val = 0 : i32, lock_rel_id = 0 : i32, lock_rel_val = 0 : i32, next_bd = 0 : i32, out_of_order_id = 0 : i32, packet_id = 0 : i32, packet_type = 0 : i32, row = 1 : i32, use_next_bd = 0 : i32, valid_bd = 1 : i32}
      %cst_npu_20 = arith.constant 0xa0634 : i32
      %cst_npu_21 = arith.constant 1 : i32
      aiex.npu.write32(%cst_npu_20, %cst_npu_21) {column = 0 : i32, row = 1 : i32} : i32, i32
