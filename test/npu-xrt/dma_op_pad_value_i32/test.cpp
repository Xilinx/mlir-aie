...
// Host side of the dialect aie.dma region-form pad_value test: 13 i32 arrive on
// the MemTile S2MM and the padded MM2S sends 16 (2 before, 1 after) with the
// pad region filled by pad_value = 42. See aie.mlir.
...
int main(int argc, const char *argv[]) {
  cxxopts::Options options("dma_op_pad_value_i32");
