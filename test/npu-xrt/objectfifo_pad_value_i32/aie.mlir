...
// objectfifo with padDimensions + padValue pads a 13-element i32 transfer up to
// 16 elements (2 before, 1 after) and fills the pad with padValue = 42. Pure
...
module {
  aie.device(NPUDEVICE) {
    ...
    aie.objectfifo @out0(%tile_0_1 dimensionsToStream [<size = 13, stride = 1>], {%tile_0_0}, 2 : i32) {padDimensions = #aie<bd_pad_layout_array[<const_pad_before = 2, const_pad_after = 1>]>, padValue = 42 : i32} : !aie.objectfifo<memref<16xi32>>
