  ...
  aie.device(NPUDEVICE) {
    ...
    %memtile_dma_0_1 = aie.memtile_dma(%tile_0_1) {
      ...
      %0 = aie.dma(S2MM, 0) [{
        ...
        aie.dma_bd(%buffer_0_1 : memref<16xi32> sizes = [] strides = [])
      ...
      %2 = aie.dma(S2MM, 1) [{
        ...
        aie.dma_bd(%buffer_0_1_0 : memref<16xi32> sizes = [] strides = [])
    ...
    %mem_0_2 = aie.mem(%tile_0_2) {
     // in
      %0 = aie.dma(S2MM, 0) [{
        ...
        aie.dma_bd(%buffer_0_2 : memref<16xi32> sizes = [] strides = [])
        aie.use_lock(%lock_0_2_1, Release, 1)
      }]
      // out
      %1 = aie.dma(MM2S, 0) [{
        aie.use_lock(%lock_0_2_3, AcquireGreaterEqual, 1)
        aie.dma_bd(%buffer_0_2_1 : memref<16xi32> sizes = [] strides = [])
