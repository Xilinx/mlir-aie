...
# RUN: %aiecc --no-xchesscc --no-xbridge --no-aiesim --get-xclbin --get-npu-insts --get-input-with-addresses --no-compile-host --xclbin-name=final.xclbin --npu-insts-name=insts.bin trace_lowered.mlir
#
