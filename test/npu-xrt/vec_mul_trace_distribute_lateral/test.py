...
# RUN: %python aiecc.py --no-xchesscc --no-xbridge --no-aiesim --aie-generate-xclbin --aie-generate-npu-insts --aie-generate-input-with-addresses --no-compile-host --xclbin-name=final.xclbin --npu-insts-name=insts.bin trace_lowered.mlir
#
...
def main(opts):
    ...
    # -- Check 3: Run CLI trace parse scripts to validate file-based path --
