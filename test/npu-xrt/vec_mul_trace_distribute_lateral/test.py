...
# RUN: %aiecc --no-xchesscc --no-xbridge --get-xclbin --get-npu-insts --get-input-with-addresses --xclbin-name=final.xclbin --npu-insts-name=insts.bin trace_lowered.mlir
#
