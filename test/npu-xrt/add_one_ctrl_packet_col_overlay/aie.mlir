  ...
  aie.device(npu1) {
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        aie.use_lock(%input_0_2_lock0, AcquireGreaterEqual, %c1_ul0)
        scf.for %arg1 = %c0 to %c8 step %c1 {
          // 4
        ...
        aie.use_lock(%input_0_2_lock2, AcquireGreaterEqual, %c1_ul2)
        scf.for %arg1 = %c0 to %c8 step %c1 {
          // 6
          %1 = memref.load %input_0_2_buffer[%arg1] : memref<8xi32>
          %2 = arith.addi %1, %c1_i32 : i32
        ...
        aie.use_lock(%output_0_2_lock5, AcquireGreaterEqual, %c1_ul4)
        scf.for %arg1 = %c0 to %c8 step %c1 {
            %1 = memref.load %input_0_2_buffer[%arg1] : memref<8xi32>
            memref.store %1, %output_0_2_buffer[%arg1] : memref<8xi32>
        }
        %c1_ul5 = arith.constant 1 : i32
        aie.use_lock(%output_0_2_lock4, Release, %c1_ul5)
      }
      aie.end
    }
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.use_lock(%output_0_2_lock4, AcquireGreaterEqual, %c1_ul6)
      aie.dma_bd(%output_0_2_buffer : memref<8xi32>, 0, 8)
      %c1_ul7 = arith.constant 1 : i32
      aie.use_lock(%output_0_2_lock5, Release, %c1_ul7)
      aie.next_bd ^bb1
    ^bb2:
      aie.end
    }
    ...
    %core_0_3 = aie.core(%tile_0_3) {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        aie.use_lock(%input_0_3_lock0, AcquireGreaterEqual, %c1_ul8)
        scf.for %arg1 = %c0 to %c8 step %c1 {
          // 4
        ...
        aie.use_lock(%input_0_3_lock2, AcquireGreaterEqual, %c1_ul10)
        scf.for %arg1 = %c0 to %c8 step %c1 {
          // 6
          %1 = memref.load %input_0_3_buffer[%arg1] : memref<8xi32>
          %2 = arith.addi %1, %c1_i32 : i32
        ...
        aie.use_lock(%output_0_3_lock5, AcquireGreaterEqual, %c1_ul12)
        scf.for %arg1 = %c0 to %c8 step %c1 {
            %1 = memref.load %input_0_3_buffer[%arg1] : memref<8xi32>
            memref.store %1, %output_0_3_buffer[%arg1] : memref<8xi32>
        }
        %c1_ul13 = arith.constant 1 : i32
        aie.use_lock(%output_0_3_lock4, Release, %c1_ul13)
      }
      aie.end
    }
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.use_lock(%output_0_3_lock4, AcquireGreaterEqual, %c1_ul14)
      aie.dma_bd(%output_0_3_buffer : memref<8xi32>, 0, 8)
      %c1_ul15 = arith.constant 1 : i32
      aie.use_lock(%output_0_3_lock5, Release, %c1_ul15)
      aie.next_bd ^bb1
    ^bb2:
      aie.end
    }
    ...
    %core_0_4 = aie.core(%tile_0_4) {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        aie.use_lock(%input_0_4_lock0, AcquireGreaterEqual, %c1_ul16)
        scf.for %arg1 = %c0 to %c8 step %c1 {
          // 4
        ...
        aie.use_lock(%input_0_4_lock2, AcquireGreaterEqual, %c1_ul18)
        scf.for %arg1 = %c0 to %c8 step %c1 {
          // 6
          %1 = memref.load %input_0_4_buffer[%arg1] : memref<8xi32>
          %2 = arith.addi %1, %c1_i32 : i32
        ...
        aie.use_lock(%output_0_4_lock5, AcquireGreaterEqual, %c1_ul20)
        scf.for %arg1 = %c0 to %c8 step %c1 {
            %1 = memref.load %input_0_4_buffer[%arg1] : memref<8xi32>
            memref.store %1, %output_0_4_buffer[%arg1] : memref<8xi32>
        }
        %c1_ul21 = arith.constant 1 : i32
        aie.use_lock(%output_0_4_lock4, Release, %c1_ul21)
      }
      aie.end
    }
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.use_lock(%output_0_4_lock4, AcquireGreaterEqual, %c1_ul22)
      aie.dma_bd(%output_0_4_buffer : memref<8xi32>, 0, 8)
      %c1_ul23 = arith.constant 1 : i32
      aie.use_lock(%output_0_4_lock5, Release, %c1_ul23)
      aie.next_bd ^bb1
    ^bb2:
      aie.end
    }
    ...
    %core_0_5 = aie.core(%tile_0_5) {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        aie.use_lock(%input_0_5_lock0, AcquireGreaterEqual, %c1_ul24)
        scf.for %arg1 = %c0 to %c8 step %c1 {
          // 4
        ...
        aie.use_lock(%input_0_5_lock2, AcquireGreaterEqual, %c1_ul26)
        scf.for %arg1 = %c0 to %c8 step %c1 {
          // 6
          %1 = memref.load %input_0_5_buffer[%arg1] : memref<8xi32>
          %2 = arith.addi %1, %c1_i32 : i32
        ...
        aie.use_lock(%output_0_5_lock5, AcquireGreaterEqual, %c1_ul28)
        scf.for %arg1 = %c0 to %c8 step %c1 {
            %1 = memref.load %input_0_5_buffer[%arg1] : memref<8xi32>
            memref.store %1, %output_0_5_buffer[%arg1] : memref<8xi32>
        }
        %c1_ul29 = arith.constant 1 : i32
        aie.use_lock(%output_0_5_lock4, Release, %c1_ul29)
      }
      aie.end
    }
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.use_lock(%output_0_5_lock4, AcquireGreaterEqual, %c1_ul30)
      aie.dma_bd(%output_0_5_buffer : memref<8xi32>, 0, 8)
      %c1_ul31 = arith.constant 1 : i32
      aie.use_lock(%output_0_5_lock5, Release, %c1_ul31)
      aie.next_bd ^bb1
    ^bb2:
      aie.end
    }
