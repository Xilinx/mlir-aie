...
# RUN: %aiecc %backend_flags --no-aiesim --get-xclbin --get-npu-insts --get-input-with-addresses --no-compile-host --xclbin-name=final.xclbin --npu-insts-name=insts.bin %S/aie.mlir
