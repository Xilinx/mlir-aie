...
# ObjectFIFO lock C API test with depth 1 (single buffering).
...
def design():
    ...
    with mlir_mod_ctx() as ctx:
        ...
        def device_body():
            ...
            # Depth 1: single buffer, no ping-pong
            of_in = object_fifo("of_in", shim_tile, compute_tile, 1, tile_ty)
            of_out = object_fifo("of_out", compute_tile, shim_tile, 1, tile_ty)
