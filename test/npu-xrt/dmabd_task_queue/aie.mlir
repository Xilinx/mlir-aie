...
module {
  aie.device(NPUDEVICE) {
    ...
    ^bb1:  // pred: ^bb0
      ...
      aie.dma_bd(%buf3 : memref<5xi32, 2 : i32> offset = 0 len = 5 sizes = [] strides = [])
    ...
    ^bb3:  // pred: ^bb2
      aie.use_lock(%lock_0_2_4, AcquireGreaterEqual, 1)
      aie.dma_bd(%buf4 : memref<12xi32, 2 : i32> offset = 0 len = 12 sizes = [] strides = [])
      aie.use_lock(%lock_0_2_5, Release, 1)
      aie.next_bd ^bb4
    ...
    ^bb6:  // 2 preds: ^bb5, ^bb6
      ...
      aie.dma_bd(%buf1 : memref<12xi32, 2 : i32> offset = 0 len = 12 sizes = [] strides = [])
    ...
    ^bb8:  // 2 preds: ^bb7, ^bb8
      ...
      aie.dma_bd(%buf2 : memref<9xi32, 2 : i32> offset = 0 len = 9 sizes = [] strides = [])
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%buf5 : memref<9xi32, 1 : i32> offset = 0 len = 9 sizes = [] strides = [])
    ...
    ^bb1:  // pred: ^bb0
      ...
      aie.dma_bd(%buf7 : memref<5xi32, 1 : i32> offset = 0 len = 5 sizes = [] strides = [])
    ...
    ^bb3:  // pred: ^bb2
      aie.use_lock(%lock_0_1, AcquireGreaterEqual, 1)
      aie.dma_bd(%buf8 : memref<12xi32, 1 : i32> offset = 0 len = 12 sizes = [] strides = [])
      aie.use_lock(%lock_0_1_1, Release, 1)
      aie.next_bd ^bb4
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%buf6 : memref<12xi32, 1 : i32> offset = 0 len = 12 sizes = [] strides = [])
