...
// CHECK:   aie.objectfifo.dma_endpoint @in0_prod_dma(%[[T22]]) drains of @in0_pool
// CHECK:   aie.objectfifo.dma_endpoint @in0_cons_dma(%[[T21]]) fills of @out_pool {fifoName = "in0", segments = array<i32: 0>}
...
// CHECK:   aie.objectfifo.dma_endpoint @in1_prod_dma(%[[T23]]) drains of @in1_pool
// CHECK:   aie.objectfifo.dma_endpoint @in1_cons_dma(%[[T21]]) fills of @out_pool {fifoName = "in1", segments = array<i32: 1>}
...
// CHECK:   aie.objectfifo.dma_endpoint @out_prod_dma(%[[T21]]) drains of @out_pool {fifoName = "out"}
// CHECK:   aie.objectfifo.dma_endpoint @out_cons_dma(%[[T20]]) fills {fifoName = "out"}
