...
// CHECK:   aie.objectfifo.pool @out_cons_pool(%[[T20]]) {depth = 2 : i32, fifoName = "out", segments = [#aie.objectfifo_segment<offset = 0, size = 48>]} : memref<48xi32>
// CHECK:   aie.objectfifo.dma_endpoint @out_cons_dma(%[[T20]]) fills @out_cons_pool {fifoName = "out"}
