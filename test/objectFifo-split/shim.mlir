...
// CHECK:   aie.route_endpoint @of_in_prod_dma(%[[SHIM]]) DMA {fifoName = "of_in"}
// CHECK:   aie.objectfifo.pool @of_in_cons_pool(%[[T02]]) {depth = 2 : i32, fifoName = "of_in"} : memref<16xi32>
...
// CHECK:   aie.route from @of_in_prod_dma to [@of_in_cons_dma]
