...
// CHECK:   aie.objectfifo.pool @of1_pool(%[[T12]]) {depth = 2 : i32, segments = [#aie.objectfifo_segment<offset = 0, size = 16>]} : memref<16xi32>
...
// CHECK:   aie.objectfifo.pool @of1_cons_pool(%[[T33]]) {depth = 2 : i32, segments = [#aie.objectfifo_segment<offset = 0, size = 16>]} : memref<16xi32>
