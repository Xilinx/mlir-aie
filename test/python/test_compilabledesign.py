...
def test_mlir_path_compile_forwards_include_paths_with_no_kernels(
    ...
    def fake_compile_external_kernels(funcs, kernel_dir, target_arch, include_dirs=None):
    ...
    monkeypatch.setattr(compilabledesign_module._manifest, "record", lambda *args: None)
    monkeypatch.setattr(compilabledesign_module, "parse_dma_sizes", lambda *args: [])

    CompilableDesign(mlir_path, include_paths=[include_path]).compile(
