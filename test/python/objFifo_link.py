...
# CHECK:      aie.objectfifo @of2(%tile_1_1 toStream [<size = 1, stride = 2>], {%tile_2_2 fromStream [<size = 1, stride = 2>], %tile_2_3 fromStream [<size = 1, stride = 2>]}, [2 : i32, 2 : i32, 7 : i32]) : !aie.objectfifo<memref<256xui8>>
