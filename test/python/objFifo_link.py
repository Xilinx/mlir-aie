...
# CHECK:      aie.objectfifo @of2(%tile_1_2 toStream [<wrap = 1, stride = 2>], {%tile_2_2 fromStream [<wrap = 1, stride = 2>], %tile_2_3 fromStream [<wrap = 1, stride = 2>]}, [2 : i32, 2 : i32, 7 : i32]) : !aie.objectfifo<memref<256xui8>>
# CHECK:    }
# CHECK:  }
...
def link_example():
    ...
    with InsertionPoint(dev_block):
        ...
        objectfifo(
            ...
            [bd_dim_layout(wrap=1, stride=2)],
            [[bd_dim_layout(wrap=1, stride=2)], [bd_dim_layout(wrap=1, stride=2)]],
        )
