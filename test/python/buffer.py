...
# CHECK:      %uninit_local_buf = aie.buffer(%[[TILE]]) {sym_name = "uninit_local_buf"} : memref<4096xui8>
# CHECK:      %init_local_buf = aie.buffer(%[[TILE]]) {sym_name = "init_local_buf"} : memref<4096xui8> = dense<0>
