...
# CHECK:      aie.objectfifo @of2(%tile_0_1, {%tile_1_2}, 2 : i32) {memtile_repeat = 4 : i32} : !aie.objectfifo<memref<256xi32>>
...
def objFifo_example():
    ...
    with InsertionPoint(dev_block):
        ...
        of2 = object_fifo("of2", M, T_, 2, T.memref(256, T.i32()))
        of2.set_memtile_repeat(4)
