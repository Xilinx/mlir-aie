module {
  aie.device(npu1_1col) {
    ...
    %in2_prod_lock = aie.lock(%tile_0_0, 2) {init = 0 : i32, sym_name = "in2_prod_lock"}
    ...
    %in1_prod_lock = aie.lock(%tile_0_0, 0) {init = 0 : i32, sym_name = "in1_prod_lock"}
    ...
    aiex.runtime_sequence(%arg0: memref<15360xi32>, %arg1: memref<15360xi32>, %arg2: memref<15360xi32>) {
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 0][1, 1, 1, 15360][0, 0, 0, 1]) {id = 0 : i64, metadata = @out} : memref<15360xi32>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 0][1, 1, 1, 15360][0, 0, 0, 1]) {id = 1 : i64, metadata = @in1} : memref<15360xi32>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 0][1, 1, 1, 15360][0, 0, 0, 1]) {id = 2 : i64, metadata = @in2} : memref<15360xi32>
