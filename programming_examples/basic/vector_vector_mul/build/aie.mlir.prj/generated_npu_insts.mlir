module {
  aie.device(npu1_1col) {
    ...
    memref.global "private" constant @blockwrite_data_0 : memref<8xi32> = dense<[15360, 0, 0, 0, -2147483648, 0, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_1 : memref<8xi32> = dense<[15360, 0, 0, 0, -2147483648, 0, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_2 : memref<8xi32> = dense<[15360, 0, 0, 0, -2147483648, 0, 0, 33554432]>
