...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd0), /* addrA */ 0x500,  /* len */ 64));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd1), /* addrA */ 0x540,  /* len */ 64));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd2), /* addrA */ 0x480,  /* len */ 64));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd3), /* addrA */ 0x4C0,  /* len */ 64));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd4), /* addrA */ 0x400,  /* len */ 64));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd5), /* addrA */ 0x440,  /* len */ 64));
...
__mlir_aie_try(XAie_StrmConnCctEnable(&(ctx->DevInst), XAie_TileLoc(x,y), SOUTH, 3, CTRL, 0));
...
x = 0;
y = 2;
__mlir_aie_try(XAie_StrmConnCctEnable(&(ctx->DevInst), XAie_TileLoc(x,y), SOUTH, 1, CTRL, 0));
...
const int in2_cons_buff_0_offset = 1152;
int32_t mlir_aie_read_buffer_in2_cons_buff_0(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,2), in2_cons_buff_0_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_in2_cons_buff_0(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,2), in2_cons_buff_0_offset + (index*4), int_value);
return rc;
}
const int in2_cons_buff_1_offset = 1216;
int32_t mlir_aie_read_buffer_in2_cons_buff_1(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,2), in2_cons_buff_1_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_in2_cons_buff_1(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,2), in2_cons_buff_1_offset + (index*4), int_value);
return rc;
}
const int in1_cons_buff_0_offset = 1280;
int32_t mlir_aie_read_buffer_in1_cons_buff_0(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,2), in1_cons_buff_0_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_in1_cons_buff_0(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,2), in1_cons_buff_0_offset + (index*4), int_value);
return rc;
}
const int in1_cons_buff_1_offset = 1344;
int32_t mlir_aie_read_buffer_in1_cons_buff_1(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,2), in1_cons_buff_1_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_in1_cons_buff_1(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,2), in1_cons_buff_1_offset + (index*4), int_value);
return rc;
}
