module {
  aie.device(npu1_1col) {
    ...
    aiex.runtime_sequence() {
      ...
      aiex.control_packet {address = 1769472 : ui32, data = array<i32: -1073741686>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 1769476 : ui32, data = array<i32: -1073741685>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 1769508 : ui32, data = array<i32: -1073741816>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 1769520 : ui32, data = array<i32: -1073741755>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 1769536 : ui32, data = array<i32: -1073741815>, opcode = 0 : i32, stream_id = 0 : i32}
      ...
      aiex.control_packet {address = 1769772 : ui32, data = array<i32: -1073741824>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 1770164 : ui32, data = array<i32: 52363522>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 1769732 : ui32, data = array<i32: -1073741824>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 1770000 : ui32, data = array<i32: 35586304>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 1769780 : ui32, data = array<i32: -1073741824>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 1770192 : ui32, data = array<i32: 18809091>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 1769728 : ui32, data = array<i32: -1073741824>, opcode = 0 : i32, stream_id = 0 : i32}
      aiex.control_packet {address = 1769984 : ui32, data = array<i32: 2031873>, opcode = 0 : i32, stream_id = 0 : i32}
