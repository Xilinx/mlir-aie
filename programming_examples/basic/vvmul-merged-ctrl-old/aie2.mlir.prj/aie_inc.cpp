...
x = 0;
y = 1;
__mlir_aie_try(XAie_StrmPktSwMstrPortEnable(&(ctx->DevInst), XAie_TileLoc(x,y), DMA, 0, /* drop_header */ XAIE_SS_PKT_DROP_HEADER, /* arbiter */ 3, /* MSelEn */ 0x1));
__mlir_aie_try(XAie_StrmPktSwMstrPortEnable(&(ctx->DevInst), XAie_TileLoc(x,y), DMA, 1, /* drop_header */ XAIE_SS_PKT_DROP_HEADER, /* arbiter */ 2, /* MSelEn */ 0x1));
__mlir_aie_try(XAie_StrmPktSwMstrPortEnable(&(ctx->DevInst), XAie_TileLoc(x,y), SOUTH, 2, /* drop_header */ XAIE_SS_PKT_DONOT_DROP_HEADER, /* arbiter */ 1, /* MSelEn */ 0x1));
...
__mlir_aie_try(XAie_StrmPktSwMstrPortEnable(&(ctx->DevInst), XAie_TileLoc(x,y), NORTH, 5, /* drop_header */ XAIE_SS_PKT_DONOT_DROP_HEADER, /* arbiter */ 0, /* MSelEn */ 0x1));
...
__mlir_aie_try(XAie_StrmPktSwSlavePortEnable(&(ctx->DevInst), XAie_TileLoc(x,y), SOUTH, 4));
__mlir_aie_try(XAie_StrmPktSwSlaveSlotEnable(&(ctx->DevInst), XAie_TileLoc(x,y), SOUTH, 4, /* slot */ 1, /* packet */ XAie_PacketInit(3,0), /* mask */ 0x1F, /* msel */ 0, /* arbiter */ 3));
__mlir_aie_try(XAie_StrmPktSwSlavePortEnable(&(ctx->DevInst), XAie_TileLoc(x,y), DMA, 1));
__mlir_aie_try(XAie_StrmPktSwSlaveSlotEnable(&(ctx->DevInst), XAie_TileLoc(x,y), DMA, 1, /* slot */ 0, /* packet */ XAie_PacketInit(2,0), /* mask */ 0x1F, /* msel */ 0, /* arbiter */ 1));
__mlir_aie_try(XAie_StrmPktSwSlavePortEnable(&(ctx->DevInst), XAie_TileLoc(x,y), NORTH, 0));
__mlir_aie_try(XAie_StrmPktSwSlaveSlotEnable(&(ctx->DevInst), XAie_TileLoc(x,y), NORTH, 0, /* slot */ 0, /* packet */ XAie_PacketInit(1,0), /* mask */ 0x1F, /* msel */ 0, /* arbiter */ 2));
__mlir_aie_try(XAie_StrmPktSwSlavePortEnable(&(ctx->DevInst), XAie_TileLoc(x,y), DMA, 0));
__mlir_aie_try(XAie_StrmPktSwSlaveSlotEnable(&(ctx->DevInst), XAie_TileLoc(x,y), DMA, 0, /* slot */ 0, /* packet */ XAie_PacketInit(0,0), /* mask */ 0x1F, /* msel */ 0, /* arbiter */ 0));
