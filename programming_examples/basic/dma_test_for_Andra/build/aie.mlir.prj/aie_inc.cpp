...
XAie_DmaTensor dma_tile_0_2_bd_0_tensor = {};
dma_tile_0_2_bd_0_tensor.NumDim = 3;
dma_tile_0_2_bd_0_tensor.Dim =__mlir_aie_alloc_dim_desc(3);
if(NULL == dma_tile_0_2_bd_0_tensor.Dim){
  return 1;
}
dma_tile_0_2_bd_0_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 20, /* Size */ 4};
dma_tile_0_2_bd_0_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 80, /* Size */ 2};
dma_tile_0_2_bd_0_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 20};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile02_bd0), &dma_tile_0_2_bd_0_tensor, 0x8000,  /* len */ 640));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd2), /* addrA */ 0x400,  /* len */ 640));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd3), /* addrA */ 0x4000,  /* len */ 640));
...
XAie_DmaTensor dma_tile_0_2_bd_1_tensor = {};
dma_tile_0_2_bd_1_tensor.NumDim = 3;
dma_tile_0_2_bd_1_tensor.Dim =__mlir_aie_alloc_dim_desc(3);
if(NULL == dma_tile_0_2_bd_1_tensor.Dim){
  return 1;
}
dma_tile_0_2_bd_1_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 20, /* Size */ 4};
dma_tile_0_2_bd_1_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 80, /* Size */ 2};
dma_tile_0_2_bd_1_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 20};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile02_bd1), &dma_tile_0_2_bd_1_tensor, 0xC000,  /* len */ 640));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd0), /* addrA */ 0xA0000,  /* len */ 640));
...
dma_tile_0_1_bd_2_tensor.NumDim = 4;
dma_tile_0_1_bd_2_tensor.Dim =__mlir_aie_alloc_dim_desc(4);
if(NULL == dma_tile_0_1_bd_2_tensor.Dim){
  return 1;
}
dma_tile_0_1_bd_2_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 160, /* Size */ 1};
dma_tile_0_1_bd_2_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 5, /* Size */ 4};
dma_tile_0_1_bd_2_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 20, /* Size */ 8};
dma_tile_0_1_bd_2_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 5};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd2), &dma_tile_0_1_bd_2_tensor, 0xA0000,  /* len */ 640));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd24), /* addrA */ 0x80000,  /* len */ 640));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd26), /* addrA */ 0x80000,  /* len */ 640));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd27), /* addrA */ 0x90000,  /* len */ 640));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd25), /* addrA */ 0x90000,  /* len */ 640));
...
dma_tile_0_1_bd_3_tensor.NumDim = 4;
dma_tile_0_1_bd_3_tensor.Dim =__mlir_aie_alloc_dim_desc(4);
if(NULL == dma_tile_0_1_bd_3_tensor.Dim){
  return 1;
}
dma_tile_0_1_bd_3_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 160, /* Size */ 1};
dma_tile_0_1_bd_3_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 5, /* Size */ 4};
dma_tile_0_1_bd_3_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 20, /* Size */ 8};
dma_tile_0_1_bd_3_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 5};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd3), &dma_tile_0_1_bd_3_tensor, 0xB0000,  /* len */ 640));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd1), /* addrA */ 0xB0000,  /* len */ 640));
...
__mlir_aie_try(XAie_StrmConnCctEnable(&(ctx->DevInst), XAie_TileLoc(x,y), DMA, 1, SOUTH, 2));
...
const int comp_to_mem_buff_0_offset = 1024;
int32_t mlir_aie_read_buffer_comp_to_mem_buff_0(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,2), comp_to_mem_buff_0_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_comp_to_mem_buff_0(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,2), comp_to_mem_buff_0_offset + (index*4), int_value);
return rc;
}
const int comp_to_mem_buff_1_offset = 16384;
int32_t mlir_aie_read_buffer_comp_to_mem_buff_1(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,2), comp_to_mem_buff_1_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_comp_to_mem_buff_1(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,2), comp_to_mem_buff_1_offset + (index*4), int_value);
return rc;
}
const int mem_to_comp_cons_buff_0_offset = 32768;
int32_t mlir_aie_read_buffer_mem_to_comp_cons_buff_0(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,2), mem_to_comp_cons_buff_0_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_mem_to_comp_cons_buff_0(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,2), mem_to_comp_cons_buff_0_offset + (index*4), int_value);
return rc;
}
const int mem_to_comp_cons_buff_1_offset = 49152;
int32_t mlir_aie_read_buffer_mem_to_comp_cons_buff_1(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,2), mem_to_comp_cons_buff_1_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_mem_to_comp_cons_buff_1(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,2), mem_to_comp_cons_buff_1_offset + (index*4), int_value);
return rc;
}
const int comp_to_mem_cons_buff_0_offset = 0;
int32_t mlir_aie_read_buffer_comp_to_mem_cons_buff_0(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,1), comp_to_mem_cons_buff_0_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_comp_to_mem_cons_buff_0(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,1), comp_to_mem_cons_buff_0_offset + (index*4), int_value);
return rc;
}
const int comp_to_mem_cons_buff_1_offset = 65536;
int32_t mlir_aie_read_buffer_comp_to_mem_cons_buff_1(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,1), comp_to_mem_cons_buff_1_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_comp_to_mem_cons_buff_1(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,1), comp_to_mem_cons_buff_1_offset + (index*4), int_value);
return rc;
}
const int shim_to_mem_cons_buff_0_offset = 131072;
int32_t mlir_aie_read_buffer_shim_to_mem_cons_buff_0(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,1), shim_to_mem_cons_buff_0_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_shim_to_mem_cons_buff_0(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,1), shim_to_mem_cons_buff_0_offset + (index*4), int_value);
return rc;
}
const int shim_to_mem_cons_buff_1_offset = 196608;
int32_t mlir_aie_read_buffer_shim_to_mem_cons_buff_1(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,1), shim_to_mem_cons_buff_1_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_shim_to_mem_cons_buff_1(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,1), shim_to_mem_cons_buff_1_offset + (index*4), int_value);
return rc;
}
int mlir_aie_acquire_mem_to_shim_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_mem_to_shim_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_mem_to_shim_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_mem_to_shim_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_comp_to_mem_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,1), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_comp_to_mem_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,1), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_comp_to_mem_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,1), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_comp_to_mem_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,1), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_comp_to_mem_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_comp_to_mem_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_comp_to_mem_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_comp_to_mem_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_mem_to_comp_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_mem_to_comp_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_mem_to_comp_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_mem_to_comp_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_shim_to_mem_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,1), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_shim_to_mem_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,1), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_shim_to_mem_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,1), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_shim_to_mem_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,1), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_shim_to_mem_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_shim_to_mem_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_shim_to_mem_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_shim_to_mem_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,0), XAie_LockInit(id,value), timeout);
}
