...
void transpose_8x8(DTYPE *__restrict__ in_ptr, DTYPE *__restrict__ out_ptr) {
  for(unsigned col = 0; col < DIM_m; col += VECTOR_SIZE) {
    for(unsigned row = 0; row < DIM_n; row += 8) {
      ...
      aie::vector<DTYPE, VECTOR_SIZE> row_2 = aie::load_v<VECTOR_SIZE>(in_ptr + col + (row + 2) * DIM_m);
      aie::vector<DTYPE, VECTOR_SIZE> row_3 = aie::load_v<VECTOR_SIZE>(in_ptr + col + (row + 3) * DIM_m);
      aie::vector<DTYPE, VECTOR_SIZE> row_4 = aie::load_v<VECTOR_SIZE>(in_ptr + col + (row + 4) * DIM_m);
      aie::vector<DTYPE, VECTOR_SIZE> row_5 = aie::load_v<VECTOR_SIZE>(in_ptr + col + (row + 5) * DIM_m);
      aie::vector<DTYPE, VECTOR_SIZE> row_6 = aie::load_v<VECTOR_SIZE>(in_ptr + col + (row + 6) * DIM_m);
      aie::vector<DTYPE, VECTOR_SIZE> row_7 = aie::load_v<VECTOR_SIZE>(in_ptr + col + (row + 7) * DIM_m);

      // Interleave all rows one element at a time.
      // Result: zipped_0, zipped_1, zipped_2, zipped_3, zipped_4, zipped_5, zipped_6, zipped_7
      // zipped_0 = row_0[0], row_1[0], row_2[0], row_3[0], row_0[1], row_1[1], ...
      std::pair<aie::vector<DTYPE, VECTOR_SIZE>, aie::vector<DTYPE, VECTOR_SIZE>> zip_one_0 =
        aie::interleave_zip(row_0, row_1, 1);
      std::pair<aie::vector<DTYPE, VECTOR_SIZE>, aie::vector<DTYPE, VECTOR_SIZE>> zip_one_1 =
        aie::interleave_zip(row_2, row_3, 1);
      std::pair<aie::vector<DTYPE, VECTOR_SIZE>, aie::vector<DTYPE, VECTOR_SIZE>> zip_one_2 =
        aie::interleave_zip(row_4, row_5, 1);
      std::pair<aie::vector<DTYPE, VECTOR_SIZE>, aie::vector<DTYPE, VECTOR_SIZE>> zip_one_3 =
      ...
      std::pair<aie::vector<DTYPE, VECTOR_SIZE>, aie::vector<DTYPE, VECTOR_SIZE>> zip_two_1 =
        aie::interleave_zip(zip_one_0b, zip_one_1b, 2);
      std::pair<aie::vector<DTYPE, VECTOR_SIZE>, aie::vector<DTYPE, VECTOR_SIZE>> zip_two_2 =
        aie::interleave_zip(zip_one_2a, zip_one_3a, 2);
      std::pair<aie::vector<DTYPE, VECTOR_SIZE>, aie::vector<DTYPE, VECTOR_SIZE>> zip_two_3 =
      ...
      std::pair<aie::vector<DTYPE, VECTOR_SIZE>, aie::vector<DTYPE, VECTOR_SIZE>> zip_four_0 =
        aie::interleave_zip(zip_two_0a, zip_two_2a, 4);
      std::pair<aie::vector<DTYPE, VECTOR_SIZE>, aie::vector<DTYPE, VECTOR_SIZE>> zip_four_1 =
        aie::interleave_zip(zip_two_0b, zip_two_2b, 4);
      std::pair<aie::vector<DTYPE, VECTOR_SIZE>, aie::vector<DTYPE, VECTOR_SIZE>> zip_four_2 =
        aie::interleave_zip(zip_two_1a, zip_two_3a, 4);
      std::pair<aie::vector<DTYPE, VECTOR_SIZE>, aie::vector<DTYPE, VECTOR_SIZE>> zip_four_3 =
      ...
      // Result: unzipped_0, unzipped_1, unzipped_2, unzipped_3, unzipped_4, unzipped_5, unzipped_6, unzipped_7
      // unzipped_0 = zipped_0[0..8],   zipped_0[64..72], ..., zipped_1[0..8]
      // unzipped_1 = zipped_0[8..16],  zipped_0[72..80], ..., zipped_1[8..16]
      // unzipped_3 = zipped_0[16..24], zipped_0[80..88], ..., zipped_1[16..24]
      // ...
      std::pair<aie::vector<DTYPE, VECTOR_SIZE>, aie::vector<DTYPE, VECTOR_SIZE>> unzip_32_0 =
        aie::interleave_unzip(zipped_0, zipped_1, 32);
      std::pair<aie::vector<DTYPE, VECTOR_SIZE>, aie::vector<DTYPE, VECTOR_SIZE>> unzip_32_1 =
        aie::interleave_unzip(zipped_2, zipped_3, 32);
      std::pair<aie::vector<DTYPE, VECTOR_SIZE>, aie::vector<DTYPE, VECTOR_SIZE>> unzip_32_2 =
        aie::interleave_unzip(zipped_4, zipped_5, 32);
      std::pair<aie::vector<DTYPE, VECTOR_SIZE>, aie::vector<DTYPE, VECTOR_SIZE>> unzip_32_3 =
      ...
      std::pair<aie::vector<DTYPE, VECTOR_SIZE>, aie::vector<DTYPE, VECTOR_SIZE>> unzip_16_0 =
        aie::interleave_unzip(unzip_32_0a, unzip_32_1a, 16);
      std::pair<aie::vector<DTYPE, VECTOR_SIZE>, aie::vector<DTYPE, VECTOR_SIZE>> unzip_16_1 =
        aie::interleave_unzip(unzip_32_2a, unzip_32_3a, 16);
      std::pair<aie::vector<DTYPE, VECTOR_SIZE>, aie::vector<DTYPE, VECTOR_SIZE>> unzip_16_2 =
        aie::interleave_unzip(unzip_32_0b, unzip_32_1b, 16);
      std::pair<aie::vector<DTYPE, VECTOR_SIZE>, aie::vector<DTYPE, VECTOR_SIZE>> unzip_16_3 =
      ...
      std::pair<aie::vector<DTYPE, VECTOR_SIZE>, aie::vector<DTYPE, VECTOR_SIZE>> unzip_eight_2 =
        aie::interleave_unzip(unzip_16_0b, unzip_16_1b, 8);
      std::pair<aie::vector<DTYPE, VECTOR_SIZE>, aie::vector<DTYPE, VECTOR_SIZE>> unzip_eight_3 =
