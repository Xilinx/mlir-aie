module {
  aie.device(npu1_1col) {
    ...
    aie.objectfifo @in(%shim_noc_tile_0_0, {%mem_tile_0_1}, 1 : i32) {runtimeDmas = true} : !aie.objectfifo<memref<4096xi32>> 
    aie.objectfifo @in_fwd(%mem_tile_0_1, {%shim_noc_tile_0_0}, 1 : i32) {runtimeDmas = true} : !aie.objectfifo<memref<4096xi32>> 
