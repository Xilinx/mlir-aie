// Shim -> Mem (ping, ping, pong, pong) -> Shim
// Equal sizes
module {
  aie.device(npu1_1col) {
    ...
    %in_cons_buff_0 = aie.buffer(%mem_tile_0_1) {address = 0 : i32, mem_bank = 0 : i32, sym_name = "in_cons_buff_0"} : memref<512xi32> 
    %in_cons_buff_1 = aie.buffer(%mem_tile_0_1) {address = 65536 : i32, mem_bank = 1 : i32, sym_name = "in_cons_buff_1"} : memref<512xi32> 
    %in_cons_buff_pong_0 = aie.buffer(%mem_tile_0_1) {sym_name = "in_cons_buff_pong_0"} : memref<512xi32> 
    %in_cons_buff_pong_1 = aie.buffer(%mem_tile_0_1) {sym_name = "in_cons_buff_pong_1"} : memref<512xi32> 
    %in_cons_prod_lock_0 = aie.lock(%mem_tile_0_1, 0) {init = 1 : i32, sym_name = "in_cons_prod_lock_0"}
    %in_cons_prod_lock_1 = aie.lock(%mem_tile_0_1, 1) {init = 1 : i32, sym_name = "in_cons_prod_lock_1"}
    %in_cons_cons_lock_0 = aie.lock(%mem_tile_0_1, 2) {init = 0 : i32, sym_name = "in_cons_cons_lock_0"}
    ...
    ^bb2:
      aie.use_lock(%in_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%in_cons_buff_1 : memref<512xi32>, 512, 512) {bd_id = 1 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%in_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb3
    ^bb3:
      aie.use_lock(%in_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%in_cons_buff_pong_0 : memref<512xi32>, 0, 512) {bd_id = 2 : i32, next_bd_id = 3: i32}
      aie.use_lock(%in_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb4
    ^bb4:
      aie.use_lock(%in_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%in_cons_buff_pong_1 : memref<512xi32>, 512, 512) {bd_id = 3 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%in_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb5:  // pred: ^bb0
    ...
    ^bb6:  // 2 preds: ^bb3, ^bb5
      ...
      aie.dma_bd(%in_cons_buff_0 : memref<512xi32>, 0, 512) {bd_id = 4 : i32, next_bd_id = 5 : i32}
      aie.use_lock(%in_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb7
    ^bb7:  // 2 preds: ^bb3, ^bb5
      aie.use_lock(%in_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%in_cons_buff_1 : memref<512xi32>, 512, 512) {bd_id = 5 : i32, next_bd_id = 6 : i32}
      aie.use_lock(%in_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb8
    ^bb8:  // pred: ^bb4
      aie.use_lock(%in_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%in_cons_buff_pong_0 : memref<512xi32>, 0, 512) {bd_id = 6 : i32, next_bd_id = 7 : i32}
      aie.use_lock(%in_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb9
    ^bb9:  // pred: ^bb4
      aie.use_lock(%in_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%in_cons_buff_pong_1 : memref<512xi32>, 512, 512) {bd_id = 7 : i32, next_bd_id = 4 : i32}
      aie.use_lock(%in_cons_prod_lock_0, Release, 1)
      aie.next_bd ^bb6
    ^bb10:  // pred: ^bb3
      aie.end
