...
// Equal sizes: Mem1: 1024, Mem2: 512
module {
  aie.device(npu1_2col) {
    ...
    %in_cons_buff_0 = aie.buffer(%mem_tile_1_1) {address = 0 : i32, mem_bank = 0 : i32, sym_name = "in_cons_buff_0"} : memref<512xi32> 
    %in_cons_buff_1 = aie.buffer(%mem_tile_1_1) {address = 65536 : i32, mem_bank = 1 : i32, sym_name = "in_cons_buff_1"} : memref<512xi32> 
    %in_cons_buff_pong_0 = aie.buffer(%mem_tile_1_1) {sym_name = "in_cons_buff_pong_0"} : memref<512xi32> 
    %in_cons_buff_pong_1 = aie.buffer(%mem_tile_1_1) {sym_name = "in_cons_buff_pong_1"} : memref<512xi32> 
