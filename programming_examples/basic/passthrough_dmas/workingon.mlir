module {
  aie.device(npu1_1col) {
    ...
    aiex.runtime_sequence @sequence(%arg0: memref<4096xi32>, %arg1: memref<4096xi32>, %arg2: memref<4096xi32>) {
      ...
      // Input BDs (bd_id 0-1), ping-pong, for full 4096 buffer
      ...
      aiex.npu.write32 {address = 656900 : ui32, column = 0 : i32, row = 1 : i32, value = 1 : ui32}
      // Output BDs (bd_id 2-3), ping-pong, 2x1024 each
