...
df = DataFrame(columns=['m_k_n', 'MACs', 'mxn' ,'Data_mem_double_buff', 'A_mem', 'B_mem', 'C_mem', 'Ideal Cycles'])
                ...
                if ((2*single_mem_size) < 63*1024):
                    ...
                    if in_a_type == "int8" and in_b_type == "int8":
                        ...
                        if ((m % (4*r) == 0) and (n % (2*t) == 0)):
                            ...
                            df.loc[len(df)] = [str(m) + '_' + str(k) + '_' + str(n), m*k*n, m*n, 2*single_mem_size/1024, A_mem_size/1024, B_mem_size/1024, C_mem_size/1024, (m*k*n / peak_MACs_per_cycle)]
