...
# It's small for the tested case
expected_kernel_efficiency = 0.60
...
if in_a_type == "int8":
    in_a_bytes = 1
    # 512 GOPs is for int8 for each core
    theoretical_GOPs_per_core = 512

elif in_a_type == "int16":
    in_a_bytes = 2
    # 128 GOPs is for int16 for each core
    theoretical_GOPs_per_core = 128
...
# Start with full array for phoenix
aie_rows = 4
aie_cols = 4
...
# theoretical TOPs
theoretical_TOPs = theoretical_GOPs_per_core * (aie_rows * aie_cols) / 1000
