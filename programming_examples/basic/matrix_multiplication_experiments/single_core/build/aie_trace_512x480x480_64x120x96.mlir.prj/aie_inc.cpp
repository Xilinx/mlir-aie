...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd0), /* addrA */ 0xBE00,  /* len */ 7680));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd2), /* addrA */ 0x6400,  /* len */ 11520));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd4), /* addrA */ 0x400,  /* len */ 12288));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd5), /* addrA */ 0x3400,  /* len */ 12288));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd3), /* addrA */ 0x9100,  /* len */ 11520));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd1), /* addrA */ 0xDC00,  /* len */ 7680));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd0), /* addrA */ 0x8BA00,  /* len */ 7680));
...
dma_tile_0_1_bd_2_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 120, /* Size */ 16};
dma_tile_0_1_bd_2_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 2, /* Size */ 15};
dma_tile_0_1_bd_2_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 30, /* Size */ 4};
dma_tile_0_1_bd_2_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 2};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd2), &dma_tile_0_1_bd_2_tensor, 0x8BA00,  /* len */ 7680));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd24), /* addrA */ 0x86000,  /* len */ 11520));
...
dma_tile_0_1_bd_26_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 192, /* Size */ 15};
dma_tile_0_1_bd_26_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 2, /* Size */ 12};
dma_tile_0_1_bd_26_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 24, /* Size */ 8};
dma_tile_0_1_bd_26_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 2};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd26), &dma_tile_0_1_bd_26_tensor, 0x86000,  /* len */ 11520));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd4), /* addrA */ 0x80000,  /* len */ 12288));
...
dma_tile_0_1_bd_6_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 192, /* Size */ 16};
dma_tile_0_1_bd_6_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 4, /* Size */ 4};
dma_tile_0_1_bd_6_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 16, /* Size */ 12};
dma_tile_0_1_bd_6_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 4};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd6), &dma_tile_0_1_bd_6_tensor, 0x80000,  /* len */ 12288));
...
dma_tile_0_1_bd_7_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 192, /* Size */ 16};
dma_tile_0_1_bd_7_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 4, /* Size */ 4};
dma_tile_0_1_bd_7_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 16, /* Size */ 12};
dma_tile_0_1_bd_7_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 4};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd7), &dma_tile_0_1_bd_7_tensor, 0x83000,  /* len */ 12288));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd5), /* addrA */ 0x83000,  /* len */ 12288));
...
dma_tile_0_1_bd_27_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 192, /* Size */ 15};
dma_tile_0_1_bd_27_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 2, /* Size */ 12};
dma_tile_0_1_bd_27_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 24, /* Size */ 8};
dma_tile_0_1_bd_27_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 2};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd27), &dma_tile_0_1_bd_27_tensor, 0x88D00,  /* len */ 11520));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd25), /* addrA */ 0x88D00,  /* len */ 11520));
...
dma_tile_0_1_bd_3_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 120, /* Size */ 16};
dma_tile_0_1_bd_3_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 2, /* Size */ 15};
dma_tile_0_1_bd_3_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 30, /* Size */ 4};
dma_tile_0_1_bd_3_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 2};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd3), &dma_tile_0_1_bd_3_tensor, 0x8D800,  /* len */ 7680));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd1), /* addrA */ 0x8D800,  /* len */ 7680));
...
__mlir_aie_try(XAie_StrmPktSwSlaveSlotEnable(&(ctx->DevInst), XAie_TileLoc(x,y), NORTH, 0, /* slot */ 0, /* packet */ XAie_PacketInit(1,0), /* mask */ 0x1F, /* msel */ 0, /* arbiter */ 0));
...
__mlir_aie_try(XAie_StrmPktSwMstrPortEnable(&(ctx->DevInst), XAie_TileLoc(x,y), SOUTH, 0, /* drop_header */ XAIE_SS_PKT_DONOT_DROP_HEADER, /* arbiter */ 0, /* MSelEn */ 0x1));
__mlir_aie_try(XAie_StrmPktSwSlavePortEnable(&(ctx->DevInst), XAie_TileLoc(x,y), NORTH, 0));
__mlir_aie_try(XAie_StrmPktSwSlaveSlotEnable(&(ctx->DevInst), XAie_TileLoc(x,y), NORTH, 0, /* slot */ 0, /* packet */ XAie_PacketInit(1,0), /* mask */ 0x1F, /* msel */ 0, /* arbiter */ 0));
...
// buffer memC_buff_0 with unsupported type memref<64x96xi16>;
// buffer memC_buff_1 with unsupported type memref<64x96xi16>;
// buffer memB_cons_buff_0 with unsupported type memref<120x96xi8>;
// buffer memB_cons_buff_1 with unsupported type memref<120x96xi8>;
// buffer memA_cons_buff_0 with unsupported type memref<64x120xi8>;
// buffer memA_cons_buff_1 with unsupported type memref<64x120xi8>;
// buffer memC_cons_buff_0 with unsupported type memref<64x96xi16>;
// buffer memC_cons_buff_1 with unsupported type memref<64x96xi16>;
// buffer inB_cons_buff_0 with unsupported type memref<120x96xi8>;
// buffer inB_cons_buff_1 with unsupported type memref<120x96xi8>;
// buffer inA_cons_buff_0 with unsupported type memref<64x120xi8>;
// buffer inA_cons_buff_1 with unsupported type memref<64x120xi8>;
