...
def main():
    ...
    kernel_eff_B_row = 0.805
    kernel_eff_B_col = 0.80

    csvfile_B_row_maj = './sweep_results/GEMM_sweep_kernel_48x100x56_i16_i32_mtk_400_B_row_maj.csv'
    csvfile_B_col_maj = './sweep_results/GEMM_sweep_kernel_48x100x56_i16_i32_mtk_400_ktn_400_B_col_maj.csv'
    ...
    plt.title('Phoenix GEMM sweep int16/int32')
    # Display the legend
    plt.legend()

    
    plot_file_name = './sweep_results/GEMM_sweep_kernel_48x100x56_i16_i32_mtk_400_ktn_400_both_row_col.png'
