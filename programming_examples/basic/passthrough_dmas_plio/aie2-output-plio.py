...
def my_passthrough():
    with mlir_mod_ctx() as ctx:
        ...
        def device_body():
            ...
            line_ty = np.ndarray[np.int32, (1024,)]
            ...
            of_in = object_fifo("in", ShimTile1, ComputeTile2, 2, line_ty)
            of_out = object_fifo("out", ComputeTile2, ShimTile2, 2, line_ty, plio=True)
