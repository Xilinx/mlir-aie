...
if __name__ == "__main__":
    ...
    p.add_argument("dev", help="npu => Phoenix, npu2 => Strix, Kracken", type=str, default="npu")
    p.add_argument("dims", help="m, M, k, K, n, N", type=int, nargs="*")
    p.add_argument("npu_cols", help="Number of NPU columns", type=int, choices=[1, 2, 4, 8], default=4)
