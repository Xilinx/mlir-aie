...
def explicit_link():
    with mlir_mod_ctx() as ctx:
        ...
        def device_body():
            ...
            of_in = object_fifo("in", ShimTile, MemTile, 2, line_ty)
            of_in1 = object_fifo("in1", MemTile, ComputeTile2, 2, op_ty)
            of_in2 = object_fifo("in2", MemTile, ComputeTile3, 2, op_ty)
            object_fifo_link(of_in, [of_in1, of_in2], [], [0, op_size])
