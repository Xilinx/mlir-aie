module {
  aie.device(npu1_4col) {
    ...
    %out_buff_0 = aie.buffer(%tile_1_2) {address = 3072 : i32, mem_bank = 0 : i32, sym_name = "out_buff_0"} : memref<1xi32> 
    %out_buff_1 = aie.buffer(%tile_1_2) {address = 18432 : i32, mem_bank = 1 : i32, sym_name = "out_buff_1"} : memref<1xi32> 
    %out_prod_lock_0 = aie.lock(%tile_1_2, 6) {init = 2 : i32, sym_name = "out_prod_lock_0"}
    %out_cons_lock_0 = aie.lock(%tile_1_2, 7) {init = 0 : i32, sym_name = "out_cons_lock_0"}
    %outC_cons_buff_0 = aie.buffer(%tile_1_2) {address = 32768 : i32, mem_bank = 2 : i32, sym_name = "outC_cons_buff_0"} : memref<4xi32> 
    %outC_cons_buff_1 = aie.buffer(%tile_1_2) {address = 49152 : i32, mem_bank = 3 : i32, sym_name = "outC_cons_buff_1"} : memref<4xi32> 
    %outC_cons_prod_lock_0 = aie.lock(%tile_1_2, 4) {init = 2 : i32, sym_name = "outC_cons_prod_lock_0"}
    %outC_cons_cons_lock_0 = aie.lock(%tile_1_2, 5) {init = 0 : i32, sym_name = "outC_cons_cons_lock_0"}
    %outC_buff_0 = aie.buffer(%mem_tile_1_1) {address = 131072 : i32, mem_bank = 2 : i32, sym_name = "outC_buff_0"} : memref<4xi32> 
    %outC_buff_1 = aie.buffer(%mem_tile_1_1) {address = 196608 : i32, mem_bank = 3 : i32, sym_name = "outC_buff_1"} : memref<4xi32> 
    %outC_prod_lock_0 = aie.lock(%mem_tile_1_1, 8) {init = 2 : i32, sym_name = "outC_prod_lock_0"}
    %outC_cons_lock_0 = aie.lock(%mem_tile_1_1, 9) {init = 0 : i32, sym_name = "outC_cons_lock_0"}
    %outC_prod_lock_1 = aie.lock(%mem_tile_1_1, 10) {init = 2 : i32, sym_name = "outC_prod_lock_1"}
    %outC_cons_lock_1 = aie.lock(%mem_tile_1_1, 11) {init = 0 : i32, sym_name = "outC_cons_lock_1"}
    %outC_prod_lock_2 = aie.lock(%mem_tile_1_1, 12) {init = 2 : i32, sym_name = "outC_prod_lock_2"}
    %outC_cons_lock_2 = aie.lock(%mem_tile_1_1, 13) {init = 0 : i32, sym_name = "outC_cons_lock_2"}
    %outC_prod_lock_3 = aie.lock(%mem_tile_1_1, 14) {init = 2 : i32, sym_name = "outC_prod_lock_3"}
    %outC_cons_lock_3 = aie.lock(%mem_tile_1_1, 15) {init = 0 : i32, sym_name = "outC_cons_lock_3"}
    %memC3_buff_0 = aie.buffer(%tile_1_5) {address = 32768 : i32, mem_bank = 2 : i32, sym_name = "memC3_buff_0"} : memref<1xi32> 
    %memC3_buff_1 = aie.buffer(%tile_1_5) {address = 49152 : i32, mem_bank = 3 : i32, sym_name = "memC3_buff_1"} : memref<1xi32> 
    %memC3_prod_lock_0 = aie.lock(%tile_1_5, 2) {init = 2 : i32, sym_name = "memC3_prod_lock_0"}
    %memC3_cons_lock_0 = aie.lock(%tile_1_5, 3) {init = 0 : i32, sym_name = "memC3_cons_lock_0"}
    %memA3_cons_buff_0 = aie.buffer(%tile_1_5) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "memA3_cons_buff_0"} : memref<512xi32> 
    %memA3_cons_buff_1 = aie.buffer(%tile_1_5) {address = 16384 : i32, mem_bank = 1 : i32, sym_name = "memA3_cons_buff_1"} : memref<512xi32> 
    %memA3_cons_prod_lock_0 = aie.lock(%tile_1_5, 0) {init = 2 : i32, sym_name = "memA3_cons_prod_lock_0"}
    %memA3_cons_cons_lock_0 = aie.lock(%tile_1_5, 1) {init = 0 : i32, sym_name = "memA3_cons_cons_lock_0"}
    %memC2_buff_0 = aie.buffer(%tile_1_4) {address = 32768 : i32, mem_bank = 2 : i32, sym_name = "memC2_buff_0"} : memref<1xi32> 
    %memC2_buff_1 = aie.buffer(%tile_1_4) {address = 49152 : i32, mem_bank = 3 : i32, sym_name = "memC2_buff_1"} : memref<1xi32> 
    %memC2_prod_lock_0 = aie.lock(%tile_1_4, 2) {init = 2 : i32, sym_name = "memC2_prod_lock_0"}
    %memC2_cons_lock_0 = aie.lock(%tile_1_4, 3) {init = 0 : i32, sym_name = "memC2_cons_lock_0"}
    %memA2_cons_buff_0 = aie.buffer(%tile_1_4) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "memA2_cons_buff_0"} : memref<512xi32> 
    %memA2_cons_buff_1 = aie.buffer(%tile_1_4) {address = 16384 : i32, mem_bank = 1 : i32, sym_name = "memA2_cons_buff_1"} : memref<512xi32> 
    %memA2_cons_prod_lock_0 = aie.lock(%tile_1_4, 0) {init = 2 : i32, sym_name = "memA2_cons_prod_lock_0"}
    %memA2_cons_cons_lock_0 = aie.lock(%tile_1_4, 1) {init = 0 : i32, sym_name = "memA2_cons_cons_lock_0"}
    %memC1_buff_0 = aie.buffer(%tile_1_3) {address = 32768 : i32, mem_bank = 2 : i32, sym_name = "memC1_buff_0"} : memref<1xi32> 
    %memC1_buff_1 = aie.buffer(%tile_1_3) {address = 49152 : i32, mem_bank = 3 : i32, sym_name = "memC1_buff_1"} : memref<1xi32> 
    %memC1_prod_lock_0 = aie.lock(%tile_1_3, 2) {init = 2 : i32, sym_name = "memC1_prod_lock_0"}
    %memC1_cons_lock_0 = aie.lock(%tile_1_3, 3) {init = 0 : i32, sym_name = "memC1_cons_lock_0"}
    %memA1_cons_buff_0 = aie.buffer(%tile_1_3) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "memA1_cons_buff_0"} : memref<512xi32> 
    %memA1_cons_buff_1 = aie.buffer(%tile_1_3) {address = 16384 : i32, mem_bank = 1 : i32, sym_name = "memA1_cons_buff_1"} : memref<512xi32> 
    ...
    %memC0_buff_0 = aie.buffer(%tile_1_2) {address = 32784 : i32, mem_bank = 2 : i32, sym_name = "memC0_buff_0"} : memref<1xi32> 
    %memC0_buff_1 = aie.buffer(%tile_1_2) {address = 49168 : i32, mem_bank = 3 : i32, sym_name = "memC0_buff_1"} : memref<1xi32> 
    %memC0_prod_lock_0 = aie.lock(%tile_1_2, 2) {init = 2 : i32, sym_name = "memC0_prod_lock_0"}
    %memC0_cons_lock_0 = aie.lock(%tile_1_2, 3) {init = 0 : i32, sym_name = "memC0_cons_lock_0"}
    %memA0_cons_buff_0 = aie.buffer(%tile_1_2) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "memA0_cons_buff_0"} : memref<512xi32> 
    %memA0_cons_buff_1 = aie.buffer(%tile_1_2) {address = 16384 : i32, mem_bank = 1 : i32, sym_name = "memA0_cons_buff_1"} : memref<512xi32> 
    %memA0_cons_prod_lock_0 = aie.lock(%tile_1_2, 0) {init = 2 : i32, sym_name = "memA0_cons_prod_lock_0"}
    %memA0_cons_cons_lock_0 = aie.lock(%tile_1_2, 1) {init = 0 : i32, sym_name = "memA0_cons_cons_lock_0"}
    %inA_cons_buff_0 = aie.buffer(%mem_tile_1_1) {address = 0 : i32, mem_bank = 0 : i32, sym_name = "inA_cons_buff_0"} : memref<2048xi32> 
    %inA_cons_buff_1 = aie.buffer(%mem_tile_1_1) {address = 65536 : i32, mem_bank = 1 : i32, sym_name = "inA_cons_buff_1"} : memref<2048xi32> 
    %inA_cons_prod_lock_0 = aie.lock(%mem_tile_1_1, 0) {init = 2 : i32, sym_name = "inA_cons_prod_lock_0"}
    %inA_cons_cons_lock_0 = aie.lock(%mem_tile_1_1, 1) {init = 0 : i32, sym_name = "inA_cons_cons_lock_0"}
    %inA_cons_prod_lock_1 = aie.lock(%mem_tile_1_1, 2) {init = 2 : i32, sym_name = "inA_cons_prod_lock_1"}
    %inA_cons_cons_lock_1 = aie.lock(%mem_tile_1_1, 3) {init = 0 : i32, sym_name = "inA_cons_cons_lock_1"}
    %inA_cons_prod_lock_2 = aie.lock(%mem_tile_1_1, 4) {init = 2 : i32, sym_name = "inA_cons_prod_lock_2"}
    %inA_cons_cons_lock_2 = aie.lock(%mem_tile_1_1, 5) {init = 0 : i32, sym_name = "inA_cons_cons_lock_2"}
    %inA_cons_prod_lock_3 = aie.lock(%mem_tile_1_1, 6) {init = 2 : i32, sym_name = "inA_cons_prod_lock_3"}
    %inA_cons_cons_lock_3 = aie.lock(%mem_tile_1_1, 7) {init = 0 : i32, sym_name = "inA_cons_cons_lock_3"}
    %inA_prod_lock_0 = aie.lock(%shim_noc_tile_1_0, 0) {init = 1 : i32, sym_name = "inA_prod_lock_0"}
    %inA_cons_lock_0 = aie.lock(%shim_noc_tile_1_0, 1) {init = 0 : i32, sym_name = "inA_cons_lock_0"}
    ...
    aie.flow(%tile_1_2, DMA : 1, %shim_noc_tile_1_0, DMA : 0)
    ...
    aie.shim_dma_allocation @inA(MM2S, 0, 1)
