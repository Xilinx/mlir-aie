...
# Test for Prototype 6: Runtime-Programmable MemTile Hub
...
def main(opts):
    ...
    print("Running Prototype 6: Runtime-Programmable MemTile Hub...")
    ...
    print(f"  Pattern:       DDR → MemTile buf → Core(0,2) + Core(0,3) → MemTile → DDR")
