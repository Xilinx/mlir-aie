...
int verify_vector_scalar_mul(DATATYPE_IN1 *bufIn1, DATATYPE_IN2 *bufIn2, DATATYPE_OUT *bufOut, int SIZE, int verbosity)
{
  int errors = 0;
...
int main(int argc, const char *argv[]) {
  ...
  // constexpr int IN1_VOLUME = VECTORSCALARMUL_SIZE; // 1024; define via Makefile
  // constexpr int IN2_VOLUME = 1;
  // constexpr int OUT_VOLUME = IN1_VOLUME; // define via Makefile
  ...
  int res = xrt_test_run<DATATYPE_IN1, DATATYPE_IN2, DATATYPE_OUT,
                    initialize_bufIn1, initialize_bufIn2, initialize_bufOut,
