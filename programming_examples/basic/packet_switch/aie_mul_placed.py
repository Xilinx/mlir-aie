...
def packet_switch_kernel(dev, in_out_size):
    ...
    def device_body():
        ...
        # core_0_2
        core02_buff_in = buffer(
            tile=CT_0_2, datatype=vector_ty, name="core02_buff_in"
        )
        ...
        # core_0_3
        core03_buff_in = buffer(
            tile=CT_0_3, datatype=vector_ty, name="core03_buff_in"
        )
        ...
        def core_body():
            for _ in range_(sys.maxsize):
                ...
                use_lock(
                    core02_cons_lock_in, LockAction.AcquireGreaterEqual, value=1
                )
                use_lock(
                    core02_prod_lock_out, LockAction.AcquireGreaterEqual, value=1
                )
        ...
        def m(block):
            ...
            with block[1]:
                ...
                use_lock(
                    core02_prod_lock_in, LockAction.AcquireGreaterEqual, value=1
                )
            ...
            with block[3]:
                ...
                use_lock(
                    core02_cons_lock_out, LockAction.AcquireGreaterEqual, value=1
                )
        ...
        def core_body():
            for _ in range_(sys.maxsize):
                ...
                use_lock(
                    core03_cons_lock_in, LockAction.AcquireGreaterEqual, value=1
                )
                use_lock(
                    core03_prod_lock_out, LockAction.AcquireGreaterEqual, value=1
                )
        ...
        def m(block):
            ...
            with block[1]:
                ...
                use_lock(
                    core03_prod_lock_in, LockAction.AcquireGreaterEqual, value=1
                )
            ...
            with block[3]:
                ...
                # Data is then routed to memtile_0_1
                use_lock(
                    core03_cons_lock_out, LockAction.AcquireGreaterEqual, value=1
                )
        ...
        def m(block):
            ...
            with block[1]:
                ...
                use_lock(
                    mem01_prod_lock_in, LockAction.AcquireGreaterEqual, value=1
                )
                dma_bd(mem01_buff_in)  # First 4 byte is the packet header becasue in packet_flow(pkt_id=0) configured "keep_pkt_header"
            ...
            with block[3]:
                ...
                use_lock(
                    mem01_cons_lock_in, LockAction.AcquireGreaterEqual, value=1
                )
            ...
            with block[5]:
                ...
                use_lock(
                    mem01_prod_lock_out, LockAction.AcquireGreaterEqual, value=1
                )
            ...
            with block[7]:
                ...
                use_lock(
                    mem01_cons_lock_out, LockAction.AcquireGreaterEqual, value=1
                )
