...
module {
  aie.device(npu1_1col) {
    ...
    aiex.runtime_sequence(%arg0: memref<512xui8>, %arg1: memref<512xui8>, %arg2: memref<512xui8>) {
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 0][1, 1, 1, 512][0, 0, 0, 1]) {id = 0 : i64, metadata = @in} : memref<512xui8>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 0][1, 1, 1, 512][0, 0, 0, 1]) {id = 1 : i64, metadata = @out} : memref<512xui8>
...
module {
  aie.device(npu1_1col) {
    %tile_0_2 = aie.tile(0, 2)
    %tile_0_0 = aie.tile(0, 0)
    aie.objectfifo @"0"(%tile_0_2, {%tile_0_0}, 2 : i32) : !aie.objectfifo<memref<512xi8>>
    aie.objectfifo @"1"(%tile_0_0, {%tile_0_2}, 2 : i32) : !aie.objectfifo<memref<512xi8>>
  }
}