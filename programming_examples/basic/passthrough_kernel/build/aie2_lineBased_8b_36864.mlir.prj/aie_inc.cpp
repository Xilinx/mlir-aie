...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd0), /* addrA */ 0x8000,  /* len */ 9216));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd1), /* addrA */ 0xC000,  /* len */ 9216));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd2), /* addrA */ 0x400,  /* len */ 9216));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd3), /* addrA */ 0x4000,  /* len */ 9216));
...
// buffer out_buff_0 with unsupported type memref<9216xui8>;
// buffer out_buff_1 with unsupported type memref<9216xui8>;
// buffer in_cons_buff_0 with unsupported type memref<9216xui8>;
// buffer in_cons_buff_1 with unsupported type memref<9216xui8>;
