...
@in_cons_buff_1 = external global [7168 x i8]
@in_cons_buff_0 = external global [7168 x i8]
@out_buff_1 = external global [7168 x i8]
@out_buff_0 = external global [7168 x i8]
@out_cons = external global [7168 x i8]
@out = external global [7168 x i8]
@in_cons = external global [7168 x i8]
@in = external global [7168 x i8]
...
4:                                                ; preds = %1
  ...
  call void @passThroughLine(ptr @in_cons_buff_0, ptr @out_buff_0, i32 7168)
  ...
  call void @passThroughLine(ptr @in_cons_buff_1, ptr @out_buff_1, i32 7168)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 51, i32 1)
  %13 = add i64 %2, 2
  br label %1
