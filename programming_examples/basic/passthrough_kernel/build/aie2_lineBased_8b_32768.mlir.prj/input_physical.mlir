module {
  aie.device(npu1_1col) {
    ...
    ^bb2:  // pred: ^bb1
      ...
      func.call @passThroughLine(%in_cons_buff_1, %out_buff_1, %c8192_i32_0) : (memref<8192xui8>, memref<8192xui8>, i32) -> ()
      aie.use_lock(%in_cons_prod_lock, Release, 1)
      aie.use_lock(%out_cons_lock, Release, 1)
    ...
    ^bb3:  // pred: ^bb1
      ...
      func.call @passThroughLine(%in_cons_buff_0, %out_buff_0, %c8192_i32_1) : (memref<8192xui8>, memref<8192xui8>, i32) -> ()
      aie.use_lock(%in_cons_prod_lock, Release, 1)
      aie.use_lock(%out_cons_lock, Release, 1)
      aie.end
