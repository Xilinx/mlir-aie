module {
  aie.device(npu1_1col) {
    ...
    ^bb2:  // pred: ^bb1
      ...
      aie.use_lock(%out_prod_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%in_cons_cons_lock, AcquireGreaterEqual, 1)
      func.call @passThroughLine(%in_cons_buff_1, %out_buff_1, %c11264_i32) : (memref<11264xui8>, memref<11264xui8>, i32) -> ()
      aie.use_lock(%in_cons_prod_lock, Release, 1)
      aie.use_lock(%out_cons_lock, Release, 1)
    ...
    memref.global "private" constant @blockwrite_data_0 : memref<8xi32> = dense<[11264, 0, 0, 0, -2147483648, 0, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_1 : memref<8xi32> = dense<[11264, 0, 0, 0, -2147483648, 0, 0, 33554432]>
