module attributes {llvm.target_triple = "aie2"} {
  llvm.mlir.global external @in_cons_buff_1() {addr_space = 0 : i32} : !llvm.array<2048 x i8>
  llvm.mlir.global external @in_cons_buff_0() {addr_space = 0 : i32} : !llvm.array<2048 x i8>
  llvm.mlir.global external @out_buff_1() {addr_space = 0 : i32} : !llvm.array<2048 x i8>
  llvm.mlir.global external @out_buff_0() {addr_space = 0 : i32} : !llvm.array<2048 x i8>
  ...
  llvm.mlir.global external @out_cons() {addr_space = 0 : i32} : !llvm.array<2048 x i8>
  llvm.mlir.global external @out() {addr_space = 0 : i32} : !llvm.array<2048 x i8>
  llvm.mlir.global external @in_cons() {addr_space = 0 : i32} : !llvm.array<2048 x i8>
  llvm.mlir.global external @in() {addr_space = 0 : i32} : !llvm.array<2048 x i8>
  ...
  ^bb2:  // pred: ^bb1
    ...
    %17 = llvm.getelementptr %4[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<2048 x i8>
    ...
    llvm.call @llvm.aie2.acquire(%10, %13) : (i32, i32) -> ()
    llvm.call @llvm.aie2.acquire(%9, %13) : (i32, i32) -> ()
    %25 = llvm.getelementptr %1[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<2048 x i8>
    %26 = llvm.ptrtoint %25 : !llvm.ptr to i64
    %27 = llvm.and %26, %3  : i64
    %28 = llvm.icmp "eq" %27, %14 : i64
    "llvm.intr.assume"(%28) : (i1) -> ()
    %29 = llvm.getelementptr %0[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<2048 x i8>
  ...
  ^bb3:  // pred: ^bb1
    llvm.call @llvm.aie2.acquire(%10, %13) : (i32, i32) -> ()
    llvm.call @llvm.aie2.acquire(%9, %13) : (i32, i32) -> ()
    %34 = llvm.getelementptr %4[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<2048 x i8>
    %35 = llvm.ptrtoint %34 : !llvm.ptr to i64
    %36 = llvm.and %35, %3  : i64
    %37 = llvm.icmp "eq" %36, %14 : i64
    "llvm.intr.assume"(%37) : (i1) -> ()
    %38 = llvm.getelementptr %2[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<2048 x i8>
