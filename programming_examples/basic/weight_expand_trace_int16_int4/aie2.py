...
def my_expand():
    ...
    input_buffer_size_bytes = (n // 2) + (
        sf_size * 2
    )  # They are int16 sfs after the private values
    ...
    with mlir_mod_ctx() as ctx:
        ...
        def device_body():
            ...
            expand_int4_to_int16 = external_func(
                "expand_int4_to_int16", inputs=[memRef_i_ty, memRef_o_ty]
            )
            ...
            def core_body():
                for _ in for_(0xFFFFFFFF):
                    for _ in for_(tiles):
                        ...
                        call(expand_int4_to_int16, [elem_in, elem_out])
