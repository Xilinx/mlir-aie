...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd0), /* addrA */ 0x2C00,  /* len */ 1024));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd2), /* addrA */ 0x2400,  /* len */ 1024));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd5), /* addrA */ 0x1400,  /* len */ 4096));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd3), /* addrA */ 0x2800,  /* len */ 1024));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd1), /* addrA */ 0x3000,  /* len */ 1024));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd0), /* addrA */ 0x82800,  /* len */ 1024));
...
dma_tile_0_1_bd_2_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 32, /* Size */ 8};
dma_tile_0_1_bd_2_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 2, /* Size */ 4};
dma_tile_0_1_bd_2_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 8, /* Size */ 4};
dma_tile_0_1_bd_2_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 2};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd2), &dma_tile_0_1_bd_2_tensor, 0x82800,  /* len */ 1024));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd24), /* addrA */ 0x82000,  /* len */ 1024));
...
dma_tile_0_1_bd_26_tensor.NumDim = 4;
dma_tile_0_1_bd_26_tensor.Dim =__mlir_aie_alloc_dim_desc(4);
if(NULL == dma_tile_0_1_bd_26_tensor.Dim){
  return 1;
}
dma_tile_0_1_bd_26_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 64, /* Size */ 4};
dma_tile_0_1_bd_26_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 2, /* Size */ 4};
dma_tile_0_1_bd_26_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 8, /* Size */ 8};
dma_tile_0_1_bd_26_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 2};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd26), &dma_tile_0_1_bd_26_tensor, 0x82000,  /* len */ 1024));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile01_bd4), XAie_LockInit(68,-1),XAie_LockInit(69,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd4), /* addrA */ 0x80000,  /* len */ 4096));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile01_bd6), XAie_LockInit(69,-1),XAie_LockInit(68,1)));
...
dma_tile_0_1_bd_6_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 128, /* Size */ 8};
dma_tile_0_1_bd_6_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 8, /* Size */ 4};
dma_tile_0_1_bd_6_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 32, /* Size */ 4};
dma_tile_0_1_bd_6_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 8};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd6), &dma_tile_0_1_bd_6_tensor, 0x80000,  /* len */ 4096));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile01_bd7), XAie_LockInit(69,-1),XAie_LockInit(68,1)));
XAie_DmaTensor dma_tile_0_1_bd_7_tensor = {};
dma_tile_0_1_bd_7_tensor.NumDim = 4;
dma_tile_0_1_bd_7_tensor.Dim =__mlir_aie_alloc_dim_desc(4);
if(NULL == dma_tile_0_1_bd_7_tensor.Dim){
  return 1;
}
dma_tile_0_1_bd_7_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 128, /* Size */ 8};
dma_tile_0_1_bd_7_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 8, /* Size */ 4};
dma_tile_0_1_bd_7_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 32, /* Size */ 4};
dma_tile_0_1_bd_7_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 8};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd7), &dma_tile_0_1_bd_7_tensor, 0x81000,  /* len */ 4096));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd5), /* addrA */ 0x81000,  /* len */ 4096));
...
dma_tile_0_1_bd_27_tensor.NumDim = 4;
dma_tile_0_1_bd_27_tensor.Dim =__mlir_aie_alloc_dim_desc(4);
if(NULL == dma_tile_0_1_bd_27_tensor.Dim){
  return 1;
}
dma_tile_0_1_bd_27_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 64, /* Size */ 4};
dma_tile_0_1_bd_27_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 2, /* Size */ 4};
dma_tile_0_1_bd_27_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 8, /* Size */ 8};
dma_tile_0_1_bd_27_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 2};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd27), &dma_tile_0_1_bd_27_tensor, 0x82400,  /* len */ 1024));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd25), /* addrA */ 0x82400,  /* len */ 1024));
...
dma_tile_0_1_bd_3_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 32, /* Size */ 8};
dma_tile_0_1_bd_3_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 2, /* Size */ 4};
dma_tile_0_1_bd_3_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 8, /* Size */ 4};
dma_tile_0_1_bd_3_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 2};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd3), &dma_tile_0_1_bd_3_tensor, 0x82C00,  /* len */ 1024));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd1), /* addrA */ 0x82C00,  /* len */ 1024));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(0,1), /* ChNum */2, /* dmaDir */ DMA_S2MM, /* BdNum */4, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
__mlir_aie_try(XAie_DmaChannelEnable(&(ctx->DevInst), XAie_TileLoc(0,1), /* ChNum */ 2, /* dmaDir */ DMA_S2MM));
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(0,1), /* ChNum */2, /* dmaDir */ DMA_MM2S, /* BdNum */6, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(0,1), XAie_LockInit(4, 2)));
...
const int memC_buff_0_offset = 1024;
int32_t mlir_aie_read_buffer_memC_buff_0(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,2), memC_buff_0_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_memC_buff_0(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,2), memC_buff_0_offset + (index*4), int_value);
return rc;
}
const int memC_buff_1_offset = 5120;
int32_t mlir_aie_read_buffer_memC_buff_1(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,2), memC_buff_1_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_memC_buff_1(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,2), memC_buff_1_offset + (index*4), int_value);
return rc;
}
// buffer memB_cons_buff_0 with unsupported type memref<32x32xi8>;
// buffer memB_cons_buff_1 with unsupported type memref<32x32xi8>;
// buffer memA_cons_buff_0 with unsupported type memref<32x32xi8>;
// buffer memA_cons_buff_1 with unsupported type memref<32x32xi8>;
const int memC_cons_buff_0_offset = 0;
int32_t mlir_aie_read_buffer_memC_cons_buff_0(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,1), memC_cons_buff_0_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_memC_cons_buff_0(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,1), memC_cons_buff_0_offset + (index*4), int_value);
return rc;
}
const int memC_cons_buff_1_offset = 4096;
int32_t mlir_aie_read_buffer_memC_cons_buff_1(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(0,1), memC_cons_buff_1_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_memC_cons_buff_1(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(0,1), memC_cons_buff_1_offset + (index*4), int_value);
return rc;
}
// buffer inB_cons_buff_0 with unsupported type memref<32x32xi8>;
// buffer inB_cons_buff_1 with unsupported type memref<32x32xi8>;
// buffer inA_cons_buff_0 with unsupported type memref<32x32xi8>;
// buffer inA_cons_buff_1 with unsupported type memref<32x32xi8>;
...
int mlir_aie_acquire_memC_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 4;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,1), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_memC_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 4;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,1), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_memC_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 5;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,1), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_memC_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 5;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,1), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_memC_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 4;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_memC_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 4;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_memC_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 5;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_memC_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 5;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_memB_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_memB_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_memB_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_memB_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
...
int mlir_aie_acquire_memA_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_memA_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_memA_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_memA_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
