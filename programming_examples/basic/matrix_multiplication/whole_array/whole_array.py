...
def my_matmul(
    ...
    # This design will have always 4 rows and 4 cols (to maximize performance)
    n_aie_rows = 4
    ...
    def device_body():
        ...
        for row in range(n_aie_rows):
            A_l2l1_fifos[row] = object_fifo(
                ...
                # We have 4 compute tiles, so each needs it's own
                # S2MM transformation. TODO: change that to compact format in python using for _ in range(n_aie_cols)
                [
                    [
                        (k // s, r * s),
                        (m // r, r * k),
        ...
        for col in range(n_aie_cols):
            ...
            # repeat test here
            A_l2l1_fifos[col].set_repeat_count(N//n//n_aie_cols)
                ...
                for pingpong in [0, 1]:
                    ...
                    for col in range(n_aie_cols):
                        ...
                        for tile_row in range(tb_n_rows):
                            ...
                            # A_sizes = [N // n // n_aie_cols, K // k, m, k,]
                            # A_strides = [0, k, K, 1]

                            # change those to mtk representation
