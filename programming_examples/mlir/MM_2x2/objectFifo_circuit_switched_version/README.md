...
## MM_2x2 Design Example : (ObjectFifo) Circuit-Switch Version
...
This particular design leverages the ObjectFifo abstraction, which lowers into the circuit-switched version. With this abstraction, AIE buffers and locks are abstracted into the ObjectFifo and can only be interacted with via acquire, release and subview access operations. <br>
