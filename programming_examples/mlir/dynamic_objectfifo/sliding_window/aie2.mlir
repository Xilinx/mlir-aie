...
module {
  aie.device(npu1_1col) {
    func.func private @passthrough_64_i32(memref<64xi32>, memref<64xi32>, memref<64xi32>)

    %tile_0_0 = aie.tile(0, 0)
    %tile_0_2 = aie.tile(0, 2)
    aie.objectfifo @input_fifo(%tile_0_0, {%tile_0_2}, 3 : i32) : !aie.objectfifo<memref<64xi32>>
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        %0 = aie.objectfifo.acquire @output_fifo(Produce, 1) : !aie.objectfifosubview<memref<64xi32>>
        ...
        %rel = scf.if %is_first_iter -> (index) {
          %2 = aie.objectfifo.acquire @input_fifo(Consume, 1) : !aie.objectfifosubview<memref<64xi32>>
          %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<64xi32>> -> memref<64xi32>
          func.call @sum_64_i32(%3, %3, %1) : (memref<64xi32>, memref<64xi32>, memref<64xi32>) -> ()
          ...
          %relss = scf.if %is_last_iter -> (index) {
            ...
            %2 = aie.objectfifo.acquire @input_fifo(Consume, 2) : !aie.objectfifosubview<memref<64xi32>>
            %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<64xi32>> -> memref<64xi32>
            %4 = aie.objectfifo.subview.access %2[1] : !aie.objectfifosubview<memref<64xi32>> -> memref<64xi32>
            func.call @sum_64_i32(%3, %4, %1) : (memref<64xi32>, memref<64xi32>, memref<64xi32>) -> ()
            ...
            %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<64xi32>> -> memref<64xi32>
            %4 = aie.objectfifo.subview.access %2[1] : !aie.objectfifosubview<memref<64xi32>> -> memref<64xi32>
            func.call @sum_64_i32(%input_0, %input_0, %output_fifo_buff) : (memref<64xi32>, memref<64xi32>, memref<64xi32>) -> ()
