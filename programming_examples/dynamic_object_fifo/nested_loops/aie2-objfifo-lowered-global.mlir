module {
  aie.device(npu1_1col) {
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0_2 to %c5 step %c1_3 {
        ...
        scf.for %arg1 = %c0_2 to %c5 step %c1_3 {
          ...
          func.call @passthrough_10_i32(%1, %6) : (memref<10xi32>, memref<10xi32>) -> ()
        ...
        %3 = arith.addi %2, %c1_4 : index
        %4 = arith.remsi %3, %c2_1 : index
        memref.store %4, %buffer_0_2[%c1] : memref<2xindex>
      }
      aie.end
    } {link_with = "kernel.o"}
