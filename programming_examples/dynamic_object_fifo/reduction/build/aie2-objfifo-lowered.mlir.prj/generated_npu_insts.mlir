module {
  aie.device(npu1_1col) {
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      cf.br ^bb1(%c0, %c0, %c0 : index, index, index)
    ...
    memref.global "private" constant @blockwrite_data_0 : memref<8xi32> = dense<[100, 0, 0, 0, -2147483648, 0, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_1 : memref<8xi32> = dense<[50, 0, 0, 0, -2147483648, 0, 0, 33554432]>
