...
module {
  aie.device(npu1_1col) {
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      func.call @add_10_i32(%input_fifo_cons_buff_0, %input_fifo_cons_buff_0, %output_fifo_buff_0) : (memref<10xi32>, memref<10xi32>, memref<10xi32>) -> ()
      ...
      func.call @add_10_i32(%input_fifo_cons_buff_2, %input_fifo_cons_buff_0, %output_fifo_buff_1) : (memref<10xi32>, memref<10xi32>, memref<10xi32>) -> ()
