...
alignas(128) int8_t WIn[weightTileSize];
...
int main() {
    ...
    size_t vecSizeInW = sizeof(WIn) / sizeof(v32int8); // will load 128 at a time
    ...
    printf("Compute..\n");
    dwconv_int8<M, N, C, DW_S, DW_W>((input_window_uint8*)&actInWindow,
