...
#     raise ValueError("[ERROR] In1 buffer size ("+str(in1_size)+") must be a multiple of 64 and greater than or equal to 512")
out_size = int(sys.argv[3])
trace_size = 0 if (len(sys.argv) != 5) else int(sys.argv[4])

with mlir_mod_ctx() as ctx:
    relu(dev, in1_size, out_size, trace_size)
