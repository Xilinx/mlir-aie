# eltwise_mul/eltwise_mul_iron_jit.py -*- Python -*-
#
...
@iron.jit
def my_eltwise_mul(input1, input2, output):
    ...
    eltwise_mul_bf16_vector = ExternalFunction(
        ...
        source_file=os.path.join(kernel_dir, "mul.cc"),
    ...
    def core_body(of_in1, of_in2, of_out, eltwise_mul):
        for _ in range_(N_div_n):
            ...
            eltwise_mul(elem_in1, elem_in2, elem_out)
            of_in1.release(1)
            of_in2.release(1)
            of_out.release(1)
...
def main():
    ...
    my_eltwise_mul(input1, input2, output)
