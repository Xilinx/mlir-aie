...
Same shape as ml/relu: every shim DMA in/out pair feeds a ``kernels.gelu``
worker that LUT-approximates the tanh-form of GELU on its ``1024``-element
sub-vector.

Two invocation modes:

  * standalone:   ``python3 gelu.py``
...
def gelu(
    ...
    *,
    ...
    gelu_fn = kernels.gelu(tile_size=line_size)
