...
def my_gelu(dev, size, num_columns, num_channels):
    xfr_dtype = bfloat16
...
## Call the my_gelu function with the parsed arguments
## and print the MLIR as a result
print(my_gelu(dev, length, columns, channels))
