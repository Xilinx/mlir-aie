...
from aie.utils import TraceConfig, HostRuntime, NPUKernel
...
def main(opts):
    ...
    kernel_handle = iron.DEFAULT_IRON_RUNTIME.load(npu_kernel)
    ...
    for i in range(num_iter):
        ret = iron.DEFAULT_IRON_RUNTIME.run(kernel_handle, buffers)
