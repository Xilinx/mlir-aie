...
def main():
    argparser = argparse.ArgumentParser(
        prog="AIE Matrix Multiplication MLIR Design (Whole Array) with bfp16 input/output",
...
def my_matmul(M, K, N, m, k, n, n_aie_cols):
    ...
    for col in range(n_aie_cols):
        ...
        dims_to_stream = None
        # This would be equivalent to a transposition of the shuffled matrix for a 64x64 tile
