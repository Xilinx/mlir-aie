...
void yolo_m9_sv_row_i8_i8(
  ...
  for (int cb = 0; cb < kCBlocks; ++cb) {
    ...
    if (r0 > I8_MAX) r0 = I8_MAX; if (r0 < I8_MIN) r0 = I8_MIN;
    if (r1 > I8_MAX) r1 = I8_MAX; if (r1 < I8_MIN) r1 = I8_MIN;
    if (r2 > I8_MAX) r2 = I8_MAX; if (r2 < I8_MIN) r2 = I8_MIN;
    if (r3 > I8_MAX) r3 = I8_MAX; if (r3 < I8_MIN) r3 = I8_MIN;
