//===- yolo_c3k2_heavy_inner_pair_cv1.cc ----------------------*- C++ -*-===//
//
// Scalar 3x3 stride-1 INT8 conv + SiLU LUT. Same shape signature as
// c3k2_small's m0_cv1 — kept as a separate symbol so heavy and small can
// coexist in a chain with different runtime shapes.
//
//===----------------------------------------------------------------------===//
