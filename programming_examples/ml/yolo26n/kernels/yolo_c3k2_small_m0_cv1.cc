//===- yolo_c3k2_small_m0_cv1.cc --------------------------------------*- C++ -*-===//
//
// Scalar 3x3 stride-1 INT8 conv with OIYXI8O8 weight layout. Linear-only.
// Matches iron_sim_kernels._conv3x3_stride1_math (same border semantics,
// same banker_srs requant).
//
//===----------------------------------------------------------------------===//
