...
# from aie2_bottleneckB import BottleneckBCore
...
class BottleneckBCoreB10B11:
    def __init__(self,_bottleneckName,_computeTileBN10_1,_computeTileBN10_2,_computeTileBN10_3,_computeTileBN11_1,_computeTileBN11_2,_computeTileBN11_3,
                 _weightsInBN10_1,_weightsInBN10_2,_weightsInBN10_3, _weightsInBN11_1,_weightsInBN11_2,_weightsInBN11_3,
                 _rtpBN10_1,_rtpBN10_2,_rtpBN10_3,_rtpBN11_1,_rtpBN11_2,_rtpBN11_3,
                 _skipMemTile,
        ...
        # Output 
        OF_b10_act_layer1_layer2 = object_fifo(self.bottleneckName+"_OF_b10_act_layer1_layer2", self.computeTileBN10_1, [self.computeTileBN10_2], 4,b10_layer2_in,via_DMA=True) 
        OF_b10_act_layer2_layer3 = object_fifo(self.bottleneckName+"_OF_b10_act_layer2_layer3", self.computeTileBN10_2, [self.computeTileBN10_3], 2,b10_layer3_in) 
        # ************************ bneck11 ************************ 
        OF_b10_layer3_bn_11_layer1 = object_fifo(self.bottleneckName+"_OF_b10_layer3_bn_11_layer1", self.computeTileBN10_3, [self.computeTileBN11_1,self.skipMemTile], [2, 2, 6], b11_layer1_in) 
        ...
        OF_b11_act_layer1_layer2 = object_fifo(self.bottleneckName+"_OF_b11_act_layer1_layer2", self.computeTileBN11_1, [self.computeTileBN11_2], 4,b11_layer2_in,via_DMA=True) 
        OF_b11_act_layer2_layer3 = object_fifo(self.bottleneckName+"_OF_b11_act_layer2_layer3", self.computeTileBN11_2, [self.computeTileBN11_3], 2,b11_layer3_in) # 
        # # ************************ bneck12 ************************ 
...
def mobilenetV3_A_B(tileColIndex = 0, b_start_col=0, b_start_row=2, tensorInW = 56, tensorInH = 56, tensorInC = 16, 
                                bn0_scaleFactor2 = 8, bn0_scaleFactor3 = 9,  bn0_scaleFactorAdd = 1,
...
# 
    ...
    def device_body():
        ...
        bn10_tile_1 = tile(tileColIndex+2, 4)
        bn10_tile_2 = tile(tileColIndex+2, 5)
        bn10_tile_3 = tile(tileColIndex+3, 5)

        # Moving to the next group, starting from the 4th core
        bn11_tile_1 = tile(tileColIndex+3, 4)
        bn11_tile_2 = tile(tileColIndex+3, 3)
        bn11_tile_3 = tile(tileColIndex+3, 2)
        ...
        wts_b10_L3L2 = object_fifo("wts_b10_L3L2", ShimTile20, MemTile21, 1, b10_all_wts ) 
        bn10_1_wts_OF_L3L1 = object_fifo("weightsInBN10_layer1", MemTile21, bn10_tile_1, 1, b10_layer1_wts ) 
        bn10_2_wts_OF_L3L1 = object_fifo("weightsInBN10_layer2", MemTile21, bn10_tile_2, 1, b10_layer2_wts, ) 
        bn10_3_wts_OF_L3L1 = object_fifo("weightsInBN10_layer3", MemTile21, bn10_tile_3, 1, b10_layer3_wts, ) 
        ...
        # wts 
        wts_b11_L3L2 = object_fifo("wts_b11_L3L2", ShimTile30, MemTile31, 1, b11_all_wts ) 
        bn11_1_wts_OF_L3L1 = object_fifo("weightsInBN11_layer1", MemTile31, bn11_tile_1, 1, b11_layer1_wts ) 
        bn11_2_wts_OF_L3L1 = object_fifo("weightsInBN11_layer2", MemTile31, bn11_tile_2, 1, b11_layer2_wts, ) 
        bn11_3_wts_OF_L3L1 = object_fifo("weightsInBN11_layer3", MemTile31, bn11_tile_3, 1, b11_layer3_wts, ) 
        ...
        act_bn9_bn10 = object_fifo("act_bn9_bn10", ComputeTile23, bn10_tile_1, 2, b10_layer1_in)
        ...
        bottleneckACore("bn9", ComputeTile23, act_bn8_bn9, bn9_wts_OF_L3L1, act_bn9_bn10, rtpComputeTile23, bn9_objectArchiveName, 
        ...
        act_out = object_fifo("act_out", bn11_tile_3, ShimTile30, 2, b11_layer3_out)

        BottleneckBCoreB10B11("B",bn10_tile_1,bn10_tile_2,bn10_tile_3,bn11_tile_1,bn11_tile_2,bn11_tile_3,
                        bn10_1_wts_OF_L3L1,bn10_2_wts_OF_L3L1,bn10_3_wts_OF_L3L1,bn11_1_wts_OF_L3L1,bn11_2_wts_OF_L3L1,bn11_3_wts_OF_L3L1,
                        bn10_1_rtp,bn10_2_rtp,bn10_3_rtp,bn11_1_rtp,bn11_2_rtp,bn11_3_rtp,
                        MemTile21,act_bn9_bn10,act_out, bn10_scaleFactor1,bn10_scaleFactor2,bn10_scaleFactor3,
                           bn11_scaleFactor1,bn11_scaleFactor2,bn11_scaleFactor3,bn11_scaleFactorAdd,
                           bn12_scaleFactor1,bn12_scaleFactor2,bn12_scaleFactor3)
        ...
        B_block_totalWeightsSize32b = (
            memtile_21_wts32b + memtile_31_wts32b 
        )

        weightsInL3_ty = MemRefType.get((total_weights//4+B_block_totalWeightsSize32b,), int32_ty)
        ...
        def sequence(inputFromL3, weightsFromL3, outputToL3):
            ...
            NpuWriteRTPOp("bn10_1_rtp", col=tileColIndex+2, row=4, index=0, value=bn10_scaleFactor1)
            NpuWriteRTPOp("bn10_2_rtp", col=tileColIndex+2, row=5, index=0, value=bn10_scaleFactor2)
            NpuWriteRTPOp("bn10_3_rtp", col=tileColIndex+3, row=5, index=0, value=bn10_scaleFactor3)


            NpuWriteRTPOp("bn11_1_rtp", col=tileColIndex+3, row=4, index=0, value=bn11_scaleFactor1)
            NpuWriteRTPOp("bn11_2_rtp", col=tileColIndex+3, row=3, index=0, value=bn11_scaleFactor2)
            NpuWriteRTPOp("bn11_3_rtp", col=tileColIndex+3, row=2, index=0, value=bn11_scaleFactor3)
            NpuWriteRTPOp("bn11_3_rtp", col=tileColIndex+3, row=2, index=1, value=bn11_scaleFactorAdd)

            # NpuWriteRTPOp("bn12_1_rtp", col=selected_cores[6][0], row=selected_cores[6][1], index=0, value=bn12_scaleFactor1)
            # NpuWriteRTPOp("bn12_2_rtp", col=selected_cores[7][0], row=selected_cores[7][1], index=0, value=bn12_scaleFactor2)
            # NpuWriteRTPOp("bn12_3_rtp", col=selected_cores[8][0], row=selected_cores[8][1], index=0, value=bn12_scaleFactor3)
            ...
            npu_dma_memcpy_nd(
                ...
                bd_id=1,
                mem=weightsFromL3,
                offsets=[0, 0, 0, memtile_21_offset],
                sizes=[1, 1, 1, memtile_21_wts32b],
            )
            npu_dma_memcpy_nd(
                metadata="wts_b11_L3L2",
                bd_id=1,
                mem=weightsFromL3,
                offsets=[0, 0, 0, memtile_31_offset],
                sizes=[1, 1, 1, memtile_31_wts32b],
            )
            # npu_dma_memcpy_nd(
            #     metadata="wts_b12_L3L2",
            #     bd_id=1,
            #     mem=weightsFromL3,
            #     offsets=[0, 0, 0, memtile_41_offset],
            #     sizes=[1, 1, 1, memtile_41_wts32b],
            # )
...
with mlir_mod_ctx() as ctx:
    ...
    mobilenetV3_A_B(tileColIndex = 0,b_start_col=0, b_start_row=2,
                                        tensorInW = 112, tensorInH = 112, tensorInC = 16, 
