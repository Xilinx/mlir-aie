...
Entries missing here are left to aiecc's placer. The remaining ones are
needed for the design to compile: the fused pairs' alloc tiles also host
init and bn11, and without the rest the placer overflows L1 or memtile
capacity or cannot seat the cascade chains.
"""
