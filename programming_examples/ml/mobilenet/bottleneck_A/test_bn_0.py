...
def main(opts):
    ...
    bn0_wts2.tofile(
        weight_folder + "/bn0_layer2_after_weights_mem_fmt_final.txt",
        sep=",",
        format="%d",
    )
    bn0_wts3.tofile(
        weight_folder + "/bn0_layer3_after_weights_mem_fmt_final.txt",
        sep=",",
        format="%d",
    )
    ...
    total_wts.tofile(
        weight_folder + "/bn0_after_weights_mem_fmt_final.txt", sep=",", format="%d"
    )
