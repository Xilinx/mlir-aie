...
def main(opts):
    ...
    bn0_total_wts.tofile(log_folder + "/bn0_chain.txt", sep=",", format="%d")
    bn1_total_wts.tofile(log_folder + "/bn1_chain.txt", sep=",", format="%d")
    bn01_total_wts.tofile(log_folder + "/bn0_1_chain.txt", sep=",", format="%d")
    bn2_total_wts.tofile(log_folder + "/bn2_chain.txt", sep=",", format="%d")
    bn3_total_wts.tofile(log_folder + "/bn3_chain.txt", sep=",", format="%d")
    bn4_total_wts.tofile(log_folder + "/bn4_chain.txt", sep=",", format="%d")
    bn5_total_wts.tofile(log_folder + "/bn5_chain.txt", sep=",", format="%d")
    bn4_5_total_wts.tofile(log_folder + "/bn4_5_chain.txt", sep=",", format="%d")
    bn6_total_wts.tofile(log_folder + "/bn6_chain.txt", sep=",", format="%d")
    bn7_total_wts.tofile(log_folder + "/bn7_chain.txt", sep=",", format="%d")
    bn8_total_wts.tofile(log_folder + "/bn8_chain.txt", sep=",", format="%d")
    bn9_total_wts.tofile(log_folder + "/bn9_chain.txt", sep=",", format="%d")
    bn8_9_total_wts.tofile(log_folder + "/bn8_9_chain.txt", sep=",", format="%d")
