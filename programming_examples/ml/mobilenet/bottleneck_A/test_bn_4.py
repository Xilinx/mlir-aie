...
bneck_4_InW1 = tensorInW
bneck_4_InH1 = tensorInH
bneck_4_InC1 = tensorInC
bneck_4_OutC1 = depthWiseChannels

bneck_4_InW2 = bneck_4_InW1
bneck_4_InH2 = bneck_4_InH1
bneck_4_OutC2 = bneck_4_OutC1

bneck_4_InW3 = bneck_4_InW2
bneck_4_InH3 = bneck_4_InH2
bneck_4_OutC3 = bneck_4_InC1

bneck_4_InC1_vec =  math.floor(bneck_4_InC1/vectorSize)
bneck_4_OutC3_vec =  math.floor(bneck_4_OutC3/vectorSize)


def main(opts):
    design = "mobilenet_bottleneck_A_bn4"
    ...
    shape_total_wts = (bneck_4_InC1*bneck_4_OutC1 + 3*3*bneck_4_OutC2 + bneck_4_OutC2*bneck_4_OutC3, 1)
    shape_in_act = (bneck_4_InH1, bneck_4_InC1_vec, bneck_4_InW1, vectorSize)  #'YCXC8' , 'CYX'
    shape_out = (bneck_4_InH3, bneck_4_OutC3_vec, bneck_4_InW3, vectorSize) # HCWC8
    shape_out_final = (bneck_4_OutC3_vec*vectorSize, bneck_4_InH3, bneck_4_InW3) # CHW
    
    # ------------------------------------------------------
    # Initialize activation, weights, scaling factor for int8 model
    # ------------------------------------------------------
    input = torch.randn(1, bneck_4_InC1_vec*vectorSize, bneck_4_InH1, bneck_4_InW1)
    # ------------------------------------------------------
    ...
    class QuantBottleneckA(nn.Module):
        def __init__(self, in_planes=16, bn4_expand=16,bn4_project=16):
    ...
    quant_bottleneck_model = QuantBottleneckA(in_planes=bneck_4_InC1, bn4_expand=bneck_4_OutC1,bn4_project=bneck_4_OutC3)
    ...
    transform = transforms.Compose([
        ...
        transforms.CenterCrop(bneck_4_InW1),
        transforms.ToTensor(),
        transforms.Normalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225]),
        ExpandChannels(target_channels=bneck_4_InC1)  # Expand to 80 channels
    ])
    data_dir = "data"
    ...
    block_4_inp_scale1= quant_bottleneck_model.quant_id_1.quant_act_scale()
    ...
    total_wts = np.concatenate((bn4_wts1, bn4_wts2, bn4_wts3), axis=None)
