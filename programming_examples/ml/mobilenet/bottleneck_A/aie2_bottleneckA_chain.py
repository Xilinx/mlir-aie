...
from aie2_bottleneck8And9Static import bottleneckAFused_8and9Static
from aie2_bottleneck0Static import bottleneckBN0Static
...
def mobilenetV3_bn_0_1_2_3_4_5_6_7_8_9(
    ...
    def device_body():
        ...
        bn0_tile = tile(tileColIndex, 3)  # bn0
        bn1_tile = tile(tileColIndex, 4)  # bn1
        bn2_tile = tile(tileColIndex, 5)  # bn2
        bn3_tile = tile(tileColIndex + 1, 3)  # bn3
        # bn4_tile = tile(tileColIndex + 1, 4)  # bn4
        # bn5_tile = tile(tileColIndex + 1, 5)  # bn5
        bn4_5_tile = tile(tileColIndex + 1, 2)  # bn4
        ...
        # rtp_bn1_tile = buffer(bn1_tile, [16], T.i32(), "rtp04") #bn1
        # rtp_bn2_tile = buffer(bn2_tile, [16], T.i32(), "rtp05") #bn2
        # rtp_bn3_tile = buffer(bn3_tile, [16], T.i32(), "rtp15") #bn3
        # rtpbn4_tile = buffer(bn4_tile, [16], T.i32(), "rtp14") #bn4
        # rtpbn5_tile = buffer(bn5_tile, [16], T.i32(), "rtp13") #bn5
        # rtp_bn6_tile = buffer(bn6_tile, [16], T.i32(), "rtp12") #bn6
        # rtp_bn7_tile = buffer(bn7_tile, [16], T.i32(), "rtp22") #bn7
        # rtp_bn8_9_tile = buffer(bn8_9_tile, [16], T.i32(), "rtp23") #bn8+bn9

        rtp_bn0_tile = buffer(
            bn0_tile, np.ndarray[(16,), np.dtype[np.int32]], "rtp_bn0_tile"
        )  # bn0
        rtp_bn1_tile = buffer(
            bn1_tile, np.ndarray[(16,), np.dtype[np.int32]], "rtp_bn1_tile"
        )  # bn1
        rtp_bn2_tile = buffer(
            bn2_tile, np.ndarray[(16,), np.dtype[np.int32]], "rtp_bn2_tile"
        )  # bn2
        rtp_bn3_tile = buffer(
            bn3_tile, np.ndarray[(16,), np.dtype[np.int32]], "rtp_bn3_tile"
        )  # bn3
        # rtpbn4_tile = buffer(
        #     bn4_tile, np.ndarray[(16,), np.dtype[np.int32]], "rtp14"
        # )  # bn4
        # rtpbn5_tile = buffer(
        #     bn5_tile, np.ndarray[(16,), np.dtype[np.int32]], "rtp13"
        # )  # bn5
        rtp_bn4_5_tile = buffer(
            bn4_5_tile, np.ndarray[(16,), np.dtype[np.int32]], "rtp_bn4_5_tile"
        )  # bn0
        rtp_bn6_tile = buffer(
            bn6_tile, np.ndarray[(16,), np.dtype[np.int32]], "rtp_bn6_tile"
        )  # bn6
        rtp_bn7_tile = buffer(
            bn7_tile, np.ndarray[(16,), np.dtype[np.int32]], "rtp_bn7_tile"
        )  # bn7
        rtp_bn8_9_tile = buffer(
            bn8_9_tile, np.ndarray[(16,), np.dtype[np.int32]], "rtp_bn8_9_tile"
        )  # bn8+bn9

        # rtpL1_tile_for_bn4_5 = buffer(L1_tile_for_bn4_5, [16], T.i32(), "rtp24") #bn9
        # AIE-array data movement with object fifos

        # Input
        act_in = object_fifo("act_in", ShimTile00, bn0_tile, 4, tensorLayerIn_ty)
        ...
        #     "bn0_wts_OF_L2L1", MemTile01, bn0_tile, [1, 1], bn0_weightsAllLayers_ty
        # )
        # bn1_wts_OF_L3L1 = object_fifo(
        #     "bn1_wts_OF_L2L1", MemTile01, bn1_tile, [1, 1], bn1_weightsAllLayers_ty
        # )
        # bn2_wts_OF_L3L1 = object_fifo(
        #     "bn2_wts_OF_L2L1", MemTile01, bn2_tile, [1, 1], bn2_weightsAllLayers_ty
        # )
        # bn3_wts_OF_L3L1 = object_fifo(
        #     "bn3_wts_OF_L2L1", MemTile01, bn3_tile, [1, 1], bn3_weightsAllLayers_ty
        # )
        # bn4_wts_OF_L3L1 = object_fifo(
        #     "bn4_wts_OF_L2L1", MemTile01, bn4_tile, [1, 1], bn4_weightsAllLayers_ty
        # )
        # bn5_wts_OF_L3L1 = object_fifo(
        #     "bn5_wts_OF_L2L1", MemTile01, bn5_tile, [1, 1], bn5_weightsAllLayers_ty
        # )
        # object_fifo_link(
        #     wts_OF_01_L3L2,
        #     [
        ...
        #     "bn6_wts_OF_L2L1", MemTile11, bn6_tile, [1, 1], bn6_weightsAllLayers_ty
        # )
        # bn7_wts_OF_L3L1 = object_fifo(
        #     "bn7_wts_OF_L2L1", MemTile11, bn7_tile, [1, 1], bn7_weightsAllLayers_ty
        # )
        ...
        # )
        # # bn9_wts_OF_L3L1 = object_fifo("bn9_wts_OF_L2L1", MemTile11, L1_tile_for_bn4_5, [1,1], bn9_weightsAllLayers_ty)
        # object_fifo_link(
        #     wts_OF_11_L3L2,
        ...
        act_bn7_bn8 = object_fifo(
            "act_bn7_bn8", bn7_tile, bn8_9_tile, 2, bn7_tensorLayer3Out_ty
        )
        ...
        #  # Output
        # act_bn8_bn9 = object_fifo("act_bn8_bn9", bn8_9_tile, L1_tile_for_bn4_5, 2, bn8_tensorLayer3Out_ty)
        # # act_out = object_fifo("act_out", bn8_9_tile, [ShimTile10], 1, bn8_tensorLayer3Out_ty)

        # bottleneckACore("bn8", bn8_9_tile, act_bn7_bn8, bn8_9_wts_OF_L3L1, act_bn8_bn9, rtp_bn8_9_tile, bn8_objectArchiveName,
        ...
        # # Output
        # act_out = object_fifo("act_out", L1_tile_for_bn4_5, ShimTile10, 2, tensorLayerOut_ty)
        ...
        # bottleneckACore("bn9", L1_tile_for_bn4_5, act_bn8_bn9, bn9_wts_OF_L3L1, act_out, rtpL1_tile_for_bn4_5, bn9_objectArchiveName,
        ...
        def sequence(inputFromL3, weightsFromL3, outputToL3):
            ...
            # bn2
            NpuWriteRTPOp("rtp_bn2_tile", index=0, value=bn2_scaleFactor1)
            NpuWriteRTPOp("rtp_bn2_tile", index=1, value=bn2_scaleFactor2)
            ...
            NpuWriteRTPOp("rtp_bn3_tile", index=3, value=bn3_scaleFactorAdd)
            ...
            NpuWriteRTPOp("rtp_bn8_9_tile", index=7, value=bn9_scaleFactorAdd)
