...
def main(opts):
    ...
    shape_total_wts = (bneck_7_InC1*bneck_7_OutC1 + 3*3*bneck_7_OutC2 + bneck_7_OutC2*bneck_7_OutC3, 1)
    shape_in_act = (bneck_7_InH1, bneck_7_InC1_vec, bneck_7_InW1, vectorSize)  #'YCXC8' , 'CYX'
    shape_out = (bneck_7_InH3, bneck_7_OutC3_vec, bneck_7_InW3, vectorSize) # HCWC8
    shape_out_final = (bneck_7_OutC3_vec*vectorSize, bneck_7_InH3, bneck_7_InW3) # CHW
    ...
    quant_bottleneck_model = QuantBottleneckA(in_planes=bneck_7_InC1, bn7_expand=bneck_7_OutC1,bn7_project=bneck_7_OutC3)
    ...
    block_7_inp_scale1= quant_bottleneck_model.quant_id_1.quant_act_scale()
