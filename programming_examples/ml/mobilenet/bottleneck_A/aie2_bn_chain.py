...
from aie2_bottleneck8And9 import bottleneckAFused_8and9
from aie2_bottleneck0 import bottleneckBN0
...
def mobilenetV3_bn_0_1_2_3_4_5_6_7_8_9(
    ...
    def device_body():
        ...
        memtile_11_wts = bn6_weights_size + bn7_weights_size + bn8_9_weights_size
        ...
        ComputeTile03 = tile(tileColIndex, 3)  # bn0
        ComputeTile04 = tile(tileColIndex, 4)  # bn1
        ComputeTile05 = tile(tileColIndex, 5)  # bn2
        ComputeTile15 = tile(tileColIndex + 1, 5)  # bn3
        ComputeTile14 = tile(tileColIndex + 1, 4)  # bn4
        ComputeTile13 = tile(tileColIndex + 1, 3)  # bn5
        ComputeTile12 = tile(tileColIndex + 1, 2)  # bn6
        ComputeTile22 = tile(tileColIndex + 2, 2)  # bn7
        ComputeTile23 = tile(tileColIndex + 2, 3)  # bn8+bn9
        ComputeTile24 = tile(tileColIndex + 2, 4)  # bn9

        # Set up compute tiles
        # rtpComputeTile03 = buffer(ComputeTile03, [16], T.i32(), "rtp03") #bn0
        # rtpComputeTile04 = buffer(ComputeTile04, [16], T.i32(), "rtp04") #bn1
        # rtpComputeTile05 = buffer(ComputeTile05, [16], T.i32(), "rtp05") #bn2
        # rtpComputeTile15 = buffer(ComputeTile15, [16], T.i32(), "rtp15") #bn3
        # rtpComputeTile14 = buffer(ComputeTile14, [16], T.i32(), "rtp14") #bn4
        # rtpComputeTile13 = buffer(ComputeTile13, [16], T.i32(), "rtp13") #bn5
        # rtpComputeTile12 = buffer(ComputeTile12, [16], T.i32(), "rtp12") #bn6
        # rtpComputeTile22 = buffer(ComputeTile22, [16], T.i32(), "rtp22") #bn7
        # rtpComputeTile23 = buffer(ComputeTile23, [16], T.i32(), "rtp23") #bn8+bn9

        rtpComputeTile03 = buffer(
            ComputeTile03, np.ndarray[(16,), np.dtype[np.int32]], "rtp03"
        )  # bn0
        rtpComputeTile04 = buffer(
            ComputeTile04, np.ndarray[(16,), np.dtype[np.int32]], "rtp04"
        )  # bn1
        rtpComputeTile05 = buffer(
            ComputeTile05, np.ndarray[(16,), np.dtype[np.int32]], "rtp05"
        )  # bn2
        rtpComputeTile15 = buffer(
            ComputeTile15, np.ndarray[(16,), np.dtype[np.int32]], "rtp15"
        )  # bn3
        rtpComputeTile14 = buffer(
            ComputeTile14, np.ndarray[(16,), np.dtype[np.int32]], "rtp14"
        )  # bn4
        rtpComputeTile13 = buffer(
            ComputeTile13, np.ndarray[(16,), np.dtype[np.int32]], "rtp13"
        )  # bn5
        rtpComputeTile12 = buffer(
            ComputeTile12, np.ndarray[(16,), np.dtype[np.int32]], "rtp12"
        )  # bn6
        rtpComputeTile22 = buffer(
            ComputeTile22, np.ndarray[(16,), np.dtype[np.int32]], "rtp22"
        )  # bn7
        rtpComputeTile23 = buffer(
            ComputeTile23, np.ndarray[(16,), np.dtype[np.int32]], "rtp23"
        )  # bn8+bn9

        # rtpComputeTile24 = buffer(ComputeTile24, [16], T.i32(), "rtp24") #bn9
        # AIE-array data movement with object fifos

        # Input
        act_in = object_fifo("act_in", ShimTile00, ComputeTile03, 4, tensorLayerIn_ty)

        # wts
        wts_OF_01_L3L2 = object_fifo(
            "wts_OF_01_L3L2", ShimTile00, MemTile01, 1, memtile_01_wts_ty
        )
        bn0_wts_OF_L3L1 = object_fifo(
            "bn0_wts_OF_L2L1", MemTile01, ComputeTile03, [1, 1], bn0_weightsAllLayers_ty
        )
        bn1_wts_OF_L3L1 = object_fifo(
            "bn1_wts_OF_L2L1", MemTile01, ComputeTile04, [1, 1], bn1_weightsAllLayers_ty
        )
        bn2_wts_OF_L3L1 = object_fifo(
            "bn2_wts_OF_L2L1", MemTile01, ComputeTile05, [1, 1], bn2_weightsAllLayers_ty
        )
        bn3_wts_OF_L3L1 = object_fifo(
            "bn3_wts_OF_L2L1", MemTile01, ComputeTile15, [1, 1], bn3_weightsAllLayers_ty
        )
        bn4_wts_OF_L3L1 = object_fifo(
            "bn4_wts_OF_L2L1", MemTile01, ComputeTile14, [1, 1], bn4_weightsAllLayers_ty
        )
        bn5_wts_OF_L3L1 = object_fifo(
            "bn5_wts_OF_L2L1", MemTile01, ComputeTile13, [1, 1], bn5_weightsAllLayers_ty
        )
        object_fifo_link(
            wts_OF_01_L3L2,
            [
            ...
            [
                0,
                bn0_weights_size,
                bn0_weights_size + bn1_weights_size,
                bn0_weights_size + bn1_weights_size + bn2_weights_size,
                bn0_weights_size
                + bn1_weights_size
                + bn2_weights_size
                + bn3_weights_size,
        ...
        #  # wts
        wts_OF_11_L3L2 = object_fifo(
            "wts_OF_11_L3L2", ShimTile10, MemTile11, 1, memtile_11_wts_ty
        )
        bn6_wts_OF_L3L1 = object_fifo(
            "bn6_wts_OF_L2L1", MemTile11, ComputeTile12, [1, 1], bn6_weightsAllLayers_ty
        )
        bn7_wts_OF_L3L1 = object_fifo(
            "bn7_wts_OF_L2L1", MemTile11, ComputeTile22, [1, 1], bn7_weightsAllLayers_ty
        )
        bn8_9_wts_OF_L3L1 = object_fifo(
            "bn8_9_wts_OF_L2L1",
            MemTile11,
            ComputeTile23,
            [1, 1],
            bn8_9_weightsAllLayers_ty,
        )
        # bn9_wts_OF_L3L1 = object_fifo("bn9_wts_OF_L2L1", MemTile11, ComputeTile24, [1,1], bn9_weightsAllLayers_ty)
        object_fifo_link(
            wts_OF_11_L3L2,
            [bn6_wts_OF_L3L1, bn7_wts_OF_L3L1, bn8_9_wts_OF_L3L1],
            [],
            [0, bn6_weights_size, bn6_weights_size + bn7_weights_size],
        )
        ...
        act_bn0_bn1 = object_fifo(
            "act_bn0_bn1", ComputeTile03, ComputeTile04, 2, bn0_tensorLayer3Out_ty
        )
        # act_bn0_bn1 = object_fifo("act_out", ComputeTile03, ShimTile10, 2, bn0_tensorLayer3Out_ty)
        ...
        act_bn1_bn2 = object_fifo(
            "act_bn1_bn2", ComputeTile04, ComputeTile05, 2, bn1_tensorLayer3Out_ty
        )
        # act_bn1_bn2 = object_fifo("act_out", ComputeTile04, ShimTile10, 2, bn1_tensorLayer3Out_ty)
        ...
        act_bn2_bn3 = object_fifo(
            "act_bn2_bn3", ComputeTile05, ComputeTile15, 2, bn2_tensorLayer3Out_ty
        )
        # act_out = object_fifo("act_out", ComputeTile05, [ShimTile10], 1, bn2_tensorLayer3Out_ty)
        ...
        act_bn3_bn4 = object_fifo(
            "act_bn3_bn4", ComputeTile15, ComputeTile14, 2, bn3_tensorLayer3Out_ty
        )
        # act_out = object_fifo("act_out", ComputeTile15, [ShimTile10], 1, bn3_tensorLayer3Out_ty)
        bottleneckACore(
            "bn3",
            ComputeTile15,
            act_bn2_bn3,
        ...
        act_bn4_bn5 = object_fifo(
            "act_bn4_bn5", ComputeTile14, ComputeTile13, 2, bn4_tensorLayer3Out_ty
        )
        # act_out = object_fifo("act_out", ComputeTile14, [ShimTile10], 1, bn4_tensorLayer3Out_ty)
        bottleneckACore(
            "bn4",
            ComputeTile14,
            act_bn3_bn4,
        ...
        act_bn5_bn6 = object_fifo(
            "act_bn5_bn6", ComputeTile13, ComputeTile12, 2, bn5_tensorLayer3Out_ty
        )
        # act_out = object_fifo("act_out", ComputeTile13, [ShimTile10], 1, bn5_tensorLayer3Out_ty)
        bottleneckACore(
            "bn5",
            ComputeTile13,
            act_bn4_bn5,
        ...
        act_bn6_bn7 = object_fifo(
            "act_bn6_bn7", ComputeTile12, ComputeTile22, 2, bn6_tensorLayer3Out_ty
        )
        ...
        act_bn7_bn8 = object_fifo(
            "act_bn7_bn8", ComputeTile22, ComputeTile23, 2, bn7_tensorLayer3Out_ty
        )
        # act_bn7_bn8 = object_fifo("act_out", ComputeTile22, [ShimTile10], 1, bn7_tensorLayer3Out_ty)
        bottleneckACore(
            "bn7",
            ComputeTile22,
            act_bn6_bn7,
        ...
        act_out = object_fifo(
            "act_out", ComputeTile23, [ShimTile10], 1, tensorLayerOut_ty
        )
        ...
        #  # Output
        # act_bn8_bn9 = object_fifo("act_bn8_bn9", ComputeTile23, ComputeTile24, 2, bn8_tensorLayer3Out_ty)
        # # act_out = object_fifo("act_out", ComputeTile23, [ShimTile10], 1, bn8_tensorLayer3Out_ty)

        # bottleneckACore("bn8", ComputeTile23, act_bn7_bn8, bn8_9_wts_OF_L3L1, act_bn8_bn9, rtpComputeTile23, bn8_objectArchiveName,
        ...
        # # Output
        # act_out = object_fifo("act_out", ComputeTile24, ShimTile10, 2, tensorLayerOut_ty)
        ...
        # bottleneckACore("bn9", ComputeTile24, act_bn8_bn9, bn9_wts_OF_L3L1, act_out, rtpComputeTile24, bn9_objectArchiveName,
        ...
        def sequence(inputFromL3, weightsFromL3, outputToL3):
            ...
            # # bn1
            NpuWriteRTPOp("rtp04", index=0, value=bn1_scaleFactor1)
            NpuWriteRTPOp("rtp04", index=1, value=bn1_scaleFactor2)
            NpuWriteRTPOp("rtp04", index=2, value=bn1_scaleFactor3)

            # bn2
            NpuWriteRTPOp("rtp05", index=0, value=bn2_scaleFactor1)
            NpuWriteRTPOp("rtp05", index=1, value=bn2_scaleFactor2)
            NpuWriteRTPOp("rtp05", index=2, value=bn2_scaleFactor3)
            NpuWriteRTPOp("rtp05", index=3, value=bn2_scaleFactorAdd)

            # # bn3
            NpuWriteRTPOp("rtp15", index=0, value=bn3_scaleFactor1)
            NpuWriteRTPOp("rtp15", index=1, value=bn3_scaleFactor2)
            NpuWriteRTPOp("rtp15", index=2, value=bn3_scaleFactor3)
            NpuWriteRTPOp("rtp15", index=3, value=bn3_scaleFactorAdd)

            # bn4
            NpuWriteRTPOp("rtp14", index=0, value=bn4_scaleFactor1)
            NpuWriteRTPOp("rtp14", index=1, value=bn4_scaleFactor2)
            NpuWriteRTPOp("rtp14", index=2, value=bn4_scaleFactor3)
            NpuWriteRTPOp("rtp14", index=3, value=bn4_scaleFactorAdd)

            # # bn5
            NpuWriteRTPOp("rtp13", index=0, value=bn5_scaleFactor1)
            NpuWriteRTPOp("rtp13", index=1, value=bn5_scaleFactor2)
            NpuWriteRTPOp("rtp13", index=2, value=bn5_scaleFactor3)
            NpuWriteRTPOp("rtp13", index=3, value=bn5_scaleFactorAdd)
            ...
            NpuWriteRTPOp("rtp22", index=0, value=bn7_scaleFactor1)
            NpuWriteRTPOp("rtp22", index=1, value=bn7_scaleFactor2)
            NpuWriteRTPOp("rtp22", index=2, value=bn7_scaleFactor3)
            NpuWriteRTPOp("rtp22", index=3, value=bn7_scaleFactorAdd)

            NpuWriteRTPOp("rtp23", index=0, value=bn8_scaleFactor1)
            NpuWriteRTPOp("rtp23", index=1, value=bn8_scaleFactor2)
            NpuWriteRTPOp("rtp23", index=2, value=bn8_scaleFactor3)
            NpuWriteRTPOp("rtp23", index=3, value=bn8_scaleFactorAdd)

            NpuWriteRTPOp("rtp23", index=4, value=bn9_scaleFactor1)
            NpuWriteRTPOp("rtp23", index=5, value=bn9_scaleFactor2)
            NpuWriteRTPOp("rtp23", index=6, value=bn9_scaleFactor3)
            NpuWriteRTPOp("rtp23", index=7, value=bn9_scaleFactorAdd)
...
if __name__ == "__main__":
    ...
    with mlir_mod_ctx() as ctx:
        mobilenetV3_bn_0_1_2_3_4_5_6_7_8_9(
            tileColIndex=0,
            tensorInW=112,
            tensorInH=112,
            tensorInC=16,
