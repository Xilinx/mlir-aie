...
def main(opts):
    ...
    shape_total_wts = ((bneck_8_InC1*bneck_8_OutC1 + 3*3*bneck_8_OutC2 + bneck_8_OutC2*bneck_8_OutC3)+
    ...
    class QuantBottleneck0(nn.Module):
        def __init__(self,bn7_project=40, 
                     bn8_expand=92,bn8_project=40,
                     bn9_expand=92,bn9_project=40):
