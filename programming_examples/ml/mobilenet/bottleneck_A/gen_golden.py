...
def main():
    ...
    print("Running torch reference model for bottleneck_A_chain ...")
    ...
    # quant_model = GGQuantBottleneck(in_planes=bneck_2_InC1, bn2_expand=bneck_2_OutC1,bn2_project=bneck_2_OutC3)
    ...
    # gg_block_2_int_weight_1 = quant_model.bn2_quant_conv1.quant_weight().int(
    #     float_datatype=True
    # )
    # gg_block_2_int_weight_2 = quant_model.bn2_quant_conv2.quant_weight().int(
    #     float_datatype=True
    # )
    # gg_block_2_int_weight_3 = quant_model.bn2_quant_conv3.quant_weight().int(
    #     float_datatype=True
    # )
    # **************************** bn2 ****************************
    ...
    # gg_q_bottleneck_out = quant_model(input)
    ...
    block_0_inp_scale = quant_model.quant_id_1.act_quant.scale()
