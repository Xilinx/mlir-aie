...
sys.path.append(os.path.join(os.path.dirname(__file__), "bottleneck_A"))
from aie2_bottleneckAStatic import bottleneckACoreStatic
from bottleneck_B.aie2_bottleneckBStatic import bottleneckBCoreStatic
from bottleneck_C.aie2_bottleneckC import bottleneckCCore
...
def mobilenetV3(
    ...
    def device_body():
        ...
        # rtp_bn4_tile = buffer(bn4_tile, np.ndarray[(16,), np.dtype[np.int32]], "rtp_bn4") #bn4
        # rtp_bn5_tile = buffer(bn5_tile, np.ndarray[(16,), np.dtype[np.int32]], "rtp_bn5") #bn5
        rtp_bn6_tile = buffer(
        ...
        rtp_bn8_9_tile = buffer(
            bn8_9_tile, np.ndarray[(16,), np.dtype[np.int32]], "rtp_bn8_bn9"
        )  # bn8+bn9
        ...
        act_bn9_bn10 = object_fifo(
            "act_bn9_bn10", bn8_9_tile, bn10_tile_1, [1, 2], bn8_tensorLayer3Out_ty
        ...
        #                  bn5_tile, bn6_tile, bn7_tile, bn8_9_tile, ComputeTile24]
