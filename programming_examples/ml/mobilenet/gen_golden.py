...
def main():
    ...
    print("Running torch reference model for mobilenet ...")
    ...
    class QuantMobilenet(nn.Module):
        def __init__(
            ...
            self.bn0_quant_id_2.act_quant.fused_activation_quant_proxy.tensor_quant.scaling_impl = (
                self.init_relu.act_quant.fused_activation_quant_proxy.tensor_quant.scaling_impl
            )
            self.bn0_quant_id_2.act_quant.fused_activation_quant_proxy.tensor_quant.int_scaling_impl = (
                self.init_relu.act_quant.fused_activation_quant_proxy.tensor_quant.int_scaling_impl
            )
    ...
    quant_model = QuantMobilenet(
        in_planes=tensorInC,
        bn0_expand=bneck_0_InC2,
        bn0_project=bneck_0_OutC3,
        bn1_expand=bneck_1_OutC1,
        bn1_project=bneck_1_OutC3,
        bn2_expand=bneck_2_OutC1,
        bn2_project=bneck_2_OutC3,
        bn3_expand=bneck_3_OutC1,
        bn3_project=bneck_3_OutC3,
        bn4_expand=bneck_4_OutC1,
        bn4_project=bneck_4_OutC3,
        bn5_expand=bneck_5_OutC1,
        bn5_project=bneck_5_OutC3,
        bn6_expand=bneck_6_OutC1,
        bn6_project=bneck_6_OutC3,
        bn7_expand=bneck_7_OutC1,
        ...
        bn10_expand=bneck_10_OutC2,
        bn10_project=bneck_10_OutC3,
        bn11_expand=bneck_11_OutC2,
        bn11_project=bneck_11_OutC3,
        bn12_expand=bneck_12_OutC2,
        bn12_project=bneck_12_OutC3,
        bn13_expand=bneck_13_OutC2,
        bn13_project=bneck_13_OutC3,
        bn14_expand=bneck_13_OutC2,
        bn14_project=bneck_13_OutC3,
        post_conv1=post_L1_OutC,
    ...
    post_combined_conv1_scale = -torch.log2(
        block_14_skip_add * post_weight_scale1 / post_relu
    )
    ...
    post_layer2_combined_conv1_scale = -torch.log2(
        post_relu * post_layer2_weight_scale1 / post_layer2_relu
    )
    print("********************POST*******************************")
    print("combined_scale after POST conv1x1:", post_combined_conv1_scale.item())
    print(
        "combined_scale after POST 2 conv1x1:", post_layer2_combined_conv1_scale.item()
    )
    ...
    post_layer3_combined_conv1_scale = -torch.log2(
        post_layer2_relu * post_layer3_weight_scale1 / post_layer3_relu
    )
    print("********************FC2*******************************")
    ...
    post_layer2_conv1_int_weight = (
        quant_model.post_layer2_quant_conv1.quant_weight().int(float_datatype=True)
    )
    post_layer3_conv1_int_weight = (
        quant_model.post_layer3_quant_conv1.quant_weight().int(float_datatype=True)
    )
    print("FC1 weights shape::", post_layer2_conv1_int_weight.shape)
    print("FC2 weights shape::", post_layer3_conv1_int_weight.shape)
    padded_post_layer2_conv1_int_weight = pad_weights(
        post_layer2_conv1_int_weight, target_weights_shape
    )
    padded_post_layer3_conv1_int_weight = pad_weights(
        post_layer3_conv1_int_weight, target_weights_shape
    )
    ...
    init_wts_fmt.tofile(log_dir + "init_chain.txt", sep=",", format="%d")
    bn0_total_wts.tofile(log_dir + "bn0_chain.txt", sep=",", format="%d")
    bn1_total_wts.tofile(log_dir + "bn1_chain.txt", sep=",", format="%d")
    bn01_total_wts.tofile(log_dir + "bn0_1_chain.txt", sep=",", format="%d")
    bn2_total_wts.tofile(log_dir + "bn2_chain.txt", sep=",", format="%d")
    bn3_total_wts.tofile(log_dir + "bn3_chain.txt", sep=",", format="%d")
    bn4_total_wts.tofile(log_dir + "bn4_chain.txt", sep=",", format="%d")
    bn5_total_wts.tofile(log_dir + "bn5_chain.txt", sep=",", format="%d")
    bn4_5_total_wts.tofile(log_dir + "bn4_5_chain.txt", sep=",", format="%d")
    bn6_total_wts.tofile(log_dir + "bn6_chain.txt", sep=",", format="%d")
    bn7_total_wts.tofile(log_dir + "bn7_chain.txt", sep=",", format="%d")
    bn8_total_wts.tofile(log_dir + "bn8_chain.txt", sep=",", format="%d")
    bn9_total_wts.tofile(log_dir + "bn9_chain.txt", sep=",", format="%d")
    bn8_9_total_wts.tofile(log_dir + "bn8_9_chain.txt", sep=",", format="%d")
    #
    ...
    #
    bn13_wts1.tofile(log_dir + "bn13_1_chain.txt", sep=",", format="%d")
    bn13_wts2.tofile(log_dir + "bn13_2_chain.txt", sep=",", format="%d")
    bn13_wts3_put.tofile(log_dir + "bn13_3_put_chain.txt", sep=",", format="%d")
    bn13_wts3_get.tofile(log_dir + "bn13_3_get_chain.txt", sep=",", format="%d")
    bn14_wts1.tofile(log_dir + "bn14_1_chain.txt", sep=",", format="%d")
    bn14_wts2.tofile(log_dir + "bn14_2_chain.txt", sep=",", format="%d")
    bn14_wts3_put.tofile(log_dir + "bn14_3_put_chain.txt", sep=",", format="%d")
    bn14_wts3_get.tofile(log_dir + "bn14_3_get_chain.txt", sep=",", format="%d")

    post_conv1_int_weight_fmt = ds.reorder_mat(
        post_conv1_int_weight.data.numpy().astype(dtype_wts), "OIYXI8O8", "OIYX"
    )
    post_conv1_int_weight_fmt.tofile(
        log_dir + "post_conv_chain.txt", sep=",", format="%d"
    )
    ...
    post_layer2_conv1_weights_splits = [
        padded_post_layer2_conv1_int_weight[
            k * (O_total // 4) : (k + 1) * (O_total // 4), ...
        ]
        for k in range(4)
    ]
    post_layer2_conv1_int_weight_fmt = [
        ds.reorder_mat(weight_split.data.numpy().astype(dtype_wts), "OIYXI8O8", "OIYX")
        for weight_split in post_layer2_conv1_weights_splits
    ]

    post_layer3_conv1_weights_splits = [
        padded_post_layer3_conv1_int_weight[
            k * (O_total // 4) : (k + 1) * (O_total // 4), ...
        ]
        for k in range(4)
    ]
    post_layer3_conv1_int_weight_fmt = [
        ds.reorder_mat(weight_split.data.numpy().astype(dtype_wts), "OIYXI8O8", "OIYX")
        for weight_split in post_layer3_conv1_weights_splits
    ]
    ...
    np.concatenate((post_layer2_conv1_int_weight_fmt), axis=None).tofile(
        log_dir + "FC1_chain.txt", sep=",", format="%d"
    )
    post_layer2_conv1_int_weight_fmt[0].tofile(
        log_dir + "FC1_0_chain.txt", sep=",", format="%d"
    )
    post_layer2_conv1_int_weight_fmt[1].tofile(
        log_dir + "FC1_1_chain.txt", sep=",", format="%d"
    )
    post_layer2_conv1_int_weight_fmt[2].tofile(
        log_dir + "FC1_2_chain.txt", sep=",", format="%d"
    )
    post_layer2_conv1_int_weight_fmt[3].tofile(
        log_dir + "FC1_3_chain.txt", sep=",", format="%d"
    )
    np.concatenate((post_layer3_conv1_int_weight_fmt), axis=None).tofile(
        log_dir + "FC2_chain.txt", sep=",", format="%d"
    )
    post_layer3_conv1_int_weight_fmt[0].tofile(
        log_dir + "FC2_0_chain.txt", sep=",", format="%d"
    )
    post_layer3_conv1_int_weight_fmt[1].tofile(
        log_dir + "FC2_1_chain.txt", sep=",", format="%d"
    )
    post_layer3_conv1_int_weight_fmt[2].tofile(
        log_dir + "FC2_2_chain.txt", sep=",", format="%d"
    )
    post_layer3_conv1_int_weight_fmt[3].tofile(
        log_dir + "FC2_3_chain.txt", sep=",", format="%d"
    )
