...
def mobilenetBottleneckB(bn10_scaleFactor1=10,bn10_scaleFactor2=7,bn10_scaleFactor3=9,
    ...
    with mlir_mod_ctx() as ctx:
        ...
        def device_body():
            ...
            OF_bneck_10_layer3_bn_11_layer1 = object_fifo("OF_bneck_10_layer3_bn_11_layer1", ComputeTile04, [MemTile21], 2, ty_bneck_11_layer1_in)
            OF_outOFL2L3 = object_fifo("outOFL2L3", MemTile21, [ShimTile10], 2, ty_bneck_11_layer1_in)
            object_fifo_link(OF_bneck_10_layer3_bn_11_layer1, OF_outOFL2L3)
