...
class bottleneckBCore:
    ...
    # ************************ bneck10 ************************
        # 1x1 conv2d
        @core(self.computeTileBN10_1, "bn10_conv2dk1_fused_relu_dummy.o")
        def core_body():
        ...
        # # # Compute tile 3
        @core(self.computeTileBN10_2, "bn10_conv2dk3_dw_dummy.o")
        def core_body():
            scale = 7
        ...
        # Compute tile 4
        @core(self.computeTileBN10_3, "bn10_conv2dk1_ui8_dummy.o")
        def core_body():
    ...
    # # # ************************ bneck11 ************************
    # #     #     # 1x1 conv2d
        @core(self.computeTileBN11_1, "bn11_conv2dk1_fused_relu_dummy.o")
        def core_body():
        ...
        # # # # # # Compute tile 3
        @core(self.computeTileBN11_2, "bn11_conv2dk3_dw_dummy.o")
        def core_body():
            scale = 8
        ...
        # # Compute tile 4
        @core(self.computeTileBN11_3, "bn11_conv2dk1_skip_dummy.o")
        def core_body():
    ...
    # # # ************************ bneck12 ************************
    #     # 1x1 conv2d
        @core(self.computeTileBN12_1 , "bn12_conv2dk1_fused_relu_dummy.o")
        def core_body():
        ...
        @core(self.computeTileBN12_2, "bn12_conv2dk3_dw_stride2_dummy.o")
        def core_body():
            scale = 8
    ...
    #     # # Compute tile 4
        @core(self.computeTileBN12_3, "bn12_conv2dk1_ui8_dummy.o")
        def core_body():
