module {
  aie.device(npu1_1col) {
    ...
    aie.objectfifo @OF_bneck_10_act_layer1_layer2(%tile_0_2, {%tile_0_3}, 4 : i32) : !aie.objectfifo<memref<14x1x480xui8>>
    aie.objectfifo @OF_bneck_10_layer2_final(%tile_0_3, {%tile_0_1}, 2 : i32) : !aie.objectfifo<memref<14x1x480xui8>>
    aie.objectfifo @outOFL2L3(%tile_0_1, {%tile_0_0}, 2 : i32) : !aie.objectfifo<memref<14x1x480xui8>>
    aie.objectfifo.link [@OF_bneck_10_layer2_final] -> [@outOFL2L3]()
    ...
    %core_0_3 = aie.core(%tile_0_3) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %5 = aie.objectfifo.acquire @OF_bneck_10_layer2_final(Produce, 1) : !aie.objectfifosubview<memref<14x1x480xui8>>
        %6 = aie.objectfifo.subview.access %5[0] : !aie.objectfifosubview<memref<14x1x480xui8>> -> memref<14x1x480xui8>
        %c14_i32 = arith.constant 14 : i32
        ...
        aie.objectfifo.release @OF_bneck_10_layer2_final(Produce, 1)
        ...
        scf.for %arg1 = %c0_2 to %c12 step %c1_3 {
          ...
          %16 = aie.objectfifo.acquire @OF_bneck_10_layer2_final(Produce, 1) : !aie.objectfifosubview<memref<14x1x480xui8>>
        ...
        %10 = aie.objectfifo.acquire @OF_bneck_10_layer2_final(Produce, 1) : !aie.objectfifosubview<memref<14x1x480xui8>>
    ...
    func.func @sequence(%arg0: memref<3920xi32>, %arg1: memref<10680xi32>, %arg2: memref<23520xi32>) {
      aiex.npu.rtp_write(0, 2, 0, 8) {buffer_sym_name = "rtp2"}
      ...
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 0][1, 1, 1, 23520][0, 0, 0]) {id = 2 : i64, metadata = @outOFL2L3} : memref<23520xi32>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 0][1, 1, 1, 10680][0, 0, 0]) {id = 1 : i64, metadata = @OF_bneck_10_wts_L3L2} : memref<10680xi32>
