...
quant_model_out_int = quant_model_out.int(float_datatype=True).data.numpy().astype(np.dtype("int8"))
...
final_output_quant=init_scale_2*torch.clamp(torch.round(conv1_out_quant/init_scale_2), min, max)
