...
1. `relu.cc` / `silu.cc` / `gelu.cc`: Vectorized AIE kernels pulled from the IRON kernel library. Sources under [`aie_kernels/eltwise/`](../../../aie_kernels/eltwise/) (relu) and [`aie_kernels/activation/`](../../../aie_kernels/activation/) (silu, gelu).
