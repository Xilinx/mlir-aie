...
In the NYCXC8 data layout, the data is organized in memory as follows:

* N: Represents the batch-size (currently N=1).
...
* 8: Indicates that 8 elements of the input channel are processed together.
