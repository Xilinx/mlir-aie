...
module {
  aie.device(npu1_1col) {
    ...
    // ========================================================================
    // HIGH-LEVEL DECLARATIVE TRACE CONFIGURATION (NEW SYNTAX)
    // ========================================================================
    
    // Trace configuration for compute tile (0,2)
    // This is declarative - specify WHAT you want to trace, not HOW
    aie.trace @core_trace(%tile_0_2) {
      ...
      aie.trace.event<"ACTIVE">               // Core active cycles
      aie.trace.event<"DISABLED">             // Core disabled/idle
