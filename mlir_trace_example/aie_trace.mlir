...
//===----------------------------------------------------------------------===//
//
// This is a standalone MLIR example demonstrating trace functionality on NPU.
// It implements a simple vector-scalar multiplication with trace enabled.
//
...
module {
  aie.device(npu1_1col) {
    ...
    // Flow 1: Route trace from compute tile (0,2) to shim tile (0,0) DMA channel 1
    aie.packet_flow(1) {
      aie.packet_source<%tile_0_2, Trace : 0>
      aie.packet_dest<%shim_noc_tile_0_0, DMA : 1>
    } {keep_pkt_header = true}
    
    // Flow 2: Route trace from shim tile itself to DMA channel 1
    aie.packet_flow(2) {
    ...
    aiex.runtime_sequence(%arg0: memref<4096xi32>, %arg1: memref<1xi32>, %arg2: memref<4096xi32>) {
      ...
      // Address 213200 (0x34110): Trace Control 0 register
      ...
      // Address 213204 (0x34114): Trace Control 1 register
      ...
      // Address 213216 (0x34120): Trace Event register 0
      ...
      // Address 213220 (0x34124): Trace Event register 1
      ...
      // ========================================================================
      // TRACE BUFFER DESCRIPTOR CONFIGURATION
      // ========================================================================
      
      // Configure buffer descriptor 15 for trace data capture
      // This BD writes trace packets to DDR memory (8KB buffer)
      // burst_length = 64 means 64-byte bursts
      // enable_packet = 1 enables packet-switched mode
      aiex.npu.writebd {
        bd_id = 15 : i32, 
      ...
      // ========================================================================
      // DATA TRANSFER CONFIGURATION (as normal)
      // ========================================================================
