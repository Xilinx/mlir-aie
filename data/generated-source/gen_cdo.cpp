...
bool ppgraph_load_elf(const std::string &work_path,
  ...
  {
    if (XAie_LoadElf(&DevInst, XAie_TileLoc(7, 2),
                     (work_dir + "/core_7_2.elf").c_str(),
                     XAIE_ENABLE) != XAIE_OK) {
...
void ppgraph_init(const std::string &work_path) {
  ...
  for (int l = 0; l < 16; l++)
    XAie_LockSetValue(&DevInst, XAie_TileLoc(7, 2), XAie_LockInit(l, 0));
  XAie_DmaDesc dma_tile72_bd0;
  XAie_DmaDescInit(&DevInst, &(dma_tile72_bd0), XAie_TileLoc(7, 2));
  XAie_DmaSetLock(&(dma_tile72_bd0), XAie_LockInit(0, 0), XAie_LockInit(0, 1));
  XAie_DmaSetAddrLen(&(dma_tile72_bd0), /* addrA */ 0x400, /* len */ 128 * 4);
  XAie_DmaSetNextBd(&(dma_tile72_bd0), /* nextbd */ 1, /* enableNextBd */ 1);
  XAie_DmaEnableBd(&(dma_tile72_bd0));
  XAie_DmaWriteBd(&DevInst, &(dma_tile72_bd0), XAie_TileLoc(7, 2), /* bd */ 0);
  XAie_DmaDesc dma_tile72_bd1;
  XAie_DmaDescInit(&DevInst, &(dma_tile72_bd1), XAie_TileLoc(7, 2));
  XAie_DmaSetLock(&(dma_tile72_bd1), XAie_LockInit(1, 0), XAie_LockInit(1, 1));
  XAie_DmaSetAddrLen(&(dma_tile72_bd1), /* addrA */ 0xA00, /* len */ 128 * 4);
  XAie_DmaSetNextBd(&(dma_tile72_bd1), /* nextbd */ 0, /* enableNextBd */ 1);
  XAie_DmaEnableBd(&(dma_tile72_bd1));
  XAie_DmaWriteBd(&DevInst, &(dma_tile72_bd1), XAie_TileLoc(7, 2), /* bd */ 1);
  XAie_DmaDesc dma_tile72_bd2;
  XAie_DmaDescInit(&DevInst, &(dma_tile72_bd2), XAie_TileLoc(7, 2));
  XAie_DmaSetLock(&(dma_tile72_bd2), XAie_LockInit(4, 0), XAie_LockInit(4, 1));
  XAie_DmaSetAddrLen(&(dma_tile72_bd2), /* addrA */ 0x600, /* len */ 128 * 4);
  XAie_DmaSetNextBd(&(dma_tile72_bd2), /* nextbd */ 3, /* enableNextBd */ 1);
  XAie_DmaEnableBd(&(dma_tile72_bd2));
  XAie_DmaWriteBd(&DevInst, &(dma_tile72_bd2), XAie_TileLoc(7, 2), /* bd */ 2);
  XAie_DmaDesc dma_tile72_bd3;
  XAie_DmaDescInit(&DevInst, &(dma_tile72_bd3), XAie_TileLoc(7, 2));
  XAie_DmaSetLock(&(dma_tile72_bd3), XAie_LockInit(5, 0), XAie_LockInit(5, 1));
  XAie_DmaSetAddrLen(&(dma_tile72_bd3), /* addrA */ 0xC00, /* len */ 128 * 4);
  XAie_DmaSetNextBd(&(dma_tile72_bd3), /* nextbd */ 2, /* enableNextBd */ 1);
  XAie_DmaEnableBd(&(dma_tile72_bd3));
  XAie_DmaWriteBd(&DevInst, &(dma_tile72_bd3), XAie_TileLoc(7, 2), /* bd */ 3);
  XAie_DmaDesc dma_tile72_bd4;
  XAie_DmaDescInit(&DevInst, &(dma_tile72_bd4), XAie_TileLoc(7, 2));
  XAie_DmaSetLock(&(dma_tile72_bd4), XAie_LockInit(2, 1), XAie_LockInit(2, 0));
  XAie_DmaSetAddrLen(&(dma_tile72_bd4), /* addrA */ 0x800, /* len */ 128 * 4);
  XAie_DmaSetNextBd(&(dma_tile72_bd4), /* nextbd */ 5, /* enableNextBd */ 1);
  XAie_DmaEnableBd(&(dma_tile72_bd4));
  XAie_DmaWriteBd(&DevInst, &(dma_tile72_bd4), XAie_TileLoc(7, 2), /* bd */ 4);
  XAie_DmaDesc dma_tile72_bd5;
  XAie_DmaDescInit(&DevInst, &(dma_tile72_bd5), XAie_TileLoc(7, 2));
  XAie_DmaSetLock(&(dma_tile72_bd5), XAie_LockInit(3, 1), XAie_LockInit(3, 0));
  XAie_DmaSetAddrLen(&(dma_tile72_bd5), /* addrA */ 0xE00, /* len */ 128 * 4);
  XAie_DmaSetNextBd(&(dma_tile72_bd5), /* nextbd */ 4, /* enableNextBd */ 1);
  XAie_DmaEnableBd(&(dma_tile72_bd5));
  XAie_DmaWriteBd(&DevInst, &(dma_tile72_bd5), XAie_TileLoc(7, 2), /* bd */ 5);
  XAie_DmaChannelPushBdToQueue(&DevInst, XAie_TileLoc(7, 2), /* ChNum */ 0,
                               /* dmaDir */ DMA_S2MM, /* BdNum */ 0);
  XAie_DmaChannelEnable(&DevInst, XAie_TileLoc(7, 2), /* ChNum */ 0,
                        /* dmaDir */ DMA_S2MM);
  XAie_DmaChannelPushBdToQueue(&DevInst, XAie_TileLoc(7, 2), /* ChNum */ 1,
                               /* dmaDir */ DMA_S2MM, /* BdNum */ 2);
  XAie_DmaChannelEnable(&DevInst, XAie_TileLoc(7, 2), /* ChNum */ 1,
                        /* dmaDir */ DMA_S2MM);
  XAie_DmaChannelPushBdToQueue(&DevInst, XAie_TileLoc(7, 2), /* ChNum */ 0,
                               /* dmaDir */ DMA_MM2S, /* BdNum */ 4);
  XAie_DmaChannelEnable(&DevInst, XAie_TileLoc(7, 2), /* ChNum */ 0,
                        /* dmaDir */ DMA_MM2S);
  int x, y;
  ...
  XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(x, y), NORTH, 1, SOUTH, 3);
  ...
  XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(x, y), DMA, 1, SOUTH, 1);
  ...
  XAie_StrmConnCctEnable(&DevInst, XAie_TileLoc(x, y), NORTH, 1, SOUTH, 1);
  ...
  XAie_EnableAieToShimDmaStrmPort(&DevInst, XAie_TileLoc(x, y), 3);
} // ppgraph_init
...
public:
  InitializeAIEControl() {
    ...
    XAie_SetupPartitionConfig(&DevInst, XAIE_PARTITION_BASE_ADDR, 1, 8);
