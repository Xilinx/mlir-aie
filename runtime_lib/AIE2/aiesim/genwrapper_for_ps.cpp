...
void PSIP_ps_i3::aximm_transaction(xtlm::xtlm_aximm_initiator_rd_socket_util& rd_util, xtlm::xtlm_aximm_initiator_wr_socket_util& wr_util, xtlm::xtlm_command command, unsigned long long address, unsigned char* pData, unsigned int trans_size_in_bytes)
{
...
void PSIP_ps_i3::set_payload_attr(xtlm::aximm_payload* trans, size_t transBytes) {
