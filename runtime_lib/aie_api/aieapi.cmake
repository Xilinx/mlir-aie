...
function(add_aie_api_headers SRCPATH BUILDPATH INSTALLPATH)
  ...
  # copy aie_api header files into install area
  install(DIRECTORY ${SRCPATH}/ DESTINATION ${INSTALLPATH}/aie_api)

  message("Copying aie_api includes from ${SRCPATH} to ${BUILDPATH}/aie_api")
  
  # copy aie_api header files into build area
  ...
  foreach(header ${headers_to_copy})
      ...
      set(dest ${BUILDPATH}/aie_api/${rel_path})
