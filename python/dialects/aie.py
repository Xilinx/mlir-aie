...
class Core(CoreOp):
    ...
    def __init__(self, tile, link_with=None, dynamic_objfifo_lowering=False):
        super().__init__(result=T.index(), tile=tile, link_with=link_with, dynamic_objfifo_lowering=dynamic_objfifo_lowering)
