...
class LitConfigHelper:
    ...
    @staticmethod
    def detect_rocm(hsa_dir: str, aie_host_target: str, 
                    enable_board_tests: bool = False) -> HardwareConfig:
        """
            ...
            try:
                ...
                for line in output:
                    if "Versal VCK5000" in line:
                        ...
                        found_vck5000 = True
                        config.substitutions["%run_on_vck5000"] = "flock /tmp/vck5000.lock"
                        break
    ...
    @staticmethod
    def detect_xrt(xrt_lib_dir: str, xrt_include_dir: str, 
                   xrt_bin_dir: str, aie_src_root: str) -> Tuple[HardwareConfig, str, str]:
        """
    ...
    @staticmethod
    def detect_chess(vitis_root: str, enable_chess_tests: bool, 
                     llvm_config) -> HardwareConfig:
        """
    ...
    @staticmethod
    def detect_peano(peano_tools_dir: str, peano_install_dir: str, 
                     llvm_config) -> HardwareConfig:
        """
    ...
    @staticmethod
    def setup_host_target_triplet(aie_host_target: str, 
                                  vitis_sysroot: str = "") -> Tuple[str, str]:
        """
    ...
    @staticmethod
    def setup_standard_environment(llvm_config, config_obj, aie_obj_root: str, 
                                   vitis_aietools_dir: str):
        """
    ...
    @staticmethod
    def setup_test_lib_substitutions(config_obj, aie_obj_root: str, 
                                     aie_host_target: str):
        """
