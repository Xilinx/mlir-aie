...
# Key: (function_name, args_signature) -> NPUCallable instance
...
class Compilable:
    ...
    def compile(self, *args, **kwargs) -> NPUCallable:
        """
        Compile the function into an NPUCallable using the provided arguments.

        Args:
            *args: Arguments passed to the function for MLIR generation.
            **kwargs: Keyword arguments passed to the function.

        Returns:
            NPUCallable: The compiled callable.
        """
        ...
        cache_key = _create_function_cache_key(self.function, args, kwargs)
        ...
        compiled_kernel = NPUCallable(
            xclbin_path,
            inst_path,
            kernel_name="MLIR_AIE",
            trace_config=trace_config,
        )
        _compiled_kernels[cache_key] = compiled_kernel
