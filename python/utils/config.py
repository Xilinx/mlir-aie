...
def nm_path():
    ...
    Same sourcing rule as :func:`objcopy_path`: AIE objects use the AIEngine
    ELF e_machine, which GNU binutils nm cannot parse.
    """
    ...
    raise RuntimeError(
        ...
        "or on PATH. GNU binutils nm cannot process AIE objects, so an LLVM "
        "nm is required."
    )
